...
6. 【订单中心】新增订单，1028分辨率下，参团的线路产品控件显示不出来了； 编辑->有安排的返程住宿，应该不能清空（现在清空有安排的返程住宿保存提示成功，进入时没有清空的； 编辑和查看页面中，客户的联系人没有显示出来； 新增游客小组，行程手工输入，添加两段参团后，保存；再次编辑，删除这两段，系统保存成功了，且行程变成了选择的线路产品。不正确，应该提示用户需要有参团信息。

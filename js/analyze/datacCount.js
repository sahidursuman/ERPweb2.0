var data = {
	...
	'tab-resource_travelLine-content':[
		...
		{
			key: '#tab-resource_lineProduct-add-content .T-details',
			args:  ["_trackEvent", "新建线路产品", "按钮", "编辑行程详情", 1, siteId]
		},
		{
			key: '#tab-resource_lineProduct-add-content .T-delete',
			args:  ["_trackEvent", "新建线路产品", "按钮", "删除", 1, siteId]
		},
		{
			key: '#tab-resource_lineProduct-add-content .T-btn-cancel',
			args:  ["_trackEvent", "新建线路产品", "按钮", "取消", 1, siteId]
		},
		{
			key: '#tab-resource_lineProduct-add-content .T-btn-save',
			args:  ["_trackEvent", "新建线路产品", "按钮", "保存", 1, siteId]
		},
		{//复制线路模板
	...
	'tab-arrange_quote-content':[//报价管理
		...
		{//修改报价
			key: '#quoteContent-update-update .T-addInsurance',
			args:  ["_trackEvent", "修改报价", "按钮", "新增保险", 1, siteId]
		},
		{
			key: '#quoteContent-update-update .T-addBusCompany',
			args:  ["_trackEvent", "修改报价", "按钮", "新增车队", 1, siteId]
		},
		{
			key: '#quoteContent-update-update .T-insuranceForm .T-delTr',
			args:  ["_trackEvent", "修改报价", "按钮", "删除保险", 1, siteId]
		},
		{
			key: '#quoteContent-update-update .T-busCompanyForm .T-delTr',
			args:  ["_trackEvent", "修改报价", "按钮", "删除车队", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addRestaurant',
			args:  ["_trackEvent", "修改报价", "按钮", "新增餐饮", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addHotel',
			args:  ["_trackEvent", "修改报价", "按钮", "新增酒店", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addScenic',
			args:  ["_trackEvent", "修改报价", "按钮", "新增景区", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addSelfPay',
			args:  ["_trackEvent", "修改报价", "按钮", "新增自费", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addTraffic',
			args:  ["_trackEvent", "修改报价", "按钮", "新增交通", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-addOther',
			args:  ["_trackEvent", "修改报价", "按钮", "新增其他", 1, siteId]
		},
		{
			key:'#dayListupdate-0 .T-hotel',
			args:  ["_trackEvent", "修改报价", "按钮", "酒店询价", 1, siteId]
		},
		{
			key: '#quoteContent-update-update  .T-btn-submit-quote',
			args:  ["_trackEvent", "修改报价", "按钮", "提交", 1, siteId]
		},
		{//复制报价 报价详情
			key: '#tab-arrange_quote-copy-content .T-addInsurance',
			args:  ["_trackEvent", "报价详情", "按钮", "新增保险", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-addBusCompany',
			args:  ["_trackEvent", "报价详情", "按钮", "新增车队", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-insuranceForm .T-delTr',
			args:  ["_trackEvent", "报价详情", "按钮", "删除保险", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-busCompanyForm .T-delTr',
			args:  ["_trackEvent", "报价详情", "按钮", "删除车队", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-car',
			args:  ["_trackEvent", "报价详情", "按钮", "删除车队", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-busCompanyForm .T-delTr',
		...
		{
			key: '#dayListcopy-0 .T-addRestaurant',
			args:  ["_trackEvent", "报价详情", "按钮", "新增餐饮", 1, siteId]
		},
		{
			key: '#dayListcopy-0 .T-addHotel',
			args:  ["_trackEvent", "报价详情", "按钮", "新增酒店", 1, siteId]
		},
		{
			key: '#dayListcopy-0 .T-addScenic',
			args:  ["_trackEvent", "报价详情", "按钮", "新增景区", 1, siteId]
		},
		{
			key: '#dayListcopy-0 .T-addSelfPay',
			args:  ["_trackEvent", "报价详情", "按钮", "新增自费", 1, siteId]
		},
		{
			key: '#dayListcopy-0 .T-addTraffic',
			args:  ["_trackEvent", "报价详情", "按钮", "新增交通", 1, siteId]
		},
		{
			key: '#dayListcopy-0 .T-addOther',
			args:  ["_trackEvent", "报价详情", "按钮", "新增其他", 1, siteId]
		},
		{
			key: '#tab-arrange_quote-copy-content .T-btn-submit-quote',
			args:  ["_trackEvent", "报价详情", "按钮", "提交", 1, siteId]
		},
		{//询价状态
			key: '#inquiryContent-update-update .T-refresh-status',
			args:  ["_trackEvent", "询价状态", "按钮", "刷新", 1, siteId]
		},
		{
			key: '#busInquiryResult-update-update .T-bus-delete',
			args:  ["_trackEvent", "报价详情", "按钮", "删除车队", 1, siteId]
		},
		{
			key: '#hotelInquiryContent-update-update .T-hotel-delete',
			args:  ["_trackEvent", "报价详情", "按钮", "删除房", 1, siteId]
		},
	],
	...
	'tab-resource_touristGroup-content':[ //游客管理
		...
		{//编辑游客
			key: '#tab-resource_touristGroup-update-contentc .T-submit-updateTouristGroup',
			args:  ["_trackEvent", "编辑游客", "按钮", "提交", 1, siteId]
		},
		{//添加游客
	...
	'tab-arrange_transit-content':[ //中转安排
		...
		},
		{
			...
			args:  ["_trackEvent", "中转安排", "按钮", "删除", 1, siteId]
		},
		{//送团
			key: '#tab-arrange_transit-update-content #sendList .T-btn-bus-add',
			args:  ["_trackEvent", "中转安排", "按钮", "新增车俩", 1, siteId]
		},
		{
			key: '#tab-arrange_transit-update-content #sendList .T-btn-hotel-add',
			args:  ["_trackEvent", "中转安排", "按钮", "新增酒店", 1, siteId]
		},
		{
			key: '#tab-arrange_transit-update-content #sendList .T-btn-ticket-add',
			args:  ["_trackEvent", "中转安排", "按钮", "新增票务", 1, siteId]
		},
		{
			key: '#tab-arrange_transit-update-content #sendList .T-btn-restaurant-add',
			args:  ["_trackEvent", "中转安排", "按钮", "新增餐厅", 1, siteId]
		},
		{
			key: '#tab-arrange_transit-update-content #sendList .T-btn-other-add',
			args:  ["_trackEvent", "中转安排", "按钮", "新增其他", 1, siteId]
		}
	],
	...
	'tab-arrange_plan-content' :[
		...
		},
		{
			...
			args:  ["_trackEvent", "编辑发团计划", "按钮", "新增费用项", 1, siteId]
		},
		{
			key: '#tab-arrange_plan_group_update-content .T-delete',
			args:  ["_trackEvent", "编辑发团计划", "按钮", "删除", 1, siteId]
		},
		{
			...
			args:  ["_trackEvent", "编辑发团计划", "按钮", "取消", 1, siteId]
		},
		{
			key: '#tab-arrange_plan_group_update-content .T-savePlan',
			args:  ["_trackEvent", "编辑发团计划", "按钮", "保存", 1, siteId]
		},
		{//散客
			key: '#tab-arrange_plan-content #arrangePlanTab_2 .T-btn-tripPlan-search',
			args:  ["_trackEvent", "团体", "按钮", "搜索", 1, siteId]
		...
		},
		{
			...
			args:  ["_trackEvent", "编辑发团计划", "按钮", "选择游客", 1, siteId]
		},
		{
			key: '#tab-arrange_plan_single_add-content .T-groupView',
			args:  ["_trackEvent", "编辑发团计划", "按钮", "查看", 1, siteId]
		},
		{

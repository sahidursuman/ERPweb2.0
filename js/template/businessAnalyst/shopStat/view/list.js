/*TMODJS:{"debug":true,"version":15,"md5":"62ca3621395d86c142e0fdfcf45dbc06"}*/
    ...
    return require("../../../template")("businessAnalyst/shopStat/view/list", function($data, $filename) {
        try {
            ...
            $line = 33, $each(shopListdata, function(rs) {
                ...
                $out += '" style="text-align:left"> <span>线路产品：', $line = 36, $out += $escape(rs.lineName), 

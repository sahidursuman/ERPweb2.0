/*TMODJS:{"debug":true,"version":15,"md5":"5fa416574ef66be6cebfc4284ee0bfb8"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/shopStat/view/list", function($data, $filename) {
        try {
            ...
            $data.$index, $utils.$escape), totalShop = ($data.shop, $data.index, $data.totalShop), $out = ($data.total, 
            "");
            ...
            $line = 31, $each(shopListdata, function(rs) {
                ...
                $line = 45), $out += " </tr> ", $line = 47, $each(rs.shopList, function(shop) {
                    $out += ' <tr shopId = "', $line = 48, $out += $escape(shop.shopId), $out += '" tripPlanId = "', 
                    $line = 48, $out += $escape(shop.tripPlanId), $out += '"> <td>', $line = 49, $out += $escape($helpers.dateFormat(shop.inStoreDate, "yyyy-MM-dd")), 

/*TMODJS:{"debug":true,"version":2,"md5":"6275c9bcd3e818ea22048abf3c18e135"}*/
        ...
        try {
            ...
            $line = 33, $each(shopListdata, function(rs) {
                ...
                $line = 54), $out += " </tr> ", $line = 56, $each(rs.shopList, function(shop) {
                    ...
                    $line = 60, $out += $escape(shop.consumeMoney), $out += '</a></td> <td class="P-tdFontSize">', 
                    $line = 61, $out += $escape(shop.aveconsumeMoney), $out += '</td> <td class="P-tdFontSize">', 
                    $line = 62, $out += $escape(shop.guideRebateMoney), $out += '</td> <td class="P-tdFontSize">', 
                    $line = 63, $out += $escape(shop.travelAgencyRebateMoney), $out += '</td> <td class="P-tdFontSize">', 
                    $line = 64, $out += $escape(shop.sumRebateMoney), $out += '</td> <td class="P-tdFontSize">', 
                    $line = 65, $out += $escape(shop.aveRebateMoney), $out += "</td> </tr> ", $line = 67;
                }), $out += " ", $line = 68;

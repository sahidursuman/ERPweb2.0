/*TMODJS:{"debug":true,"version":39,"md5":"95f7d4721bda19aac6cd2132e3d8617c"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/shopStat/view/list", function($data, $filename) {
        try {
            ...
            $line = 66, $out += $escape(totalShop.sumConsumeMoney), $out += '</td> <td class="P-tdFontSize">', 
            $line = 67, $out += $escape(totalShop.aveconsumeMoney), $out += '</td> <td class="P-tdFontSize">', 
            ...
            $line = 71, $out += $escape(totalShop.aveRebateMoney), $out += '</td> </tr> </tbody> </table> <div class="pageMode T-noprint"> <div class="col-xs-5"> <small><span class="recordSize"></span></small> </div> <div class="col-xs-7"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

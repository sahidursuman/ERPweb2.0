/*TMODJS:{"debug":true,"version":100,"md5":"b10d66b13f11ae3e8e2a6eaef6f9118a"}*/
    ...
    return require("../../../template")("businessAnalyst/employeePerfor/view/listSalePer", function($data, $filename) {
        try {
            ...
            $line = 13, $each(result, function(salePerL) {
                ...
                $out += "小</td> </tr> ", $line = 18;
            }), $out += ' <tr style="background-color:#effef4"> <td style="font-weight: bold;">合计</td> <td class="T-totalCount"></td> </tr> </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 

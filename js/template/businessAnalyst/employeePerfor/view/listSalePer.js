/*TMODJS:{"debug":true,"version":103,"md5":"ad9c6433ed00da627cdf33abda2afc3f"}*/
    ...
    return require("../../../template")("businessAnalyst/employeePerfor/view/listSalePer", function($data, $filename) {
        try {
            ...
            $line = 13, $each(result, function(salePerL) {
                ...
                $out += "小</td> </tr> ", $line = 18;
            }), $out += ' <tr style="background-color:#effef4"> <td style="font-weight: bold;">合计</td> <td class="T-totalCount"></td> </tr> </tbody> </table> <div class="row pageMode"> <div class="col-xs-5"> <small>共计 ', 

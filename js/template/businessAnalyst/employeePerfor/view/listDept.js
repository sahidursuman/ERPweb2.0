/*TMODJS:{"debug":true,"version":209,"md5":"e9effaa8ebaa0a4ddaa205b6197b3f2e"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listDept", function($data, $filename) {
        try {
            ...
            $out += $escape(getAdultCount), $out += "大", $line = 62, $out += $escape(getChildCount), 
            $out += "小</td> <td>", $line = 63, $out += $escape(getNotDirectAdultCount), $out += "大", 
            $line = 63, $out += $escape(getNotDirectChildCount), $out += "小</td> <td>", $line = 64, 
            $out += $escape(tripCount), $out += "</td> <td>", $line = 65, $out += $escape(adultCount), 
            $out += "大", $line = 65, $out += $escape(childCount), $out += "小</td> <td>", $line = 66, 
            $out += $escape(transAdultCount), $out += "大", $line = 66, $out += $escape(transChildCount), 
            $out += "小</td> <td>", $line = 67, $out += $escape(innerAdultCount), $out += "大", 
            $line = 67, $out += $escape(innerChildCount), $out += "小</td> <td>", $line = 68, 
            $out += $escape(orderCount), $out += "</td> </tr> </tbody> </table>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

/*TMODJS:{"debug":true,"version":91,"md5":"b96d52182e4348147b9ec5377ca09375"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listDept", function($data, $filename) {
        try {
            ...
            $line = 5, isChildGroup && ($out += " <th>子部门</th> ", $line = 7), $out += " <th>收客量</th> <th>内转收客量</th> <th>发团量</th> <th>发客量</th> <th>外转客量</th> <th>内转客量</th> <th>代订单量</th> </tr> </thead> <tbody> ", 

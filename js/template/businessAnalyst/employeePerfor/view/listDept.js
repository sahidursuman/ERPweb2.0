/*TMODJS:{"debug":true,"version":51,"md5":"45720deca6af0908b38ed09f5d4a6679"}*/
    ...
    return require("../../../template")("businessAnalyst/employeePerfor/view/listDept", function($data, $filename) {
        try {
            ...
            $line = 23, $each(result, function(deptL) {
                ...
                $out += $escape(deptL.tripPlanChildCount), $out += "小</td> <td>", $line = 29, $out += $escape(deptL.transCount), 
                $out += "</td> <td>", $line = 30, $out += $escape(deptL.innerCount), $out += "</td> <td>", 
                $line = 31, $out += $escape(deptL.orderCount), $out += "</td> </tr> ", $line = 33;

/*TMODJS:{"debug":true,"version":78,"md5":"debf845d25980bd4d990d18aa35337c8"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listDept", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight table-fixed"> <thead> <tr class="bg-blur"> <th>部门</th> <th>直客量</th> <th>非直客量</th> <th>发团量</th> <th>发客量</th> <th>外转客量</th> <th>内转客量</th> <th>代订单量</th> </tr> </thead> <tbody> ', 

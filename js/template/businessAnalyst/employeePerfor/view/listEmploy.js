/*TMODJS:{"debug":true,"version":77,"md5":"48c5876ef2acb5c28973c1092a947c2b"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listEmploy", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight table-fixed"> <colgroup> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:20%;"></col> <col style="width:15%;"></col> <col style="width:15%;"></col> </colgroup> <thead> <tr class="bg-blur"> <th class="col-sm-1">员工</th> <th class="col-sm-1">发团量</th> <th class="col-sm-2">发客量</th> <th class="col-sm-1">外转客量</th> <th class="col-sm-1">内转转出量</th> <th class="col-sm-2">代订单量</th> </tr> </thead> <tbody> ', 

/*TMODJS:{"debug":true,"version":91,"md5":"e09d64af4c9f77aa55efb2d3e1d52e73"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listEmploy", function($data, $filename) {
        try {
            ...
            }), $out += ' <tr style="background-color:#effef4"> <td class="text-bold">合计</td> <td class="T-tripTotalCount">0</td> <td class="T-sTotalGrossProfit"></td> <td class="T-tTotalGrossProfit"></td> <td class="sPreTotalGrossProfit"></td> <td class="tPreTotalGrossProfit"></td> <td class="T-adChilTotalCount">0</td> <td class="T-transAdChilTotalCount">0</td> <td class="T-innerAdChilTotalCount">0</td> <td class="T-orderTotalCount">0</td> </tr> </tbody> </table> <div class="row pageMode"> <div class="col-xs-5"> <small>共计 ', 

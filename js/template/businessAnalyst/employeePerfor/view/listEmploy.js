/*TMODJS:{"debug":true,"version":71,"md5":"891a940ffafc3d609d6e96e2078ccd37"}*/
define(function(require) {
    return require("../../../template")("businessAnalyst/employeePerfor/view/listEmploy", function($data, $filename) {
        try {
            ...
            }), $out += ' <tr style="background-color:#effef4"> <td>合计</td> <td class="T-tripTotalCount">0</td> <td class="T-adChilTotalCount">0</td> <td class="T-transAdChilTotalCount">0</td> <td class="T-innerAdChilTotalCount">0</td> <td class="T-orderTotalCount">0</td> </tr> </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 

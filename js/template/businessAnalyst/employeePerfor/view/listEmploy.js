/*TMODJS:{"debug":true,"version":37,"md5":"778dd55f5a0d61bd256415e58ae5299d"}*/
    ...
    return require("../../../template")("businessAnalyst/employeePerfor/view/listEmploy", function($data, $filename) {
        try {
            ...
            $line = 23, $each(resultList, function(empL) {
                ...
                $line = 26, $out += $escape(empL.getAdultCount), $out += "大", $line = 26, $out += $escape(empL.getChildCount), 
                $out += "小</td> <td>", $line = 27, $out += $escape(empL.tripPlanCount), $out += "</td> <td>", 
                $line = 28, $out += $escape(empL.tripPlanAdultCount), $out += "大", $line = 28, $out += $escape(empL.tripPlanChildCount), 
                $out += "小</td> <td>", $line = 29, $out += $escape(empL.transCount), $out += "</td> <td>", 
                $line = 30, $out += $escape(empL.innerCount), $out += "</td> <td>", $line = 31, 
                $out += $escape(empL.orderCount), $out += "</td> </tr> ", $line = 33;

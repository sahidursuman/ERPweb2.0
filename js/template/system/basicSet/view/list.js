/*TMODJS:{"debug":true,"version":146,"md5":"cf433d98ea722cf46e129fda4a14d273"}*/
    ...
    return require("../../../template")("system/basicSet/view/list", function($data, $filename) {
        try {
            ...
            $line = 46, $each(newSubjectAccountList, function(rs) {
                ...
                0 == rs.type ? ($out += "收入 ", $line = 51) : 1 == rs.type && ($out += "支出 ", $line = 52), 
                $out += ' </span> </td> <td><span class="title">', $line = 55, $out += $escape(rs.subjectName), 
                ...
                $line = 59, 1 == rs.status ? ($out += " 已启用 ", $line = 61) : ($out += " 已停用 ", $line = 63), 
                $out += " </span> </td> </tr> ", $line = 67;

/*TMODJS:{"debug":true,"version":49,"md5":"849a5104cba480879e45f222c36e10fa"}*/
define(function(require) {
    return require("../../../template")("system/department/view/addGroup", function($data, $filename) {
        try {
            ...
            $data.$index, "");
            return $out += '<div class="col-xs-12"> <form class="form-horizontal groupMainForm" role="form" style="margin-top:26px" onsubmit="return false"> <input type="hidden" value="', 
            ...
            }), $out += ' </select> </div> </div> <div class="form-group"> <label class="col-sm-4 control-label no-padding-right"><span class="necessary">*</span>子部门名称:</label> <div class="col-sm-6"> <input type="text" name="name" class="col-sm-12" /> </div> </div> <div class="space-10"></div> <button class="btn btn-block btn-primary btn-submit-group"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> </form> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

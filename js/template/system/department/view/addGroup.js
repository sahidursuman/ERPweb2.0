/*TMODJS:{"debug":true,"version":3,"md5":"2e45b8e3867eabe72ca1ed7f0f0b8e36"}*/
define(function(require) {
    return require("../../../template")("system/department/view/addGroup", function($data, $filename) {
        try {
            ...
            }), $out += ' </select> </div> </div> <div class="form-group"> <label class="col-sm-4 control-label no-padding-right"><span class="necessary">*</span>子部门名称:</label> <div class="col-sm-6"> <input class="col-sm-12 groupName" type="text" name="name" /> </div> </div> <div class="space-10"></div> <button class="btn btn-block btn-primary T-save-group"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> </form> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

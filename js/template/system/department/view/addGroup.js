/*TMODJS:{"debug":true,"version":1,"md5":"72f7f67cf645a868d23be8bfec06e3d4"}*/
define(function(require) {
    return require("../../../template")("system/department/view/addGroup", function($data, $filename) {
        try {
            ...
            }), $out += ' </select> </div> </div> <div class="form-group"> <label class="col-sm-4 control-label no-padding-right"><span class="necessary">*</span>子部门名称:</label> <div class="col-sm-6"> <input type="text" name="names" class="col-sm-12" /> </div> </div> <div class="space-10"></div> <button class="btn btn-block btn-primary T-save-group"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> </form> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

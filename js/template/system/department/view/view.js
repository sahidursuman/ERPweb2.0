/*TMODJS:{"debug":true,"version":93,"md5":"bff96a50169f54ba5cc39700767e9851"}*/
define(function(require) {
    return require("../../../template")("system/business/view/view", function($data, $filename) {
        try {
            ...
            $line = 3, $out += $escape(businessGroup.id), $out += '" id="businessGroupId" /> <div style="float: left;font-size:15px;"> <table> <tr> <td>部门信息：</td> <td>', 
            $line = 8, $out += $escape(businessGroup.name), $out += "</td> </tr> <tr> <td>创建时间：</td> <td>", 
            $line = 12, $out += $escape($helpers.dateFormat(businessGroup.createTime, "yyyy-MM-dd")), 
            $out += '</td> </tr> </table> </div> <div style="clear: both;"></div> <div style="float: right;"> <button class="btn btn-sm btn-success btn-group-add" > <i class="ace-icon fa fa-plus"></i> 新增子部门 </button> </div> <div style="clear: both;"></div> </div> <div class="row groupList" style="margin:5px 10px 0px 10px;"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>子部门名称</th> <th>创建时间</th> <th>操作</th> </tr> </thead> <tbody id="groupContent"> ', 
            $line = 37, $each(groupList, function(group) {
                $out += ' <tr class="business-', $line = 38, $out += $escape(group.id), $out += '"> <td>', 
                $line = 39, $out += $escape(group.name), $out += "</td> <td>", $line = 40, $out += $escape($helpers.dateFormat(group.createTime, "yyyy-MM-dd")), 
                $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <button data-entity-id="', 
                $line = 44, $out += $escape(group.id), $out += '" class="btn btn-xs btn-info btn-group-edit"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </button> <button data-entity-id="', 
                ...
                $line = 59, $out += $escape(group.id), $out += '" href="javascript:void(0)" class="tooltip-success btn-group-edit" data-rel="tooltip"> <span class="green"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </span> </a> </li> </ul> </div> </div> </td> </tr> ', 
                $line = 71;

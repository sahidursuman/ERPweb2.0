/*TMODJS:{"debug":true,"version":95,"md5":"23cd71f717a4699f522e5fb117aa804b"}*/
    ...
    return require("../../../template")("system/department/view/view", function($data, $filename) {
        try {
            ...
            $line = 35, $each(groupList, function(group) {
                ...
                $line = 42, $out += $escape(group.id), $out += '" class="btn btn-xs btn-info btn-group-edit"> <i class="ace-icon fa fa-pencil-square-o bigger-120"></i> </button> <button data-entity-id="', 

/*TMODJS:{"debug":true,"version":62,"md5":"13654747eafdeecf343155195d709a08"}*/
define(function(require) {
    return require("../../../template")("system/accountSetting/view/application", function($data, $filename) {
        try {
            ...
            return $out += '<div class="applicationMain" style="margin-top: 10px;"> <form class="T-main-form" role="form" onsubmit="return false"> <span style="margin-left: 40px;font-family: \'宋体\';color: #666666">为了保证您的账号安全，更换手机前请先进行安全验证</span> <span style="margin-left: 40px;font-family: \'宋体\';color: #666666;display: inline-block;">发送成功，<a class="T-solution">收不到验证怎么办?</a> </span> <h5 style="margin-left: 40px;font-family: \'宋体\';font-weight: bold;">验证方式</h5> <div class="application"><span style="margin-left: 46px;margin-top: 11px;position: absolute;">绑定手机</span> <input type="text" placeholder="绑定手机" name="mobile" class="newPhone" value="', 

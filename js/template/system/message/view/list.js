/*TMODJS:{"debug":true,"version":237,"md5":"f00f8e78fb2228a57b963c008fd4c74f"}*/
    ...
    return require("../../../template")("system/message/view/list", function($data, $filename) {
        try {
            ...
            $line = 32, $each(msgList, function(msg) {
                ...
                $line = 34, null == msg.menu || "" == msg.menu ? ($out += "-", $line = 34) : ($line = 34, 
                $out += $escape(msg.menu.name), $line = 34), $out += '</td> <td class="align-left">', 

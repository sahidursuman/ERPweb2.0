/*TMODJS:{"debug":true,"version":161,"md5":"0b836a2e9653b8c91658081c21a85be3"}*/
define(function(require) {
    return require("../../../template")("system/user/view/list", function($data, $filename) {
        try {
            ...
            $line = 14), $out += ' </span> <i class="ace-icon fa fa-angle-down icon-on-right"></i> </button> <ul class="dropdown-menu"> <li> <a data-value="1" href="javascript:void(0)">已启用</a> </li> <li> <a data-value="0" href="javascript:void(0)">已停用</a> </li> </ul> </div> <button class="btn btn-sm btn-success T-add R-right" data-right=\'1420001\' style="margin-left:15px;"> <i class="ace-icon fa fa-plus"></i> 新增人员 </button> </div> <div class="row userList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>姓名</th> <th>账号</th> <th>初始密码</th> <th>联系电话</th> <th>业务部</th> <th>子部门</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 

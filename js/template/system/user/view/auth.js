/*TMODJS:{"debug":true,"version":374,"md5":"1d62521354c2e572024b67263d3af3f7"}*/
    ...
    return require("../../../template")("system/user/view/auth", function($data, $filename) {
        try {
            ...
            $line = 75, $each(listMenu, function(menu) {
                $out += ' <li class="meun" data-toid="D-', $line = 76, $out += $escape(menu.id), 
                $out += '">', $line = 76, $out += $escape(menu.name), $out += "</li> ", $line = 77;

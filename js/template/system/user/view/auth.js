/*TMODJS:{"debug":true,"version":259,"md5":"689469708fd081d3d3bd12d468558c82"}*/
        ...
        try {
            ...
            $line = 9, $each(listMenu, function(menu, menuIndex) {
                ...
                $line = 29, $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 43, $out += $escape(submenu.name), $out += '</td> <td width="80"><input type="radio" class="ace T-function-area1" value="1" name="', 
                    $line = 44, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>个人</td> <td width="80"><input type="radio" class="ace T-function-area2" value="2" name="', 
                    $line = 45, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>子部门</td> <td width="90"><input type="radio" class="ace T-function-area3" value="3" name="', 
                    $line = 46, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>业务部门</td> <td width="80"><input type="radio" class="ace T-function-area4" value="4" name="', 
                    $line = 47, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>公司</td> <td> ', 
                    $line = 50, $each(submenu.menuFunctionShipList, function(func) {
                        ...
                        $line = 52, $out += $escape(func.id), $out += '" value="', $line = 52, $out += $escape(func.id), 
                        $out += '" /><span class="lbl"></span> ', $line = 53, $out += $escape(func.functionName), 
                        $out += " </div> ", $line = 55;
                    }), $out += " </td> </tr> ", $line = 58;
                }), $out += " </table> </td></tr> ", $line = 61), $out += " ", $line = 62;

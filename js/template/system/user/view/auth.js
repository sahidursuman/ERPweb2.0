/*TMODJS:{"debug":true,"version":121,"md5":"f2b9603de8442e18ee38caa1c7ae68eb"}*/
        ...
        try {
            ...
            $line = 9, $each(listMenu, function(menu, menuIndex) {
                ...
                $line = 29, $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 39), $out += ' <tr class="T-submenu" data-id="', $line = 40, $out += $escape(submenu.id), 
                    $out += '"> <td><input type="checkbox" class="ace T-submenu-check T-submenu-id', 
                    $line = 41, $out += $escape(submenu.id), $out += '"/><span class="lbl"></span>', 
                    $line = 41, $out += $escape(submenu.name), $out += '</td> <td width="80"><input type="radio" class="ace T-function-area1" value="1" name="', 
                    $line = 42, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>个人</td> <td width="80"><input type="radio" class="ace T-function-area2" value="2" name="', 
                    $line = 43, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>子部门</td> <td width="90"><input type="radio" class="ace T-function-area3" value="3" name="', 
                    $line = 44, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>业务部门</td> <td width="80"><input type="radio" class="ace T-function-area4" value="4" name="', 
                    $line = 45, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>公司</td> <td> ', 
                    $line = 48, $each(submenu.menuFunctionShipList, function(func) {
                        ...
                        $line = 50, $out += $escape(func.id), $out += '" value="', $line = 50, $out += $escape(func.id), 
                        $out += '" /><span class="lbl"></span> ', $line = 51, $out += $escape(func.functionName), 
                        $out += " </div> ", $line = 53;
                    }), $out += " </td> </tr> ", $line = 56;
                }), $out += " </table> </td></tr> ", $line = 59), $out += " ", $line = 60;

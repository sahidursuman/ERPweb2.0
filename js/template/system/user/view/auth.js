/*TMODJS:{"debug":true,"version":373,"md5":"7d5eba5757034f291aa30a511c90714e"}*/
define(function(require) {
    return require("../../../template")("system/user/view/auth", function($data, $filename) {
        try {
            ...
            }), $out += ' </table> <div class="space-10"></div> </form> <div class="userAuthWidth"> ', 
            $line = 74, $each(listMenu, function(menu, menuIndex) {
                $out += " ", $line = 75, "工作台" != menu.name && "消息中心" != menu.name && ($out += ' <table class="table table-striped table-bordered table-hover"> ', 
                $line = 77, 0 == menuIndex && ($out += ' <thead> <th class="th-border">功能模块</th> <th class="th-border" colspan="5">权限</th> </thead> ', 
                $line = 82), $out += ' <ul class="userAuth"> <li class="meun" data-toid="D-', $line = 84, 
                $out += $escape(menu.id), $out += '">', $line = 84, $out += $escape(menu.name), 
                $out += "</li> ", $line = 85), $out += " ", $line = 86;

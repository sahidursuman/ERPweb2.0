/*TMODJS:{"debug":true,"version":365,"md5":"149fb5a3a70b0a1e015e12c177d7a03b"}*/
define(function(require) {
    return require("../../../template")("system/user/view/auth", function($data, $filename) {
        try {
            ...
            }), $out += ' </table> <div class="space-10"></div> </form> <button class="btn btn-block btn-primary T-saveAuth saveAuth-user"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> <div class="userAuthWidth"> ', 

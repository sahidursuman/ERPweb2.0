/*TMODJS:{"debug":true,"version":256,"md5":"435d436477e3f5d9caaded21aac0d95f"}*/
        ...
        try {
            ...
            $line = 10, $each(listMenu, function(menu, menuIndex) {
                ...
                $line = 30, $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 42), $out += ' <tr class="T-submenu" data-id="', $line = 43, $out += $escape(submenu.id), 
                    $out += '"> <td><input type="checkbox" class="ace T-submenu-check T-submenu-id', 
                    $line = 44, $out += $escape(submenu.id), $out += '"/><span class="lbl"></span>', 
                    $line = 44, $out += $escape(submenu.name), $out += '</td> <td width="80"><input type="radio" class="ace T-function-area1" value="1" name="', 
                    $line = 45, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>个人</td> <td width="80"><input type="radio" class="ace T-function-area2" value="2" name="', 
                    $line = 46, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>子部门</td> <td width="90"><input type="radio" class="ace T-function-area3" value="3" name="', 
                    $line = 47, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>业务部门</td> <td width="80"><input type="radio" class="ace T-function-area4" value="4" name="', 
                    $line = 48, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>公司</td> <td> ', 
                    $line = 51, $each(submenu.menuFunctionShipList, function(func) {
                        ...
                        $line = 53, $out += $escape(func.id), $out += '" value="', $line = 53, $out += $escape(func.id), 
                        $out += '" /><span class="lbl"></span> ', $line = 54, $out += $escape(func.functionName), 
                        $out += " </div> ", $line = 56;
                    }), $out += " </td> </tr> ", $line = 59;
                }), $out += " </table> </td></tr> ", $line = 62), $out += " ", $line = 63;

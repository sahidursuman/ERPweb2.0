/*TMODJS:{"debug":true,"version":269,"md5":"700753499524d20344c28edf1b138678"}*/
        ...
        try {
            ...
            $line = 9, $each(listMenu, function(menu, menuIndex) {
                ...
                $line = 29, $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 43, $out += $escape(submenu.name), $out += "</td> ", $line = 44, 63 == menu.id ? ($out += " ", 
                    $line = 45, 80 == submenu.id ? ($out += ' <td width="80"><input type="radio" class="ace T-function-area1" value="1" name="', 
                    $line = 46, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>个人</td> <td width="80"><input type="radio" class="ace T-function-area2" value="2" name="', 
                    $line = 47, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>子部门</td> <td width="90"><input type="radio" class="ace T-function-area3" value="3" name="', 
                    $line = 48, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>业务部门</td> ', 
                    $line = 49) : ($out += ' <td width="80">-</td> <td width="80">-</td> <td width="90">-</td> ', 
                    $line = 53), $out += ' <td width="80"><input type="radio" class="ace T-function-area4" value="4" name="', 
                    $line = 54, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>公司</td> ', 
                    $line = 55) : ($out += " ", $line = 56, 95 == submenu.id ? ($out += ' <td width="80">-</td> <td width="80">-</td> ', 
                    $line = 59) : ($out += ' <td width="80"><input type="radio" class="ace T-function-area1" value="1" name="', 
                    $line = 60, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>个人</td> <td width="80"><input type="radio" class="ace T-function-area2" value="2" name="', 
                    $line = 61, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>子部门</td> ', 
                    $line = 62), $out += ' <td width="90"><input type="radio" class="ace T-function-area3" value="3" name="', 
                    $line = 63, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>业务部门</td> <td width="80"><input type="radio" class="ace T-function-area4" value="4" name="', 
                    $line = 64, $out += $escape(submenu.id), $out += '"><span class="lbl"></span>公司</td> ', 
                    $line = 65), $out += " <td> ", $line = 67, $each(submenu.menuFunctionShipList, function(func) {
                        ...
                        $line = 69, $out += $escape(func.id), $out += '" value="', $line = 69, $out += $escape(func.id), 
                        $out += '" /><span class="lbl"></span> ', $line = 70, $out += $escape(func.functionName), 
                        $out += " </div> ", $line = 72;
                    }), $out += " </td> </tr> ", $line = 75;
                }), $out += " </table> </td></tr> ", $line = 78), $out += " ", $line = 79;

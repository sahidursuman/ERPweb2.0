/*TMODJS:{"debug":true,"version":395,"md5":"5aca8063ab40de1b855402eeb767e932"}*/
            ...
            $line = 9, $each(listMenu, function(menu, menuIndex) {
                ...
                $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 54, $each(submenu.menuFunctionShipList, function(func) {
                        ...
                        $line = 56, $out += $escape(func.id), $out += " ", $line = 57, 17 == submenu.id && ($line = 57, 
                        50 == func.id ? ($out += "T-arrange", $line = 57) : ($out += "T-arrgItem", $line = 57), 
                        $line = 57), $out += '" value="', $line = 57, $out += $escape(func.id), $out += '" /> <span class="lbl"></span>', 
                        $line = 58, $out += $escape(func.functionName), $out += " </div> ", $line = 60;
                    }), $out += " </td> </tr> ", $line = 63;
                }), $out += " </table> </td></tr> ", $line = 66), $out += " ", $line = 67;
            }), $out += ' </table> <div class="space-10"></div> </form> <div class="userAuthWidth"> <ul class="userAuth"> ', 
            $line = 75, $each(listMenu, function(menu) {
                $out += " ", $line = 76, "工作台" != menu.name && "消息中心" != menu.name && ($out += ' <li class="meun" data-toid="D-', 
                $line = 77, $out += $escape(menu.id), $out += '"><a>', $line = 77, $out += $escape(menu.name), 
                $out += "</a></li> ", $line = 78), $out += " ", $line = 79;

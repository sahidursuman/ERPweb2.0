/*TMODJS:{"debug":true,"version":110,"md5":"e0855b158b2a9e58fe1109581c872550"}*/
define(function(require) {
    return require("../../../template")("system/user/view/auth", function($data, $filename) {
        try {
            ...
            $line = 6, $out += $escape(user.id), $out += '" id="userId" /> <div style="margin:10px 0px 20px 0px;display: none;"><button id="btn_groul_all">全选</button><button id="btn_groul_no" style="margin-left:10px;">全不选</button><button id="btn_groul_bak" style="margin-left:10px;">反选</button></div> <table class="table table-striped table-bordered table-hover" style="font-size:15px;"> <thead> <th class="th-border">功能模块</th> <th class="th-border" colspan="7">权限</th> </thead> <tbody> ', 
            $line = 15, $each(menuList, function(menu) {
                ...
                $line = 22, $each(menuList, function(menu2, index) {
                    $out += " ", $line = 23, 0 == index && ($out += ' <tr> <td><input style="display: none;" class="sAll" td="0" data-id="', 
                    $line = 25, $out += $escape(menu.id), $out += '" type="button" value="全选" /></td> <td><input style="display: none;" class="sAll" td="1" data-id="', 
                    $line = 26, $out += $escape(menu.id), $out += '" type="button" value="全选" /></td> <td><input style="display: none;" class="sAll" td="2" data-id="', 
                    $line = 27, $out += $escape(menu.id), $out += '" type="button" value="全选" /></td> <td><input style="display: none;" class="sAll" td="3" data-id="', 
                    $line = 28, $out += $escape(menu.id), $out += '" type="button" value="全选" /></td> <td><a style="font-size:12px;" href="javascript:;" class="sAll" td="4" data-id="', 
                    $line = 29, $out += $escape(menu.id), $out += '">全选</a></td> <td><a style="font-size:12px;" href="javascript:;" class="sAll" td="5" data-id="', 
                    $line = 30, $out += $escape(menu.id), $out += '">全选</a></td> <td><a style="font-size:12px;" href="javascript:;" class="sAll" td="6" data-id="', 
                    $line = 31, $out += $escape(menu.id), $out += '">全选</a></td> <td><a style="font-size:12px;" href="javascript:;" class="sAll" td="7" data-id="', 
                    $line = 32, $out += $escape(menu.id), $out += '">全选</a></td> </tr> ', $line = 34), 
                    $out += " ", $line = 35, menu2.pid == menu.id && ($out += ' <tr class="authId checkibox', 
                    $line = 36, $out += $escape(menu2.id), $out += " pmodule", $line = 36, $out += $escape(menu.id), 
                    $out += '" data-id="', $line = 36, $out += $escape(menu2.id), $out += '"> <td><input type="checkbox" class="ace" name="" value="', 
                    $line = 37, $out += $escape(menu2.id), $out += '|s" class="smodule" /><span class="lbl"></span>', 
                    $line = 37, $out += $escape(menu2.name), $out += '</td> <td><input type="checkbox" class="ace" name="" value="', 
                    $line = 38, $out += $escape(menu2.id), $out += '|a" /><span class="lbl"></span>添加</td> <td><input type="checkbox" class="ace" name="" value="', 
                    $line = 39, $out += $escape(menu2.id), $out += '|e" /><span class="lbl"></span>修改</td> <td><input type="checkbox" class="ace" name="" value="', 
                    $line = 40, $out += $escape(menu2.id), $out += '|d" /><span class="lbl"></span>删除</td> <td><input type="radio" class="ace" name="auTy', 
                    $line = 41, $out += $escape(menu2.id), $out += '" value="auTy1"><span class="lbl"></span>个人</td> <td><input type="radio" class="ace" name="auTy', 
                    $line = 42, $out += $escape(menu2.id), $out += '" value="auTy2"><span class="lbl"></span>子部门</td> <td><input type="radio" class="ace" name="auTy', 
                    $line = 43, $out += $escape(menu2.id), $out += '" value="auTy3"><span class="lbl"></span>业务部门</td> <td><input type="radio" class="ace" name="auTy', 
                    $line = 44, $out += $escape(menu2.id), $out += '" value="auTy4"><span class="lbl"></span>公司</td> </tr> ', 
                    $line = 46), $out += " ", $line = 47;
                }), $out += " ", $line = 48), $out += " ", $line = 49;

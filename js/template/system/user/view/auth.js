/*TMODJS:{"debug":true,"version":293,"md5":"0582ad2f029dac982420f208a266c29e"}*/
define(function(require) {
    return require("../../../template")("system/user/view/auth", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12 T-update-auth" id="userSetAuth"> <div class="page-header" style="font-weight: bold;font-size:14px;"> 【当前用户：', 
            ...
            $line = 9, $each(listMenu, function(menu, menuIndex) {
                ...
                $line = 29, $each(menu.childMenuList, function(submenu, index) {
                    ...
                    $line = 43, $out += $escape(submenu.name), $out += "</td> ", $line = 44, 95 == submenu.id ? ($out += ' <td width="80">-</td> <td width="80">-</td> ', 
            ...
            }), $out += ' </table> <div class="space-10"></div> <button class="btn btn-block btn-primary T-saveAuth" style="margin-bottom:10px;"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> </form> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":92,"md5":"867ac80e1545f8fe4a6e7ea44740ab52"}*/
define(function(require) {
    return require("../../../template")("system/user/view/update", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12 globalAdd"> <form class="form-horizontal T-updateUser-form" role="form" style="margin-top:10px" onsubmit="return false"> <div class="form-group guideInterval"> <label class="col-sm-2 control-label no-padding-right">用户名:</label> <div class="col-sm-3"> ', 
            ...
            $line = 53, 1 == user.status && ($out += 'checked="checked"', $line = 53), $out += ' type="checkbox" name="" class="ace T-user-status" /> <span class="lbl"> 启用 </span> </label> </div> </div> <div class="space-10"></div> <button class="btn btn-block btn-primary T-updateUser"> <i class="ace-icon fa fa-check"></i> 提交信息 </button> </form> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

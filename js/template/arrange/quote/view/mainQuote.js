/*TMODJS:{"debug":true,"version":16,"md5":"24b59aba1e0a50719b80eda6b20c6f77"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/mainQuote", function($data, $filename) {
        try {
            ...
            $line = 5, $out += $escape(a), $out += '" class="quoteContent quoteWidthAdd" aria-expanded="false" data-value="1"> 报价详情 </a> </li> <li> <a data-toggle="tab" href="#inquiryContent-', 
            $line = 10, $out += $escape(a), $out += '" class="inquiryContent quoteWidthAdd" aria-expanded="true" data-value="2"> 询价状态 </a> </li> </ul> <div class="tab-content" style="position:relative;top: -2px">  <div id="quoteContent-', 

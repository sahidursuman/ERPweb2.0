/*TMODJS:{"debug":true,"version":9,"md5":"b691df4253496f5c1c17ce5f337ecbff"}*/
    ...
    return require("../../../template")("arrange/quote/view/lineProductList", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(lineProductList, function(lineProduct) {
                ...
                $out += " </td> <td> ", $line = 7, $out += $escape(lineProduct.days), $out += "天 </td> <td> ", 
                ...
                $line = 17), $out += ' </td> <td> <label class="choice-TravelLine-click"> <input type="radio" class="ace" value="123" name="choice-TravelLine" index="0"> <span class="lbl"> </span> </label> </td> </tr> ', 
                $line = 28;
            }), new String($out);
        } catch (e) {
            throw {

/*TMODJS:{"debug":true,"version":85,"md5":"5be1222612e69d6cd9197666fffcfc89"}*/
    ...
    return require("../../../template")("arrange/quote/view/hotelInquiryList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(hotelList, function(hotel) {
                ...
                $line = 43, $out += $escape(hotel.inquiryHotelRoolList.length), $out += '"><a class="T-chooseHotel">添加</a></td> </tr> ', 

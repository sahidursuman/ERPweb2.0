/*TMODJS:{"debug":true,"version":83,"md5":"23a5aefed5b837ce7cc65c20ad694c4b"}*/
        ...
        try {
            ...
            $line = 17, $each(hotelList, function(hotel) {
                ...
                $line = 34) : ($out += " ", $line = 35, $each(hotel.inquiryHotelRoolList, function(room, index) {
                    ...
                    $line = 39, $out += $escape(room.inquiryPriceList), $out += "</td> ", $line = 40), 
                    $out += " ", $line = 41;
                }), $out += " ", $line = 42), $out += ' <td style="vertical-align:middle" rowspan="', 
                $line = 43, $out += $escape(hotel.inquiryHotelRoolList.length), $out += '"><a class="T-chooseHotel">选择</a></td> </tr> ', 
                $line = 45, $each(hotel.inquiryHotelRoolList, function(room, index) {
                    $out += " ", $line = 46, index > 0 && ($out += " <tr> <td>", $line = 48, $out += $escape(room.type), 
                    $out += "</td> <td>", $line = 49, 1 == room.containBreakfast && ($out += "早餐、", 
                    $line = 49), $line = 49, 1 == room.containLunch && ($out += "午餐、", $line = 49), 
                    $line = 49, 1 == room.containDinner && ($out += "晚餐", $line = 49), $out += "</td> <td>", 
                    $line = 50, $out += $escape(room.inquiryPriceList), $out += "</td> </tr> ", $line = 52), 
                    $out += " ", $line = 53;
                }), $out += " ", $line = 54;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 59, $out += $escape(searchParam.totalCount), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

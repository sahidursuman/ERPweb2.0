/*TMODJS:{"debug":true,"version":84,"md5":"1fdb3af25eeae357720db61c019fb176"}*/
        ...
        try {
            ...
            $line = 17, $each(hotelList, function(hotel) {
                ...
                $line = 45, $each(hotel.inquiryHotelRoolList, function(room, index) {
                    ...
                    $line = 50, null != room.price && ($line = 50, $out += $escape(room.price.contractPrice), 
                    $line = 50), $out += "</td> </tr> ", $line = 52), $out += " ", $line = 53;
                }), $out += " ", $line = 54;

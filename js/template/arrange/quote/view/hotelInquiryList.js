/*TMODJS:{"debug":true,"version":86,"md5":"08d2f127d6de824ea002dfeabb02d69a"}*/
        ...
        try {
            ...
            $line = 17, $each(hotelList, function(hotel) {
                ...
                $line = 47, $each(hotel.inquiryHotelRoolList, function(room, index) {
                    ...
                    $line = 51, 1 == room.containDinner && ($out += "晚餐", $line = 51), $out += "</td> <td>", 
                    $line = 52, null != room.price && ($line = 52, $out += $escape(room.price.contractPrice), 
                    $line = 52), $out += "</td> </tr> ", $line = 54), $out += " ", $line = 55;
                }), $out += " ", $line = 56;

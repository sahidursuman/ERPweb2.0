/*TMODJS:{"debug":true,"version":70,"md5":"9508d92fa30337fd6294fb970c6b925a"}*/
        ...
        try {
            ...
            $line = 22, $each(data, function(rs) {
                ...
                $out += "</td> ", $line = 28, $each(rs.hotelList, function(offer, index) {
                    ...
                    $line = 136, $out += $escape(hotel.id), $out += '"> ', $line = 137, "等待确认" == offer.status ? ($out += ' <a class="T-hotel-refresh">刷新</a><span> | </span> ', 

/*TMODJS:{"debug":true,"version":90,"md5":"7ed845ccaa2949cdb4b75a0812322d4f"}*/
        ...
        try {
            ...
            $line = 22, $each(data, function(rs) {
                ...
                $out += "</td> ", $line = 28, $each(rs.hotelList, function(offer, index) {
                    ...
                    $out += " ", $line = 171) : 0 == offer.reserveMinutes ? ($out += " ", $line = 172, 
                    "已同意" == offer.status ? ($out += "已到期", $line = 172) : ($out += "-", $line = 172), 
                    $out += " ", $line = 173) : ($out += " ", $line = 174, $out += $escape(offer.reserveTime), 
                    $out += " ", $line = 175), $out += ' </td> <td rowspan="', $line = 177, $out += $escape(offer.roomTypeList.length), 
                    $out += '">', $line = 177, $out += $escape(offer.expiryTime), $out += '</td> <td rowspan="', 
                    $line = 178, $out += $escape(offer.roomTypeList.length), $out += '">', $line = 178, 
                    $out += $escape(offer.status), $out += '</td> <td rowspan="', $line = 179, $out += $escape(offer.roomTypeList.length), 
                    $out += '" data-id="', $line = 179, $out += $escape(offer.id), $out += '"> ', $line = 180, 
                    "等待确认" == offer.status ? ($out += ' <a class="T-hotel-refresh">刷新</a><span> | </span> ', 

/*TMODJS:{"debug":true,"version":77,"md5":"6a0cc24fc4ab4d6fd18a2eb52f17d2ca"}*/
        ...
        try {
            ...
            $line = 22, $each(data, function(rs) {
                ...
                $out += "</td> ", $line = 28, $each(rs.hotelList, function(offer, index) {
                    ...
                    $line = 65) : ($out += " ", $line = 66, offer.reserveMinutes / 60 > 1 && ($out += " ", 
                    $line = 67, $out += $escape((offer.reserveMinutes - offer.reserveMinutes % 60) / 60), 
                    $out += "小时 ", $line = 68), $out += " ", $line = 69, $out += $escape(offer.reserveMinutes % 60), 
                    $out += "分钟 ", $line = 70), $out += ' </td> <td rowspan="', $line = 72, $out += $escape(offer.roomTypeList.length), 

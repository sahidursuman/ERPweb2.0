/*TMODJS:{"debug":true,"version":90,"md5":"24f10c2154c273258b351a690b563a91"}*/
        ...
        try {
            ...
            $line = 22, $each(data, function(rs) {
                ...
                $out += "</td> ", $line = 28, $each(rs.hotelList, function(offer, index) {
                    ...
                    $out += $escape(offer.id), $out += '"> ', $line = 86, "已同意" == offer.status && ($out += ' <a class="T-hotel-add">加入</a><span> | </span> ', 
                    ...
                    $line = 97, $each(offer.roomTypeList, function(room, index) {
                        $out += " ", $line = 98, index > 0 && ($out += ' <td class="T-hotelType-', $line = 99, 
                        $out += $escape(offer.id), $out += '">', $line = 99, $out += $escape(room.type), 
                        $out += '</td> <td class="T-hotelPrice-', $line = 100, $out += $escape(offer.id), 
                        $out += '"> ', $line = 101, 1 == room.isContractPrice ? ($out += " ", $line = 102, 
                        $out += $escape(room.price), $out += " ", $line = 103) : ($out += " ", $line = 104, 
                        "已同意" == offer.status ? ($out += " ", $line = 105, $out += $escape(room.replyPrice), 
                        $out += " ", $line = 106) : ($out += " - ", $line = 108), $out += " ", $line = 109), 
                        $out += " </td> ", $line = 111), $out += " ", $line = 112;
                    }), $out += " ", $line = 113) : ($out += ' <td class="T-hotelType-', $line = 114, 
                    $out += $escape(offer.id), $out += '"></td> <td class="T-hotelPrice-', $line = 115, 
                    $out += $escape(offer.id), $out += '"></td> ', $line = 116), $out += " ", $line = 117), 
                    $out += " ", $line = 118;
                    ...
                    $out += " ", $line = 169) : 0 == offer.reserveMinutes ? ($out += " - ", $line = 171) : ($out += " ", 
                    $line = 172, $out += $escape(offer.reserveTime), $out += " ", $line = 173), $out += ' </td> <td rowspan="', 
                    $line = 175, $out += $escape(offer.roomTypeList.length), $out += '">', $line = 175, 
                    $out += $escape(offer.expiryTime), $out += '</td> <td rowspan="', $line = 176, $out += $escape(offer.roomTypeList.length), 
                    $out += '">', $line = 176, $out += $escape(offer.status), $out += '</td> <td rowspan="', 
                    $line = 177, $out += $escape(offer.roomTypeList.length), $out += '" data-id="', 
                    $line = 177, $out += $escape(offer.id), $out += '"> ', $line = 178, "已同意" == offer.status && ($out += ' <a class="T-hotel-add">加入</a><span> | </span> ', 
                    ...
                    offer.roomTypeList.length > 0 ? ($out += " ", $line = 185, $each(offer.roomTypeList, function(room, index) {
                        $out += " ", $line = 186, index > 0 && ($out += ' <td class="T-hotelType-', $line = 187, 
                        $out += $escape(offer.id), $out += '">', $line = 187, $out += $escape(room.type), 
                        ...
                        $out += " </td> ", $line = 199), $out += " ", $line = 200;
                    }), $out += " ", $line = 201) : ($out += ' <td class="T-hotelType-', $line = 202, 
                    $out += $escape(offer.id), $out += '"></td> <td class="T-hotelPrice-', $line = 203, 
                    $out += $escape(offer.id), $out += '"></td> ', $line = 204), $out += " ", $line = 205), 
                    $out += " ", $line = 206;
                }), $out += " ", $line = 207;

/*TMODJS:{"debug":true,"version":78,"md5":"73f68e5f49b04288b9a6bbc5437e87be"}*/
        ...
        try {
            ...
            $line = 22, $each(data, function(rs) {
                ...
                $out += "</td> ", $line = 28, $each(rs.hotelList, function(offer, index) {
                    ...
                    $line = 75) : ($out += " ", $line = 76, offer.reserveMinutes / 60 > 0 && ($out += " ", 
                    $line = 77, $out += $escape(offer.reserveMinutes / 60), $out += "小时 ", $line = 78), 
                    $out += " ", $line = 79, $out += $escape(offer.reserveMinutes % 60), $out += "分钟 ", 
                    $line = 80), $out += ' </td> <td rowspan="', $line = 82, $out += $escape(offer.roomTypeList.length), 

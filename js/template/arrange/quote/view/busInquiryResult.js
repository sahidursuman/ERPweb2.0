/*TMODJS:{"debug":true,"version":54,"md5":"0285a251b59c50f49d2467ff9ddde73a"}*/
        ...
        try {
            ...
            $line = 19, $each(data, function(rs) {
                ...
                $out += $escape(rs.condition), $out += "</td> ", $line = 24, $each(rs.busCompanyOfferList, function(offer, index) {
                    ...
                    $line = 33) : ($out += " ", $line = 34, offer.reserveMinutes / 60 > 1 && ($out += " ", 
                    $line = 35, $out += $escape((offer.reserveMinutes - offer.reserveMinutes % 60) / 60), 

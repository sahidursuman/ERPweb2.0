/*TMODJS:{"debug":true,"version":55,"md5":"ed13cf3bf493782f93b394b2bc99d28a"}*/
        ...
        try {
            ...
            $line = 19, $each(data, function(rs) {
                ...
                $out += $escape(rs.condition), $out += "</td> ", $line = 24, $each(rs.busCompanyOfferList, function(offer, index) {
                    ...
                    $line = 58, $out += $escape(offer.remark), $out += "</td> <td>", $line = 59, -1 == offer.reserveMinutes ? ($out += " 一直保留 ", 
                    $line = 61) : 0 == offer.reserveMinutes ? ($out += " - ", $line = 63) : ($out += " ", 
                    $line = 64, offer.reserveMinutes / 60 > 1 && ($out += " ", $line = 65, $out += $escape((offer.reserveMinutes - offer.reserveMinutes % 60) / 60), 
                    $out += "小时 ", $line = 66), $out += " ", $line = 67, $out += $escape(offer.reserveMinutes % 60), 
                    $out += "分钟 ", $line = 68), $out += " </td> <td>", $line = 70, $out += $escape(offer.expiryTime), 
                    $out += '</td> <td class="T-status">', $line = 71, $out += $escape(offer.status), 
                    $out += '</td> <td data-id="', $line = 72, $out += $escape(offer.id), $out += '"> ', 
                    $line = 73, "等待确认" == offer.status ? ($out += ' <a class="T-bus-refresh">刷新</a><span> | </span> ', 
                    $line = 75) : "已同意" == offer.status && ($out += ' <a class="T-bus-add">加入</a><span> | </span> ', 
                    $line = 77), $out += ' <a class="T-bus-delete">删除</a> </td> </tr> ', $line = 81), 
                    $out += " ", $line = 82;
                }), $out += " ", $line = 83;

/*TMODJS:{"debug":true,"version":46,"md5":"fe2ea1e787effe95a0f81fd82b8dc415"}*/
        ...
        try {
            ...
            $line = 19, $each(data, function(rs) {
                ...
                $out += $escape(rs.condition), $out += "</td> ", $line = 24, $each(rs.busCompanyOfferList, function(offer, index) {
                    ...
                    $line = 29, -1 == offer.reserveMinutes ? ($out += " 一直保留 ", $line = 31) : ($out += " ", 
                    $line = 32, offer.reserveMinutes / 60 > 0 && ($out += " ", $line = 33, $out += $escape(offer.reserveMinutes / 60), 
                    $out += "小时 ", $line = 34), $out += " ", $line = 35, $out += $escape(offer.reserveMinutes % 60), 
                    $out += "分钟 ", $line = 36), $out += " </td> <td>", $line = 38, $out += $escape(offer.expiryTime), 
                    $out += '</td> <td class="T-status">', $line = 39, $out += $escape(offer.status), 
                    $out += '</td> <td data-id="', $line = 40, $out += $escape(offer.id), $out += '"> ', 
                    $line = 41, "等待确认" == offer.status ? ($out += ' <a class="T-bus-refresh">刷新</a><span> | </span> ', 
                    $line = 43) : "已同意" == offer.status && ($out += ' <a class="T-bus-add">加入</a><span> | </span> ', 
                    $line = 45), $out += ' <a class="T-bus-delete">删除</a> </td> ', $line = 48), $out += " ", 
                    $line = 49;
                }), $out += " </tr> ", $line = 51, $each(rs.busCompanyOfferList, function(offer, index) {
                    $out += " ", $line = 52, index > 0 && ($out += " <tr> <td>", $line = 54, $out += $escape(offer.busCompanyName), 
                    $out += '</td> <td class="T-price">', $line = 55, $out += $escape(offer.replyPrice), 
                    $out += "</td> <td>", $line = 56, $out += $escape(offer.remark), $out += "</td> <td>", 
                    $line = 57, $out += $escape(offer.reserveMinutes), $out += "</td> <td>", $line = 58, 
                    $out += $escape(offer.expiryTime), $out += '</td> <td class="T-status">', $line = 59, 
                    $out += $escape(offer.status), $out += '</td> <td data-id="', $line = 60, $out += $escape(offer.id), 
                    $out += '"> ', $line = 61, "等待确认" == offer.status ? ($out += ' <a class="T-bus-refresh">刷新</a><span> | </span> ', 
                    $line = 63) : "已同意" == offer.status && ($out += ' <a class="T-bus-add">加入</a><span> | </span> ', 
                    $line = 65), $out += ' <a class="T-bus-delete">删除</a> </td> </tr> ', $line = 69), 
                    $out += " ", $line = 70;
                }), $out += " ", $line = 71;

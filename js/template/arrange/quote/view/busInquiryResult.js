/*TMODJS:{"debug":true,"version":47,"md5":"5b4370b9716c269d7edbc528f35078b8"}*/
        ...
        try {
            ...
            $line = 19, $each(data, function(rs) {
                ...
                $out += $escape(rs.condition), $out += "</td> ", $line = 24, $each(rs.busCompanyOfferList, function(offer, index) {
                    ...
                    $line = 29, -1 == offer.reserveMinutes ? ($out += " 一直保留 ", $line = 31) : 0 == offer.reserveMinutes ? ($out += " - ", 
                    $line = 33) : ($out += " ", $line = 34, offer.reserveMinutes / 60 > 0 && ($out += " ", 
                    $line = 35, $out += $escape(offer.reserveMinutes / 60), $out += "小时 ", $line = 36), 
                    $out += " ", $line = 37, $out += $escape(offer.reserveMinutes % 60), $out += "分钟 ", 
                    $line = 38), $out += " </td> <td>", $line = 40, $out += $escape(offer.expiryTime), 
                    ...
                    $out += '</td> <td class="T-price">', $line = 57, $out += $escape(offer.replyPrice), 
                    $out += "</td> <td>", $line = 58, $out += $escape(offer.remark), $out += "</td> <td>", 
                    $line = 59, $out += $escape(offer.reserveMinutes), $out += "</td> <td>", $line = 60, 
                    $out += $escape(offer.expiryTime), $out += '</td> <td class="T-status">', $line = 61, 
                    $out += $escape(offer.status), $out += '</td> <td data-id="', $line = 62, $out += $escape(offer.id), 
                    $out += '"> ', $line = 63, "等待确认" == offer.status ? ($out += ' <a class="T-bus-refresh">刷新</a><span> | </span> ', 

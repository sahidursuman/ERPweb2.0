/*TMODJS:{"debug":true,"version":74,"md5":"55050310bfeb72cefa18ae2148da808d"}*/
        ...
        try {
            ...
            $line = 19, $each(data, function(rs) {
                ...
                $out += $escape(rs.condition), $out += "</td> ", $line = 24, $each(rs.busCompanyOfferList, function(offer, index) {
                    ...
                    $line = 67, "已同意" == offer.status ? ($out += "已到期", $line = 67) : ($out += "-", 
                    $line = 67), $out += " ", $line = 68) : ($out += " ", $line = 69, $out += $escape(offer.reserveTime), 
                    $out += " ", $line = 70), $out += " </td> <td>", $line = 72, $out += $escape(offer.expiryTime), 

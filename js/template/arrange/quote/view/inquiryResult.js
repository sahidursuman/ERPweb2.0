/*TMODJS:{"debug":true,"version":17,"md5":"2dcbe0376c1d24aed8fbe872db809a37"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/inquiryResult", function($data, $filename) {
        try {
            ...
            $line = 5, $out += $escape(a), $out += '" class="busInquiryResult" aria-expanded="false" data-value="1"> 车 </a> </li> <li> <a data-toggle="tab" href="#hotelInquiryContent-', 
            $line = 10, $out += $escape(a), $out += '" class="hotelInquiryContent" aria-expanded="true" data-value="2"> 房 </a> </li> </ul> <div class="tab-content" style="position:relative;top: -2px">  <div id="busInquiryResult-', 

/*TMODJS:{"debug":true,"version":28,"md5":"e868ea16d8028feaedb12e8f9a46e883"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/inquiryResult", function($data, $filename) {
        try {
            ...
            $line = 7, $out += $escape(a), $out += '" class="busInquiryResult stateQuoteStyle" aria-expanded="false" data-value="1"> 车 </a> </li> <li> <a data-toggle="tab" href="#hotelInquiryContent-', 
            $line = 12, $out += $escape(a), $out += '" class="hotelInquiryContent stateQuoteStyle" aria-expanded="true" data-value="2"> 房 </a> </li> </ul> <div class="tab-content" style="position:relative;top: -2px">  <div id="busInquiryResult-', 
            $line = 19, $out += $escape(a), $out += '" class="tab-pane fade active in clearfix"> </div>  <div id="hotelInquiryContent-', 
            $line = 22, $out += $escape(a), $out += '" class="tab-pane fade clearfix"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

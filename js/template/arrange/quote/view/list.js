/*TMODJS:{"debug":true,"version":139,"md5":"7a3a592d2d1601488ebd3491f9ab4f1f"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $out += "> 修改 <span style='margin-left:5px;'>|</span> </a> <a class=\"cursor T-action T-view\"> 查看 <span style='margin-left:5px;'>|</span> </a> <a class=\"cursor R-right T-action ", 

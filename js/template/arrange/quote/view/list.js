/*TMODJS:{"debug":true,"version":160,"md5":"003c22131333a7bc2532cf1af34bd4a7"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $out += $escape(quote.createTime), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor R-right T-action T-status" data-right="1440002"> 询价状态 <span style=\'margin-left:5px;\'>|</span> </a> <a class="cursor R-right T-action ', 

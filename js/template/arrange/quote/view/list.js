/*TMODJS:{"debug":true,"version":108,"md5":"8c4acd8298192906e3dc7c62014b886d"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $line = 43, quote.touristGroupId || ($out += " T-update ", $line = 43), $out += '" data-right="1450002" ', 
                $line = 43, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 43), 
                $out += '> 修改 </a> <a>|</a> <a class="cursor R-right T-action T-view"> 查看 </a> <a>|</a> <a class="cursor R-right T-action ', 
                $line = 51, quote.touristGroupId || ($out += " T-delete ", $line = 51), $out += '" data-right="1450003" ', 
                $line = 51, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 51), 

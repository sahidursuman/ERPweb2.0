/*TMODJS:{"debug":true,"version":153,"md5":"78d25c53b2d552d2e55b19a76aa6fc56"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $out += $escape(quote.createTime), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor T-action T-status"> 询价状态 <span style=\'margin-left:5px;\'>|</span> </a> <a class="cursor R-right T-action ', 

/*TMODJS:{"debug":true,"version":160,"md5":"d5b375a78d6e61bacbea3730cc1a1e1e"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 23, $each(quoteList, function(quote) {
                ...
                $line = 27), $out += "</td> <td>", $line = 28, null != quote.lineProduct && ($line = 28, 
                $out += $escape(quote.lineProduct.days), $line = 28), $out += "</td> <td>", $line = 29, 
                $out += $escape(quote.adultCount), $out += "大", $line = 29, $out += $escape(quote.childCount), 
                $out += "小</td> <td>", $line = 30, null != quote.lineProduct && ($line = 30, $out += $escape(quote.lineProduct.type), 
                ...
                $out += "</td> <td>", $line = 34, $out += $escape(quote.adultQuotePrice), $out += "</td> <td>", 
                $line = 35, $out += $escape(quote.childQuotePrice), $out += "</td> <td>", $line = 36, 
                $out += $escape(quote.sumQuoteFee), $out += "</td> <td>", $line = 37, null != quote.user && ($line = 37, 
                $out += $escape(quote.user.realName), $line = 37), $out += "</td> <td>", $line = 38, 

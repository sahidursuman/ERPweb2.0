/*TMODJS:{"debug":true,"version":173,"md5":"fbbfeb20e42fbcfeae569725269bffcc"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12"> <table class="table table-striped overflow-table table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>报价单号</th> <th>产品名称</th> <th>出游日期</th> <th>天数</th> <th>人数</th> <th>类别</th> <th>针对客源</th> <th>客户</th> <th>联系人</th> <th>大人报价</th> <th>小孩报价</th> <th>总报价</th> <th>报价人</th> <th class="col-sm-1">报价时间</th> <th>操作</th> </tr> </thead> <tbody>', 

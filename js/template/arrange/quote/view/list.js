/*TMODJS:{"debug":true,"version":195,"md5":"1dcd58879e741f093e18d8614854f784"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div class=""> <table class="table table-striped overflow-table table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>报价单号</th> <th>产品信息</th> <th>出游日期</th> <th>人数</th> <th>客户</th> <th>联系人</th> <th>大人报价</th> <th>小孩报价</th> <th>总报价</th> <th>报价人</th> <th class="col-sm-1">报价时间</th> <th>操作</th> </tr> </thead> <tbody>', 
            $line = 19, $each(quoteList, function(quote) {
                ...
                $line = 23), $out += "</p> <p> <span>", $line = 25, null != quote.lineProduct && ($line = 25, 
                0 == quote.lineProduct.customerType ? ($out += "散客", $line = 25) : ($out += "团体", 
                $line = 25), $line = 25), $out += "</span> <span>", $line = 26, null != quote.lineProduct && ($line = 26, 
                $out += $escape(quote.lineProduct.type), $line = 26), $out += '</span> <label><span class="F-float F-count">', 

/*TMODJS:{"debug":true,"version":158,"md5":"f0f6e30f900a903146f8051f53475068"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>产品名称</th> <th>出游日期</th> <th>天数</th> <th>人数</th> <th>类别</th> <th>应用范围</th> <th>客户</th> <th>联系人</th> <th>大人报价</th> <th>小孩报价</th> <th>总报价</th> <th>报价人</th> <th class="col-sm-1">报价时间</th> <th width="300">操作</th> </tr> </thead> <tbody>', 
            $line = 22, $each(quoteList, function(quote) {
                ...
                $out += $escape(quote.createTime), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor R-right T-action T-status"> 询价状态 <span style=\'margin-left:5px;\' data-right="1440002">|</span> </a> <a class="cursor R-right T-action ', 
                ...
                $line = 45, quote.touristGroupId || ($out += " T-copy ", $line = 45), $out += '" data-right="1440002" ', 
                $line = 45, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 45), 
                ...
                $line = 52, quote.touristGroupId || ($out += " T-delete ", $line = 52), $out += '" data-right="1440003" ', 
                $line = 52, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 52), 

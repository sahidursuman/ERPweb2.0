/*TMODJS:{"debug":true,"version":80,"md5":"354dab3c7a710298db77460163694878"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 20, $each(quoteList, function(quote) {
                ...
                $out += $escape(quote.createTime), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor R-right T-action"> 询价状态 </a> <a>|</a> <a class="cursor R-right T-action T-update"> 修改 </a> <a>|</a> <a class="cursor R-right T-action T-view"> 查看 </a> <a>|</a> <a class="cursor R-right T-action T-delete"> 删除 </a> <a>|</a> <a class="cursor R-right T-action T-share"> 分享 </a> </div> </td> </tr>', 
                $line = 56;

/*TMODJS:{"debug":true,"version":87,"md5":"99287fd074ec562f56cf01e03eb7d5f3"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 20, $each(quoteList, function(quote) {
                ...
                $out += $escape(quote.sumQuoteFee), $out += "</td> <td>", $line = 31, null != quote.user && ($line = 31, 
                $out += $escape(quote.user.realName), $line = 31), $out += "</td> <td>", $line = 32, 
                $out += $escape(quote.createTime), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor R-right T-action T-status"> 询价状态 </a> <a>|</a> <a class="cursor R-right T-action ', 
                $line = 39, quote.touristGroupId || ($out += " T-update ", $line = 39), $out += '" ', 
                $line = 39, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 39), 
                $out += '> 修改 </a> <a>|</a> <a class="cursor R-right T-action T-view"> 查看 </a> <a>|</a> <a class="cursor R-right T-action ', 
                $line = 47, quote.touristGroupId || ($out += " T-delete ", $line = 47), $out += '" ', 
                $line = 47, quote.touristGroupId && ($out += ' style="color:#bbb;" ', $line = 47), 
                $out += '> 删除 </a> <a>|</a> <a class="cursor R-right T-action T-share"> 分享 </a> </div> </td> </tr>', 
                $line = 56;

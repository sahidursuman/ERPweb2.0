/*TMODJS:{"debug":true,"version":205,"md5":"fda2de12686d0e26b126b4c68442940a"}*/
define(function(require) {
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            return $out += ' <table class="table table-striped overflow-table table-bordered table-hover T-showHighLight"> <thead> <colgroup> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col></col> <col width="277"></col> </colgroup> <tr class="bg-blur T-tr-fixed"> <th>报价单号</th> <th>产品信息</th> <th>出游日期</th> <th>人数</th> <th>客户</th> <th>联系人</th> <th>大人报价</th> <th>小孩报价</th> <th>总报价</th> <th>报价人</th> <th class="col-sm-1">报价时间</th> <th>操作</th> </tr> </thead> <tbody>', 
            $line = 33, $each(quoteList, function(quote) {
                ...
                $out += "天", $line = 41), $out += "</span></label> </p> </td> <td>", $line = 44, 
                quote.startTime && ($line = 44, $out += $escape($helpers.dateFormat(quote.startTime, "yyyy-MM-dd")), 
                $line = 44), $out += '</td> <td><span class="F-float F-count">', $line = 45, $out += $escape(quote.adultCount), 

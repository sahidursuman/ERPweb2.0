/*TMODJS:{"debug":true,"version":121,"md5":"4399f41d84562a4a7fa6127fc61435c0"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $line = 43, quote.touristGroupId || ($out += " T-update ", $line = 43), $out += '" data-right="1440002" ', 
                ...
                $line = 51, quote.touristGroupId || ($out += " T-delete ", $line = 51), $out += '" data-right="1440003" ', 

/*TMODJS:{"debug":true,"version":95,"md5":"3f8beabf3280d0ea16d462ceb5fa1871"}*/
    ...
    return require("../../../template")("arrange/quote/view/list", function($data, $filename) {
        try {
            ...
            $line = 22, $each(quoteList, function(quote) {
                ...
                $line = 43, quote.touristGroupId || ($out += " T-update ", $line = 43), $out += '" ', 
                ...
                $line = 51, quote.touristGroupId || ($out += " T-delete ", $line = 51), $out += '" ', 

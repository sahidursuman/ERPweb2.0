/*TMODJS:{"debug":true,"version":10,"md5":"9c2eda9d91ab4f829aa38d6551733a22"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/busList", function($data, $filename) {
        try {
            ...
            $line = 14, $each(bookingOrderList, function(rs) {
                ...
                $out += $escape(rs.outOPUserName), $out += "</td> <td> ", $line = 22, 1 == rs.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i>已安排 ', 
                $line = 24) : ($out += ' <i class="ace-icon fa fa-times red bigger-125"></i>未安排 ', 
                $line = 26), $out += ' </td> <td> <a class="cursor T-action T-send R-right" data-right="1140010" title="通知"> 通知 <label style="padding-left:10px;">|</label> </a> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 39;

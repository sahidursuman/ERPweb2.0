/*TMODJS:{"debug":true,"version":11,"md5":"36c0553a6b6963fb3e2fc718fb5a661d"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/busList", function($data, $filename) {
        try {
            ...
            $line = 14, $each(bookingOrderList, function(rs) {
                ...
                $line = 26), $out += ' </td> <td> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 36;

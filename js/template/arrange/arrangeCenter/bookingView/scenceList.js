/*TMODJS:{"debug":true,"version":9,"md5":"c4b17617a471f6c0c0590b477ef963af"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/scenceList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(bookingOrderList, function(rs) {
                ...
                $line = 31), $out += ' </td> <td> <a class="cursor T-action T-send R-right" data-right="1140010" title="通知"> 通知 <label style="padding-left:10px;">|</label> </a> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 44;

/*TMODJS:{"debug":true,"version":11,"md5":"203770c70d01e47b9d46d84759baa97c"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/scenceList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(bookingOrderList, function(rs) {
                ...
                $line = 31), $out += ' </td> <td> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 41;

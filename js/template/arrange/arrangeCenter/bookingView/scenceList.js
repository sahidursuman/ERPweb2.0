/*TMODJS:{"debug":true,"version":1,"md5":"533cbbe9e789ca7e234fc972292bbbc3"}*/
define(function(require) {
    return require("/js/template/template")("arrange/arrangeCenter/bookingView/scenceList", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), $escape = $utils.$escape, recordSize = $data.recordSize, $out = "";
            return $out += ' <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur T-tr-fixed"> <th>待订单号</th> <th>类型</th> <th>出游时间</th> <th>路程</th> <th>座位级别</th> <th>数量</th> <th>要求</th> <th>安排结果</th> <th>外联销售</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody class="T-guide-list"> <tr data-id=""> <td>DJ2342222</td>  <td>2016-04-05</td> <td>峨眉山</td> <td>10</td> <td>请安排</td> <td>-</td> <td>张也</td> <td><div class="fa fa-check green"></div>已安排</td> <td style="vertical-align:middle;width:200px"> <a class="cursor T-action T-send R-right" data-right="1140010" title="通知"> 通知 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> <label class="padding-right20">|</label> 安排 </a> </td> </tr> </tbody> </table> <div class="clearfix"></div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 43, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="T-pagenation text-right"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

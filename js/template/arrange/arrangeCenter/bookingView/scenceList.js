/*TMODJS:{"debug":true,"version":17,"md5":"44875da0ebeb9be61f26466a6b0ba1be"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/scenceList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(bookingOrderList, function(rs) {
                ...
                $line = 31), $out += ' </td> <td> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1480008" title="安排"> 安排 </a> <a class="cursor T-action T-view" title="查看"> <label class="padding-right20">|</label> 查看 </a> </td> </tr> ', 
                $line = 41;

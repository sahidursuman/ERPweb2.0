/*TMODJS:{"debug":true,"version":8,"md5":"ceb355c6a16c406c11cd266736961ca5"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/busView", function($data, $filename) {
        try {
            ...
            $line = 28, arrangeList && arrangeList.length > 0 && ($out += " ", $line = 29, $each(arrangeList, function(rs) {
                ...
                $out += "</td> <td>", $line = 36, $out += $escape(rs.fee), $out += "</td> <td>", 
                $line = 37, $out += $escape(rs.reduceMoney), $out += "</td> <td>", $line = 38, $out += $escape(rs.sumCostMoney), 
                $out += "</td> <td>", $line = 39, $out += $escape(rs.prePayMoney), $out += "</td> <td>", 
                $line = 40, $out += $escape(rs.remark), $out += "</td> </tr> ", $line = 42;

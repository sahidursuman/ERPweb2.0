/*TMODJS:{"debug":true,"version":9,"md5":"dc2cad5223c631ea5d7b407b3c1fbde0"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/ticketList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(bookingOrderList, function(rs) {
                ...
                $line = 35), $out += ' </td> <td> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1480009" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 45;

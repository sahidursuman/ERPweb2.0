/*TMODJS:{"debug":true,"version":13,"md5":"657b04a0430f11d38d5902d2c1e3cf6b"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/ticketList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(bookingOrderList, function(rs) {
                ...
                $line = 31, 1 == rs.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i>已完成 ', 
                $line = 33) : ($out += ' <i class="ace-icon fa fa-times red bigger-125"></i>未完成 ', 
                $line = 35), $out += ' </td> <td> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1480009" title="安排"> 安排 </a> <a class="cursor T-action T-view" title="查看"> <label class="padding-right20">|</label> 查看 </a> </td> </tr> ', 
                $line = 45;

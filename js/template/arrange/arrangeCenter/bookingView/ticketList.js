/*TMODJS:{"debug":true,"version":6,"md5":"45511d07aa7db2d74a7fa363f0bcc329"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/bookingView/ticketList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(bookingOrderList, function(rs) {
                ...
                $line = 35), $out += ' </td> <td> <a class="cursor T-action T-send R-right" data-right="1140010" title="通知"> 通知 <label style="padding-left:10px;">|</label> </a> <a billstatus="-1" class="cursor T-action T-plan R-right" data-right="1140007" title="安排"> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> </td> </tr> ', 
                $line = 48;
            }), $out += ' </tbody> </table> <div class="clearfix"></div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 54, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="T-pagenation text-right"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

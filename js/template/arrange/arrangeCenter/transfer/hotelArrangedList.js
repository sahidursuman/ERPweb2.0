/*TMODJS:{"debug":true,"version":3,"md5":"08a9487c9f68a2efbc33f1792513e895"}*/
define(function(require) {
    return require("/js/template/template")("arrange/arrangeCenter/transfer/hotelArrangedList", function($data, $filename) {
        try {
            ...
            $line = 14, $each(unifyList, function(hotel) {
                $out += " ", $line = 15, $each(hotel.hotelList, function(itme) {
                    $out += " ", $line = 16, $each(hotel.outRemarkList, function(seat, index) {
                        ...
                        $line = 45, $out += $escape(hotel.outRemarkList.length), $out += '"> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 

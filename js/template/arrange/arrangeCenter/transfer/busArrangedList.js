/*TMODJS:{"debug":true,"version":68,"md5":"d558f6b07cab681ecdb57251a876b28c"}*/
        ...
        try {
            ...
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $line = 44, $out += $escape(buslist.arrangeUserName), $out += "</td> <td>", $line = 45, 
                    3 == buslist.status ? ($out += "已完成", $line = 45) : ($out += "未完成", $line = 45), 
                    $out += "</td> ", $line = 46, 0 == index && ($out += ' <td rowspan="', $line = 47, 
                    $out += $escape(bus.outRemarkList.length), $out += '"> <a class="cursor T-action T-inform">通知</a> <a class="cursor T-arrange-item T-action"> <label class="padding-right20">|</label> 安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 
                    $line = 54), $out += " </tr> ", $line = 56;
                }), $out += " ", $line = 57;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 62, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

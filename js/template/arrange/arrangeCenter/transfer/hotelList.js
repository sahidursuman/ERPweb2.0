/*TMODJS:{"debug":true,"version":13,"md5":"59dd449967d9c8e770aa2969f94f456a"}*/
define(function(require) {
    return require("/js/template/template")("arrange/arrangeCenter/transfer/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 22, hotel.checked && ($out += ' checked="checked" ', $line = 22), $out += '> <span class="lbl"></span> </label> </td> <td class="h-touristGroupInfo"> <p>中转单号：', 
                ...
                $out += "</span><span>外联销售：", $line = 28, $out += $escape(hotel.outOPUserName), 
                ...
                $line = 55), $out += ' </td> <td> <a class="cursor T-inform T-action"> 通知</a> <a class="cursor T-arrange-item T-action"> <label class="padding-right20">|</label> 安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> </tr> ', 
                $line = 66;
            }), $out += ' </tbody> </table> <div class="text-center"> <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 71, canMergeArrange || ($out += ' disabled="disabled" ', $line = 71), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> </div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 78, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation-hotel"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":7,"md5":"3b04022dcc85f5b81113a2f20533dd15"}*/
define(function(require) {
    return require("/js/template/template")("arrange/arrangeCenter/transfer/busList", function($data, $filename) {
        try {
            ...
            $line = 53, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="T-pagenation"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

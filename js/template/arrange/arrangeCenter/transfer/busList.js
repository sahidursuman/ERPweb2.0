/*TMODJS:{"debug":true,"version":11,"md5":"83361cd555bdf3347e833b8c0cc0b253"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transfer/busList", function($data, $filename) {
        try {
            ...
            $line = 15, $each(outRemarkArrangeList, function(bus) {
                ...
                $line = 45;
            }), $out += ' </tbody> </table> <button class="btn btn-sm btn-success T-start-merge R-right" style="margin-left:50%" data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> <div class="style=\'clear: both;\'"></div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 

/*TMODJS:{"debug":true,"version":31,"md5":"412b04042273dbe8e259af291029ee44"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/planCollection", function($data, $filename) {
        try {
            ...
            $line = 15, $each(collectionList, function(item) {
                ...
                $out += "</td> <td>", $line = 31, $out += $escape(item.outOPUser), $out += '</td> <td><input type="text" name="collectionGroup" value="', 
                $line = 32, $out += $escape(item.collectionGroup), $out += '" maxlength="11" ', 
                $line = 32, ("1" == isConfirmAccount || isView) && ($out += "disabled", $line = 32), 
                $out += '></td> <td><input type="text" name="collectionItem" value="', $line = 33, 
                $out += $escape(item.collectionItem), $out += '" maxlength="11" ', $line = 33, ("1" == isConfirmAccount || isView) && ($out += "disabled", 

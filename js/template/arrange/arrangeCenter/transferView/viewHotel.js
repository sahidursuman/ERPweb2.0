/*TMODJS:{"debug":true,"version":7,"md5":"92c8fbcf58644d6e0fee1e6c73b41689"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/viewHotel", function($data, $filename) {
        try {
            ...
            $line = 3, $each(outRemarkList, function(viewmian) {
                $out += ' <table class="table table-striped table-bordered mar-b-20"> <tbody class="T-transfersId-hotel T-arrange"> <tr> <td style="text-align: left;"> <input type="hidden" name="id" value="', 
            ...
            $line = 52, $each(outHotelList, function(view) {
                $out += ' <tr data-entity-id="', $line = 53, $out += $escape(view.id), $out += '"> <td> ', 
                ...
                $out += " </td> <td> ", $line = 88, $out += $escape(view.prePayMoney), $out += ' </td> <td> <a class="cursor T-collection T-collection" data-type="bus">', 

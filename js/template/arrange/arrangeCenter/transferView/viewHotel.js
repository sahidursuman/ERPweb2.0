/*TMODJS:{"debug":true,"version":95,"md5":"5380a30c6bcb7f4930b9c2be57c25d5b"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/viewHotel", function($data, $filename) {
        try {
            ...
            $line = 3, $each(outRemarkList, function(viewmian) {
                ...
                $line = 8, $out += $escape(viewmian.orderNumber), $out += '</label> <label class="control-label mar-r-20">人数：', 
                $line = 9, $out += $escape(viewmian.adultCount), $out += " 大 ", $line = 9, $out += $escape(viewmian.childCount), 
                $out += '小</label> <label class="control-label mar-r-20">联系人电话：', $line = 10, $out += $escape(viewmian.contactMemberPhoneNumber), 
                $out += '</label> <!-- <label class="control-label mar-r-20">抵达时间：', $line = 11, 
                $out += $escape(viewmian.arriveTime), $out += '</label> --> <label class="control-label mar-r-20">游客联系人：', 
                $line = 12, $out += $escape(viewmian.contactMemberName), $out += '</label> <label class="control-label mar-r-20">线路名称：', 
                $line = 13, $out += $escape(viewmian.lineProductName), $out += '</label> <label class="control-label">外联销售：', 
                $line = 14, $out += $escape(viewmian.outOPUserName), $out += '</label> </td> </tr> <tr> <td style="text-align: left;"> <label class="control-label mar-r-20">客户名：', 
            ...
            $line = 50, $each(outHotelList, function(view) {
                $out += ' <tr data-entity-id="', $line = 51, $out += $escape(view.id), $out += '"> <td> ', 
                $line = 53, $out += $escape(view.checkInTime), $out += " </td> <td> ", $line = 56, 
                $out += $escape(view.checkOutTime), $out += " </td> <td> ", $line = 59, $out += $escape($helpers.getHotelLevelDesc(view.hotelLevel)), 
                $out += " </td> <td> ", $line = 62, $out += $escape(view.hotelName), $out += " </td> <td> ", 
                $line = 65, $out += $escape(view.hotelManagerName), $out += " </td> <td> ", $line = 68, 
                $out += $escape(view.hotelMobileNumber), $out += " </td> <td> ", $line = 71, $out += $escape(view.hotelRoomType), 
                $out += " </td> <td> ", $line = 74, $out += $escape(view.price), $out += " </td> <td> ", 
                $line = 77, $out += $escape(view.memberCount), $out += " </td> <td> ", $line = 80, 
                $out += $escape(view.reduceMoney), $out += " </td> <td> ", $line = 83, $out += $escape(view.needPayMoney), 
                $out += " </td> <td> ", $line = 86, $out += $escape(view.prePayMoney), $out += " </td> <td>", 
                $line = 88, $out += $escape(view.remark), $out += "</td> </tr>", $line = 89;

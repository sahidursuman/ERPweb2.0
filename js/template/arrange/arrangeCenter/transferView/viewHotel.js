/*TMODJS:{"debug":true,"version":3,"md5":"1487d75df9921ee4147ead6a87f6c0ee"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeCenter/transferView/viewHotel", function($data, $filename) {
        try {
            ...
            $data.$index, $utils.$escape), viewlist = $data.viewlist, outHotelList = $data.outHotelList, $out = ($data.view, 
            "");

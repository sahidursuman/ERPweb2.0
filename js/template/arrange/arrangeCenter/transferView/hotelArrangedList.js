/*TMODJS:{"debug":true,"version":69,"md5":"152f0f27237cd059a1fdf73f28743543"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $line = 71, 1 == hotel.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="hotel" title="取消"><label class="padding-right20">|</label>取消</a> ', 

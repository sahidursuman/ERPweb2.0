/*TMODJS:{"debug":true,"version":89,"md5":"00685b1c3a960efabef76d19e3e5f3ca"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $line = 68, 1 == hotel.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="hotel" title="已对账，无法删除"><label class="padding-right20">|</label>取消</a> ', 

/*TMODJS:{"debug":true,"version":47,"md5":"9f9c85aa2519b38ee5bf73bb0213fbde"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $out += "</span><span>外链销售：", $line = 37, $out += $escape(seat.outOPUserName), $out += "</span></p> <p>收客单号：", 
                    ...
                    $line = 61, $out += $escape(hotel.outRemarkList.length), $out += '"> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> <a class="cursor T-action T-hotel-cancel"> <label class="padding-right20">|</label>取消 </a> </td> ', 
                    $line = 70), $out += " </tr> ", $line = 72;
                }), $out += " ", $line = 73;

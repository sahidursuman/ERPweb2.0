/*TMODJS:{"debug":true,"version":44,"md5":"0cfd622340493f1687f3aa31c62bdfdd"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $line = 61, $out += $escape(hotel.outRemarkList.length), $out += '"> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> <a class="cursor T-action T-cancel"> <label class="padding-right20">|</label>取消 </a> </td> ', 

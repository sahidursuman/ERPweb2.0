/*TMODJS:{"debug":true,"version":68,"md5":"e41afcbcb3a35fcece5920308e108d5e"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $line = 38, $out += $escape(seat.tgOrderNumber), $out += "</p> </td> <td> <p><span>", 
                    $line = 41, $out += $escape(seat.contactMemberName), $out += "</span></p> <p> ", 
                    $line = 42, $out += $escape(seat.adultCount), $out += " 大 ", $line = 42, $out += $escape(seat.childCount), 
                    ...
                    $out += " ", $line = 55, 1 == hotel.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i>已完成 ', 
                    $line = 57) : ($out += '<i class="ace-icon fa fa-times red bigger-125"></i>未完成 ', 
                    $line = 58), $out += " </td> ", $line = 60), $out += " ", $line = 62, 0 == index && ($out += ' <td rowspan="', 
                    $line = 63, $out += $escape(hotel.outRemarkList.length), $out += '"> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> ', 
                    $line = 68, 1 == hotel.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="hotel" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 69) : ($out += ' <a class="cursor T-action T-hotel-cancel" data-catename="hotel" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 71), $out += " </td> ", $line = 73), $out += " </tr> ", $line = 75;
                }), $out += " ", $line = 76;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 81, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":3,"md5":"14c9cd2c5123b7fd0e14e48742f1c1c2"}*/
        ...
        try {
            ...
            $line = 16, $each(unifyList, function(hotel) {
                $out += " ", $line = 17, $each(hotel.outRemarkList, function(seat, index) {
                    ...
                    $line = 41, $out += $escape(seat.adultCount), $out += " 大 ", $line = 41, $out += $escape(seat.childCount), 
                    $out += " 小</p> ", $line = 42, $each(seat.contactMemberList, function(itme) {
                        ...
                        $out += ")</span></p> ", $line = 45;
                    }), $out += " </td> <td>", $line = 47, $out += $escape(seat.checkInTime), $out += "</td> <td> ", 
                    $line = 49, $out += $escape(seat.require), $out += " </td> ", $line = 51, 0 == index && ($out += ' <td rowspan="', 
                    $line = 52, $out += $escape(hotel.outRemarkList.length), $out += '"> ', $line = 53, 
                    $out += $escape(hotel.arrangeUserName), $out += "</td> ", $line = 54, 0 == index && ($out += ' <td rowspan="', 
                    $line = 55, $out += $escape(hotel.outRemarkList.length), $out += '"> ', $line = 56), 
                    $out += " ", $line = 58, 1 == hotel.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i>已完成 ', 
                    $line = 60) : ($out += '<i class="ace-icon fa fa-times red bigger-125"></i>未完成 ', 
                    $line = 61), $out += " </td> ", $line = 63), $out += " ", $line = 65, 0 == index && ($out += ' <td rowspan="', 
                    $line = 66, $out += $escape(hotel.outRemarkList.length), $out += '"> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> ', 
                    $line = 71, 1 == hotel.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="hotel" title="已对账，无法删除"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 72) : ($out += ' <a class="cursor T-action T-hotel-cancel" data-catename="hotel" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 74), $out += " </td> ", $line = 76), $out += " </tr> ", $line = 78;
                }), $out += " ", $line = 79;

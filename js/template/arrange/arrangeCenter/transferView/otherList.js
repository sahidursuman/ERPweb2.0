/*TMODJS:{"debug":true,"version":109,"md5":"7f3691043e11114d74fad7af47806e21"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/otherList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outOtherList, function(item) {
                ...
                $out += "</span><span>", $line = 23, $out += $escape(item.partnerAgencyName), $out += "</span><span>外联销售：", 
                $line = 23, $out += $escape(item.outOPUserName), $out += "</span></p> <p>收客单号：", 
                $line = 24, $out += $escape(item.tgOrderNumber), $out += '</p> </td> <td rowspan="', 
                $line = 26, $out += $escape(item.size), $out += '"> ', $line = 27, 1 == item.shuttleType ? ($out += "接团 ", 
                ...
                $line = 77, 1 == item.status && ($out += ' <a class="cursor T-arrage T-inform T-action"> 通知</a> <label class="padding-right20">|</label> ', 
                $line = 81), $out += ' <a class="cursor T-arrage T-arrange-item T-action" data-right=\'1480005\'> 安排</a> <a class="cursor T-arrage T-view T-action"> <label class="padding-right20">|</label> 查看 </a> </td> </tr> ', 
                $line = 89, $each(item.arrangeItems, function(arrange, level2) {
                    $out += " ", $line = 90, level2 > 0 && ($out += " <tr> <td> ", $line = 93, "ticket" == arrange.arrangeType ? ($out += " 票 ", 
                    $line = 94) : "restaurant" == arrange.arrangeType ? ($out += "餐 ", $line = 95) : "other" == arrange.arrangeType && ($out += "它 ", 
                    $line = 96), $out += " </td> <td>", $line = 98, $out += $escape(arrange.require), 
                    $out += '</td>  <td class="h-touristGroupInfo"> ', $line = 102, $each(arrange.arrangeResultList, function(list) {
                        $out += ' <p class="inline-block">  ', $line = 105, $out += $escape(list.name), 
                        $out += "  ", $line = 107, $out += $escape(list.shift), $out += " </p> ", $line = 109;
                    }), $out += " </td> <td> ", $line = 113, 1 == arrange.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i> 已完成 ', 
                    $line = 115) : 0 == arrange.status && ($out += ' <i class="ace-icon fa fa-times red bigger-125"></i> 未完成 ', 
                    $line = 117), $out += " </td> </tr> ", $line = 120), $out += " ", $line = 121;
                }), $out += " ", $line = 122;

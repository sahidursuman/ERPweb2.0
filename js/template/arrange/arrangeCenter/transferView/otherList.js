/*TMODJS:{"debug":true,"version":105,"md5":"2599e28dbfa40db03ade37763c3f1638"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/otherList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outOtherList, function(item) {
                ...
                $line = 81), $out += ' <a class="cursor T-arrage T-arrange-item T-action"> 安排</a> <a class="cursor T-arrage T-view T-action"> <label class="padding-right20">|</label> 查看 </a> </td> </tr> ', 

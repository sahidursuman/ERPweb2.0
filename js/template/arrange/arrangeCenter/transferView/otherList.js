/*TMODJS:{"debug":true,"version":115,"md5":"e44f9281ee2cfbd37543e5411a595d72"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/otherList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outOtherList, function(item) {
                ...
                $line = 80), $out += ' <a class="cursor T-arrage T-arrange-item T-action R-right" data-right=\'1480005\'> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-arrage T-view T-action"> 查看 </a> </td> </tr> ', 

/*TMODJS:{"debug":true,"version":3,"md5":"eb3110b107830bfeff47a33512cb161d"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transfer/otherList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outOtherList, function(item) {
                ...
                $line = 78), $out += ' <a class="cursor T-arrage T-arrange-item T-action"> 安排</a> <a class="cursor T-arrage T-view T-action"> <label class="padding-right20">|</label> 查看 </a> </td> </tr> ', 

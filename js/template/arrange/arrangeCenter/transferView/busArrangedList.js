/*TMODJS:{"debug":true,"version":116,"md5":"84cbb7e556493dcd0049187a05a5b946"}*/
        ...
        try {
            ...
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $line = 57, $out += $escape(bus.outRemarkList.length), $out += '">  <a class="cursor T-arrange-item T-action">  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> <a class="cursor T-action T-cancel"> <label class="padding-right20">|</label>取消 </a> </td> ', 

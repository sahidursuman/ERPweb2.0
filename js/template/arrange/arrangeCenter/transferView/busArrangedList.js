/*TMODJS:{"debug":true,"version":120,"md5":"816add0880cfa4de74d597e3f97f27d1"}*/
        ...
        try {
            ...
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $out += $escape(buslist.partnerAgencyName), $out += "</span><span>外联销售：", $line = 36, 
                    ...
                    $line = 57, $out += $escape(bus.outRemarkList.length), $out += '">  <a class="cursor T-arrange-item T-action">  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> <a class="cursor T-action T-bus-cancel"> <label class="padding-right20">|</label>取消 </a> </td> ', 
                    $line = 69), $out += " </tr> ", $line = 71;
                }), $out += " ", $line = 72;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 77, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":134,"md5":"9654c17f2ba8b9d6ae0ae64b73b6af39"}*/
        ...
        try {
            ...
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $out += "</p> </td> <td> <p>", $line = 40, $out += $escape(buslist.contactMemberName), 
                    $out += "</p> <p>", $line = 41, $out += $escape(buslist.adultCount), $out += "大", 
                    ...
                    $line = 48), $out += " ", $line = 49, 0 == index && ($out += ' <td rowspan="', $line = 50, 
                    $out += $escape(bus.outRemarkList.length), $out += '">', $line = 50, 3 == buslist.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i> 已完成', 
                    $line = 52) : ($out += ' <i class="ace-icon fa fa-times red bigger-125"></i>未完成', 
                    $line = 53), $out += " </td> ", $line = 55), $out += " ", $line = 56, 0 == index && ($out += ' <td rowspan="', 
                    $line = 57, $out += $escape(bus.outRemarkList.length), $out += '">  <a class="cursor T-arrange-item T-action">  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> ', 
                    $line = 65, 1 == bus.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="bus" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 66) : ($out += ' <a class="cursor T-action T-bus-cancel" data-catename="bus" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 68), $out += " </td> ", $line = 70), $out += " </tr> ", $line = 72;
                }), $out += " ", $line = 73;

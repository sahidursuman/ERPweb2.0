/*TMODJS:{"debug":true,"version":184,"md5":"6c9dca1a531bdc5493d3ac6ac981d563"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeCenter/transferView/busArrangedList", function($data, $filename) {
        try {
            ...
            $data.itme, $data.recordSize), $out = "";
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur T-tr-fixed"> <th>车俩信息</th> <th>类型</th> <th>中转信息</th> <th>客人信息</th> <th>抵达/送离时间</th> <th>班次</th> <th>要求</th> <th>安排人</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody class="T-busCompleted-list"> ', 
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $out += "</p> </td> <td> <p> ", $line = 40, $out += $escape(buslist.adultCount), 
                    $out += "大", $line = 40, $out += $escape(buslist.childCount), $out += "小</p> ", 
                    $line = 41, $each(buslist.contactMemberList, function(itme) {
                        $out += ' <p><span class="contactMemberName">', $line = 42, $out += $escape(itme.contactMemberName), 
                        $out += '</span> <span class="contactMemberPhoneNumber">(', $line = 43, $out += $escape(itme.contactMemberPhoneNumber), 
                        $out += ")</span></p> ", $line = 44;
                    }), $out += " </td> <td>", $line = 46, $out += $escape(buslist.arriveTime), $out += "</td> <td>", 
                    $line = 47, $out += $escape(buslist.shift), $out += "</td> <td>", $line = 48, $out += $escape(buslist.require), 
                    $out += "</td> ", $line = 49, 0 == index && ($out += ' <td rowspan="', $line = 50, 
                    $out += $escape(bus.outRemarkList.length), $out += '">', $line = 50, $out += $escape(bus.arrangeUserName), 
                    $out += "</td> ", $line = 51), $out += " ", $line = 53, 0 == index && ($out += ' <td rowspan="', 
                    $line = 54, $out += $escape(bus.outRemarkList.length), $out += '">', $line = 54, 
                    1 == buslist.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i> 已完成', 
                    $line = 56) : ($out += ' <i class="ace-icon fa fa-times red bigger-125"></i>未完成', 
                    $line = 57), $out += " </td> ", $line = 59), $out += " ", $line = 61, 0 == index && ($out += ' <td rowspan="', 
                    $line = 62, $out += $escape(bus.outRemarkList.length), $out += '">  <a class="cursor T-arrange-item T-action">  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> ', 
                    $line = 70, 1 == bus.isConfirmAccount ? ($out += ' <a class="cursor" style="color:#bbb;" data-catename="bus" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 71) : ($out += ' <a class="cursor T-action T-bus-cancel" data-catename="bus" title="取消"><label class="padding-right20">|</label>取消</a> ', 
                    $line = 73), $out += " </td> ", $line = 75), $out += " </tr> ", $line = 77;
                }), $out += " ", $line = 78;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 83, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

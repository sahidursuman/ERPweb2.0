/*TMODJS:{"debug":true,"version":74,"md5":"84f56507490eccba7f4caf81ca680c7e"}*/
        ...
        try {
            ...
            $line = 17, $each(unifyList, function(bus) {
                $out += " ", $line = 18, $each(bus.outRemarkList, function(buslist, index) {
                    ...
                    $line = 50, $out += $escape(bus.outRemarkList.length), $out += '"> <a class="cursor T-action T-inform">通知</a> <a class="cursor T-arrange-item T-action"> <label class="padding-right20">|</label> 安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 
                    $line = 57), $out += " </tr> ", $line = 59;
                }), $out += " ", $line = 60;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 65, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

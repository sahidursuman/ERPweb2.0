/*TMODJS:{"debug":true,"version":91,"md5":"448dfa5a3d305df31b3f14af6bef3628"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/busList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outRemarkArrangeList, function(bus) {
                ...
                $line = 43, $out += $escape(bus.childCount), $out += "</span>小 </p> </td> <td>", 
                $line = 46, $out += $escape(bus.arriveTime), $out += "</td> <td>", $line = 47, $out += $escape(bus.shift), 
                $out += '</td> <td><span class="require">', $line = 48, $out += $escape(bus.require), 
                $out += "</span></td> ", $line = 49, isFrame || ($out += ' <td> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </a> <a class="cursor T-action T-cancel"> <label class="padding-right20">|</label>取消 </a> </td> ', 

/*TMODJS:{"debug":true,"version":41,"md5":"a64593424986e1dedf311339f1bcc9ff"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transfer/busList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outRemarkArrangeList, function(bus) {
                ...
                $out += '</td> <td><span class="require">', $line = 45, $out += $escape(bus.require), 
                $out += "</span></td> ", $line = 46, isFrame || ($out += ' <td> <a class="cursor T-arrange-item T-action">安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 

/*TMODJS:{"debug":true,"version":179,"md5":"a665069593726f6c7b43ebe03e31166c"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/busList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outRemarkArrangeList, function(bus) {
                ...
                $line = 49, $out += $escape(bus.require), $out += "</span></td> ", $line = 50, isFrame || ($out += ' <td> <a class="cursor T-arrange-item T-action R-right" data-right=\'1480001\'> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-view T-action">查看</a> </td> ', 

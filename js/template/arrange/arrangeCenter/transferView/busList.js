/*TMODJS:{"debug":true,"version":194,"md5":"d763c6e49f503bf7e5605a1e2ce6d88d"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/busList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outRemarkArrangeList, function(bus) {
                ...
                $out += $escape(bus.childCount), $out += '</span>小 </p> <p><span class="contactMemberName">', 
                $line = 45, $out += $escape(bus.contactMemberName), $out += '</span> <span class="contactMemberPhoneNumber">(', 
                $line = 46, $out += $escape(bus.contactMemberPhoneNumber), $out += ')</span></p> </td> <td><span class="arriveTime">', 
                $line = 48, $out += $escape(bus.arriveTime), $out += '</span></td> <td><span class="shift">', 
                $line = 49, $out += $escape(bus.shift), $out += '</span></td> <td><span class="require">', 
                $line = 50, $out += $escape(bus.require), $out += "</span></td> ", $line = 51, isFrame || ($out += ' <td> <a class="cursor T-arrange-item T-action R-right" data-right=\'1480001\'> 安排 </a> <a class="cursor T-view T-action"><label class="padding-right20">|</label> 查看</a> </td> ', 

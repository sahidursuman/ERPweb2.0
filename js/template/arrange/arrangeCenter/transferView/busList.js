/*TMODJS:{"debug":true,"version":216,"md5":"b5632d4310d67d1d6f361cc15d31968c"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeCenter/transferView/busList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur T-tr-fixed"> <th><label class="pos-rel"><input type="checkbox" class="ace T-chekedAll"><span class="lbl"></span> 选择</label></th> <th>中转信息</th> <th>类型</th> <th>客人信息</th> <th>抵达/送离时间</th> <th>班次</th> <th>要求</th> ', 

/*TMODJS:{"debug":true,"version":190,"md5":"013fe6b4deaebbf96b8f1a8a385ae084"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/busList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(outRemarkArrangeList, function(bus) {
                ...
                $line = 49, $out += $escape(bus.require), $out += "</span></td> ", $line = 50, isFrame || ($out += ' <td> <a class="cursor T-arrange-item T-action R-right" data-right=\'1480001\'> 安排 </a> <a class="cursor T-view T-action"><label class="padding-right20">|</label> 查看</a> </td> ', 
                $line = 57), $out += " </tr> ", $line = 59;
            }), $out += ' </tbody> </table> <div class="clearfix"></div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 65, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="T-pagenation text-right"> </div> </div> </div> <div class="text-center"> ', 
            $line = 73, isFrame || ($out += ' <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 74, canMergeArrange || ($out += ' disabled="disabled" ', $line = 74), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> ', 
            $line = 77), $out += " </div> ", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

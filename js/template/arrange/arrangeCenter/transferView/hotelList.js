/*TMODJS:{"debug":true,"version":179,"md5":"b8f87deb832b4c9833633d3af6757dcc"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 40, $out += $escape(hotel.childCount), $out += '</span>小 </p> <p><span class="contactMemberName">', 
                $line = 42, $out += $escape(hotel.contactMemberName), $out += '</span> <span class="contactMemberPhoneNumber">(', 
                $line = 42, $out += $escape(hotel.contactMemberPhoneNumber), $out += ')</span></p> </td> <td><span class="checkInTime">', 
                ...
                isFrame || ($out += ' <td>  <a class="cursor T-arrange-item T-action R-right" data-right=\'1480003\'> 安排 </a> <a class="cursor T-view T-action"><label class="padding-right20">|</label> 查看</a> </td> ', 
                $line = 61), $out += " </tr> ", $line = 63;
            }), $out += ' </tbody> </table> <div class="text-center"> ', $line = 67, isFrame || ($out += ' <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 68, canMergeArrange || ($out += ' disabled="disabled" ', $line = 68), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> ', 
            $line = 71), $out += ' </div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 75, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

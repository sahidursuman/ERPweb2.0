/*TMODJS:{"debug":true,"version":80,"md5":"3f1c53e57f941cb89788fc1fc3dc0dcc"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 57), $out += " </tr> ", $line = 59;
            }), $out += ' </tbody> </table> <div class="text-center"> ', $line = 63, isFrame || ($out += ' <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 64, canMergeArrange || ($out += ' disabled="disabled" ', $line = 64), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> ', 
            $line = 67), $out += ' </div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 

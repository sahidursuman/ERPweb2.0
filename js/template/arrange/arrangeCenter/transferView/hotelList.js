/*TMODJS:{"debug":true,"version":76,"md5":"845d010644f51a0acf4740cf6f65d97c"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                $out += ' <tr data-id="', $line = 19, $out += $escape(hotel.outRemarkId), $out += '" ', 
                $line = 19, hotel.checked && ($out += ' class="success"', $line = 19), $out += '> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-touristGroupMergeCheckBox T-hotelcheked" ', 
                ...
                $line = 29, $out += $escape(hotel.tgOrderNumber), $out += "</p> </td> <td> <span >", 
                $line = 32, 1 == hotel.shuttleType ? ($out += " 接团 ", $line = 32) : 2 == hotel.shuttleType && ($out += " 送团", 
                $line = 32), $out += '</span> <input type="hidden" name="shuttleType" value="', 
                ...
                $out += '</p> <p><span class="adultCount">', $line = 37, $out += $escape(hotel.adultCount), 
                $out += '</span>大<span class="childCount">', $line = 37, $out += $escape(hotel.childCount), 
                $out += "</span>小</p> </td> <td> <p>", $line = 40, $out += $escape(hotel.checkInTime), 
                $out += "</p> </td> <td>", $line = 42, $out += $escape(hotel.hotelLevel), $out += "</td> <td> ", 
                $line = 44, $out += $escape(hotel.roomCount), $out += ' </td> <td><span class="require">', 
                $line = 46, $out += $escape(hotel.require), $out += "</span></td> ", $line = 47, 
                isFrame || ($out += ' <td> <a class="cursor T-inform T-action"> 通知</a> <a class="cursor T-arrange-item T-action"> <label class="padding-right20">|</label> 安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 
                $line = 56), $out += " </tr> ", $line = 58;
            }), $out += ' </tbody> </table> <div class="text-center"> ', $line = 62, isFrame || ($out += ' <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 63, canMergeArrange || ($out += ' disabled="disabled" ', $line = 63), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> ', 
            $line = 66), $out += ' </div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 71, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":150,"md5":"3d1e7c1b6f82358f5413b5959040f29d"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                isFrame || ($out += ' <td>  <a class="cursor T-arrange-item T-action" data-right=\'1480003\'>  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 

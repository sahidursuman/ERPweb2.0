/*TMODJS:{"debug":true,"version":174,"md5":"8b33c11091e49f2d8473082e3a8d7dfd"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 35), $out += '"> </td> <td> <p>', $line = 38, $out += $escape(hotel.contactMemberName), 
                $out += '</p> <p> <span class="adultCount">', $line = 40, $out += $escape(hotel.adultCount), 
                $out += '</span>大 <span class="childCount">', $line = 41, $out += $escape(hotel.childCount), 
                $out += '</span>小 </p> <p><span class="contactMemberPhoneNumber">', $line = 43, 
                $out += $escape(hotel.contactMemberPhoneNumber), $out += '</span></p> </td> <td><span class="checkInTime">', 
                $line = 45, $out += $escape(hotel.checkInTime), $out += '</span></td> <td> <span class="hotelLevel">', 
                $line = 47, $out += $escape($helpers.getHotelLevelDesc(hotel.hotelLevel)), $out += '</span> </td> <td> <span class="roomCount">', 
                $line = 50, $out += $escape(hotel.roomCount), $out += '</span> </td> <td><span class="require">', 
                $line = 52, $out += $escape(hotel.require), $out += "</span></td> ", $line = 53, 

/*TMODJS:{"debug":true,"version":152,"md5":"58e6b0c8ac8dd30b555bdaff6d19ed68"}*/
    ...
    return require("../../../template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                isFrame || ($out += ' <td>  <a class="cursor T-arrange-item T-action R-right" data-right=\'1480003\'> 安排 <label class="padding-right20">|</label> </a> <a class="cursor T-view T-action">查看</a> </td> ', 

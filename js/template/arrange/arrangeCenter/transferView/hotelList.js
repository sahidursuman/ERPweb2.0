/*TMODJS:{"debug":true,"version":197,"md5":"7acdfc62c321f6e975a2612b0c9b71b5"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th><label class="pos-rel"><input type="checkbox" class="ace T-chekedAll"><span class="lbl"></span> 选择</label></th> <th>中转信息</th> <th>类型</th> <th>客人信息</th> <th>入住时间</th> <th>星级</th> <th>间数</th> <th>要求</th> ', 
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 35) : 3 == hotel.shuttleType && ($out += " 3", $line = 35), $out += '"> </td> <td> <p> <span class="adultCount">', 
                $line = 39, $out += $escape(hotel.adultCount), $out += '</span>大 <span class="childCount">', 

/*TMODJS:{"debug":true,"version":145,"md5":"21a7f22de28f4e51a59e3a0d4e71f369"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 19), $out += '> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-touristGroupMergeCheckBox T-hotelcheked" ', 
                ...
                $out += $escape(hotel.contactMemberPhoneNumber), $out += '</span></p> </td> <td> <span class="hotelLevel">', 
                $line = 45, $out += $escape($helpers.getHotelLevelDesc(hotel.hotelLevel)), $out += '</span> </td> <td> <span class="roomCount">', 
                $line = 48, $out += $escape(hotel.roomCount), $out += '</span> </td> <td><span class="require">', 
                $line = 50, $out += $escape(hotel.require), $out += '</span></td> <td><span class="require">', 

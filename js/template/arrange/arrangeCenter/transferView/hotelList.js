/*TMODJS:{"debug":true,"version":123,"md5":"686e59a7f67f696d2065152703f37bc8"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/transferView/hotelList", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelRemarkList, function(hotel) {
                ...
                $line = 32) : 3 == hotel.shuttleType && ($out += "返程住宿", $line = 32), $out += '</span> <input type="hidden" name="shuttleType" value="', 
                ...
                $out += "</p> </td> <td> ", $line = 43, $out += $escape($helpers.getHotelLevelDesc(hotel.hotelLevel)), 
                $out += " </td> <td> ", $line = 46, $out += $escape(hotel.roomCount), $out += ' </td> <td><span class="require">', 
                $line = 48, $out += $escape(hotel.require), $out += "</span></td> ", $line = 49, 
                isFrame || ($out += ' <td>  <a class="cursor T-arrange-item T-action">  安排</a> <a class="cursor T-view T-action"> <label class="padding-right20">|</label>查看 </td> ', 
                $line = 59), $out += " </tr> ", $line = 61;
            }), $out += ' </tbody> </table> <div class="text-center"> ', $line = 65, isFrame || ($out += ' <button class="btn btn-sm btn-success w-150 R-right T-merge-arrange" ', 
            $line = 66, canMergeArrange || ($out += ' disabled="disabled" ', $line = 66), $out += ' data-right="1130004"> <i class="ace-icon fa fa-user-plus"></i> 统一安排 </button> ', 
            $line = 69), $out += ' </div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 

/*TMODJS:{"debug":true,"version":25,"md5":"c054a2787ce8ee135af52182f3bf6908"}*/
    ...
    return require("/js/template/template")("arrange/arrangeCenter/groupView/list", function($data, $filename) {
        try {
            ...
            $line = 15, $each(tripPlanArrangeList, function(item) {
                ...
                $line = 47), $out += ' </td> <td style="vertical-align:middle;width:200px"> <a class="cursor T-action T-inform R-right" data-right="1140010" title="通知"> 通知 </a> <a class="cursor T-action T-arrange-item R-right" data-right="1140007" title="安排"> <label class="padding-right20">|</label> 安排 </a> <a class="cursor T-action T-view" title="查看"> <label class="padding-right20">|</label>查看 </a> </td> </tr> ', 
                $line = 58;
            }), $out += ' </tbody> </table> <div class="clearfix"></div> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 64, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="T-pagenation text-right"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":44,"md5":"acb027b64dc04a9584bfc485043674e3"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd T-showHighLight table-fixed"> <colgroup> <col style="width:5%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:10%;"></col> <col style="width:12%;"></col> <col style="width:12%;"></col> <col style="width:20%;"></col> <col style="width:12%;"></col> </colgroup> <thead> <tr class="bg-blur"> <th class="R-right" data-right="1130004">选择</th> <th>来源</th> <th>线路产品</th> <th>线路类型</th> <th>应用范围</th> <th>天数</th> <th>出游日期</th> <th>联系人</th> <th>联系电话</th> <th>人数</th> <th>客源地</th> <th>年龄</th> <th>备注</th> <th>查看</th> </tr> </thead> <tbody class="T-arrageVisitor-list"> ', 
            $line = 37, $each(touristGroupList, function(touristGroupList) {
                ...
                $line = 40, $out += $escape(touristGroupList.partnerAgency.travelAgencyName), $out += "</td> <td>", 
                $line = 41, $out += $escape(touristGroupList.lineProduct.name), $out += "</td> <td>", 
                ...
                $line = 47), $out += " </td> <td>", $line = 49, $out += $escape(touristGroupList.lineProduct.days), 
                $out += "</td> <td>", $line = 50, $out += $escape($helpers.dateFormat(touristGroupList.startTime, "yyyy-MM-dd")), 
                $out += "</td> <td>", $line = 51, $out += $escape(touristGroupList.contactMember.name), 
                $out += "</td> <td>", $line = 52, $out += $escape(touristGroupList.contactMember.mobileNumber), 
                $out += "</td> <td>", $line = 53, $out += $escape(touristGroupList.adultCount), 
                $out += " 大 ", $line = 53, $out += $escape(touristGroupList.childCount), $out += "小</td> <td>", 
                $line = 55, $out += $escape(touristGroupList.areaData), $out += "</td> <td>", $line = 56, 
                $out += $escape(touristGroupList.ageData), $out += '</td> <td class="T-ctrl-tip" title="', 
                $line = 57, $out += $escape(touristGroupList.remark), $out += '"><span style="height: 35px">', 
                $line = 57, $out += $escape(touristGroupList.remark), $out += '</span></td> <td><a class="cursor T-arrageVisitor-view T-action"> 查看 </a></td> </tr> ', 
                $line = 60;
            ...
            $line = 84, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

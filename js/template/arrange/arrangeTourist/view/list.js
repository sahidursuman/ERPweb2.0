/*TMODJS:{"debug":true,"version":40,"md5":"61448d32160b4411efc72a7a72c13057"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            $line = 19, $each(arrangeTouristGroupList, function(arrangeTourist) {
                ...
                $line = 39, $out += $escape(arrangeTourist.sumCurrentNeedPayMoney), $out += '</td> <td> <button data-entity-id="', 
                $line = 41, $out += $escape(arrangeTourist.lineProductId), $out += '" data-entity-startTime="', 
                $line = 41, $out += $escape(arrangeTourist.startTime), $out += '" class="btn btn-success btn-sm btn-divide"> <i class="ace-icon fa fa-users"></i> 分团 </button> <button data-entity-id="', 
                $line = 45, $out += $escape(arrangeTourist.lineProductId), $out += '" data-entity-startTime="', 
                $line = 45, $out += $escape(arrangeTourist.startTime), $out += '" class=" btn btn-sm btn-success btn-transfer"> <i class="ace-icon fa fa-exchange"></i> 转客 </button> </td> </tr> ', 
                $line = 53;
            ...
            $line = 69, 0 == totalPage ? ($out += " 0/0 ", $line = 71) : ($out += " ", $line = 72, 
            $out += $escape(pageNo + 1), $out += "/", $line = 72, $out += $escape(totalPage), 
            $out += " ", $line = 73), $out += ' </a> </li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="next" href="javascript:void(0)">下一页</a></li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="last" href="javascript:void(0)">尾页</a></li> </ul> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

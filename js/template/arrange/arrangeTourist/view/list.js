/*TMODJS:{"debug":true,"version":58,"md5":"abde7dd7460da5db2e73afd339730f06"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd"> <thead> <tr class="bg-blur"> <th>并团选择</th> <th>线路产品</th> <th>类别</th> <th>应用范围</th> <th>天数</th> <th>出游日期</th> <th>人数</th> <th>未分团人数</th> <th>应收款</th> <th>已收款</th> <th>现收款</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 19, $each(arrangeTouristGroupList, function(arrangeTourist) {
                ...
                $line = 44, $out += $escape(arrangeTourist.startTime), $out += '" class=" btn-transfer cursor"> 转客 </a><a href="" class="cursor"> |</a> <a data-entity-id="', 
                $line = 47, $out += $escape(arrangeTourist.lineProductId), $out += '" data-entity-startTime="', 
                $line = 47, $out += $escape(arrangeTourist.startTime), $out += '" class=" btn-inTransfer cursor"> 内转 </a> </td> </tr> ', 
                $line = 52;
            ...
            $line = 68, 0 == totalPage ? ($out += " 0/0 ", $line = 70) : ($out += " ", $line = 71, 
            $out += $escape(pageNo + 1), $out += "/", $line = 71, $out += $escape(totalPage), 
            $out += " ", $line = 72), $out += ' </a> </li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="next" href="javascript:void(0)">下一页</a></li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="last" href="javascript:void(0)">尾页</a></li> </ul> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":171,"md5":"b77834e8f61262ab0f3800e6e14d62eb"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd"> <thead> <tr class="bg-blur"> <th class="R-right" data-right="1130004">并团选择</th> <th>线路产品</th> <th>类别</th> <th>应用范围</th> <th>天数</th> <th>出游日期</th> <th>人数</th> <th>未分团人数</th> <th>操作</th> </tr> </thead> <tbody class="T-arrageVisitor-list"> ', 

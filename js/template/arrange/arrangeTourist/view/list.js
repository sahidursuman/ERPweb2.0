/*TMODJS:{"debug":true,"version":110,"md5":"f520de38d297604838920964900572b2"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            $line = 16, $each(arrangeTouristGroupList, function(arrangeTourist) {
                ...
                $out += "</td> <td>", $line = 31, $out += $escape(arrangeTourist.startTime), $out += "</td> <td>", 
                $line = 32, $out += $escape(arrangeTourist.sumAdultCount), $out += "大", $line = 32, 
                $out += $escape(arrangeTourist.sumChildCount), $out += "小</td> <td>", $line = 33, 
                $out += $escape(arrangeTourist.sumNoOperationAdultCount), $out += "大", $line = 33, 

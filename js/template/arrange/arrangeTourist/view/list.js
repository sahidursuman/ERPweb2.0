/*TMODJS:{"debug":true,"version":348,"md5":"8316ac0094956388fb85435e51df4359"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            $line = 37, $each(touristGroupList, function(touristGroupList) {
                ...
                $out += "</td> <td> ", $line = 49, 0 == touristGroupList.customerType ? ($out += "散拼 ", 
                $line = 50) : 1 == touristGroupList.customerType ? ($out += "团体 ", $line = 51) : 2 == touristGroupList.customerType && ($out += "转客 ", 

/*TMODJS:{"debug":true,"version":70,"md5":"c8b1ffb469d86067aa1b757c327ed0df"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            $line = 70, 0 == totalPage ? ($out += " 0/0 ", $line = 72) : ($out += " ", $line = 73, 
            $out += $escape(pageNo + 1), $out += "/", $line = 73, $out += $escape(totalPage), 
            $out += " ", $line = 74), $out += ' </a> </li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="next" href="javascript:void(0)">下一页</a></li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="last" href="javascript:void(0)">尾页</a></li> </ul> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":266,"md5":"092f3f9c3ef2e9ff5ed6d67080a2d007"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/list", function($data, $filename) {
        try {
            ...
            $line = 37, $each(touristGroupList, function(touristGroupList) {
                ...
                $line = 54) : ($out += " <td></td> <td></td> ", $line = 57), $out += " <td>", $line = 58, 
                $out += $escape(touristGroupList.adultCount), $out += " 大 ", $line = 58, $out += $escape(touristGroupList.childCount), 
                $out += "小</td> <td>", $line = 60, $out += $escape(touristGroupList.areaData), $out += "</td> <td>", 
                $line = 61, $out += $escape(touristGroupList.ageData), $out += '</td> <td class="T-ctrl-tip" title="', 
                $line = 62, $out += $escape(touristGroupList.remark), $out += '"><span style="height: 35px">', 
                $line = 62, $out += $escape(touristGroupList.remark), $out += '</span></td> <td><a class="cursor T-arrageVisitor-view T-action"> 查看 </a></td> </tr> ', 
                $line = 65;

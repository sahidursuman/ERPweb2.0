/*TMODJS:{"debug":true,"version":51,"md5":"3483fcd2a61ee0c31e8ad6b38a760862"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/viewTripPlan", function($data, $filename) {
        try {
            ...
            $out += '</label> </div> </form> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover all"> <thead> <tr> <th> 选择 </th> <th>团号</th> <th>出团日期</th> <th>人数</th> <th>导游</th> <th>车牌号</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody class="chooseTripPlanTbody">', 
            $line = 26, $each(tripPlanList, function(tripPlanList) {
                $out += ' <tr data-entity-id="', $line = 27, $out += $escape(tripPlanList.id), $out += '"> <td> <label class="pos-rel"> <input type="radio" class="ace ridioCheck" name="form-field-radio"> <span class="lbl"></span> </label> </td> <td>', 
                $line = 34, $out += $escape(tripPlanList.tripNumber), $out += "</td> <td>", $line = 35, 
                $out += $escape(tripPlanList.startTime), $out += "</td> <td>大人", $line = 36, $out += $escape(tripPlanList.touristAdultCount), 
                $out += "小孩", $line = 36, $out += $escape(tripPlanList.touristChildCount), $out += "</td> <td>", 
                $line = 37, null != tripPlanList.guide && ($line = 37, $out += $escape(tripPlanList.guide.realname), 
                $line = 37), $out += "</td> <td>", $line = 38, null != tripPlanList.bus && ($line = 38, 
                $out += $escape(tripPlanList.bus.licenseNumber), $line = 38), $out += '</td> <td></td> <td> <a class="groupView cursor" data-entity-id="', 
                $line = 41, $out += $escape(tripPlanList.id), $out += '"> 查看 </a> </td> </tr>', 
                $line = 45;

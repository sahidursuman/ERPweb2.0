/*TMODJS:{"debug":true,"version":54,"md5":"d89a50dd9dfd595ccbf5a752a871def3"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/viewTripPlan", function($data, $filename) {
        try {
            ...
            $line = 24, $each(tripPlanList, function(tripPlanList) {
                ...
                $out += $escape($helpers.dateFormat(tripPlanList.startTime, "yyyy-MM-dd")), $out += "</td> <td>大人", 
                $line = 34, $out += $escape(tripPlanList.touristAdultCount), $out += "小孩", $line = 34, 
                $out += $escape(tripPlanList.touristChildCount), $out += "</td> <td>", $line = 35, 

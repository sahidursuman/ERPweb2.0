/*TMODJS:{"debug":true,"version":22,"md5":"ab30c2381a0999385110d7e0c4bfc3b8"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/chooseTravelLine", function($data, $filename) {
        try {
            ...
            $line = 16, $each(tripPlanList, function(tripPlanList) {
                ...
                $line = 35;
            }), $out += ' </tbody> </table> <form class="form-horizontal" role="form" onsubmit="return false"> <div class="form-group" style="text-align: center;margin:0px;"> <button class="btn btn-block btn-success btn-chooseMergeTripPlan"> <i class="ace-icon fa fa-check"></i> 选择计划 </button> </div> </form> <div style="padding:20px"></div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

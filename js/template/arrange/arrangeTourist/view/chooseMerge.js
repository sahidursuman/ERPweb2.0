/*TMODJS:{"debug":true,"version":33,"md5":"b223bad294f083a22dd88232f8868219"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/chooseMerge", function($data, $filename) {
        try {
            ...
            $line = 13, $each(touristGroupMergeList, function(touristGroupMerge) {
                $out += ' <tr data-entity-id="', $line = 14, $out += $escape(touristGroupMerge.touristGroupId), 
                ...
                $line = 16, $out += $escape(touristGroupMerge.lineProductType), $out += "</td> <td>", 
                $line = 17, $out += $escape(touristGroupMerge.days), $out += "</td> <td>", $line = 18, 
                $out += $escape(touristGroupMerge.startTime), $out += '</td> <td> <label class="pos-rel"> <input type="radio" class="ace ridioCheck" name="form-field-radio"> <span class="lbl"></span> </label> </span> </td> </tr> ', 
                $line = 23;

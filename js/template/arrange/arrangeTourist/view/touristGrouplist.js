/*TMODJS:{"debug":true,"version":96,"md5":"a5edb0ec793f3ac81479b41e6493ec96"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/touristGrouplist", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd T-showHighLight"> <thead> <tr class="bg-blur"> <th>线路产品</th> <th>类别</th> <th>应用范围</th> <th>天数</th> <th>出游日期</th> <th>人数</th> <th>未分团人数</th> <th>操作</th> </tr> </thead> <tbody class="T-arrageGroup-list"> ', 
            $line = 15, $each(arrangeTouristGroupList, function(arrangeTourist) {
                ...
                $out += "</td> <td>", $line = 27, $out += $escape(arrangeTourist.startTime), $out += "</td> <td>", 
                $line = 28, $out += $escape(arrangeTourist.sumAdultCount), $out += "大", $line = 28, 
                $out += $escape(arrangeTourist.sumChildCount), $out += "小</td> <td>", $line = 29, 
                $out += $escape(arrangeTourist.sumNoOperationAdultCount), $out += "大", $line = 29, 
                $out += $escape(arrangeTourist.sumNoOperationChildCount), $out += '小</td> <td> <a data-entity-id="', 

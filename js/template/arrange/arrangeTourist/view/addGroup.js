/*TMODJS:{"debug":true,"version":65,"md5":"e44f84374bfcf0e6864165fe3303a131"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/addGroup", function($data, $filename) {
        try {
            ...
            $line = 24, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 32, $out += $escape(touristGroup.lineProduct.name), $out += '</td> <td name="contactMemberName">', 
                $line = 33, $out += $escape(touristGroup.contactMember.name), $out += '</td> <td name="contactMemberMobileNumber">', 
                $line = 34, $out += $escape(touristGroup.contactMember.mobileNumber), $out += '</td> <td name="areaData">', 
                $line = 35, $out += $escape(touristGroup.areaData), $out += '</td> <td name="ageData">', 
                $line = 36, $out += $escape(touristGroup.ageData), $out += '</td> <td name="peopleCount">', 
                $line = 37, $out += $escape(touristGroup.adultCount + touristGroup.childCount), 
                $out += '</td> <td name="remark">', $line = 38, $out += $escape(touristGroup.remark), 
                $out += '</td> <td> <a data-entity-id="', $line = 40, $out += $escape(touristGroup.id), 
                $out += '" class="cursor addGroupView"> 查看 </a> </td> </tr>', $line = 44;

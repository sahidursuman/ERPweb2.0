/*TMODJS:{"debug":true,"version":60,"md5":"558c4dd13d37b725a3d688ed2bcdcd8d"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/addGroup", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-sm-12 globalAdd" style="margin-top:10px;" > <div class="tabbable addTouristGroupList"> <div class=" col-xs-12" style="padding:10px 0 0 0;"> <div class="tab-pane fade active in"> <div class="col-xs-12" class="search-TravelLineList"> <table class="table table-striped table-hover add-travelLineList-table all"> <thead> <tr> <th class="th-border"> <label class="pos-rel"> <input type="checkbox" class="ace addMainCheckBox"> <span class="lbl"></span> </label></th> <th class="th-border">来源</th> <th class="th-border">联系人</th> <th class="th-border">联系电话</th> <th class="th-border">客源地</th> <th class="th-border">年龄</th> <th class="th-border">人数</th> <th class="th-border">备注</th> <th class="th-border">操作</th> </tr> </thead> <tbody>', 
            $line = 24, $each(touristGroupList, function(touristGroup) {
                $out += ' <tr data-entity-id="', $line = 25, $out += $escape(touristGroup.id), $out += '"> <td> <label class="pos-rel"> <input type="checkbox" class="ace touristGroupCheckBox"> <span class="lbl"></span> </label> </td> <td name="lineProductName">', 
                $line = 32, $out += $escape(touristGroup.lineProduct.name), $out += '</td> <td name="hotelLevel">', 
                $line = 33, $out += $escape(touristGroup.hotelLevel), $out += '</td> <td name="includeSelfPay">', 
                $line = 34, $out += $escape(touristGroup.includeSelfPay), $out += '</td> <td name="travelAgencyName">', 
                $line = 35, $out += $escape(touristGroup.partnerAgency.travelAgencyName), $out += '</td> <td name="contactMemberName">', 
                $line = 36, $out += $escape(touristGroup.contactMember.name), $out += '</td> <td name="contactMemberMobileNumber">', 
                $line = 37, $out += $escape(touristGroup.contactMember.mobileNumber), $out += '</td> <td name="areaData">', 
                $line = 38, $out += $escape(touristGroup.areaData), $out += '</td> <td name="ageData">', 
                $line = 39, $out += $escape(touristGroup.ageData), $out += '</td> <td name="peopleCount">', 
                $line = 40, $out += $escape(touristGroup.adultCount + touristGroup.childCount), 
                $out += '</td> <td name="remark">', $line = 41, $out += $escape(touristGroup.remark), 
                $out += '</td> <td> <a data-entity-id="', $line = 43, $out += $escape(touristGroup.id), 
                $out += '" class="cursor addGroupView"> 查看 </a> </td> </tr>', $line = 47;

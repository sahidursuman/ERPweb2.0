/*TMODJS:{"debug":true,"version":96,"md5":"6eab00425c20b3e49a9bebb5416261db"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/viewGroup", function($data, $filename) {
        try {
            ...
            $line = 20, $each(memberList, function(memberList) {
                ...
                $out += $escape(memberList.area), $line = 41) : $line = 41, $out += "</td> <td>", 
                $line = 42, 0 == memberList.idCardType ? ($line = 42, 0 == memberList.age ? ($out += "--", 
                $line = 42) : ($line = 42, $out += $escape(memberList.age), $line = 42), $line = 42) : $line = 42, 
                $out += "</td> </tr>", $line = 43;

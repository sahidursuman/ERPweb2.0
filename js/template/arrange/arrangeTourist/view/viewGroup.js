/*TMODJS:{"debug":true,"version":91,"md5":"755541f96ff9becc6cc7cec9e218784d"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/viewGroup", function($data, $filename) {
        try {
            ...
            $line = 20, $each(memberList, function(memberList) {
                ...
                $out += "</td> <td>", $line = 42, 0 == memberList.age ? ($out += "--", $line = 42) : ($line = 42, 
                $out += $escape(memberList.age), $line = 42), $out += "</td> </tr>", $line = 43;

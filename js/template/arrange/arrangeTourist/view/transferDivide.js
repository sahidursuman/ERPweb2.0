/*TMODJS:{"debug":true,"version":34,"md5":"66e5a1369a810a8a70a574feabef5d07"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/transferDivide", function($data, $filename) {
        try {
            ...
            $line = 9, $out += $escape(lineProduct.startTime), $out += '</label> <label class="pull-left control-label pitch no-padding-right">人数合计：', 
            $line = 10, $out += $escape(lineProduct.adultCount), $out += "大", $line = 10, $out += $escape(lineProduct.childCount), 
            $out += '小</label> <label class="pull-left control-label pitch no-padding-right">已选人数：<span class="choosenAdultAndChildCount">0大0小</span></label> </div> </form> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover all"> <thead> <tr class="bg-blur"> <th>来源</th> <th>联系人</th> <th>联系电话</th> <th>客源地</th> <th>年龄</th> <th>人数</th> <th>备注</th> <th width="135">操作</th> </tr> </thead> <tbody class="T-Transferdivide-list"> ', 
            $line = 29, $each(touristGroupList, function(touristGroup) {
                ...
                $out += $escape(touristGroup.ageData), $out += "</td> <td>", $line = 36, $out += $escape(touristGroup.adultCount), 
                $out += "大", $line = 36, $out += $escape(touristGroup.childCount), $out += "小</td> <td>", 

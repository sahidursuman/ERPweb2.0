    ...
    return require("../../../template")("arrange/arrangeTourist/view/divide", function($data, $filename) {
        try {
            ...
            $line = 35, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 43, $out += $escape(touristGroup.partnerAgency.travelAgencyName), $out += "</td> ", 
                $line = 44, null != touristGroup.contactMember && ($out += " <td>", $line = 45, 
                $out += $escape(touristGroup.contactMember.name), $out += "</td> ", $line = 46), 
                $out += " ", $line = 47, null != touristGroup.contactMember && ($out += " <td>", 
                $line = 48, $out += $escape(touristGroup.contactMember.mobileNumber), $out += "</td> ", 
                $line = 49), $out += " <td>", $line = 50, $out += $escape(touristGroup.areaData), 
                $out += "</td> <td>", $line = 51, $out += $escape(touristGroup.ageData), $out += "</td> <td>大人", 
                $line = 52, $out += $escape(touristGroup.adultCount), $out += "小孩", $line = 52, 
                $out += $escape(touristGroup.childCount), $out += "</td> <td>", $line = 53, $out += $escape(touristGroup.remark), 
                $out += '</td> <td> <a data-entity-id="', $line = 55, $out += $escape(touristGroup.id), 
                $out += '" class="cursor groupView"> 查看 </a> </td> </tr> ', $line = 60;

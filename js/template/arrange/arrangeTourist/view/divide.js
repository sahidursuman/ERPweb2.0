/*TMODJS:{"debug":true,"version":113,"md5":"8c5ed62a49e5b3db9ad34d1c80a4665c"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/divide", function($data, $filename) {
        try {
            ...
            $out += '小</label> <label class="pull-left control-label pitch no-padding-right">已选人数：<span class="choosenAdultAndChildCount">0 大 0 小</span></label> </div> </form> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover all"> <thead> <tr class="bg-blur"> <th> <label class="pos-rel"> <input type="checkbox" class="ace mainCheckBox"> <span class="lbl"></span> </label> </th> <th>来源</th> <th>联系人</th> <th>联系电话</th> <th>客源地</th> <th>年龄</th> <th>人数</th> <th>备注</th> <th width="50">操作</th> </tr> </thead> <tbody> ', 
            $line = 35, $each(touristGroupList, function(touristGroup) {
                ...
                $out += $escape(touristGroup.ageData), $out += "</td> <td>", $line = 48, $out += $escape(touristGroup.adultCount), 
                $out += "大", $line = 48, $out += $escape(touristGroup.childCount), $out += "小</td> <td>", 

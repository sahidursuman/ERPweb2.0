/*TMODJS:{"debug":true,"version":102,"md5":"2498d439b92d1eb8a10b9d1c52519793"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/listTransfer", function($data, $filename) {
        try {
            ...
            $line = 37, $each(touristGroupList, function(group) {
                ...
                $out += $escape($helpers.dateFormat(group.startTime, "yyyy-MM-dd")), $out += "</td> <td>", 
                $line = 57, $out += $escape(group.contactMember.name), $out += "</td> <td>", $line = 58, 
                $out += $escape(group.contactMember.mobileNumber), $out += "</td> <td>", $line = 59, 
                $out += $escape(group.adultCount), $out += " 大 ", $line = 59, $out += $escape(group.childCount), 
                $out += "小</td> <td>", $line = 61, $out += $escape(group.areaData), $out += "</td> <td>", 
                $line = 62, $out += $escape(group.ageData), $out += '</td> <td class="T-ctrl-tip" title="', 
                $line = 63, $out += $escape(group.remark), $out += '"><span style="height: 35px">', 
                $line = 63, $out += $escape(group.remark), $out += '</span></td> <td><a class="cursor T-arrageTransfer-view T-action"> 查看 </a></td> </tr> ', 
                $line = 66;

/*TMODJS:{"debug":true,"version":1,"md5":"c9061397adfcee3858038e4d7f27be47"}*/
    ...
    return require("../../../template")("arrange/arrangeTourist/view/listGroup", function($data, $filename) {
        try {
            ...
            $line = 21, $each(touristGroupList, function(touristGroupList) {
                ...
                $line = 22, $out += $escape(touristGroupList.childCount), $out += '> <td><label class="pos-rel"> <input type="checkbox" class="ace T-arrageGroupCheckBox T-cheked"> <span class="lbl"></span> </label></td> <td>', 
                $line = 24, null != touristGroupList.partnerAgency && ($line = 24, $out += $escape(touristGroupList.partnerAgency.travelAgencyName), 
                $line = 24), $out += "</td> <td>", $line = 25, $out += $escape(touristGroupList.lineProduct.name), 
                $out += "</td> <td>", $line = 26, $out += $escape(touristGroupList.lineProduct.type), 
                $out += "</td> <td> ", $line = 28, 0 == touristGroupList.lineProduct.customerType ? ($out += "散拼 ", 
                $line = 29) : 1 == touristGroupList.lineProduct.customerType ? ($out += "团体 ", $line = 30) : 2 == touristGroupList.lineProduct.customerType && ($out += "转客 ", 

/*TMODJS:{"debug":true,"version":52,"md5":"06b94b1967dc89c9be1dc23687ee852c"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTourist/view/listMain", function($data, $filename) {
        try {
            ...
            return $out += '<div class="row"> <div class="col-xs-12 arrangeTouristMain globalAdd"> <div class="search-area"> <form class="form-horizontal" role="form" onsubmit="return false"> <div class="form-group"> <label class="col-sm-1 control-label no-padding-right">线路产品：</label> <div class="col-sm-2"> <select name="lineProductId" class="col-xs-12 guideInputList"> <option></option> ', 

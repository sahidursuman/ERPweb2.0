                            ...
                            if (data.success == 1) {
                                ...
                                inTransferTr.each(function(i) {
                                    ...
                                    if (id == data.touristGroupId) {
                                        ...
                                        inTransferTr.eq(i).find(".T-needPay").html(data.transPayedMoney);
                                        inTransferTr.eq(i).find(".T-payed").html(data.transNeedPayAllMoney);
                                    }
                                })
                            ...
                            if (data.success == 1) {
                                ...
                                transferTr.each(function(i) {
                                    ...
                                    if (id == data.id) {
                                        ...
                                        transferTr.eq(i).find(".T-needPay").html(data.transPayedMoney);
                                        transferTr.eq(i).find(".T-payed").html(data.transNeedPayAllMoney);

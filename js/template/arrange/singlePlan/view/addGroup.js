/*TMODJS:{"debug":true,"version":146,"md5":"722110ea89cb57477c7ed11d1cf2f7d2"}*/
    ...
    return require("../../../template")("arrange/singlePlan/view/addGroup", function($data, $filename) {
        try {
            ...
            $line = 35, $each(touristGroupList, function(touristGroup) {
                $out += ' <tr data-id="', $line = 36, $out += $escape(touristGroup.id), $out += '"> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-tourist-check"> <span class="lbl"></span> </label> </td> <td>', 

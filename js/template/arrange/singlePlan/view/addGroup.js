/*TMODJS:{"debug":true,"version":141,"md5":"ff93b96da89f98f15b5d521c337d9ad4"}*/
    ...
    return require("../../../template")("arrange/singlePlan/view/addGroup", function($data, $filename) {
        try {
            ...
            $line = 34, $each(touristGroupList, function(touristGroup) {
                ...
                $out += '">', $line = 50, $out += $escape(touristGroup.adultCount), $out += "大", 
                $line = 50, $out += $escape(touristGroup.childCount), $out += '小</td> <td name="currentNeedPayMoney">', 
                $line = 51, $out += $escape(touristGroup.currentNeedPayMoney), $out += '</td> <td name="hotelLevel">', 
                $line = 52, $out += $escape($helpers.getHotelLevelDesc(touristGroup.hotelLevel)), 

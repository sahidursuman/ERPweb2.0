/*TMODJS:{"debug":true,"version":75,"md5":"7f92a9f2684048b91ab40a3febbf951b"}*/
    ...
    return require("../../../template")("arrange/transitPlan/view/listHotel", function($data, $filename) {
        try {
            ...
            $line = 18, $each(outHotelList, function(hotel) {
                $out += ' <tr data-id="', $line = 19, $out += $escape(hotel.id), $out += '"> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-touristGroupMergeCheckBox T-cheked"> <span class="lbl"></span> </label> </td> <td class="h-touristGroupInfo"> <p>中转单号：', 
                ...
                0 == hotel.arrangeResultList.hotelName && ($line = 48, $out += $escape(hotel.arrangeResultList.hotelName), 
                $line = 48), $out += "</a> </td> <td> ", $line = 51, 1 == hotel.status ? ($out += ' <i class="ace-icon fa fa-check green bigger-130"></i> 已完成 ', 

    ...
    return require("../../../template")("arrange/transit/view/FinancialNotice", function($data, $filename) {
        try {
            ...
            $line = 10, $each(userList, function(user) {
                ...
                $line = 12, $out += $escape(user.realName), $out += '</td> <td><label class="pos-rel"><input type="checkbox" name="receiveUserName" class="ace T-add"> <span class="lbl"></span> </label> </td> </tr> ', 
                $line = 16;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-3"> <small>共计 ', 
            $line = 21, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-9"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

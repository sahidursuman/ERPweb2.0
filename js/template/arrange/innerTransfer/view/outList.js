/*TMODJS:{"debug":true,"version":224,"md5":"311a8ee1b82e9738df06c3567514d39d"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/outList", function($data, $filename) {
        try {
            ...
            $line = 15, $each(resultList, function(list) {
                ...
                $line = 38, 1 != list.status && ($out += "T-TransferOut-delete", $line = 38), $out += ' R-right T-action" data-right="1340003" ', 
                $line = 38, 1 == list.status && ($out += 'style="color:#bbb"', $line = 38), $out += '> <label class="padding-right20">|</label> 撤销 </a> <a class="cursor ', 
                $line = 43, 1 == list.status && ($out += "T-returnTransferOut-delete", $line = 43), 
                $out += ' R-right T-action" data-right="1340003" ', $line = 43, 1 != list.status && ($out += 'style="color:#bbb"', 

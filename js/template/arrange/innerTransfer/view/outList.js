/*TMODJS:{"debug":true,"version":317,"md5":"bb07536fa7357b801abfcc2a649cca46"}*/
define(function(require) {
    return require("../../../template")("arrange/innerTransfer/view/outList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>接收部门</th> <th>游客</th> <th>联系电话</th> <th>人数</th> <th>应付款</th> <th>转客人</th> <th>转客时间</th> <th>对方状态</th> <th>操作</th> </tr> </thead> <tbody class="T-transferOut-list">', 
            $line = 15, $each(resultList, function(list) {
                ...
                $line = 32, 1 != list.status && 4 != list.status && 2 != list.status && ($out += "T-TransferOut-edit", 
                $line = 32), $out += ' R-right T-action" data-right="1340002" ', $line = 32, (1 == list.status || 2 == list.status || 4 == list.status) && ($out += 'style="color:#bbb"', 
                $line = 32), $out += '> 编辑 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-TransferOut-view T-action"> 查看 </a> <a class="cursor ', 

/*TMODJS:{"debug":true,"version":40,"md5":"f9d5e55ad9e9246fcb7b3525040eea0a"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/outList", function($data, $filename) {
        try {
            ...
            $line = 16, $each(resultList, function(list) {
                ...
                0 == list.status ? ($out += "未确认", $line = 26) : 1 == list.status ? ($out += "已确认", 
                $line = 26) : 2 == list.status && ($out += "已拒收", $line = 26), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group" style="width:120px;"> <a class="cursor ', 

/*TMODJS:{"debug":true,"version":44,"md5":"5ed8163dc1dcb28a576c7e0365062477"}*/
define(function(require) {
    return require("../../../template")("arrange/innerTransfer/view/innerTransferOutView", function($data, $filename) {
        try {
            ...
            $line = 19, null != innerTransfer.touristGroup.partnerAgency && ($line = 19, $out += $escape(innerTransfer.touristGroup.partnerAgency.contactRealname), 
            $line = 19), $out += '</td> <td class="style-myself CheckPlan">联系人电话</td> <td style="text-align: left;padding: 0px 0px 0px 10px">', 
            $line = 21, null != innerTransfer.touristGroup.partnerAgency && ($line = 21, $out += $escape(innerTransfer.touristGroup.partnerAgency.contactMobileNumber), 

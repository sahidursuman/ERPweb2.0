/*TMODJS:{"debug":true,"version":103,"md5":"e6c05bb5e14f7b9c8be31f7f5a6cf427"}*/
define(function(require) {
    return require("../../../template")("arrange/innerTransfer/view/innerTransferOutView", function($data, $filename) {
        try {
            ...
            $line = 17, null != innerTransfer.fromBusinessGroup && ($line = 17, $out += $escape(innerTransfer.fromBusinessGroup.name), 
            $line = 17), $out += '</td> <td class="style-myself CheckPlan">同行联系人</td> <td style="text-align: left;padding: 0px 0px 0px 10px">', 
            $line = 19, null != innerTransfer.dutyOPUser && ($line = 19, $out += $escape(innerTransfer.dutyOPUser.realName), 
            $line = 19), $out += '</td> <td class="style-myself CheckPlan">联系人电话</td> <td style="text-align: left;padding: 0px 0px 0px 10px">', 
            $line = 21, null != innerTransfer.dutyOPUser && ($line = 21, $out += $escape(innerTransfer.dutyOPUser.mobileNumber), 

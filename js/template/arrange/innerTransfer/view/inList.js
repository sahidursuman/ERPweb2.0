/*TMODJS:{"debug":true,"version":144,"md5":"05f81ad9d5b0b9bcd2a54ad3083864e1"}*/
define(function(require) {
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>线路产品</th> <th>天数</th> <th>出游日期</th> <th>游客</th> <th>人数</th> <th>来源部门</th> <th>联系人</th> <th>联系电话</th> <th>应收</th> <th>已收</th> <th>我方状态</th> <th width="143">操作</th> </tr> </thead> <tbody class="T-transferIn-list">', 
            $line = 18, $each(resultList, function(list) {
                $out += ' <tr data-value="', $line = 19, $out += $escape(list.id), $out += '"> <td>', 
                $line = 20, $out += $escape(list.lineProduct.name), $out += '</td> <td><span class=" F-float F-count">', 
                $line = 21, $out += $escape(list.lineProduct.days), $out += "</span>天</td> <td>", 

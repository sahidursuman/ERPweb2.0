/*TMODJS:{"debug":true,"version":272,"md5":"fce6027b2b5c6398cf702bc1af89a8d2"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 16, $each(resultList, function(list) {
                ...
                $line = 34, 1 != list.status && 4 != list.status && ($out += "T-TransferIn-save", 
                $line = 34), $out += ' R-right T-action" data-right="1340004" ', $line = 34, (1 == list.status || 4 == list.status) && ($out += 'style="color:#bbb"', 

/*TMODJS:{"debug":true,"version":228,"md5":"5842c90af583a231f3259688e0cade66"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(resultList, function(list) {
                ...
                $line = 28, 0 == list.status ? ($out += '<span style="color:#D2691E;">未确认</span>', 
                ...
                $line = 31, 1 != list.status && ($out += "T-TransferIn-save", $line = 31), $out += ' R-right T-action" data-right="1340004" ', 
                $line = 31, 1 == list.status && ($out += 'style="color:#bbb"', $line = 31), $out += '> 确认 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-TransferIn-view T-action"> 查看 </a> <a class="cursor ', 
                $line = 38, 1 != list.status && ($out += "T-TransferIn-refuse", $line = 38), $out += ' R-right T-action" data-right="1340005" ', 
                $line = 38, 1 == list.status && ($out += 'style="color:#bbb"', $line = 38), $out += '> <label class="padding-right20">|</label> 拒绝 </a> <a class="cursor ', 
                $line = 43, 1 == list.status && ($out += "T-returnTransferIn-refuse", $line = 43), 
                $out += ' R-right T-action" data-right="1340005" ', $line = 43, 1 != list.status && ($out += 'style="color:#bbb"', 
                $line = 43), $out += '> <label class="padding-right20">|</label> 申请退回 </a> </div> </td> </tr> ', 
                $line = 51;

/*TMODJS:{"debug":true,"version":234,"md5":"f470a702e1ae4d90c61c2d3ba5376756"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(resultList, function(list) {
                ...
                $line = 32), $out += ' </td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="cursor ', 
                $line = 36, 1 != list.status && ($out += "T-TransferIn-save", $line = 36), $out += ' R-right T-action" data-right="1340004" ', 
                $line = 36, 1 == list.status && ($out += 'style="color:#bbb"', $line = 36), $out += '> 确认 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-TransferIn-view T-action"> 查看 </a> <a class="cursor ', 
                $line = 43, 1 != list.status && ($out += "T-TransferIn-refuse", $line = 43), $out += ' R-right T-action" data-right="1340005" ', 
                $line = 43, 1 == list.status && ($out += 'style="color:#bbb"', $line = 43), $out += '> <label class="padding-right20">|</label> 拒绝 </a> <a class="cursor ', 
                ...
                $line = 48), $out += '> <label class="padding-right20">|</label> 申请退回 </a> </div> </td> </tr> ', 
                $line = 56;

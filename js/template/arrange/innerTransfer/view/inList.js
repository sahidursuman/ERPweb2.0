/*TMODJS:{"debug":true,"version":271,"md5":"24e87644b8a84c2923f9cbf99a425948"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 16, $each(resultList, function(list) {
                ...
                $line = 34, 1 != list.status && ($out += "T-TransferIn-save", $line = 34), $out += ' R-right T-action" data-right="1340004" ', 
                $line = 34, 1 == list.status && ($out += 'style="color:#bbb"', $line = 34), $out += '> 确认 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-TransferIn-view T-action"> 查看 </a> <a class="cursor ', 

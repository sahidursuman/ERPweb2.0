/*TMODJS:{"debug":true,"version":276,"md5":"a2aff99a825b23360744a17660a85008"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(resultList, function(list) {
                ...
                $line = 36, 1 != list.status && 4 != list.status && ($out += "T-TransferIn-save", 
                $line = 36), $out += ' R-right T-action" data-right="1340004" ', $line = 36, (1 == list.status || 4 == list.status) && ($out += 'style="color:#bbb"', 

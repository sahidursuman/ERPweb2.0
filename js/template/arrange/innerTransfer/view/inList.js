/*TMODJS:{"debug":true,"version":240,"md5":"a9b817cd50c0e6bb49c1c558edf70618"}*/
    ...
    return require("../../../template")("arrange/innerTransfer/view/inList", function($data, $filename) {
        try {
            ...
            $line = 17, $each(resultList, function(list) {
                ...
                $line = 32) : 5 == result.status && ($out += '<span style="color: red">已退回</span> ', 
                ...
                $line = 49), $out += '> <label class="padding-right20">|</label> 申请退回 </a> </div> </td> </tr> ', 
                $line = 57;

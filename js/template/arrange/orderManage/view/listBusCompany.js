/*TMODJS:{"debug":true,"version":257,"md5":"2da2f5f514e083a9a0b7f268c4742f91"}*/
    ...
    return require("../../../template")("arrange/orderManage/view/listBusCompany", function($data, $filename) {
        try {
            ...
            $line = 21, $each(busOrderList, function(busOrderList) {
                ...
                $out += ' R-right T-action" data-right="1450002" style="', $line = 37, (1 == busOrderList.status || -1 == busOrderList.status) && ($out += "color:#bbb", 

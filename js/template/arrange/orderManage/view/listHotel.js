/*TMODJS:{"debug":true,"version":329,"md5":"faedd79f0d4ffe2f5a5147a50134d224"}*/
    ...
    return require("../../../template")("arrange/orderManage/view/listHotel", function($data, $filename) {
        try {
            ...
            $line = 22, $each(hotelOrderList, function(hotOrderList) {
                ...
                $line = 57, $out += $escape(hotOrderList.statusStr), $out += '</td> <td rowspan="', 
                $line = 58, $out += $escape(hotOrderList.hotelOrderNeedRoomList.length), $out += '" style="vertical-align:middle"> <a class="cursor ', 
                $line = 59, 0 == hotOrderList.status && ($out += "T-listHotel-refuse", $line = 59), 
                $out += ' R-right T-action" data-right="1450002" style="', $line = 59, (1 == hotOrderList.status || -1 == hotOrderList.status) && ($out += "color:#bbb;", 
                $line = 59), $out += '"> 撤销 </a> </td> </tr> ', $line = 65, $each(hotOrderList.hotelOrderNeedRoomList, function(htOrderNList, index) {
                    $out += " ", $line = 66, index > 0 && ($out += " <tr> <td>", $line = 68, $out += $escape(htOrderNList.type), 
                    $out += "</td> <td>", $line = 69, $out += $escape(htOrderNList.needRoomCount), $out += "</td> <td>", 
                    $line = 70, $out += $escape(htOrderNList.price), $out += "</td> <td>", $line = 71, 
                    $out += $escape(htOrderNList.price), $out += "</td> </tr> ", $line = 73), $out += " ", 
                    $line = 74;
                }), $out += " ", $line = 75;
            }), $out += ' </tbody> </table>  <div class="row pageMode"> <div class="col-xs-4"> <small>共计', 
            $line = 81, $out += $escape(searchParam.totalCount), $out += '条记录</small> </div> <div style="width:320px; float:right;"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>  </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":735,"md5":"75dd76d4c9098e66924818bf94f08455"}*/
define(function(require) {
    return require("../../../template")("arrange/orderManage/view/listHotel", function($data, $filename) {
        try {
            ...
            return $out += ' <div class="listHotel"> <table class="table table-striped table-bordered table-hover table-fixed T-showHighLight"> <colgroup> <col style="width:190px;"> <col style="width:50px;"> <col style="width:155px;"> <col> <col style="width:70px;"> <col style="width:70px;"> <col style="width:40px;"> <col style="width:80px"> <col style="width:80px"> <col style="width:75px;"> <col style="width:100px;"> <col style=""> <col style="width:60px;"> </colgroup> <thead> <tr class="bg-blur"> <th>订单号</th> <th>类型</th> <th>类型编号</th> <th>酒店</th> <th>星级</th> <th>房型</th> <th>数量</th> <th>单价</th> <th>金额</th> <th>操作人</th> <th>操作时间</th> <th>备注</th> <th>状态</th> </tr> </thead> <tbody class="T-Hotel-list"> ', 

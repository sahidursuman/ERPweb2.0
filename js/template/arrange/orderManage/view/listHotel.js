/*TMODJS:{"debug":true,"version":703,"md5":"345cb4a8a5a7132e7c8a13b307daf5d2"}*/
define(function(require) {
    return require("../../../template")("arrange/orderManage/view/listHotel", function($data, $filename) {
        try {
            ...
            return $out += ' <div class="listHotel"> <table class="table table-striped table-bordered table-hover table-fixed T-showHighLight"> <colgroup> <col style="width:175px;"> <col style="width:80px;"> <col style="width:175px;"> <col style=""> <col style="width:70px;"> <col style="width:100px;"> <col style="width:80px"> <col style="width:80px"> <col style="width:80px;"> <col style="width:80px;"> <col style="width:110px;"> <col style=""> <col style="width:100px;"> </colgroup> <thead> <tr class="bg-blur"> <th>订单号</th> <th>类型</th> <th>类型编号</th> <th>酒店</th> <th>星级</th> <th>房型</th> <th>数量</th> <th>单价</th> <th>金额</th> <th>操作人</th> <th>操作时间</th> <th>备注</th> <th>状态</th> </tr> </thead> <tbody class="T-Hotel-list"> ', 
            $line = 37, $each(hotelOrderList, function(hotOrderList) {
                ...
                $line = 47) : 4 == hotOrderList.hotel.level ? ($out += "四星 ", $line = 48) : 5 == hotOrderList.hotel.level ? ($out += "准五星 ", 
                ...
                $line = 55, $each(hotOrderList.hotelOrderNeedRoomList, function(htOrderNList, index) {
                    ...
                    $out += '</td> <td class="F-float F-count">', $line = 58, $out += $escape(htOrderNList.needRoomCount), 
                    $out += '</td> <td class="F-float F-money">', $line = 59, $out += $escape(htOrderNList.price), 
                    $out += '</td> <td class="F-float F-money">', $line = 60, $out += $escape(htOrderNList.needRoomCount * htOrderNList.price), 
                ...
                $line = 82) : 1 == hotOrderList.status && 1 == hotOrderList.result && ($out += " 已预订 ", 
                $line = 84), $out += " </td> </tr> ", $line = 88, $each(hotOrderList.hotelOrderNeedRoomList, function(htOrderNList, index) {
                    ...
                    $out += '</td> <td class="count F-float F-count">', $line = 92, $out += $escape(htOrderNList.needRoomCount), 
                    $out += '</td> <td class="price F-float F-money">', $line = 93, $out += $escape(htOrderNList.price), 
                    $out += '</td> <td class="totalMoney F-float F-money">', $line = 94, $out += $escape(htOrderNList.price), 

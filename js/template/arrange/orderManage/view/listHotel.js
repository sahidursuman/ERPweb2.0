/*TMODJS:{"debug":true,"version":324,"md5":"982e6d0d9ddf4e6ca7df70840d5ecdd7"}*/
    ...
    return require("../../../template")("arrange/orderManage/view/listHotel", function($data, $filename) {
        try {
            ...
            $line = 22, $each(hotelOrderList, function(hotOrderList) {
                ...
                $out += ' R-right T-action" style="', $line = 59, (1 == hotOrderList.status || -1 == hotOrderList.status) && ($out += "color:#bbb;", 

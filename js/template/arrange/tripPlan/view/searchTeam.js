/*TMODJS:{"debug":true,"version":14,"md5":"c3c6886bd9fe527a9acdd973fcd07cfe"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/searchTeam", function($data, $filename) {
        try {
            ...
            $line = 21, $each(tourisGroupList, function(rs) {
                ...
                $line = 28, $out += $escape(rs.contactMemberName), $out += '</td> <td char="F-float F-count">', 
                $line = 29, $out += $escape(rs.adultCount), $out += "大", $line = 29, 0 != rs.childCount && ($line = 29, 

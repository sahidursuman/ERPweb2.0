/*TMODJS:{"debug":true,"version":17,"md5":"de3647f02473aec2b9abf5d982daddf3"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/searchTeam", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tourisGroupList, function(rs) {
                ...
                $line = 31, $out += $escape(rs.adultCount), $line = 31, 0 != rs.childCount && ($out += "</span>大 <span>", 
                $line = 31, $out += $escape(rs.childCount), $line = 31), $out += "</span>小</td> <td>", 

/*TMODJS:{"debug":true,"version":16,"md5":"f00b09f4b001ccafe5c98df3a8dbf375"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/searchTeam", function($data, $filename) {
        try {
            ...
            $line = 21, $each(tourisGroupList, function(rs) {
                ...
                $line = 25) : ($out += "散客", $line = 25), $out += "</td> <td>", $line = 26, $out += $escape($helpers.dateFormat(rs.startTime, "yyyy-MM-dd")), 
                $out += "</td> <td>", $line = 27, $out += $escape(rs.quoteNumber), $out += "</td> <td>", 
                $line = 28, $out += $escape(rs.contactMemberName), $out += '</td> <td><span class="F-float F-count">', 
                $line = 29, $out += $escape(rs.adultCount), $line = 29, 0 != rs.childCount && ($out += "</span>大 <span>", 
                $line = 29, $out += $escape(rs.childCount), $line = 29), $out += "</span>小</td> <td>", 

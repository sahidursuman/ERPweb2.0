/*TMODJS:{"debug":true,"version":55,"md5":"ace9685797f5824ae3e30bb1ba70f454"}*/
define(function(require) {
    return require("../../../template")("arrange/tripPlan/view/addGroup", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-sm-12" style="margin-top:10px;"> <div class="tabbable addTouristGroupListToPlan"> <div class=" col-xs-12" style="padding:10px 0 0 0;"> <div class="tab-pane fade active in"> <div class="col-xs-12" class="search-TravelLineList"> <table class="table table-striped table-bordered table-hover add-travelLineList-table all"> <thead> <tr> <th class="th-border"> <label class="pos-rel"> <input type="checkbox" class="ace addMainCheckBox"> <span class="lbl"></span> </label> </th> <th class="th-border">来源</th> <th class="th-border">联系人</th> <th class="th-border">联系电话</th> <th class="th-border">客源地</th> <th class="th-border">年龄</th> <th class="th-border">人数</th> <th class="th-border" style="width: 300px">备注</th> <th class="th-border">操作</th> </tr> </thead> <tbody class="addTGToPlanTbody">', 
            $line = 25, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 38, $out += $escape(touristGroup.adultCount + touristGroup.childCount), 
                $out += '</td> <td name="remark">', $line = 39, $out += $escape(touristGroup.remark), 
                $out += '</td> <td> <a data-entity-id="', $line = 41, $out += $escape(touristGroup.id), 
                $out += '" class="cursor addGroupView"> 查看 </a> </td> </tr>', $line = 45;

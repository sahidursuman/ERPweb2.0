/*TMODJS:{"debug":true,"version":47,"md5":"9a29c7f57a331462a5b9660fe766532d"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/addGroup", function($data, $filename) {
        try {
            ...
            $line = 25, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 39, $out += $escape(touristGroup.remark), $out += '</td> <td> <button data-entity-id="', 
                $line = 41, $out += $escape(touristGroup.id), $out += '" class="btn btn-xs btn-success addGroupView"> <i class="ace-icon fa fa-search-plus"></i> </button> </td> </tr>', 
                $line = 45;

/*TMODJS:{"debug":true,"version":15,"md5":"ca4ee2ad9ced46544a2e4a25e28cb5af"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/searchQuoteOrderList", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(lineProductList, function(rs) {
                ...
                $line = 21, $out += $escape($helpers.dateFormat(rs.startTime, "yyyy-MM-dd")), $out += '</td> <td> <label class="T-quote-line"> <input type="radio" class="ace" value="123" name="choice-TravelLine" index="0"> <span class="lbl"></span> </label> </td> </tr> ', 
                $line = 29;
            }), new String($out);
        } catch (e) {
            throw {

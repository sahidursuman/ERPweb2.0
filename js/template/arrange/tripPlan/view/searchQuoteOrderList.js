/*TMODJS:{"debug":true,"version":12,"md5":"268dd385630fbae46e4f7453e3398f56"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/searchQuoteOrderList", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(lineProductList, function(rs) {
                ...
                $line = 13), $out += " ", $line = 14), $out += " </td> <td>", $line = 16, $out += $escape(rs.adultCount), 
                $out += "大", $line = 16, $out += $escape(rs.childCount), $out += "小</td> <td>", 
                $line = 17, null != rs.lineProduct && ($line = 17, $out += $escape(rs.lineProduct.days), 
                $line = 17), $out += "</td> <td>", $line = 18, $out += $escape(rs.createTime), $out += "</td> <td>", 
                $line = 19, null != rs.partnerAgency && ($line = 19, $out += $escape(rs.partnerAgency.travelAgencyName), 

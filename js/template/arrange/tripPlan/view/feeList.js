/*TMODJS:{"debug":true,"version":24,"md5":"622acff063d46e695c60eb1b1c3262b6"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/feeList", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupFeeList, function(rs) {
                ...
                $line = 4, 1 == isGuest && ($out += "disabled", $line = 4), $out += '> <option value="1">大人结算价</option> <option value="2">小孩结算价</option> <option value="4">车辆费用</option> <option value="5">餐饮费用</option> <option value="6">保险费用</option> <option value="7">导服费</option> <option value="8">酒店费用</option> <option value="9">景区费用</option> <option value="10">自费费用</option> <option value="11">票务费用</option> <option value="12">其它费用</option> </select> </td> <td><input type="text" class="col-xs-12 T-calculate F-float F-count T-count" name="count" value="', 
                $line = 18, $out += $escape(rs.count), $out += '" ', $line = 18, 1 == isGuest && ($out += "readonly", 
                $line = 18), $out += '></td> <td><input type="text" class="col-xs-12 T-calculate T-price F-float F-money" name="price" value="', 
                $line = 19, $out += $escape(rs.price), $out += '" ', $line = 19, 1 == isGuest && ($out += "readonly", 
                $line = 19), $out += '></td> <td><input type="text" class="col-xs-12 F-float F-money" name="money" readonly value="', 
                $line = 20, rs.count && rs.price && ($line = 20, $out += $escape(rs.count * rs.price), 
                $line = 20), $out += '"></td> <td><input type="text" class="col-xs-12" name="feeRemark" maxlength="100" value="', 
                $line = 21, $out += $escape(rs.remark), $out += '" ', $line = 21, 1 == isGuest && ($out += "readonly", 
                $line = 21), $out += '></td> <td><a class="cursor T-action T-delete" title="删除">删除</a></td> </tr> ', 
                $line = 24;
            }), new String($out);
        } catch (e) {
            throw {

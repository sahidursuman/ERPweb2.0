/*TMODJS:{"debug":true,"version":10,"md5":"5f4a4b83e2b4c01af68bc59e8f820d3d"}*/
    ...
    return require("../../../template")("arrange/tripPlan/view/touristsList", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupMemberList, function(rs, index) {
                ...
                $line = 3, $out += $escape(index + 1), $out += '</td> --> <td><input type="text" class="col-xs-12" name="name" value="', 
                $line = 4, $out += $escape(rs.name), $out += '"></td> <td><input type="text" class="col-xs-12" name="mobileNumber" value="', 

/*TMODJS:{"debug":true,"version":2,"md5":"e82cf4ce23293c91b88b5c770f7c220f"}*/
    ...
    return require("../../../template")("arrange/booking/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookingOrderList, function(booking) {
                ...
                $line = 27, null != booking.operateUser && ($line = 27, $out += $escape(booking.operateUser.realName), 
                $line = 27), $out += "</td> <td>", $line = 28, $out += $escape(booking.operationTime), 

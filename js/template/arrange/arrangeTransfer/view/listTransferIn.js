/*TMODJS:{"debug":true,"version":37,"md5":"87eb8dd8e3f6569c8fecf1b7256a7b5e"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferIn", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>同行线路产品</th> <th>天数</th> <th>出游日期</th> <th>游客</th> <th>人数</th> <th>来源总社</th> <th>转客人</th> <th>联系电话</th> <th>应收</th>  <th>现收</th> <th>我方状态</th> <th>操作</th> </tr> </thead> <tbody class="T-listTransferIn"> ', 

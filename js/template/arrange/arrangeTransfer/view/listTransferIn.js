/*TMODJS:{"debug":true,"version":152,"md5":"03fa7dff4639c3a84e7c18dbb42b427f"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferIn", function($data, $filename) {
        try {
            ...
            $line = 18, $each(result, function(result) {
                ...
                $out += "</td> <td> ", $line = 31, null != result.fromName && ($out += " ", $line = 31, 
                $out += $escape(result.fromName), $out += " ", $line = 31), $out += " </td> <td> ", 
                ...
                1 != result.status && ($out += "T-transferIn-confirm", $line = 54), $out += ' R-right T-action" style="', 
                $line = 54, 1 == result.status && ($out += " color:#bbb; ", $line = 54), $out += '" data-right="1180007"> <label class="padding-right20">|</label> 确认 </a> <a data-value="', 
                $line = 58, $out += $escape(result.id), $out += '" class="cursor ', $line = 58, 
                2 != result.status && ($out += "T-transferIn-refuse", $line = 58), $out += ' R-right T-action" style="', 
                $line = 58, 2 == result.status && ($out += " color:#bbb; ", $line = 58), $out += '" data-right="1180008"> <label class="padding-right20">|</label> 拒绝 </a> <a data-value="', 
                ...
                $line = 63, 1 != result.status && ($out += " color:#bbb; ", $line = 63), $out += '" data-right="1180008"> <label class="padding-right20">|</label> 申请退回 </a> </div> </td> </tr> ', 
                $line = 71;

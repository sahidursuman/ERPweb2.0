/*TMODJS:{"debug":true,"version":261,"md5":"7b311700d7a8356a492622d844918472"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferIn", function($data, $filename) {
        try {
            ...
            $line = 18, $each(result, function(result) {
                ...
                $line = 64, 1 != result.status && ($out += " color:#bbb; ", $line = 64), $out += '" data-right="1180008"> <label class="padding-right20">|</label> 退回 </a> </div> </td> </tr> ', 
                $line = 72;

/*TMODJS:{"debug":true,"version":33,"md5":"65ee14ebcf3be05fb5188dc8f71691bf"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferIn", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>同行线路产品</th> <th>天数</th> <th>出游日期</th> <th>游客</th> <th>人数</th> <th>来源总社</th> <th>转客人</th> <th>联系电话</th> <th>应收</th> <th>已收</th> <th>现收</th> <th>我方状态</th> <th>操作</th> </tr> </thead> <tbody class="T-listTransferIn"> ', 
            $line = 20, $each(result, function(result) {
                ...
                $line = 27), $out += "</span>小</td> <td> ", $line = 30, null != result.fromName && ($out += " ", 
                $line = 31, $out += $escape(result.fromName), $out += " ", $line = 32), $out += " </td> <td> ", 
                $line = 36, null != result.user && ($out += " ", $line = 37, null != result.user.realName && ($out += " ", 
                $line = 38, $out += $escape(result.user.realName), $out += " ", $line = 39), $out += " ", 
                $line = 40), $out += " </td> <td> ", $line = 45, $out += $escape(result.fromNumber), 
                $out += ' </td> <td><span class="F-float F-money">', $line = 48, null != result.touristGroup && ($line = 48, 
                $out += $escape(result.touristGroup.transNeedPayAllMoney), $line = 48), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 49, null != result.touristGroup && ($line = 49, $out += $escape(result.touristGroup.transPayedMoney), 
                $line = 49), $out += '</span></td> <td><span class="F-float F-money">', $line = 50, 
                $out += $escape(result.touristGroup.currentNeedPayMoney), $out += '</span></td> <td class="result-status">', 
                $line = 51, null == result.transName ? ($out += "未使用", $line = 51) : ($line = 51, 

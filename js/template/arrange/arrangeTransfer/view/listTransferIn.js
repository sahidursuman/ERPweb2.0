/*TMODJS:{"debug":true,"version":291,"md5":"db40f288d075b4e21a7ef6dda4ceaa02"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferIn", function($data, $filename) {
        try {
            ...
            $line = 18, $each(result, function(result) {
                ...
                1 != result.status && 4 != result.status && ($out += "T-transferIn-confirm", $line = 54), 
                $out += ' R-right T-action" style="', $line = 54, (1 == result.status || 4 == result.status) && ($out += " color:#bbb; ", 
                ...
                2 != result.status && 1 != result.status && 4 != result.status && ($out += "T-transferIn-refuse", 
                $line = 58), $out += ' R-right T-action" style="', $line = 58, (2 == result.status || 1 == result.status || 4 == result.status) && ($out += " color:#bbb; ", 

/*TMODJS:{"debug":true,"version":413,"md5":"14b7b02893a087e5dd12fffaab7f1ecf"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                0 != result.status && 1 != result.status && 2 != result.status && 4 != result.status && ($out += "T-transfer-confirm", 
                $line = 75), $out += ' T-action R-right" ', $line = 75, (0 == result.status || 1 == result.status || 2 == result.status || 4 == result.status) && ($out += 'style="color:#bbb;"', 
                ...
                $line = 80), $out += ' T-action R-right" data-right="1180004" ', $line = 80, 4 != result.status && 1 != result.status && ($out += 'style="color:#bbb;"', 

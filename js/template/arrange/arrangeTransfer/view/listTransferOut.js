/*TMODJS:{"debug":true,"version":397,"md5":"161a3121adfee719113b535807122a4d"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                1 != result.status && 2 != result.status && 4 != result.status && ($out += "T-transfer-confirm", 
                $line = 75), $out += ' T-action R-right" ', $line = 75, (1 == result.status || 2 == result.status || 4 == result.status) && ($out += 'style="color:#bbb;"', 

/*TMODJS:{"debug":true,"version":272,"md5":"61b6ba38539bbaa60550c98ba0f6d344"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                $line = 59) : 5 == result.status && ($out += '<span style="color: green">已退回</span> ', 
                $line = 60), $out += ' </td> <td> <div class="hidden-sm hidden-xs btn-group"> <a data-value="', 
                $line = 64, $out += $escape(result.id), $out += '" class="cursor T-transfer-view T-action"> 查看 </a> <a data-value="', 
                $line = 67, $out += $escape(result.id), $out += '" class="cursor T-transfer-edit T-action R-right" data-right="1180003"> <label class="padding-right20">|</label> 编辑 </a> <a data-value="', 
                $line = 72, $out += $escape(result.id), $out += '" class="cursor ', $line = 72, 
                1 != result.status && 2 != result.status && ($out += "T-transfer-delete", $line = 72), 
                $out += ' T-action R-right" ', $line = 72, (1 == result.status || 2 == result.status) && ($out += 'style="color:#bbb;"', 
                ...
                1 != result.status && 2 != result.status && ($out += "T-transfer-confirm", $line = 77), 
                $out += ' T-action R-right" ', $line = 77, (1 == result.status || 2 == result.status) && ($out += 'style="color:#bbb;"', 
                $line = 77), $out += ' data-right="1180004"> <label class="padding-right20">|</label> 确认 </a> <a data-value="', 
                $line = 82, $out += $escape(result.id), $out += '" class="cursor ', $line = 82, 
                4 == result.status && ($out += "T-returnTransfer-confirm", $line = 82), $out += ' T-action R-right" data-right="1180004" ', 
                $line = 82, 4 != result.status && ($out += 'style="color:#bbb;"', $line = 82), $out += '> <label class="padding-right20">|</label> 确认退回 </a> </div> </td> </tr> ', 
                $line = 91), $out += " ", $line = 92;

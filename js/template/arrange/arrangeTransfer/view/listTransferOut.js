/*TMODJS:{"debug":true,"version":120,"md5":"6bf67771777bc5b5dbd8508cca1bf23a"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                $line = 59, $out += $escape(result.id), $out += '" class="cursor T-transfer-edit T-action R-right" data-right="1180003"> <label class="padding-right20">|</label> 编辑 </a> <a data-value="', 

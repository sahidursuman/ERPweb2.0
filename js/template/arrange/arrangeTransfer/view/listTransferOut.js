/*TMODJS:{"debug":true,"version":311,"md5":"938a3dd3d22fba2d4417c392f1f26dbf"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                1 != result.status && 4 != result.status && ($out += "T-transfer-edit", $line = 65), 
                $out += ' T-action R-right" data-right="1180003" ', $line = 65, (1 == result.status || 4 == result.status) && ($out += 'style="color:#bbb;"', 
                ...
                1 != result.status && 4 != result.status && ($out += "T-transfer-confirm", $line = 75), 
                $out += ' T-action R-right" ', $line = 75, (1 == result.status || 4 == result.status) && ($out += 'style="color:#bbb;"', 

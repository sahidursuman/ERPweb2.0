/*TMODJS:{"debug":true,"version":78,"md5":"4950949959aa2313fa766a7fc5b1555a"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                1 != result.status && ($out += "T-transfer-confirm", $line = 68), $out += ' T-action R-right" ', 
                $line = 68, 1 == result.status && ($out += 'style="color:#bbb;"', $line = 68), $out += ' data-right="1180004"> <label class="padding-right20">|</label> 确认 </a> </div> </td> </tr> ', 
                $line = 77), $out += " ", $line = 78;

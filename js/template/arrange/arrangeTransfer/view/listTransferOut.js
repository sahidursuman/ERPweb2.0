/*TMODJS:{"debug":true,"version":233,"md5":"fd850936c104ca3f9a591abf4bcf1d41"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 17, $each(result, function(result) {
                ...
                $line = 57) : 3 == result.status ? ($out += '<span style="">未使用</span> ', $line = 58) : 4 == result.status && ($out += '<span style="">申请退回</span> ', 
                ...
                (1 == result.status || 4 == result.status) && ($out += "T-returnTransfer-confirm", 
                $line = 81), $out += ' T-action R-right" data-right="1180004" ', $line = 81, 1 != result.status && ($out += 'style="color:#bbb;"', 
                $line = 81), $out += '> <label class="padding-right20">|</label> 确认退回 </a> </div> </td> </tr> ', 
                $line = 90), $out += " ", $line = 91;

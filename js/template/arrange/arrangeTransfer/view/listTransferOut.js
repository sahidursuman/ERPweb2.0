/*TMODJS:{"debug":true,"version":29,"md5":"301f15c4a5bf53f406037fa523f50b51"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransferOut", function($data, $filename) {
        try {
            ...
            $line = 19, $each(result, function(result) {
                ...
                $out += '</span>小 </td> <td><span class="F-float F-money">', $line = 40, $out += $escape(result.touristGroup.lineNeedPayMoney), 

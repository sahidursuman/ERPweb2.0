/*TMODJS:{"debug":true,"version":523,"md5":"d79cb43e93e73caa1b22cfbfed17502d"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransIn", function($data, $filename) {
        try {
            ...
            $line = 20, $each(pager.resultList, function(result) {
                ...
                $line = 22), $out += '</td> <td><span class="F-float F-count">', $line = 23, null != result.lineProduct && ($line = 23, 
                $out += $escape(result.lineProduct.days), $line = 23), $out += "</span></td> <td>", 
                $line = 24, $out += $escape($helpers.dateFormat(result.startTime, "yyyy-MM-dd")), 
                $out += "</td> <td>", $line = 25, null != result.touristGroup && ($line = 25, null != result.touristGroup.contactMember && ($line = 25, 
                $out += $escape(result.touristGroup.contactMember.name), $line = 25), $line = 25), 
                $out += '</td> <td><span class="F-float F-count">', $line = 27, null != result.touristGroup && ($line = 27, 
                $out += $escape(result.touristGroup.adultCount), $line = 27), $out += '</span>大<span class="F-float F-count">', 
                $line = 27, null != result.touristGroup && ($line = 27, $out += $escape(result.touristGroup.childCount), 
                $line = 27), $out += "</span>小</td> <td> <!-- ", $line = 30, null != result.partnerAgency ? ($out += " --> <!-- ", 
                $line = 31, $out += $escape(result.partnerAgency.travelAgencyName), $out += " --> <!-- ", 
                $line = 32) : ($out += " -->  <!-- ", $line = 34), $out += " --> ", $line = 35, 
                null != result.fromName && ($out += " ", $line = 36, $out += $escape(result.fromName), 
                ...
                $out += $escape(result.fromNumber), $out += ' </td> <td><span class="F-float F-money">', 
                $line = 53, null != result.touristGroup && ($line = 53, $out += $escape(result.touristGroup.transNeedPayAllMoney), 
                $line = 53), $out += '</span></td> <td><span class="F-float F-money">', $line = 54, 
                null != result.touristGroup && ($line = 54, $out += $escape(result.touristGroup.transPayedMoney), 
                $line = 54), $out += '</span></td> <td><span class="F-float F-money">', $line = 55, 
                $out += $escape(result.touristGroup.currentNeedPayMoney), $out += '</span></td> <td class="result-status">', 
                $line = 56, null == result.transName ? ($out += "未使用", $line = 56) : ($line = 56, 
                ...
                0 == result.status && ($out += "btn-transferIn-edit", $line = 62), $out += ' R-right" style="', 
                $line = 62, (1 == result.status || 2 == result.status) && ($out += " color:#bbb; ", 

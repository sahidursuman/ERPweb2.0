/*TMODJS:{"debug":true,"version":410,"md5":"3ba48efc148382246f13f84f44068809"}*/
    ...
    return require("../../../template")("arrange/arrangeTransfer/view/listTransIn", function($data, $filename) {
        try {
            ...
            $line = 20, $each(pager.resultList, function(result) {
                ...
                1 != result.status && ($out += "btn-transferIn-edit", $line = 62), $out += ' R-right" style="', 
                $line = 62, 1 == result.status && ($out += " color:#bbb; ", $line = 62), $out += '" data-right="1180007"> <label class="padding-right20">|</label> 确认 </a> <a data-entity-id="', 
                $line = 66, $out += $escape(result.id), $out += '" class="cursor ', $line = 66, 
                (1 != result.status || 2 != result.status) && ($out += "btn-transferIn-delete", 
                $line = 66), $out += ' R-right" style="', $line = 66, (1 == result.status || 2 == result.status) && ($out += " color:#bbb; ", 

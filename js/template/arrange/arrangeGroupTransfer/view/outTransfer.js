/*TMODJS:{"debug":true,"version":27,"md5":"5729787ab2b3bf6fdc395646eef83481"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeGroupTransfer/view/outTransfer", function($data, $filename) {
        try {
            ...
            return $out += '<div class="row"> <div class="col-xs-12 T-transferTouristMain globalAdd"> <table class="table table-striped table-bordered table-hover T-showHighLight all"> <thead> <tr class="bg-blur"> <th> <label class="pos-rel"> <input type="checkbox" class="ace T-CheckAllBox"> <span class="lbl"></span> </label> </th> <th>收客信息</th>  <th>天数</th> <th>出游日期</th> <th>联系人</th> <th>联系电话</th> <th>人数</th> <th>客源地</th> <th>年龄</th> <th>应付</th> <th>已付</th> <th>填写状态</th> <th>操作</th> </tr> </thead> <tbody class="T-transferTouristGroup"> ', 
            $line = 28, $each(touristGroupJson, function(touristGroup) {
                $out += ' <tr data-value="', $line = 29, $out += $escape(touristGroup.id), $out += '" data-entity-adultCount="', 
                $line = 29, $out += $escape(touristGroup.adultCount), $out += '" data-entity-childCount="', 
                $line = 29, $out += $escape(touristGroup.childCount), $out += '"> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-TransferCheckBox" /> <span class="lbl"></span> </label> </td> <td class="h-touristGroupInfo"> <div> <p> ', 
                $line = 39, touristGroup.orderNumber && ($out += '<span class="h-orderNumber">收客单号：', 
                $line = 39, $out += $escape(touristGroup.orderNumber), $out += "</span>", $line = 39), 
                $out += " ", $line = 40, touristGroup.lineProduct && ($out += ' <span class="h-type"> ', 
                $line = 42, 0 == touristGroup.lineProduct.customerType ? ($out += "散客 ", $line = 43) : 1 == touristGroup.lineProduct.customerType ? ($out += "团体 ", 
                $line = 44) : 2 == group.lineProduct.customerType && ($out += "转客 ", $line = 45), 
                $out += " </span> ", $line = 47), $out += " </p> </div> ", $line = 50, touristGroup.lineProduct && ($out += ' <p class="h-lineName">', 
                $line = 51, $out += $escape(touristGroup.lineProduct.name), $out += "</p> ", $line = 52), 
                $out += " ", $line = 53, touristGroup.partnerAgency && ($out += '<p class="h-agencyName">', 
                $line = 53, $out += $escape(touristGroup.partnerAgency.travelAgencyName), $out += "</p>", 
                $line = 53), $out += " </td> <td> ", $line = 56, touristGroup.lineProduct && ($out += " ", 
                ...
                $line = 62), $out += '</td> <td><span class="T-viewTouristGroup" data-entity-id="', 
                ...
                $line = 66, $out += $escape(touristGroup.transNeedPayAllMoney), $out += '</td> <td class="F-float F-money">', 
                $line = 67, $out += $escape(touristGroup.payedMoney), $out += '</td> <td class="transferFeeStatus">', 
                $line = 68, 1 == touristGroup.transferFeeStatus ? ($out += ' <i class ="ace-icon fa fa-check green"></i> 已填写 ', 
                $line = 71) : ($out += ' <i class ="ace-icon fa fa-times red"></i> 未填写 ', $line = 74), 
                $out += ' </td> <td> <a class="cursor T-editFee"> 填写费用 </a> </td> </tr> ', $line = 82;

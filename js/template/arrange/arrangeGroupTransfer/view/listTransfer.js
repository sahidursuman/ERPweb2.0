/*TMODJS:{"debug":true,"version":71,"md5":"fd05736137db1524801a19adb5a9bc91"}*/
    ...
    return require("../../../template")("arrange/arrangeGroupTransfer/view/listTransfer", function($data, $filename) {
        try {
            ...
            $line = 31, $each(touristGroupList, function(group) {
                ...
                $line = 32, $out += $escape(group.childCount), $out += '> <td><label class="pos-rel"> <input type="checkbox" class="ace T-transferCheckBox T-cheked"> <span class="lbl"></span> </label></td> <td class="h-touristGroupInfo"> <p> ', 

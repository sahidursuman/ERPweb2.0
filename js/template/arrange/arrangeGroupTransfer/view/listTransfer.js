/*TMODJS:{"debug":true,"version":65,"md5":"24cfdb8209104b6ef9f67d7ffcc264bf"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeGroupTransfer/view/listTransfer", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd T-showHighLight"> <colgroup> <col style="width: 45px;"> <col style="width: 300px;"> <col> <col> <col> <col> <col> <col> <col> <col> <col> <col> </colgroup> <thead> <tr class="bg-blur"> <th>选择</th> <th>收客信息</th> <th>线路类型</th> <th>天数</th> <th>出游日期</th> <th>联系人</th> <th>联系电话</th> <th>人数</th> <th>客源地</th> <th>年龄</th> <th>备注</th> <th>操作</th> </tr> </thead> <tbody class="T-arrageTransfer-list"> ', 

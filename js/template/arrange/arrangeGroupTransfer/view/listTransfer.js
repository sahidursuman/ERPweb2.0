/*TMODJS:{"debug":true,"version":142,"md5":"eb9c1d457a9d32ab37524cea67d20910"}*/
    ...
    return require("../../../template")("arrange/arrangeGroupTransfer/view/listTransfer", function($data, $filename) {
        try {
            ...
            $line = 31, $each(touristGroupList, function(group) {
                ...
                $out += "</td> ", $line = 57) : ($out += " <td>-</td> <td>-</td> ", $line = 60), 
                $out += " <td>", $line = 61, $out += $escape(group.adultCount), $out += " 大 ", $line = 61, 
                $out += $escape(group.childCount), $out += "小</td> <td>", $line = 62, $out += $escape(group.areaData), 
                $out += "</td> <td>", $line = 63, $out += $escape(group.ageData), $out += '</td> <td class="T-ctrl-tip" title="', 
                $line = 64, $out += $escape(group.remark), $out += '"><span style="height: 35px">', 
                $line = 64, $out += $escape(group.remark), $out += '</span></td> <td><a class="cursor T-list-view T-action"> 查看 </a></td> </tr> ', 
                $line = 67;
            }), $out += ' </tbody> </table> <div class="text-center clearfix"> <label class="pull-left control-label no-padding-right" style="color:#D2691E; ">已选人数 <span class="T-chosenAdultAndChildCount" style="color:#D2691E;">大人 0 小孩 0 </span></label> <button class="btn btn-sm btn-success T-inner R-right" data-right="1130005" data-type="1"> <i class="ace-icon fa fa-user-plus"></i> 内转 </button> <button class="btn btn-sm btn-primary T-out R-right" data-right="1130003" data-type="2"> <i class="ace-icon fa fa-user-plus"></i> 外转 </button> </div> <div class="row pageMode"> <div class="col-xs-5"> <small>共计 ', 
            $line = 84, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-7"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

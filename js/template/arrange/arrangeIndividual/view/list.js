/*TMODJS:{"debug":true,"version":29,"md5":"c31aeceafed1229e183d33d346bf22f8"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeIndividual/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd T-showHighLight table-fixed"> <colgroup> <col style="width:8%;"></col> <col style="width:175px"></col> <col style="width:20%;"></col> <col style="width:25%;"></col> <col style="width:95px"></col> <col style="width:95px"></col> <col style="width:80px;"></col> <col style="width:15%;"></col> <col style="width:10%;"></col> <col style="width:20%;"></col> <col style="width:25%;"></col> <col style="width:100px;"></col> <col style="width:80px;"></col> <col style="width:25%;"></col> <col style="width:100px;"></col> </colgroup> <thead> <tr class="bg-blur"> <th>选择</th> <th>收客单号</th> <th>客户</th> <th>线路产品</th> <th>线路类型</th> <th>针对客源</th> <th>天数</th> <th>出游日期</th> <th>联系人</th> <th>联系电话</th> <th>人数</th> <th>客源地</th> <th>年龄</th> <th>备注</th> <th>查看</th> </tr> </thead> <tbody class="T-arrageVisitor-list"> ', 
            $line = 39, $each(touristGroupList, function(touristGroupList) {
                ...
                $line = 48, $out += $escape(touristGroupList.orderNumber), $out += "</td> <td>", 
                $line = 49, touristGroupList.partnerAgency && ($line = 49, $out += $escape(touristGroupList.partnerAgency.travelAgencyName), 
                $line = 49), $out += '</td> <td class="T-ctrl-tip" title="', $line = 50, $out += $escape(touristGroupList.lineProduct.name), 
                $out += '"><span style="height: 35px">', $line = 50, $out += $escape(touristGroupList.lineProduct.name), 
                $out += "</span></td> <td>", $line = 51, $out += $escape(touristGroupList.lineProduct.type), 

/*TMODJS:{"debug":true,"version":133,"md5":"10ea8bd2e401571159e95bbb8506e0bb"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeIndividual/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover globalAdd T-showHighLight table-fixed"> <colgroup> <col style="width:6%;"></col> <col style="width:30%"></col> <col style="width:7%;"></col> <col style="width:25%;"></col> <col style="width:12%;"></col> <col style="width:20%;"></col> <col style="width:25%;"></col> <col style="width:100px;"></col> <col style="width:8%;"></col> <col style="width:35%;"></col> <col style="width:100px;"></col> </colgroup> <thead> <tr class="bg-blur"> <th>选择</th> <th>收客信息</th> <th>天数</th> <th>出游日期</th> <th>联系人</th> <th>联系电话</th> <th>人数</th> <th>客源地</th> <th>年龄</th> <th>备注</th> <th>查看</th> </tr> </thead> <tbody class="T-arrageVisitor-list"> ', 
            $line = 31, $each(touristGroupList, function(touristGroupL) {
                ...
                $line = 45, $out += $escape(touristGroupL.orderNumber), $out += '</p> <p class="h-orderNumber">客户：', 

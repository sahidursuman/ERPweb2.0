/*TMODJS:{"debug":true,"version":3,"md5":"3d4a5be1b1ded5142d7cc25998698549"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeIndividual/view/chooseTriPlan", function($data, $filename) {
        try {
            ...
            $line = 2, $out += $escape(searchKey), $out += '" placeholder="请输入线路产品或团号"/>&nbsp; <button class=" btn-sm T-lineProduct-search pull-left search-btn"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> <div class="col-xs-12" style="margin-top:10px"> <table class="table table-striped table-bordered table-hover search-travelLineList-table T-chex-radio"> <thead> <tr> <td>团号</td> <td>线路产品</td> <td>出团日期</td> <td>完团日期</td> <td>导游</td> <td>车牌号</td> <td>团队人数</td> <td>剩余座数</td> <td>状态</td> <td>选择计划</td> </tr> </thead> <tbody class="T-chosenTrip-list">', 
            $line = 24, $each(tripPlanList, function(tripPlanList) {
                ...
                $out += $escape(tripPlanList.bus.licenseNumber), $line = 32), $out += '</td> <td class="F-float F-count"> 大人', 
                $line = 34, $out += $escape(tripPlanList.touristAdultCount), $out += "小孩", $line = 34, 
                $out += $escape(tripPlanList.touristChildCount), $out += '</td> <td class="T-remainSeatCount F-float F-count">', 

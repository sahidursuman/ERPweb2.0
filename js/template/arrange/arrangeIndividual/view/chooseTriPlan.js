/*TMODJS:{"debug":true,"version":6,"md5":"daf076d667eb82183778ce7754b9914b"}*/
    ...
    return require("../../../template")("arrange/arrangeIndividual/view/chooseTriPlan", function($data, $filename) {
        try {
            ...
            $line = 23, $each(tripPlanList, function(tripPlanList) {
                ...
                $out += "小孩", $line = 32, $out += $escape(tripPlanList.touristChildCount), $out += '</td> <td class="T-remainSeatCount">', 

/*TMODJS:{"debug":true,"version":16,"md5":"828a9be9ba1de970de6e568691e0a465"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTravels/view/singleEvaluation", function($data, $filename) {
        try {
            var $utils = this, $helpers = $utils.$helpers, $line = 0, $escape = $utils.$escape, note = $data.note, imgUrl = $data.imgUrl, $string = $utils.$string, noteItem = $data.noteItem, $each = $utils.$each, $out = ($data.like, 
            ...
            $line = 6, $out += $escape(note.id), $out += '" data-type="singleEvaluation"><i class="fa fa-share-alt"></i>分享</a> </div> </div> <div class="row hct-note"> <div class="col-xs-12"> <div class="pull-left cursor T-action T-view-user" data-id="', 
            ...
            $line = 57, $out += $escape($helpers.getNoteItemText(noteItem.itemType)), $out += '</h3> </div> <div class="note-details-list"> <div class="note-details-body"> <div class="note-db-img"> <img src="', 
            $line = 62, $out += $escape(imgUrl + noteItem.itemImage), $out += '"> </div> <div class="note-db-itemText"> ', 
            $line = 65, $out += $string(noteItem.itemText), $out += ' </div> </div> <div class="note-details-footer"> <div class="pull-left note-df-dateTime">', 

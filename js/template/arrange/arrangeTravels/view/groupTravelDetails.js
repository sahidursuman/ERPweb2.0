/*TMODJS:{"debug":true,"version":52,"md5":"8c402a522c8843fe27a7776ceb0a8ca6"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTravels/view/groupTravelDetails", function($data, $filename) {
        try {
            ...
            $data.$index, $data.bus, $data.hotel, $data.noteList, $data.line, "");
            return $out += '<div class="container-fluid globalAdd hct-min-width"> <div class="row hct-top-header"> <div class="col-xs-12"> <span class="fa fa-ellipsis-v" style="color: #e2b058;"></span> <label class="control-label mar-l-10">', 
            $line = 5, $out += $escape(note.title), $out += '</label> <a class="hct-top-share T-action T-share" data-id="', 
            $line = 6, $out += $escape(note.id), $out += '" data-type="groupTravel"><i class="fa fa-share-alt"></i>分享</a> </div> </div> <div class="row hct-note"> <div class="col-xs-12"> <div class="pull-left cursor T-action T-view-user" data-id="', 
            ...
            $line = 22, $out += $escape(note.updateTime), $out += '</label> <label class="control-label mar-l-10">出游天数：', 
            ...
            $line = 48, $each(tripPLanDayList, function(rs) {
                ...
                $line = 56, rs.traficItemList.length > 0 && ($out += ' <div class="note-details-item"> <div class="note-details-header"> <h3>交通</h3> </div> ', 
                $line = 61, $each(rs.traficItemList, function(bus) {
                    $out += ' <div class="note-details-list"> <div class="note-details-body"> <div class="note-db-img"> <img src="', 
                    $line = 65, $out += $escape(imgUrl + bus.itemImage), $out += '"> </div> <div class="note-db-itemText"> ', 
                    $line = 68, $out += $string(bus.itemText), $out += ' </div> </div> <div class="note-details-footer"> <div class="pull-left note-df-dateTime">', 
                    $line = 72, $out += $escape(bus.createTime), $out += '</div> <div class="pull-right comment-info"> <label class="control-label"><i class="fa fa-heart"></i>', 
                    $line = 74, $out += $escape(bus.likeCount), $out += '</label> <label class="control-label mar-l-10 cursor T-action T-single-comment" data-id="', 
                    $line = 75, $out += $escape(bus.id), $out += '"><i class="fa fa-comment"></i>', 
                    $line = 75, $out += $escape(bus.commentCount), $out += "</label> </div> </div> </div> ", 
                    $line = 79;
                }), $out += " </div> ", $line = 81), $out += " ", $line = 83, rs.hotelItemList.length > 0 && ($out += ' <div class="note-details-item"> <div class="note-details-header"> <h3>住宿</h3> </div> ', 
                $line = 88, $each(rs.hotelItemList, function(hotel) {
                    $out += ' <div class="note-details-list"> <div class="note-details-body"> <div class="note-db-img"> <img src="', 
                    $line = 92, $out += $escape(imgUrl + hotel.itemImage), $out += '"> </div> <div class="note-db-itemText"> ', 
                    $line = 95, $out += $string(hotel.itemText), $out += ' </div> </div> <div class="note-details-footer"> <div class="pull-left note-df-dateTime">', 
                    $line = 99, $out += $escape(hotel.createTime), $out += '</div> <div class="pull-right comment-info"> <label class="control-label"><i class="fa fa-heart"></i>', 
                    $line = 101, $out += $escape(hotel.likeCount), $out += '</label> <label class="control-label mar-l-10 cursor T-action T-single-comment" data-id="', 
                    $line = 102, $out += $escape(hotel.id), $out += '"><i class="fa fa-comment"></i>', 
                    $line = 102, $out += $escape(hotel.commentCount), $out += "</label> </div> </div> </div> ", 
                    $line = 106;
                }), $out += " </div> ", $line = 108), $out += " ", $line = 110, rs.noteItemList.length > 0 && ($out += ' <div class="note-details-item"> <div class="note-details-header"> <h3>笔记</h3> </div> ', 
                $line = 115, $each(rs.noteItemList, function(noteList) {
                    $out += ' <div class="note-details-list"> <div class="note-details-body"> <div class="note-db-img"> <img src="', 
                    $line = 119, $out += $escape(imgUrl + noteList.itemImage), $out += '"> </div> <div class="note-db-itemText"> ', 
                    $line = 122, $out += $string(noteList.itemText), $out += ' </div> </div> <div class="note-details-footer"> <div class="pull-left note-df-dateTime">', 
                    $line = 126, $out += $escape(noteList.createTime), $out += '</div> <div class="pull-right comment-info"> <label class="control-label"><i class="fa fa-heart"></i>', 
                    $line = 128, $out += $escape(noteList.likeCount), $out += '</label> <label class="control-label mar-l-10 cursor T-action T-single-comment" data-id="', 
                    $line = 129, $out += $escape(noteList.id), $out += '"><i class="fa fa-comment"></i>', 
                    $line = 129, $out += $escape(noteList.commentCount), $out += "</label> </div> </div> </div> ", 
                    $line = 133;
                }), $out += " </div> ", $line = 135), $out += " ", $line = 137, rs.lineItemList.length > 0 && ($out += ' <div class="note-details-item"> <div class="note-details-header"> <h3>线路简介</h3> </div> ', 
                $line = 142, $each(rs.lineItemList, function(line) {
                    $out += ' <div class="note-details-list"> <div class="note-details-body"> <div class="note-db-img"> <img src="', 
                    $line = 146, $out += $escape(imgUrl + line.itemImage), $out += '"> </div> <div class="note-db-itemText"> ', 
                    $line = 149, $out += $string(line.itemText), $out += ' </div> </div> <div class="note-details-footer"> <div class="pull-left note-df-dateTime">', 
                    $line = 153, $out += $escape(line.createTime), $out += '</div> <div class="pull-right comment-info"> <label class="control-label"><i class="fa fa-heart"></i>', 
                    $line = 155, $out += $escape(line.likeCount), $out += '</label> <label class="control-label mar-l-10 cursor T-action T-single-comment" data-id="', 
                    $line = 156, $out += $escape(line.id), $out += '"><i class="fa fa-comment"></i>', 
                    $line = 156, $out += $escape(line.commentCount), $out += "</label> </div> </div> </div> ", 
                    $line = 160;
                }), $out += " </div> ", $line = 162), $out += " </div> </div> ", $line = 165;

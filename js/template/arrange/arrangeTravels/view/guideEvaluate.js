/*TMODJS:{"debug":true,"version":35,"md5":"8d7a470ed5882c6c1ccd7b6341f6c90b"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTravels/view/guideEvaluate", function($data, $filename) {
        try {
            var $utils = this, $helpers = $utils.$helpers, $line = 0, $escape = $utils.$escape, note = $data.note, imgUrl = $data.imgUrl, $string = $utils.$string, $each = $utils.$each, guideServiceStandardCommentList = $data.guideServiceStandardCommentList, $out = ($data.rs, 
            $data.$index, "");
            ...
            $line = 6, $out += $escape(note.id), $out += '" data-type="guideEvaluate"><i class="fa fa-share-alt"></i>分享</a> </div> </div> <div class="row hct-note"> <div class="col-xs-12"> <div class="pull-left"> <div class="caption-user-header pull-left', 
            ...
            $line = 42, $out += $escape(note.viewCount), $out += '</label> </p> </div> </div> </div> <div class="comment-container"> <div class="note-db-img"> <img src="', 
            $line = 49, $out += $escape(imgUrl + note.coverImage), $out += '" alt="', $line = 49, 
            $out += $escape(note.title), $out += '"> </div> </div> <div class="comment-content"> <div class="comment-cont-head"> 收到的评论 ', 
            $line = 54, $out += $escape(note.commentCount), $out += ' </div> <div class="comment-cont-body"> ', 

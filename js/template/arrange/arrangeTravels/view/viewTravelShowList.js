/*TMODJS:{"debug":true,"version":43,"md5":"95170d58321a7f0611c01250cbe1fd24"}*/
    ...
    return require("../../../template")("arrange/arrangeTravels/view/viewTravelShowList", function($data, $filename) {
        try {
            ...
            $line = 15, $each(noteList, function(rs) {
                ...
                $line = 18, $out += $escape(imgUrl + rs.coverImage), $out += '" alt="', $line = 18, 
                $out += $escape(rs.title), $out += '"> <div class="caption"> <h3 class="cursor T-action T-view-group">', 

/*TMODJS:{"debug":true,"version":19,"md5":"33159654cdac8658c2572584993ade3b"}*/
define(function(require) {
    return require("../../../template")("arrange/arrangeTravels/view/groupEvaluation", function($data, $filename) {
        try {
            ...
            $line = 6, $out += $escape(note.id), $out += '" data-type="groupEvaluation"><i class="fa fa-share-alt"></i>分享</a> </div> </div> <div class="row hct-note"> <div class="col-xs-12"> <div class="pull-left cursor T-action T-view-user" data-id="', 
            ...
            $out += $escape(note.title), $out += '"> </div> </div> <div class="praise-content"> <div class="praise-cont-head"> 收到的赞 ', 

/*TMODJS:{"debug":true,"version":73,"md5":"031febe6f1626aaaed85af114b2cbf13"}*/
define(function(require) {
    return require("../../../template")("resource/lineProduct/view/shopList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">商家名称</th> <th class="th-border">商品列表</th> <th class="th-border">操作</th> </tr> </thead> <tbody> ', 

/*TMODJS:{"debug":true,"version":100,"md5":"71257d215ed5ce1bfe225972cb5bb529"}*/
define(function(require) {
    return require("../../../template")("resource/lineProduct/view/selfPayList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">商家名称</th> <th class="th-border">自费项目</th> <th class="th-border">操作</th> </tr> </thead> <tbody> ', 

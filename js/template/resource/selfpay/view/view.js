/*TMODJS:{"debug":true,"version":289,"md5":"2f7a0ce2802f31ab89bae05153414e71"}*/
    ...
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 70, $each(selfpay.selfPayItemList, function(shopPolicy) {
                ...
                }), $out += " </td> <td> ", $line = 100, $out += $escape(shopPolicy.customerRebateMoney), 
                $out += "<br> ", $line = 101, $each(shopPolicy.SelfPayRebateList, function(customer) {
                    $out += " ", $line = 102, $out += $escape(customer.customerRebateMoney), $out += "<br> ", 
                    $line = 103;
                }), $out += ' </td> <td class="no-padding"> ', $line = 107, $out += $escape(shopPolicy.normalMarketPrice), 
                $out += "<br> ", $line = 108, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += " ", $line = 109, $out += $escape(hopTimeArea.marketPrice), $out += "<br> ", 
                    $line = 110;
                }), $out += ' </td> <td class="no-padding"> <label class="col-sm-12 control-label center"> ', 
                $line = 114, $out += $escape($helpers.toFixed(100 * shopPolicy.normalGuideRate)), 
                $out += " </label> ", $line = 116, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += ' <label class="col-sm-12 control-label center"> ', $line = 118, $out += $escape($helpers.toFixed(100 * hopTimeArea.guideRate)), 
                    $out += " </label> ", $line = 120;
                }), $out += ' </td> <td class="no-padding"> <label class="col-sm-12 control-label center"> ', 
                $line = 124, $out += $escape($helpers.toFixed(100 * shopPolicy.normalTravelAgencyRate)), 
                $out += " </label> ", $line = 126, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += ' <label class="col-sm-12 control-label center"> ', $line = 128, $out += $escape($helpers.toFixed(100 * hopTimeArea.travelAgencyRate)), 
                    $out += " </label> ", $line = 130;
                }), $out += ' </td> <td class="remarkWidth">', $line = 132, $out += $escape(shopPolicy.remark), 
                $out += "</td> </tr> ", $line = 134;

/*TMODJS:{"debug":true,"version":306,"md5":"dd2189246de9e4575e832313aea44d71"}*/
define(function(require) {
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 48, $out += $escape(selfpay.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo tableWidthImp"> <tr> <td colspan="9" class="HeadManage" style="text-align: left">项目价格列表</td> </tr> <tr> <td class="style-myself">项目名称</td> <td class="style-myself hidden">针对客源</td> <td class="style-myself">时间范围</td> <td class="style-myself">市场价格（元）</td> <td class="style-myself">人数返佣（人/元）</td> <td class="style-myself">内部价格（元）</td> <td class="style-myself">导佣比例(%)</td> <td class="style-myself">社佣比例(%)</td> <td>备注</td> </tr> ', 
            $line = 68, $each(selfpay.selfPayItemList, function(shopPolicy) {
                $out += ' <tr data-entity-id="', $line = 69, $out += $escape(shopPolicy.id), $out += '"> <td> ', 
                $line = 71, $out += $escape(shopPolicy.name), $out += ' </td> <td class="hidden"> ', 
                $line = 74, 0 == shopPolicy.customerType ? ($out += " 散客 ", $line = 76) : ($out += " 团体 ", 
                $line = 78), $out += ' </td> <td class="rangeTimeWidth" > <div> 日常价格 </div> ', $line = 84, 

/*TMODJS:{"debug":true,"version":217,"md5":"ac9e0416b592e3b10007fdfe85fc33fb"}*/
define(function(require) {
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 50, $out += $escape(selfpay.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">商品列表</td> </tr> <tr> <td class="style-myself">商品名称</td> <td class="style-myself">针对客源</td> <td class="style-myself">时间范围</td> <td class="style-myself">内部价格与市场价格</td> <td class="style-myself">导佣比例(%)</td> <td class="style-myself">社佣比例(%)</td> <td>备注</td> </tr> ', 
            $line = 68, $each(selfpay.selfPayItemList, function(shopPolicy) {
                ...
                $out += ' </td> <td class="rangeTimeWidth" > ', $line = 81, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += " <div> ", $line = 83, $out += $escape($helpers.dateFormat(hopTimeArea.startTime, "yyyy-MM-dd")), 
                    $out += "至", $line = 83, $out += $escape($helpers.dateFormat(hopTimeArea.endTime, "yyyy-MM-dd")), 
                    $out += " </div> ", $line = 85;
                }), $out += ' </td> <td class="no-padding"> ', $line = 88, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += " ", $line = 92, $out += $escape(hopTimeArea.price), $out += "至", $line = 92, 
                    $out += $escape(hopTimeArea.marketPrice), $out += "<br> ", $line = 95;
                }), $out += ' </td> <td class="no-padding"> ', $line = 98, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea, i) {
                    $out += ' <!-- <div class="col-sm-12', $line = 99, 0 != i && ($out += " border-top", 
                    $line = 99), $out += '" > --> <label class="col-sm-12 control-label center"> ', 
                    $line = 102, $out += $escape($helpers.toFixed(100 * hopTimeArea.guideRate)), $out += " </label>  ", 
                    $line = 106;
                }), $out += ' </td> <td class="no-padding"> ', $line = 109, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea, i) {
                    $out += ' <!-- <div class="col-sm-12', $line = 110, 0 != i && ($out += " border-top", 
                    $line = 110), $out += '" > --> <label class="col-sm-12 control-label center"> ', 
                    $line = 113, $out += $escape($helpers.toFixed(100 * hopTimeArea.travelAgencyRate)), 
                    $out += " </label>  ", $line = 117;
                }), $out += ' </td> <td class="remarkWidth">', $line = 119, $out += $escape(shopPolicy.remark), 
                $out += "</td> </tr> ", $line = 121;

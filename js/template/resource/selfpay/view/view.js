/*TMODJS:{"debug":true,"version":187,"md5":"fb7f3247945816cc168a2d9666e86697"}*/
define(function(require) {
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 27, $out += $escape(selfpay.faxNumber), $out += '</td> </tr> <tr> <td class="style-myself style-myselfOne">人数返佣(元/人)：</td> <td class="styleOne-self">', 
            $line = 31, $out += $escape(selfpay.customerRebateMoney), $out += '</td> <td class="style-myself style-myselfOne">停车返佣(辆/人)：</td> <td class="styleOne-self">', 
            ...
            $line = 71, $each(selfpay.selfPayItemList, function(shopPolicy) {
                ...
                $out += ' </td> <td class="rangeTimeWidth" > ', $line = 84, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    ...
                    $line = 102), $out += '" style="padding-bottom: 7px;"> <label class="col-sm-12 control-label center"> ', 
                    $line = 105, $out += $escape($helpers.toFixed(100 * hopTimeArea.guideRate)), $out += " </label> </div> ", 
                    $line = 109;
                    ...
                    $line = 113), $out += '" style="padding-bottom: 7px;"> <label class="col-sm-12 control-label center"> ', 
                    $line = 116, $out += $escape($helpers.toFixed(100 * hopTimeArea.travelAgencyRate)), 
                    $out += " </label> </div> ", $line = 120;

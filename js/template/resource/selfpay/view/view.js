/*TMODJS:{"debug":true,"version":173,"md5":"8233df89bf71ffd5f86a479b955d39f4"}*/
define(function(require) {
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 71, $each(selfpay.shopPolicyList, function(shopPolicy) {
                ...
                $out += ' </td> <td class="rangeTimeWidth" > ', $line = 84, $each(shopPolicy.shopTimeAreaList, function(hopTimeArea) {
                    ...
                    $out += " ", $line = 93, $each(hopTimeArea.shopCostRebateList, function(shopCostRebate) {
                        ...
                        $line = 95, $out += $escape(shopCostRebate.costMoneyEnd), $out += "<br> ", $line = 97;
                    }), $out += " ", $line = 99;

/*TMODJS:{"debug":true,"version":299,"md5":"e9734f2a417dbdefd8bac0bead40f6ab"}*/
define(function(require) {
    return require("../../../template")("resource/selfpay/view/view", function($data, $filename) {
        try {
            ...
            $line = 48, $out += $escape(selfpay.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo tableWidthImp"> <tr> <td colspan="9" class="HeadManage" style="text-align: left">商品列表</td> </tr> <tr> <td class="style-myself">商品名称</td> <td class="style-myself">针对客源</td> <td class="style-myself">时间范围</td> <td class="style-myself">市场价格（元）</td> <td class="style-myself">人数返佣（人/元）</td> <td class="style-myself">内部价格（元）</td> <td class="style-myself">导佣比例(%)</td> <td class="style-myself">社佣比例(%)</td> <td>备注</td> </tr> ', 
            $line = 68, $each(selfpay.selfPayItemList, function(shopPolicy) {
                ...
                $out += ' </td> <td class="rangeTimeWidth" > <div> 日常价格 </div> ', $line = 84, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    ...
                    $out += " </div> ", $line = 88;
                }), $out += ' </td> <td class="no-padding"> ', $line = 93, $out += $escape(shopPolicy.normalMarketPrice), 
                $out += "<br> ", $line = 94, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += " ", $line = 95, $out += $escape(hopTimeArea.marketPrice), $out += "<br> ", 
                    $line = 96;
                }), $out += " </td> <td> ", $line = 101, $out += $escape(shopPolicy.customerRebateMoney), 
                $out += "<br> ", $line = 102, $each(shopPolicy.SelfPayRebateList, function(customer) {
                    $out += " ", $line = 103, $out += $escape(customer.customerRebateMoney), $out += "<br> ", 
                    $line = 104;
                }), $out += ' </td> <td class="no-padding"> ', $line = 108, $out += $escape(shopPolicy.normalInnerPrice), 
                $out += "<br> ", $line = 109, $each(shopPolicy.SelfPayRebateList, function(hopTimeArea) {
                    $out += " ", $line = 110, $out += $escape(hopTimeArea.price), $out += "<br> ", $line = 111;

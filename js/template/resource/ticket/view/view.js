/*TMODJS:{"debug":true,"version":84,"md5":"b271c69ec07543a172bcd3411db042c3"}*/
define(function(require) {
    return require("../../../template")("resource/ticket/view/view", function($data, $filename) {
        try {
            ...
            $out += " ", $line = 38), $out += '</td> </tr> <tr> <td class="style-myself">所在地区：</td> <td class="styleOne-self" colspan="3">', 

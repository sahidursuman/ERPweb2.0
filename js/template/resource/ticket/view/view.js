/*TMODJS:{"debug":true,"version":73,"md5":"293b77ecc9427ec544ff5e93688686c1"}*/
define(function(require) {
    return require("../../../template")("resource/ticket/view/view", function($data, $filename) {
        try {
            ...
            return $out += ' <form class="form-horizontal ticketMainForm" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ" style="width: 96%"> <tr> <td class="style-myself">票务公司名称：</td> <td class="styleOne-self">', 
            ...
            $line = 25, $out += $escape(ticket.faxNumber), $out += '</td> </tr> <tr> <td class="style-myself style-myselfOne">票务公司所在省市：</td> <td class="styleOne-self" colspan="3">', 

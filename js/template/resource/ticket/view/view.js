/*TMODJS:{"debug":true,"version":71,"md5":"7b74a5e4343c86f7981c8be23dee7643"}*/
define(function(require) {
    return require("../../../template")("resource/ticket/view/view", function($data, $filename) {
        try {
            ...
            return $out += ' <form class="form-horizontal ticketMainForm" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereOne"> <tr> <td class="style-myself">票务公司名称：</td> <td class="styleOne-self">', 

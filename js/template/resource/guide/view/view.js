/*TMODJS:{"debug":true,"version":190,"md5":"c507dd2bc8e5eb515d28d4483c5567fc"}*/
define(function(require) {
    return require("../../../template")("resource/guide/view/view", function($data, $filename) {
        try {
            ...
            $line = 15, $out += $escape(guide.mobileNumber), $out += '</td> <td class="style-myself">所属导服司：</td> <td class="styleOne-self">', 
            $line = 17, $out += $escape(guide.company), $out += '</td> </tr> <tr> <td class="style-myself">导游证号：</td> <td class="styleOne-self">', 
            $line = 21, $out += $escape(guide.guideCardNumber), $out += '</td> <td class="style-myself">身份证号：</td> <td class="styleOne-self">', 
            $line = 23, $out += $escape(guide.idCardNumber), $out += '</td> </tr> <tr> <td class="style-myself">级别：</td> <td class="styleOne-self">', 
            ...
            $out += '</td> <td class="style-myself">是否启用：</td> <td class="styleOne-self">', 
            $line = 61, 0 == guide.status ? ($out += " 已停用 ", $line = 63) : ($out += " 已启用 ", 
            $line = 65), $out += '</td> </tr> <tr> <td class="style-myself">简介：</td> <td colspan="3" class="styleOne-self"> ', 
            $line = 69, $out += $escape(guide.remark), $out += '</td> </tr> </table> <div class="space-10"></div> </form>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":76,"md5":"f7d2d91c73a4b5c9a283065087f88199"}*/
define(function(require) {
    return require("../../../template")("resource/travelLine/view/scenicItem", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">景区名称</th> <th class="th-border">收费项目</th> <th class="th-border">操作</th> </tr> </thead> <tbody class="T-scenic-list"> ', 

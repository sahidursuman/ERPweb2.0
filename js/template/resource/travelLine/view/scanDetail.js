/*TMODJS:{"debug":true,"version":273,"md5":"6433cdad3b7a8f63eb6ed88bfb90a03d"}*/
    ...
    return require("../../../template")("resource/travelLine/view/scanDetail", function($data, $filename) {
        try {
            ...
            $line = 48, $each(travelLine.travelLineDayList, function(line) {
                ...
                $out += "天</td> <td>", $line = 51, $out += $escape($helpers.getRepastDetail(line.repastDetail)), 
                ...
                $line = 57, $out += $string($helpers.decode(line.detail)), $out += "</td> </tr> ", 
                $line = 59;
            ...
            $line = 88, $out += $escape(travelLine.remark), $out += '</td> </tr> </tbody> </table> <div class="text-center"> <button class="btn btn-xs w100 T-btn-viewCancel"> <i class="ace-icon fa fa-times"></i> 关闭 </button> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

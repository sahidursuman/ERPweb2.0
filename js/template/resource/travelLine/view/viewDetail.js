/*TMODJS:{"debug":true,"version":98,"md5":"3af6b870e426501b604dc7d42e7777c2"}*/
define(function(require) {
    return require("../../../template")("resource/travelLine/view/viewDetail", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12"> <form class="form-horizontal travelLineDayForm" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ" style="width: 96%"> <tr> <td colspan="4" class="HeadManage">行程安排主体信息</td> </tr> <tr> <td class="style-myself">日期：</td> <td class="styleOne-self">第', 

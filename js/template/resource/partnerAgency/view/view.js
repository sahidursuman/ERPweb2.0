/*TMODJS:{"debug":true,"version":85,"md5":"bfc2e5a150e4eda8c5341e68fd5e7def"}*/
define(function(require) {
    return require("../../../template")("resource/partnerAgency/view/view", function($data, $filename) {
        try {
            ...
            $data.$index, "");
            return $out += '<div class="col-xs-12"> <form class="form-horizontal PartnerAgencyDetailForm" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo" style="width: 98%"> <tr> <td colspan="4" class="HeadManage" style="text-align: left">同行旅行社主体信息</td> </tr> <tr> <td class="style-myself">同行名称</td> <td style="text-align: left;padding: 0px 0px 0px 10px">', 

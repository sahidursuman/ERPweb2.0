/*TMODJS:{"debug":true,"version":25,"md5":"63bfe246baf471e27b24125fb5f2deb6"}*/
define(function(require) {
    return require("../../../template")("resource/serviceStandards/view/update", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12 T-service-container"> <form class="form-horizontal T-mainForm" role="form" style="margin-top:10px" onsubmit="return false"> <div class="form-group guideInterval"> <label class="col-sm-2 control-label no-padding-right"><span class="necessary">*</span>服务标准:</label> <div class="col-sm-4"> <input type="text" name="serviceName" value="', 
            $line = 6, $out += $escape(gssTemplate.serviceTitle), $out += '" class="col-sm-12" maxlength="32"/> <input type="hidden" name="serviceId" value="', 
            $line = 7, $out += $escape(gssTemplate.id), $out += '" class="col-sm-12" maxlength="32"/> </div> <label class="col-sm-2 control-label no-padding-right">是否启用:</label> <div class="col-sm-3 checkbox" style="margin-left:-10px;margin-top: -6px"> <label> <input ', 
            $line = 12, 1 == gssTemplate.status && ($out += 'checked ="checked" ', $line = 12), 
            $out += ' type="checkbox" class="ace T-checkStatus" value="1" /> <span class="lbl"> 启用 </span> </label> </div> </div> <div class="form-group guideInterval"> <label class="col-sm-2 control-label no-padding-right"><span class="necessary">*</span>服务内容:</label> <div class="col-sm-9"> <textarea class="form-control" name="serviceContent" class="col-sm-12" maxlength="1000">', 
            $line = 22, $out += $escape(gssTemplate.serviceContent), $out += '</textarea> </div> </div> <div class="form-group guideInterval"> <label class="col-sm-2 control-label no-padding-right"><span class="necessary">*</span>服务要求:</label> <div class="col-sm-9"> <textarea class="form-control" name="serviceRequire" class="col-sm-12" maxlength="1000">', 

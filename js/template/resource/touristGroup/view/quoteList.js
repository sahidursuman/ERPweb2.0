/*TMODJS:{"debug":true,"version":248,"md5":"a7c39cc569d0123ed6dd96dba2597c5b"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 23, $out += $escape(lineProduct.createTime), $out += "' data-days='", $line = 24, 
                ...
                $out += "' > <td> ", $line = 31, $out += $escape(lineProduct.quoteNumber), $out += " </td> <td>", 
                $line = 33, null != lineProduct.lineProduct && ($line = 33, $out += $escape(lineProduct.lineProduct.name), 
                $line = 33), $out += "</td> <td>", $line = 35, null != lineProduct.lineProduct && ($line = 35, 
                $out += $escape(lineProduct.lineProduct.type), $line = 35), $out += "</td> <td> ", 
                $line = 37, null != lineProduct.lineProduct && ($out += " ", $line = 38, 0 == lineProduct.lineProduct.customerType ? ($out += " 散客 ", 
                $line = 40) : ($out += " 团体 ", $line = 42), $out += " ", $line = 43), $out += ' </td> <td><span class="F-float F-count">', 
                $line = 46, $out += $escape(lineProduct.adultCount), $out += '</span> 大 <span class="F-float F-count">', 
                $line = 46, $out += $escape(lineProduct.childCount), $out += '</span> 小</td> <td><span class="F-float F-count">', 
                $line = 47, null != lineProduct.lineProduct && ($line = 47, $out += $escape(lineProduct.lineProduct.days), 
                $line = 47), $out += "</span></td> <td>", $line = 48, $out += $escape(lineProduct.createTime), 
                $out += "</td> <td>", $line = 50, null != lineProduct.partnerAgency && ($line = 50, 
                $out += $escape(lineProduct.partnerAgency.travelAgencyName), $line = 50), $out += "</td> <td>", 
                $line = 51, null != lineProduct.partnerAgencyContact && ($line = 51, $out += $escape(lineProduct.partnerAgencyContact.contactRealname), 
                $line = 51), $out += "</td> <td>", $line = 52, $out += $escape($helpers.dateFormat(lineProduct.startTime, "yyyy-MM-dd")), 
            ...
            $line = 62, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

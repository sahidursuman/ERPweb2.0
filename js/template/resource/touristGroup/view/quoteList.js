/*TMODJS:{"debug":true,"version":168,"md5":"93c655f65939de58f2ea5c853cdd08fa"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $out += $escape(lineProduct.partnerAgencyContact.id), $out += "' data-adultCount='", 
                $line = 26, $out += $escape(lineProduct.adultCount), $out += "' data-adultPrice='2' data-childCount='", 
                $line = 26, $out += $escape(lineProduct.childCount), $out += "' data-childPrice='2' > <td> ", 
                $line = 28, $out += $escape(lineProduct.quoteNumber), $out += " </td> <td>", $line = 30, 
                $out += $escape(lineProduct.lineProduct.name), $out += "</td> <td>", $line = 32, 
                $out += $escape(lineProduct.lineProduct.type), $out += "</td> <td> ", $line = 34, 
                null != lineProduct.lineProduct && ($out += " ", $line = 35, 0 == lineProduct.lineProduct.customerType ? ($out += " 散客 ", 
                $line = 37) : ($out += " 团体 ", $line = 39), $out += " ", $line = 40), $out += " </td> <td>", 
                $line = 43, $out += $escape(lineProduct.adultCount), $out += " 大 ", $line = 43, 
                $out += $escape(lineProduct.childCount), $out += " 小</td> <td>", $line = 44, $out += $escape(lineProduct.lineProduct.days), 
                $out += "</td> <td>", $line = 45, $out += $escape(lineProduct.createTime), $out += "</td> <td>", 
                $line = 47, $out += $escape(lineProduct.partnerAgency.travelAgencyName), $out += "</td> <td>", 
                $line = 48, $out += $escape(lineProduct.partnerAgencyContact.contactRealname), $out += "</td> <td>", 
                $line = 49, $out += $escape(lineProduct.startTime), $out += '</td> <td> <label class="pos-rel"> <input type="radio" class="ace T-cheked" name="form-field-radio"> <span class="lbl"></span> </label> </td> </tr> ', 
                $line = 54;

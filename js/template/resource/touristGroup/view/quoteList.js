/*TMODJS:{"debug":true,"version":228,"md5":"2e52f856b701bee224a9b9e79239e341"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 23, $out += $escape(lineProduct.createTime), $out += "' data-fromPartnerAgencyId='", 
                $line = 24, null != lineProduct.partnerAgency && ($line = 24, $out += $escape(lineProduct.partnerAgency.id), 
                $line = 24), $out += "' data-fromPartnerAgencyName='", $line = 25, null != lineProduct.partnerAgency && ($line = 25, 
                $out += $escape(lineProduct.partnerAgency.travelAgencyName), $line = 25), $out += "' data-partnerAgencyContactName ='", 
                $line = 26, null != lineProduct.partnerAgencyContact && ($line = 26, $out += $escape(lineProduct.partnerAgencyContact.contactRealname), 
                $out += "-[", $line = 26, $out += $escape(lineProduct.partnerAgencyContact.contactMobileNumber), 
                $out += "]", $line = 26), $out += "' data-partnerAgencyContactId = '", $line = 27, 
                null != lineProduct.partnerAgencyContact && ($line = 27, $out += $escape(lineProduct.partnerAgencyContact.id), 
                $line = 27), $out += "' data-adultCount='", $line = 28, $out += $escape(lineProduct.adultCount), 
                $out += "' data-adultPrice='", $line = 28, $out += $escape(lineProduct.adultQuotePrice), 
                $out += "' data-childCount='", $line = 28, $out += $escape(lineProduct.childCount), 
                $out += "' data-childPrice='", $line = 28, $out += $escape(lineProduct.childQuotePrice), 
                $out += "' > <td> ", $line = 30, $out += $escape(lineProduct.quoteNumber), $out += " </td> <td>", 
                $line = 32, null != lineProduct.lineProduct && ($line = 32, $out += $escape(lineProduct.lineProduct.name), 
                $line = 32), $out += "</td> <td>", $line = 34, null != lineProduct.lineProduct && ($line = 34, 
                $out += $escape(lineProduct.lineProduct.type), $line = 34), $out += "</td> <td> ", 
                $line = 36, null != lineProduct.lineProduct && ($out += " ", $line = 37, 0 == lineProduct.lineProduct.customerType ? ($out += " 散客 ", 
                $line = 39) : ($out += " 团体 ", $line = 41), $out += " ", $line = 42), $out += " </td> <td>", 
                $line = 45, $out += $escape(lineProduct.adultCount), $out += " 大 ", $line = 45, 
                $out += $escape(lineProduct.childCount), $out += " 小</td> <td>", $line = 46, null != lineProduct.lineProduct && ($line = 46, 
                $out += $escape(lineProduct.lineProduct.days), $line = 46), $out += "</td> <td>", 
                $line = 47, $out += $escape(lineProduct.createTime), $out += "</td> <td>", $line = 49, 
                null != lineProduct.partnerAgency && ($line = 49, $out += $escape(lineProduct.partnerAgency.travelAgencyName), 
                $line = 49), $out += "</td> <td>", $line = 50, null != lineProduct.partnerAgencyContact && ($line = 50, 
                $out += $escape(lineProduct.partnerAgencyContact.contactRealname), $line = 50), 
                $out += "</td> <td>", $line = 51, $out += $escape(lineProduct.startTime), $out += '</td> <td> <label class="pos-rel"> <input type="radio" class="ace T-cheked" name="form-field-radio"> <span class="lbl"></span> </label> </td> </tr> ', 
                $line = 56;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 61, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":236,"md5":"0b69f224603aa672698ab43d1a359d92"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 40) : ($out += " 团体 ", $line = 42), $out += " ", $line = 43), $out += " </td> <td>", 
                $line = 46, $out += $escape(lineProduct.adultCount), $out += " 大 ", $line = 46, 
                $out += $escape(lineProduct.childCount), $out += " 小</td> <td>", $line = 47, null != lineProduct.lineProduct && ($line = 47, 
                $out += $escape(lineProduct.lineProduct.days), $line = 47), $out += "</td> <td>", 
                $line = 48, $out += $escape(lineProduct.createTime), $out += "</td> <td>", $line = 50, 
                null != lineProduct.partnerAgency && ($line = 50, $out += $escape(lineProduct.partnerAgency.travelAgencyName), 
                $line = 50), $out += "</td> <td>", $line = 51, null != lineProduct.partnerAgencyContact && ($line = 51, 
                $out += $escape(lineProduct.partnerAgencyContact.contactRealname), $line = 51), 
                $out += "</td> <td>", $line = 52, $out += $escape(lineProduct.startTime), $out += '</td> <td> <label class="pos-rel"> <input type="radio" class="ace T-cheked" name="form-field-radio"> <span class="lbl"></span> </label> </td> </tr> ', 
                $line = 57;

    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 47), $out += "</span></td> <td>", $line = 48, $out += $escape($helpers.dateFormat(lineProduct.startTime, "yyyy-MM-dd")), 
                ...
                $line = 51), $out += "</td> <td>", $line = 54, $out += $escape(lineProduct.createTime), 

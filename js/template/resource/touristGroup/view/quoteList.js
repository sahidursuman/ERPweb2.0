/*TMODJS:{"debug":true,"version":297,"md5":"de4df69816e83e9ac63dca8e342e3293"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 37, 0 == lineProduct.customerType ? ($out += " 散客 ", $line = 39) : ($out += " 团体 ", 
                $line = 41), $out += ' </td> <td><span class="F-float F-count">', $line = 44, $out += $escape(lineProduct.adultCount), 
                $out += '</span> 大 <span class="F-float F-count">', $line = 44, $out += $escape(lineProduct.childCount), 
                $out += '</span> 小</td> <td><span class="F-float F-count">', $line = 45, null != lineProduct.lineProduct && ($line = 45, 
                $out += $escape(lineProduct.lineProduct.days), $line = 45), $out += "</span></td> <td>", 
                $line = 46, $out += $escape($helpers.dateFormat(lineProduct.startTime, "yyyy-MM-dd")), 
                $out += "</td> <td>", $line = 48, null != lineProduct.partnerAgency && ($line = 48, 
                $out += $escape(lineProduct.partnerAgency.travelAgencyName), $line = 48), $out += "</td> <td>", 
                $line = 49, null != lineProduct.partnerAgencyContact && ($line = 49, $out += $escape(lineProduct.partnerAgencyContact.contactRealname), 
                $line = 49), $out += "</td> <td>", $line = 52, $out += $escape(lineProduct.createTime), 

/*TMODJS:{"debug":true,"version":285,"md5":"a79d7f313ec16e6501f90dba60ab2b7f"}*/
    ...
    return require("../../../template")("resource/touristGroup/view/quoteList", function($data, $filename) {
        try {
            ...
            $line = 19, $each(lineProductList, function(lineProduct) {
                ...
                $line = 47), $out += "</span></td> <td>", $line = 48, $out += $escape(lineProduct.startTime), 
                ...
                $line = 51), $out += "</td> <td>", $line = 54, $out += $escape($helpers.dateFormat(lineProduct.createTime, "yyyy-MM-dd")), 

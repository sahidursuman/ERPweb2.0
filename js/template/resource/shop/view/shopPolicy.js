/*TMODJS:{"debug":true,"version":111,"md5":"989b191f106126e145741040ecf928a8"}*/
        ...
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 44, $out += $escape(cost.costMoneyStart), $out += '" maxlength="6" /> <label>至</label> <input name="costMoneyEnd" type="text" style="width:100px" value="', 
                    $line = 46, $out += $escape(cost.costMoneyEnd), $out += '" maxlength="6" /> <label class="priceArea" style="float:right"> <button data-entity-id="', 

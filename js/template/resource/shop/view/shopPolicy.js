/*TMODJS:{"debug":true,"version":101,"md5":"b9123733c15524a2897e71f2356463d6"}*/
    ...
    return require("../../../template")("resource/shop/view/shopPolicy", function($data, $filename) {
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $out += '" class="clearfix div-', $line = 34, $out += $escape(i + 1), $out += '" style="margin-bottom:3px"> <div> <input name="startTime" type="text" class="date-picker" style="width:100px" value="', 
                $line = 36, $out += $escape(policy.startTime), $out += '"/> <label>&nbsp;至&nbsp;</label> <input name="endTime" type="text" class="date-picker" style="width:100px" value="', 
                $line = 38, $out += $escape(policy.endTime), $out += '"/> </div> </td> <td> ', $line = 42, 
                $each(policy.costMoneyList, function(cost, j) {
                    $out += ' <div data-index="', $line = 43, $out += $escape(j + 1), $out += '" class="clearfix div-', 
                    $line = 43, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="costMoneyStart" type="text" style="width:100px" value="', 
                    $line = 44, $out += $escape(cost.costMoneyStart), $out += '"/> <label>&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" style="width:100px" value="', 
                    $line = 46, $out += $escape(cost.costMoneyEnd), $out += '"/> <label class="priceArea" style="float:right"> <button data-entity-id="', 
                    $line = 48, $out += $escape(cost.id), $out += '" class="btn btn-success btn-sm btn-white ', 
                    ...
                    $line = 57, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="guideRate" type="text" value="', 
                    $line = 58, $out += $escape($helpers.toFixed(100 * cost.guideRate)), $out += '" /> </div> ', 
                    $line = 60;
                    ...
                    $line = 64, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="travelAgencyRate" type="text" value="', 
                    $line = 65, $out += $escape($helpers.toFixed(100 * cost.travelAgencyRate)), $out += '" /> </div> ', 
                    $line = 67;

/*TMODJS:{"debug":true,"version":104,"md5":"8a3020e8b8fa3dca16a5bb2c723fad85"}*/
    ...
    return require("../../../template")("resource/shop/view/shopPolicy", function($data, $filename) {
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $out += '" class="clearfix div-', $line = 34, $out += $escape(i + 1), $out += '" style="margin-bottom:3px"> <div> <input name="startTime" type="text" class="datepicker" style="width:100px" value="', 
                $line = 36, $out += $escape(policy.startTime), $out += '"/> <label>&nbsp;至&nbsp;</label> <input name="endTime" type="text" class="datepicker" style="width:100px" value="', 

/*TMODJS:{"debug":true,"version":111,"md5":"55c7c828e4bb79532ad36433dc1b9816"}*/
        ...
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 43, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="costMoneyStart" type="text" maxlength="6" style="width:100px" value="', 
                    $line = 44, $out += $escape(cost.costMoneyStart), $out += '"/> <label>&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" maxlength="6" style="width:100px" value="', 

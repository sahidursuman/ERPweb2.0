/*TMODJS:{"debug":true,"version":63,"md5":"8d6f158877aeb35c1f5d119b671c74a1"}*/
    ...
    return require("../../../template")("resource/shop/view/updateShopPolicy", function($data, $filename) {
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $line = 34, $out += $escape(i + 1), $out += '" style="margin-bottom:3px"> <div> <input name="startTime" type="text" class="datepicker col-sm-5" value="', 
                ...
                $out += '"/> </div> </td> <td> ', $line = 42, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 43, $out += $escape(j + 1), $out += ' shopPolicyPriceList" style="margin-bottom:3px"> <input name="costMoneyStart" type="text" class="col-sm-4" value="', 

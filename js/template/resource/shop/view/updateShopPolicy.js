/*TMODJS:{"debug":true,"version":50,"md5":"078bfcf780e88774cbd1003234d4b787"}*/
        ...
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $out += '"/> </div> </td> <td> ', $line = 42, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 44, $out += $escape(cost.id), $out += '"/> <label class="col-sm-2 control-label center">&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" class="col-sm-4" value="', 
                    $line = 46, $out += $escape(cost.costMoneyEnd), $out += '"/> <label class="priceArea col-sm-2"> <button data-entity-id="', 

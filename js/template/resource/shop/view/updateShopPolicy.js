/*TMODJS:{"debug":true,"version":79,"md5":"899ecc921591f3d1e62876f90fc1fa3e"}*/
        ...
        try {
            ...
            $line = 26, $each(policyData, function(policy, i) {
                ...
                $out += '"/> </div> </td> <td> ', $line = 36, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 38, $out += $escape(cost.id), $out += '" maxlength="6"/> <label class="col-sm-2 control-label center">&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" class="col-sm-4" value="', 

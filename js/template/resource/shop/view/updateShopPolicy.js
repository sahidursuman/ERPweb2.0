/*TMODJS:{"debug":true,"version":101,"md5":"a3a203fa5c3928dda5c8289130936d12"}*/
        ...
        try {
            ...
            $line = 26, $each(policyData, function(policy, i) {
                ...
                $out += '"/> </div> </td> <td> ', $line = 36, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 38, $out += $escape(cost.id), $out += '" maxlength="9"/> <label>&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" value="', 
                    $line = 40, $out += $escape(cost.costMoneyEnd), $out += '" maxlength="9" style="width:100px" /> <label class="priceArea" style="float:right"> <button data-entity-id="', 

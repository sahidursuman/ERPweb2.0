/*TMODJS:{"debug":true,"version":73,"md5":"6d2c5d395ce5eb982145e5e15cbe3360"}*/
    ...
    return require("../../../template")("resource/shop/view/updateShopPolicy", function($data, $filename) {
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $line = 34, $out += $escape(i + 1), $out += '" style="margin-bottom:2px"> <div> <input name="startTime" type="text" class="datepicker col-sm-5" value="', 
                ...
                $out += '"/> </div> </td> <td> ', $line = 42, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 43, $out += $escape(j + 1), $out += ' shopPolicyPriceList" style="margin-bottom:2px"> <input name="costMoneyStart" type="text" class="col-sm-4" value="', 
                    $line = 44, $out += $escape(cost.costMoneyStart), $out += '" data-entity-id="', 
                    $line = 44, $out += $escape(cost.id), $out += '" maxlength="6"/> <label class="col-sm-2 control-label center">&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" class="col-sm-4" value="', 
                    $line = 46, $out += $escape(cost.costMoneyEnd), $out += '" maxlength="9" /> <label class="priceArea col-sm-2"> <button data-entity-id="', 
                    ...
                    $line = 57, $out += $escape(j + 1), $out += '" style="margin-bottom:7px"> <input name="guideRate" class="col-sm-12" type="text" value="', 
                    $line = 58, $out += $escape($helpers.toFixed(100 * cost.guideRate)), $out += '" maxlength="4"/> </div> ', 
                    $line = 60;
                    ...
                    $line = 64, $out += $escape(j + 1), $out += '" style="margin-bottom:7px"> <input name="travelAgencyRate" class="col-sm-12" type="text" value="', 
                    $line = 65, $out += $escape($helpers.toFixed(100 * cost.travelAgencyRate)), $out += '" maxlength="4"/> </div> ', 
                    $line = 67;

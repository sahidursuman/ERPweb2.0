/*TMODJS:{"debug":true,"version":82,"md5":"0162ae58e0a3e026e3eb00a3002b5525"}*/
    ...
    return require("../../../template")("resource/shop/view/updateShopPolicy", function($data, $filename) {
        try {
            ...
            $line = 26, $each(policyData, function(policy, i) {
                ...
                $line = 28, $out += $escape(i + 1), $out += '" style="margin-bottom:2px"> <div> <input name="startTime" type="text" class="datepicker col-sm-5" value="', 
                ...
                $out += '"/> </div> </td> <td> ', $line = 36, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 37, $out += $escape(j + 1), $out += ' shopPolicyPriceList" style="margin-bottom:2px"> <input name="costMoneyStart" type="text" class="col-sm-4" value="', 
                    $line = 38, $out += $escape(cost.costMoneyStart), $out += '" data-entity-id="', 
                    $line = 38, $out += $escape(cost.id), $out += '" maxlength="9"/> <label class="col-sm-2 control-label center">&nbsp;至&nbsp;</label> <input name="costMoneyEnd" type="text" class="col-sm-4" value="', 
                    $line = 40, $out += $escape(cost.costMoneyEnd), $out += '" maxlength="9" /> <label class="priceArea col-sm-2"> <button data-entity-id="', 
                    $line = 42, $out += $escape(cost.id), $out += '" class="btn ', $line = 42, 0 == j ? ($out += "btn-success", 
                    $line = 42) : ($out += "btn-danger", $line = 42), $out += " btn-sm btn-white ", 
                    $line = 42, 0 == j ? ($out += "add", $line = 42) : ($out += "del", $line = 42), 
                    $out += '"> <i class="ace-icon fa ', $line = 43, 0 == j ? ($out += "fa-plus", $line = 43) : ($out += "fa-minus", 
                    $line = 43), $out += ' bigger-110 icon-only"></i> </button> </label> </div> ', $line = 47;
                    ...
                    $line = 51, $out += $escape(j + 1), $out += '" style="margin-bottom:7px"> <input name="guideRate" class="col-sm-12" type="text" value="', 
                    ...
                    $line = 58, $out += $escape(j + 1), $out += '" style="margin-bottom:7px"> <input name="travelAgencyRate" class="col-sm-12" type="text" value="', 
                ...
                $out += '" class="cursor btn-shop-policy-delete"> 删除 </a> </td> </tr> ', $line = 69;

/*TMODJS:{"debug":true,"version":72,"md5":"503fa3f6a529ad8c365167d97aa8a073"}*/
    ...
    return require("../../../template")("resource/shop/view/updateShopPolicy", function($data, $filename) {
        try {
            ...
            $line = 27, $each(policyData, function(policy, i) {
                ...
                $line = 29, $out += $escape(i + 1), $out += '" style="margin-bottom:3px"> <div> <input name="startTime" type="text" class="datepicker col-sm-5" value="', 
                ...
                $out += '"/> </div> </td> <td> ', $line = 37, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 38, $out += $escape(j + 1), $out += ' shopPolicyPriceList" style="margin-bottom:3px"> <input name="costMoneyStart" type="text" class="col-sm-4" value="', 
                    ...
                    $line = 52, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="guideRate" class="col-sm-12" type="text" value="', 
                    $line = 53, $out += $escape($helpers.toFixed(100 * cost.guideRate)), $out += '" maxlength="4"/> </div> ', 
                    $line = 55;
                    ...
                    $line = 59, $out += $escape(j + 1), $out += '" style="margin-bottom:3px"> <input name="travelAgencyRate" class="col-sm-12" type="text" value="', 
                    $line = 60, $out += $escape($helpers.toFixed(100 * cost.travelAgencyRate)), $out += '" maxlength="4"/> </div> ', 
                    $line = 62;

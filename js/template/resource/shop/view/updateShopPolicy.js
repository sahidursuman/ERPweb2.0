/*TMODJS:{"debug":true,"version":64,"md5":"545380ac0e808333d7706cfb27e9ebc2"}*/
        ...
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $out += '"/> </div> </td> <td> ', $line = 42, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 46, $out += $escape(cost.costMoneyEnd), $out += '" maxlength="6" /> <label class="priceArea col-sm-2"> <button data-entity-id="', 

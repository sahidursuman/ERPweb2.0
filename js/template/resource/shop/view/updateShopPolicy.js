/*TMODJS:{"debug":true,"version":61,"md5":"be2bbb2fea7e811d6c0563c24639f0a1"}*/
        ...
        try {
            ...
            $line = 32, $each(policyData, function(policy, i) {
                ...
                $out += '"/> </div> </td> <td> ', $line = 42, $each(policy.costMoneyList, function(cost, j) {
                    ...
                    $line = 58, $out += $escape($helpers.toFixed(100 * cost.guideRate)), $out += '" maxlength="9"/> </div> ', 
                    $line = 60;
                    ...
                    $line = 65, $out += $escape($helpers.toFixed(100 * cost.travelAgencyRate)), $out += '" maxlength="9"/> </div> ', 
                    $line = 67;

/*TMODJS:{"debug":true,"version":254,"md5":"0fcf296081fbc24efbfea854373be379"}*/
define(function(require) {
    return require("../../../template")("resource/shop/view/view", function($data, $filename) {
        try {
            ...
            $line = 27, $out += $escape(shop.faxNumber), $out += '</td> </tr> <tr> <td class="style-myselfOne">人数返佣(元/人)：</td> <td class="styleOne-self">', 
            $line = 31, $out += $escape(shop.customerRebateMoney), $out += '</td> <td class="style-myselfOne">停车返佣(辆/人)：</td> <td class="styleOne-self">', 
            $line = 33, $out += $escape(shop.parkingRebateMoney), $out += ' </td> </tr> <tr> <td class="style-myself">所在地区</td> <td class="styleOne-self" colspan="3">', 
            ...
            $line = 53, $out += $escape(shop.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">商品列表</td> </tr> <tr> <td class="style-myself">商品名称</td> <td width="100">针对客源</td> <td width="200">时间范围</td> <td width="200">价格区间</td> <td class="style-myself">导佣比例(%)</td> <td class="style-myself">社佣比例(%)</td> <td>备注</td> </tr> ', 
            $line = 71, $each(shop.shopPolicyList, function(shopPolicy) {
                $out += ' <tr data-entity-id="', $line = 72, $out += $escape(shopPolicy.id), $out += '"> <td> ', 
                $line = 74, $out += $escape(shopPolicy.name), $out += ' </td> <td width="100"> ', 
                ...
                $each(shopPolicy.shopTimeAreaList, function(hopTimeArea, i) {
                    ...
                    $line = 94), $out += " price", $line = 94, $out += $escape(i), $out += '" style="padding-bottom: 7px;"> ', 

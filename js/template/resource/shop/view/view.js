/*TMODJS:{"debug":true,"version":267,"md5":"85a7ef4175fdc658d8faa27a36964b1b"}*/
define(function(require) {
    return require("../../../template")("resource/shop/view/view", function($data, $filename) {
        try {
            ...
            $line = 53, $out += $escape(shop.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" id="shopFormCol-x12" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">商品列表</td> </tr> <tr> <td class="style-myself">商品名称</td> <td width="100">针对客源</td> <td width="200">时间范围</td> <td width="200">价格区间</td> <td class="style-myself">导佣比例(%)</td> <td class="style-myself">社佣比例(%)</td> <td>备注</td> </tr> ', 

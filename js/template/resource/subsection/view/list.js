/*TMODJS:{"debug":true,"version":512,"md5":"9e5dd463e481c9741a8521351d160d80"}*/
    ...
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 18, $each(transitSubTgroupList, function(subList, indexA) {
                $out += ' <tr data-entity-id="', $line = 19, $out += $escape(subList.id), $out += '"> <td> <p class="h-lineName"> <span> ', 
                ...
                $line = 24, $out += $escape(subList.childCount), $out += '</span>小</label> </p> <p class="h-memberName">', 

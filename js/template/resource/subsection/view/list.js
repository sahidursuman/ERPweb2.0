/*TMODJS:{"debug":true,"version":446,"md5":"7b678c0d54c55041256cb7f53dd2a2b2"}*/
    ...
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $line = 44, $out += $escape(subList.id), $out += '" class="', $line = 44, 1 == subList.isEdit ? ($out += "T-tooltip tooltip-error gray", 

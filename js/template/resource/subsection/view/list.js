/*TMODJS:{"debug":true,"version":412,"md5":"f37103c4d990222eec3bb138c6c50a39"}*/
        ...
        try {
            ...
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $line = 54, $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $line = 70) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 72) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 74) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 76) : ($out += " 已发团 ", 
                    ...
                    $line = 96) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 98) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 100) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 102) : ($out += " 已发团 ", 

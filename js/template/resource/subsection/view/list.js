/*TMODJS:{"debug":true,"version":485,"md5":"8a0742ba7db5f9881651b11bc1302f91"}*/
        ...
        try {
            ...
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $out += '" style="display: none;"> <td>', $line = 88, $out += $escape(subDetails.lineProductName), 
                    $out += "</td> <td>", $line = 89, 0 == subDetails.customerType ? ($out += "散客", 
                    $line = 89) : ($out += "团体", $line = 89), $out += "</td> <td>", $line = 90, $out += $escape($helpers.dateFormat(subDetails.startTime, "yyyy-MM-dd")), 
                    $out += "</td> <td>", $line = 91, $out += $escape(subDetails.days), $out += "</td> <td>", 
                    $line = 92, 0 == subDetails.operateCurrentNeedPayMoney ? ($out += "-", $line = 92) : ($out += "本段现收", 
                    $line = 92), $out += '</td> <td colspan="4"></td> <td>', $line = 94, 1 == subDetails.status ? ($out += " 未分团 ", 
                    $line = 96) : 2 == subDetails.status ? ($out += " 已分团 ", $line = 98) : 3 == subDetails.status ? ($out += " 已转客 ", 
                    $line = 100) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 102) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 104) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 106) : ($out += " 已发团 ", 
                    $line = 108), $out += " </td> </tr> ", $line = 111), $out += " ", $line = 112;
                }), $out += " ", $line = 113), $out += " ", $line = 114;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 120, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

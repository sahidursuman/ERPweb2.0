...
define(function(require) {
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 126, 0 == totalPage ? ($out += " 0/0 ", $line = 128) : ($out += " ", $line = 129, 
            $out += $escape(pageNo + 1), $out += "/", $line = 129, $out += $escape(totalPage), 
            $out += " ", $line = 130), $out += ' </a> </li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="next" href="javascript:void(0)">下一页</a></li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="last" href="javascript:void(0)">尾页</a></li> </ul> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

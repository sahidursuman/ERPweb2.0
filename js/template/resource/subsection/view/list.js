/*TMODJS:{"debug":true,"version":464,"md5":"c3482beecd7cac11a1ee5a6f9e67047c"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div style="clear: both;margin-bottom:10px;border-top:1px dotted #ccc;padding-bottom:5px;"></div> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>客户来源</th> <th>线路产品</th> <th>针对客源</th> <th>出游日期</th> <th>天数</th> <th>现收</th> <th>联系人</th> <th>人数</th> <th>操作人</th> <th class="col-sm-1">操作时间</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody>', 
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $line = 31), $out += " </td> <td>", $line = 33, 0 == subList.customerType ? ($out += "散客", 

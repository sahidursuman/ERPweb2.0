/*TMODJS:{"debug":true,"version":621,"md5":"51edc1e6330ce1a6bd963ed56b53472d"}*/
    ...
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 18, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $out += $escape(subList.lineProduct.name), $line = 28), $line = 28, null != subList.subTouristGroupDetails && ($out += ' <label class="lineProductArea" style="float: right;"> <button class="btn btn-success btn-sm btn-white show" index="', 
                ...
                $out += '</td> <td><span class="F-float F-count">', $line = 39, subList.lineProduct && ($line = 39, 
                $out += $escape(subList.lineProduct.days), $line = 39), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 40, $out += $escape(subList.currentNeedPayMoney), $out += "</span></td> <td>", 
                $line = 41, null != subList.subOperatorUser ? ($line = 41, $out += $escape(subList.subOperatorUser.realName), 
                $line = 41) : ($out += "-", $line = 41), $out += "</td> <td>", $line = 43, null != subList.subOperateTime ? ($line = 43, 
                ...
                $line = 44), $out += '</td> <td> <div class="btn-group"> <a data-entity-id="', $line = 47, 
                $out += $escape(subList.id), $out += '" class="', $line = 47, 1 == subList.isEdit ? ($out += "gray", 
                ...
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $line = 78) : 2 == subDetails.status ? ($out += " 已分团 ", $line = 78) : 3 == subDetails.status ? ($out += " 已外转 ", 

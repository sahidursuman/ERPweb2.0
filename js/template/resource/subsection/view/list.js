/*TMODJS:{"debug":true,"version":470,"md5":"77151b9d478c80067e86aed18d45c597"}*/
        ...
        try {
            ...
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $line = 70) : 3 == subDetails.status ? ($out += " 已转客 ", $line = 72) : 4 == subDetails.status ? ($out += " 已取消 ", 
                    ...
                    $out += '" style="display: none;"> <td>', $line = 86, $out += $escape(subDetails.lineProductName), 
                    $out += "</td> <td>", $line = 87, 0 == subDetails.customerType ? ($out += "散客", 
                    $line = 87) : ($out += "团体", $line = 87), $out += "</td> <td>", $line = 88, $out += $escape($helpers.dateFormat(subDetails.startTime, "yyyy-MM-dd")), 
                    $out += "</td> <td>", $line = 89, $out += $escape(subDetails.days), $out += "</td> <td>", 
                    $line = 90, 0 == subDetails.operateCurrentNeedPayMoney ? ($out += "-", $line = 90) : ($out += "本段现收", 
                    $line = 90), $out += '</td> <td colspan="4"></td> <td>', $line = 92, 1 == subDetails.status ? ($out += " 未分团 ", 
                    $line = 94) : 2 == subDetails.status ? ($out += " 已分团 ", $line = 96) : 3 == subDetails.status ? ($out += " 已转客 ", 
                    $line = 98) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 100) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 102) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 104) : ($out += " 已发团 ", 
                    $line = 106), $out += " </td> </tr> ", $line = 109), $out += " ", $line = 110;
                }), $out += " ", $line = 111), $out += " ", $line = 112;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 118, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":466,"md5":"3e88d67b84d3a450de89699ef002c06a"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div style="clear: both;margin-bottom:10px;border-top:1px dotted #ccc;padding-bottom:5px;"></div> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-s howHighLight"> <thead> <tr class="bg-blur"> <th>客户</th> <th>线路产品</th> <th>针对客源</th> <th>出游日期</th> <th>天数</th> <th>现收</th> <th>联系人</th> <th>人数</th> <th>操作人</th> <th class="col-sm-1">操作时间</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody>', 

/*TMODJS:{"debug":true,"version":535,"md5":"2612b43abe3b843c01b02a4d7cdb01e6"}*/
        ...
        try {
            ...
            $line = 18, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $line = 64) : ($out += "本段现收", $line = 64), $out += "</td> <td></td> <td></td> <td>", 
                    ...
                    $line = 77), $out += "</td> <td></td> <td></td> <td>", $line = 80, 1 == subDetails.status ? ($out += " 未分团 ", 
                    $line = 80) : 2 == subDetails.status ? ($out += " 已分团 ", $line = 80) : 3 == subDetails.status ? ($out += " 已转客 ", 
                    $line = 80) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 80) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 80) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 80) : ($out += " 已发团 ", 
                    $line = 80), $out += " </td> </tr> ", $line = 83), $out += " ", $line = 83;
                }), $out += " ", $line = 83), $out += " ", $line = 83;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 88, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

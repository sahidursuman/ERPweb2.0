/*TMODJS:{"debug":true,"version":523,"md5":"3b1d2f48e640e5d7212c0adb90b9f45a"}*/
    ...
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 17, $each(transitSubTgroupList, function(subList, indexA) {
                $out += ' <tr data-entity-id="', $line = 18, $out += $escape(subList.id), $out += '"> <td class="h-touristGroupInfo"> <p> <span class="h-orderNumber"> ', 

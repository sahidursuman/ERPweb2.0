/*TMODJS:{"debug":true,"version":429,"md5":"d1318da1431d7825aee4c63bb18c5b05"}*/
    ...
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            $line = 21, $each(transitSubTgroupList, function(subList, indexA) {
                ...
                $line = 44, $out += $escape(subList.id), $out += '" class="T-btn-subsection cursor R-right" data-right="1350001"> 分段 </a> <a data-entity-id="', 
                $line = 47, $out += $escape(subList.id), $out += '" class="', $line = 47, 5 == subList.status && ($out += "T-btn-subsection-revoke", 
                ...
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    ...
                    $out += '"></td> </tr> ', $line = 83) : ($out += ' <tr class="T-tr_', $line = 84, 

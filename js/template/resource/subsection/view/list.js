/*TMODJS:{"debug":true,"version":524,"md5":"71681f24dc602063ed2829503ce678fa"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>收客信息</th> <th>线路产品</th> <th>针对客源</th> <th>出游日期</th> <th>天数</th> <th>现收</th> <th>操作人</th> <th class="col-sm-1">操作时间</th> <th>状态</th> <th>操作</th> </tr> </thead> <tbody>', 
            $line = 17, $each(transitSubTgroupList, function(subList, indexA) {
                $out += ' <tr data-entity-id="', $line = 18, $out += $escape(subList.id), $out += '"> <td class="h-touristGroupInfo"> <p> <span class="h-orderNumber">收客单号：', 
                $line = 21, $out += $escape(subList.orderNumber), $out += '</span> <span class="h-memberName">', 
                $line = 22, null != subList.contactMember && ($line = 22, $out += $escape(subList.contactMember.name), 
                $line = 22), $out += '</span> <label class="h-peopleCount"><span class="F-float F-count">', 
                $line = 23, $out += $escape(subList.adultCount), $out += '</span>大<span class="F-float F-count">', 
                $line = 23, $out += $escape(subList.childCount), $out += '</span>小</label> </p> <p class="h-agencyName">', 
                $line = 25, subList.partnerAgency && ($line = 25, $out += $escape(subList.partnerAgency.travelAgencyName), 
                $line = 25), $out += "</p> </td> <td>", $line = 27, $out += $escape(subList.lineProduct.name), 
                $out += " ", $line = 27, null != subList.subTouristGroupDetails && ($out += ' <label class="lineProductArea" style="float: right;"> <button class="btn btn-success btn-sm btn-white show" index="', 
                $line = 29, $out += $escape(indexA), $out += '"> <i class="ace-icon fa fa-plus bigger-110 icon-only"></i>  </button> </label> ', 
                $line = 34), $out += " </td> <td>", $line = 36, 0 == subList.customerType ? ($out += "散客", 
                $line = 36) : ($out += "团体", $line = 36), $out += "</td> <td>", $line = 37, $out += $escape($helpers.dateFormat(subList.startTime, "yyyy-MM-dd")), 
                $out += '</td> <td><span class="F-float F-count">', $line = 38, $out += $escape(subList.lineProduct.days), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 39, $out += $escape(subList.currentNeedPayMoney), 
                $out += "</span></td> <td>", $line = 40, null != subList.subOperatorUser ? ($line = 40, 
                $out += $escape(subList.subOperatorUser.realName), $line = 40) : ($out += "-", $line = 40), 
                $out += "</td> <td>", $line = 41, null != subList.subOperateTime ? ($line = 41, 
                ...
                $line = 55, null != subList.subTouristGroupDetails && ($out += " ", $line = 55, 
                $each(subList.subTouristGroupDetails, function(subDetails, index) {
                    $out += " ", $line = 55, 0 == index ? ($out += ' <tr class="T-tr_', $line = 56, 
                    $out += $escape(indexA), $out += '" style="display: none;"> <td rowspan="', $line = 57, 
                    $out += $escape(subList.subTouristGroupDetails.length), $out += '" colspan="2"></td> <td>', 
                    $line = 58, $out += $escape(subDetails.lineProductName), $out += "</td> <td>", $line = 59, 
                    0 == subDetails.customerType ? ($out += "散客", $line = 59) : ($out += "团体", $line = 59), 
                    $out += "</td> <td>", $line = 60, $out += $escape($helpers.dateFormat(subDetails.startTime, "yyyy-MM-dd")), 
                    $out += '</td> <td><span class="F-float F-count">', $line = 61, $out += $escape(subDetails.days), 
                    $out += "</span></td> <td>", $line = 62, 0 == subDetails.operateCurrentNeedPayMoney ? ($out += "-", 
                    $line = 62) : ($out += "本段现收", $line = 62), $out += "</td> <td></td> <td>", $line = 64, 
                    1 == subDetails.status ? ($out += " 未分团 ", $line = 64) : 2 == subDetails.status ? ($out += " 已分团 ", 
                    $line = 64) : 3 == subDetails.status ? ($out += " 已外转 ", $line = 64) : 4 == subDetails.status ? ($out += " 已取消 ", 
                    $line = 64) : 5 == subDetails.status ? ($out += " 已拆分 ", $line = 64) : 6 == subDetails.status ? ($out += " 已内转 ", 
                    $line = 64) : ($out += " 已发团 ", $line = 64), $out += ' </td> <td rowspan="', $line = 66, 
                    $out += $escape(subList.subTouristGroupDetails.length), $out += '"></td> </tr> ', 
                    $line = 68) : ($out += ' <tr class="T-tr_', $line = 69, $out += $escape(indexA), 
                    $out += '" style="display: none;"> <td>', $line = 70, $out += $escape(subDetails.lineProductName), 
                    $out += "</td> <td>", $line = 71, 0 == subDetails.customerType ? ($out += "散客", 
                    $line = 71) : ($out += "团体", $line = 71), $out += "</td> <td>", $line = 72, $out += $escape($helpers.dateFormat(subDetails.startTime, "yyyy-MM-dd")), 
                    $out += "</td> <td>", $line = 73, $out += $escape(subDetails.days), $out += "</td> <td>", 
                    $line = 74, 0 == subDetails.operateCurrentNeedPayMoney ? ($out += "-", $line = 74) : ($out += "本段现收", 
                    $line = 74), $out += "</td> <td></td> <td>", $line = 76, 1 == subDetails.status ? ($out += " 未分团 ", 
                    $line = 76) : 2 == subDetails.status ? ($out += " 已分团 ", $line = 76) : 3 == subDetails.status ? ($out += " 已转客 ", 
                    $line = 76) : 4 == subDetails.status ? ($out += " 已取消 ", $line = 76) : 5 == subDetails.status ? ($out += " 已拆分 ", 
                    $line = 76) : 6 == subDetails.status ? ($out += " 已内转 ", $line = 76) : ($out += " 已发团 ", 
                    $line = 76), $out += " </td> </tr> ", $line = 79), $out += " ", $line = 79;
                }), $out += " ", $line = 79), $out += " ", $line = 79;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 84, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":393,"md5":"f2cd02ff3e051566ad0751314ac1e6cc"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/operation", function($data, $filename) {
        try {
            ...
            $line = 32, $out += $escape(ptGroup.lineProduct.customerType), $out += '">', $line = 32, 
            $each(subtGroupList, function(subList) {
                ...
                $line = 64, $out += $escape(subList.id), $out += '" class=" ', $line = 64, 1 == subList.status && ($out += "btn-operation-delete", 
            ...
            $line = 75, 1 == mark && ($out += 'data-entity-mark="1"', $line = 75), $out += '> <i class="ace-icon fa fa-check"></i> 保存 </button> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

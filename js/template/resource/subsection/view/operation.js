/*TMODJS:{"debug":true,"version":439,"md5":"d824f7ccb2d334ccf26deca5088affcd"}*/
    ...
    return require("../../../template")("resource/subsection/view/operation", function($data, $filename) {
        try {
            ...
            $each(subtGroupList, function(subList) {
                ...
                $out += '" /> </td> <td> <input type="text" name="subsectionNeedPayAllMoney" value="', 

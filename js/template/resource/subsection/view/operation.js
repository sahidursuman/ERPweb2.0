/*TMODJS:{"debug":true,"version":377,"md5":"66679ce3c098ab740abd858280382080"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/operation", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12 operationMainForm"> <div class="form-group clearfix" style="padding-bottom:15px;"> <input type="hidden" name="touristGroupId" value="', 
            ...
            }), $out += ' </tbody> </table> </div> <div class="form-group" style="text-align: center;"> <button class="btn btn-sm btn-danger btn-operation-close"> <i class="ace-icon fa fa-times"></i> 取消 </button> <button class="btn btn-sm btn-success btn-operation-save" ', 

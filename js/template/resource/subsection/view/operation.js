/*TMODJS:{"debug":true,"version":444,"md5":"bec2c3abe21940f852d70fa53946ff87"}*/
define(function(require) {
    return require("../../../template")("resource/subsection/view/operation", function($data, $filename) {
        try {
            ...
            $line = 18, $out += $escape(ptGroup.needPayAllMoney), $out += '</span></label> </div> </div> <div class="form-group"> <button class="btn btn-sm btn-success T-btn-operation-add" data-mark="', 
            ...
            $each(subtGroupList, function(subList) {
                ...
                $line = 45), $out += '" /> </td> <td> <input type="text" name="days" class="col-sm-10 F-float F-count" readonly="readonly" value="', 
                ...
                $out += '" /> </td> <td> <input class="F-float F-money" type="text" name="needPayAllMoney" value="', 
                $line = 53, $out += $escape(subList.subsectionNeedPayAllMoney), $out += '"> </td> <td> <input type="radio" name="operateCurrentNeedPayMoney" ', 

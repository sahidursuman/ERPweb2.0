...
define(function(require, exports) {
	var rule=require("./rule"),
		...
		preTypeHtml_bus_scenic = '<select name="preType"><option value="0" selected="">现金</option><option value="1">银行转账</option><option value="3">支票</option><option value="4">其他</option><option value="5">网付</option></select>';
		preTypeHtml = '<select name="preType"><option value="0" selected="">现金</option><option value="1">银行转账</option><option value="3">支票</option><option value="4">其他</option></select>';
	...
	tripPlan.addBus = function($btn, validator, $tab) {
		var $tbody = $btn.closest('.ui-sortable-handle').find('tbody'),
			html = '<tr> <td><input type="text" name="startTime" class="datepicker T-busPriceC"></td>'
					...
					+ '<td><div class="inline-flex">'+preTypeHtml_bus_scenic+'<input type="text" name="prePayMoney" class="price F-float F-money" maxlength="9" style="width: 60px;"></div></td>'
	...
	tripPlan.addScenic = function($this, validator, $tab){
		...
		'<td><div class="inline-flex">'+preTypeHtml_bus_scenic+'<input type="text" name="prePayMoney" class="price F-float F-money" style="width: 60px;" maxlength="9"/></div></td>' +

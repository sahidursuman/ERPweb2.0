/*TMODJS:{"debug":true,"version":44,"md5":"2f06456557668497b84e6e1a4a0bd2cc"}*/
        ...
        try {
            ...
            $line = 18, $each(mapList, function(rs) {
                ...
                $line = 22, $out += $escape(rs.queryJson), $out += "</td> ", $line = 23, $each(rs.busOffers, function(offer) {
                    ...
                    $out += "</td> <td>", $line = 27, "已过期" != offer.status && ($line = 27, $out += $escape(offer.reserveMinutes), 
                    $line = 27), $out += "</td> <td>", $line = 28, $out += $escape($helpers.dateFormat(offer.expiryTime, "yyyy-MM-dd")), 

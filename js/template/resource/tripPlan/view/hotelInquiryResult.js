/*TMODJS:{"debug":true,"version":64,"md5":"081849e9d73b254222c2ba6a60a1d503"}*/
            ...
            $line = 21, $each(mapList, function(rs) {
                ...
                $line = 27, $each(rs.hotelOffers, function(offer, index) {
                    ...
                    $line = 47, $each(offer.roomOffers, function(room) {
                        ...
                        $line = 49, $out += $escape(offer.id), $out += ' F-float F-money"> ', $line = 50, 
                        $out += $escape(room.price), $out += " </td> ", $line = 52;

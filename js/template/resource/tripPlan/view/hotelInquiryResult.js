/*TMODJS:{"debug":true,"version":57,"md5":"30b49dccfd96740b10dd716868f52f92"}*/
define(function(require) {
    return require("../../../template")("resource/tripPlan/view/hotelInquiryResult", function($data, $filename) {
        try {
            ...
            return $out += '<div class="col-xs-12" style="padding: 20px 0"> <table class="table table-striped table-bordered table-hover"> <thead> <tr class="bg-blur"> <th>线路产品</th> <th>出游日期</th> <th>入住日期</th> <th>需求内容</th> <th>酒店</th> <th>星级</th> <th>房型</th> <th>房费报价</th> <th>反馈内容</th> <th>资源保留期</th> <th>询价截止期</th> <th>询价状态</th> </tr> </thead> <tbody> ', 
            $line = 21, $each(mapList, function(rs) {
                ...
                $line = 27, $each(rs.hotelOffers, function(offer, index) {
                    ...
                    $out += $escape(offer.reserveMinutes), $out += '</td> <td rowspan="', $line = 55, 
                    $out += $escape(offer.roomOffers.length), $out += '">', $line = 55, $out += $escape($helpers.dateFormat(offer.expiryTime, "yyyy-MM-dd hh:mm:ss")), 

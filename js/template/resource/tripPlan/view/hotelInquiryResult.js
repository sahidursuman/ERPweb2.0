/*TMODJS:{"debug":true,"version":61,"md5":"68f72023a60c588a12d2bfacb5d00640"}*/
        ...
        try {
            ...
            $line = 21, $each(mapList, function(rs) {
                ...
                $line = 27, $each(rs.hotelOffers, function(offer, index) {
                    ...
                    "已过期" != offer.status && ($line = 54, $out += $escape(offer.reserveMinutes), $line = 54), 
                    $out += '</td> <td rowspan="', $line = 55, $out += $escape(offer.roomOffers.length), 

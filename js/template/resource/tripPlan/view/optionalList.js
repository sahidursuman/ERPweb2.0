/*TMODJS:{"debug":true,"version":32,"md5":"088fe0fad1060ece873fc58376a56f5e"}*/
define(function(require) {
    return require("../../../template")("resource/tripPlan/view/optionalList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-hover"> <thead> <tr> <th class="th-border">餐厅</th> <th class="th-border">用餐类型</th> <th class="th-border">餐标<span style="font-size:12px;">(元/人)</span></th> <th class="th-border">菜单</th> <th class="th-border">操作</th> </tr> </thead> <tbody>', 

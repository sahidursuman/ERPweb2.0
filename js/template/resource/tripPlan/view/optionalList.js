/*TMODJS:{"debug":true,"version":10,"md5":"d080b4cfece33e8865e073ad26b16a79"}*/
define(function(require) {
    return require("../../../template")("resource/tripPlan/view/optionalList", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-hover"> <thead> <tr> <th class="th-border">餐厅</th> <th class="th-border">用餐类型</th> <th class="th-border">餐标</th> <th class="th-border">菜单</th> <th class="th-border">操作</th> </tr> </thead> <tbody>', 
            $line = 11, $each(restaurantList, function(restaurant) {
                ...
                $line = 12, $out += $escape(restaurant.mobileNumber), $out += '"> <td rowspan="', 
                $line = 13, $out += $escape(restaurant.restaurantStandardList.length), $out += '" style="vertical-align:middle">', 
                $line = 13, $out += $escape(restaurant.name), $out += "</td> ", $line = 14, 0 == restaurant.restaurantStandardList.length && ($out += "<td></td><td></td><td></td>", 
                $line = 14), $out += " ", $line = 15, $each(restaurant.restaurantStandardList, function(standard, index) {
                    ...
                    $out += "</td> <td>", $line = 18, $out += $escape(standard.price), $out += '<input type="hidden" name="restaurantStandardId" value="', 
                    $line = 18, $out += $escape(standard.id), $out += '" /></td> <td>', $line = 19, 
                    $out += $escape(standard.menuList), $out += "</td> ", $line = 20), $out += " ", 
                    $line = 21;
                }), $out += ' <td rowspan="', $line = 22, $out += $escape(restaurant.restaurantStandardList.length), 
                $out += '" style="vertical-align:middle"><a class="T-add">添加</a></td> </tr> ', $line = 24, 
                $each(restaurant.restaurantStandardList, function(standard, index) {

/*TMODJS:{"debug":true,"version":13,"md5":"ecfe39b110292559a4a3cde49bbe1f36"}*/
    ...
    return require("../../../template")("resource/tripPlan/view/optionalList", function($data, $filename) {
        try {
            ...
            $line = 11, $each(restaurantList, function(restaurant) {
                ...
                $line = 22), $out += ' style="vertical-align:middle"><a class="T-add">添加</a></td> </tr> ', 

/*TMODJS:{"debug":true,"version":473,"md5":"a6b44e5bd4caaf22d4151f2d7cc13707"}*/
    ...
    return require("../../../template")("resource/tripPlan/view/list", function($data, $filename) {
        try {
            ...
            $line = 26, $out += $escape(travelAgencyName), $out += '"> ', $line = 27, $each(tripPlanList, function(tripPlan) {
                ...
                $line = 42), $out += " </td> <td>", $line = 44, $out += $escape(tripPlan.touristAdultCount + tripPlan.touristChildCount), 
                $out += '</td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_guide" class="guideStatus" data-status="', 
                ...
                0 == tripPlan.status ? ($out += ' <td class="warning-text">待确认</td> ', $line = 69) : 1 == tripPlan.status ? ($out += ' <td class="success-text">已发团</td> ', 

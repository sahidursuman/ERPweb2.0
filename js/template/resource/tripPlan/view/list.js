/*TMODJS:{"debug":true,"version":430,"md5":"27026ba672fee1fa8436918b8eaa964f"}*/
    ...
    return require("../../../template")("resource/tripPlan/view/list", function($data, $filename) {
        try {
            ...
            $line = 26, $each(tripPlanList, function(tripPlan) {
                ...
                $line = 67, $out += $escape(tripPlan.touristAdultCount + tripPlan.touristChildCount), 
                $out += '</td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_guide"><i class="ace-icon fa ', 
                $line = 70, $out += $escape($helpers.getArrangeIcon(tripPlan.guideStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_bus"><i class="ace-icon fa ', 
                $line = 72, $out += $escape($helpers.getArrangeIcon(tripPlan.busStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_insurance"><i class="ace-icon fa ', 
                ...
                $line = 78, $out += $escape($helpers.getArrangeIcon(tripPlan.hotelStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_scenic"><i class="ace-icon fa ', 
                $line = 80, $out += $escape($helpers.getArrangeIcon(tripPlan.scenicStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_ticket"><i class="ace-icon fa ', 
                $line = 82, $out += $escape($helpers.getArrangeIcon(tripPlan.ticketStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_shop"><i class="ace-icon fa ', 
                $line = 84, $out += $escape($helpers.getArrangeIcon(tripPlan.shopStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_selfPay"><i class="ace-icon fa ', 
                $line = 86, $out += $escape($helpers.getArrangeIcon(tripPlan.selfPayStatus)), $out += '"></i></td>  <td style="vertical-align:middle" data-target="#tripPlan_addPlan_other"><i class="ace-icon fa ', 
                ...
                $out += $escape(tripPlan.businessGroup.name), $line = 91), $out += "</td> ", $line = 92, 
                0 == tripPlan.status ? ($out += ' <td class="warning-text">待确认</td> ', $line = 94) : 1 == tripPlan.status ? ($out += ' <td class="success-text">已发团</td> ', 
                $line = 96) : -1 == tripPlan.status ? ($out += " <td>已取消</td> ", $line = 98) : 2 == tripPlan.status && ($out += ' <td class="error-text">已过期</td> ', 
                $line = 100), $out += ' <td style="vertical-align:middle;width:200px"> <a class="cursor T-action ', 
                $line = 102, -1 != tripPlan.status && 2 != tripPlan.status && ($out += "T-send", 
                $line = 102), $out += ' R-right" data-right="1140010" title="通知" ', $line = 102, 
                (-1 == tripPlan.status || 2 == tripPlan.status) && ($out += 'style="color:#bbb;"', 
                $line = 102), $out += '> 通知 <label style="padding-left:10px;">|</label> </a> <a class="cursor T-action T-view" title="查看"> 查看 </a> <a billStatus="', 
                $line = 109, $out += $escape(tripPlan.billStatus), $out += '" class="cursor T-action ', 
                $line = 109, -1 != tripPlan.status && 2 != tripPlan.status && ($out += "T-plan", 
                $line = 109), $out += ' R-right" data-right="1140007" title="安排" ', $line = 109, 
                (-1 == tripPlan.status || 2 == tripPlan.status) && ($out += 'style="color:#bbb;"', 
                $line = 109), $out += '> <label class="padding-right20">|</label> 安排 </a> </td> </tr> ', 
                $line = 116;

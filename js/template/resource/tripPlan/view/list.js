/*TMODJS:{"debug":true,"version":444,"md5":"6830a72f2dc8f23fe5fce7205120ce9b"}*/
    ...
    return require("../../../template")("resource/tripPlan/view/list", function($data, $filename) {
        try {
            ...
            $line = 26, $each(tripPlanList, function(tripPlan) {
                ...
                $line = 111, 2 != tripPlan.status && ($out += "T-plan", $line = 111), $out += ' R-right" data-right="1140007" title="安排" ', 
                $line = 111, 2 == tripPlan.status && ($out += 'style="color:#bbb;"', $line = 111), 
                $out += '> <label class="padding-right20">|</label> 安排 </a> </td> </tr> ', $line = 118;

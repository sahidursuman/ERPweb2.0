/*TMODJS:{"debug":true,"version":29,"md5":"af59fb098176ef62c7b6532577719f5d"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 36, 1 == touristGroup.innerFlag ? ($out += ' <a class="T-action T-outer-turn cursor"> <label class="padding-right20">|</label> <span>外转</span> </a> ', 
                $line = 41) : ($out += ' <a data-entity-id="', $line = 42, $out += $escape(touristGroup.id), 
                $out += '" class="T-action R-right ', $line = 42, touristGroup.canEdit && ($out += "T-edit", 
                $line = 42), $out += ' cursor" ', $line = 42, touristGroup.canEdit || ($out += 'style="color:#bbb;" title="', 
                $line = 42, $out += $escape(touristGroup.editTitle), $out += '"', $line = 42), $out += ' data-right="1470002"> <label class="padding-right20">|</label> <span>编辑</span> </a> ', 
                $line = 46), $out += ' <a data-entity-id="', $line = 47, $out += $escape(touristGroup.id), 
                $out += '" class="T-action R-right ', $line = 47, touristGroup.canDelete && ($out += "T-del", 
                $line = 47), $out += ' cursor" ', $line = 47, touristGroup.canDelete || ($out += 'style="color:#bbb;" title="', 
                $line = 47, $out += $escape(touristGroup.deleteTitle), $out += '"', $line = 47), 
                $out += ' data-right="1470003"> <label class="padding-right20">|</label> 删除 </a> </div> </td> </tr> ', 
                $line = 54, 5 == touristGroup.status && ($out += ' <tr class="hidden"> <td colspan="12"> <table class="table table-striped table-bordered hct-pos-inherit"> <thead> <tr> <th class="th-border">线路产品</th> <th class="th-border">出团日期</th> <th class="th-border">完团日期</th> <th class="th-border">状态</th> </tr> </thead> <tbody class="T-part-group-list"> </tbody> </table> </td> </tr> ', 
                $line = 71), $out += " ", $line = 72;
            }), $out += " ", new String($out);
        } catch (e) {
            throw {

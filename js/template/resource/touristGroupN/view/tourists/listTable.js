/*TMODJS:{"debug":true,"version":9,"md5":"7bea06745d024711f5627acc5e9bba98"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                touristGroup.canEdit && ($out += "T-edit", $line = 29), $out += ' cursor" ', $line = 29, 
                touristGroup.canEdit || ($out += 'style="color:#bbb;" title=', $line = 29, $out += $escape(touristGroup.editTitle), 
                $line = 29), $out += '> <label class="padding-right20">|</label> <span>编辑</span> </a> <a data-entity-id="', 
                $line = 33, $out += $escape(touristGroup.id), $out += '" class="T-action ', $line = 33, 
                touristGroup.canDelete && ($out += "T-del", $line = 33), $out += ' cursor" ', $line = 33, 
                touristGroup.canDelete || ($out += 'style="color:#bbb;" title=', $line = 33, $out += $escape(touristGroup.deleteTitle), 
                $line = 33), $out += '> <label class="padding-right20">|</label> 删除 </a> </div> </td> </tr> ', 
                $line = 40;
            }), $out += " ", new String($out);
        } catch (e) {
            throw {

/*TMODJS:{"debug":true,"version":26,"md5":"cd8922c9be4a2da02099d05d9e1140ae"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 36, $out += $escape(touristGroup.id), $out += '" class="T-action R-right ', 
                $line = 36, touristGroup.canEdit && ($out += "T-edit", $line = 36), $out += ' cursor" ', 
                $line = 36, touristGroup.canEdit || ($out += 'style="color:#bbb;" title="', $line = 36, 
                $out += $escape(touristGroup.editTitle), $out += '"', $line = 36), $out += ' data-right="1470002"> <label class="padding-right20">|</label> <span>编辑</span> </a> <a data-entity-id="', 
                $line = 40, $out += $escape(touristGroup.id), $out += '" class="T-action R-right ', 
                $line = 40, touristGroup.canDelete && ($out += "T-del", $line = 40), $out += ' cursor" ', 
                $line = 40, touristGroup.canDelete || ($out += 'style="color:#bbb;" title="', $line = 40, 
                $out += $escape(touristGroup.deleteTitle), $out += '"', $line = 40), $out += ' data-right="1470003"> <label class="padding-right20">|</label> 删除 </a> </div> </td> </tr> ', 
                $line = 47, 5 == touristGroup.status && ($out += ' <tr class="hidden"> <td colspan="12"> <table class="table table-striped table-bordered hct-pos-inherit"> <thead> <tr> <th class="th-border">线路产品</th> <th class="th-border">出团日期</th> <th class="th-border">完团日期</th> <th class="th-border">状态</th> </tr> </thead> <tbody class="T-part-group-list"> </tbody> </table> </td> </tr> ', 
                $line = 64), $out += " ", $line = 65;
            }), $out += " ", new String($out);
        } catch (e) {
            throw {

/*TMODJS:{"debug":true,"version":23,"md5":"7351cec27caef75940644e93e62b71e4"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $out += $escape(touristGroup.editTitle), $line = 36), $out += ' data-right="1470002"> <label class="padding-right20">|</label> <span>编辑</span> </a> <a data-entity-id="', 
                ...
                $out += $escape(touristGroup.deleteTitle), $line = 40), $out += ' data-right="1470003"> <label class="padding-right20">|</label> 删除 </a> </div> </td> </tr> ', 

/*TMODJS:{"debug":true,"version":38,"md5":"4f15fd7424ca5deb5402a0ff9048307b"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $out += '</span></td> <td><span class="F-float F-money">', $line = 16, $out += $escape(touristGroup.currentNeedPayMoney), 
                $out += '</span></td> <td> <label class="h-peopleCount"> (<span>', $line = 19, $out += $escape(touristGroup.adultCount), 
                $out += "</span>大 <span>", $line = 20, $out += $escape(touristGroup.childCount), 
                $out += "</span>小) </label> ", $line = 22, null != touristGroup.touristGroupMember && ($out += ' <label class="h-memberName"> ', 
                $line = 24, $out += $escape(touristGroup.touristGroupMember.name), $out += " </label> ", 
                $line = 26), $out += " </td> <td>", $line = 28, null != touristGroup.touristGroupMember && ($line = 28, 
                $out += $escape(touristGroup.touristGroupMember.mobileNumber), $line = 28), $out += "</span></td> <td>", 
                $line = 29, null != touristGroup.outOPUser && ($line = 29, $out += $escape(touristGroup.outOPUser.realName), 
                $line = 29), $out += "</td> <td>", $line = 30, 1 == !!touristGroup.customerType ? ($out += "独立成团", 
                $line = 30) : ($out += "散客拼团", $line = 30), $out += "</td> <td>", $line = 31, $out += $escape($helpers.getPartGroupStatusText(touristGroup.status)), 
                $out += '</td> <td> <div class="btn-group" style="width:120px;"> <a data-entity-id="', 
                $line = 34, $out += $escape(touristGroup.id), $out += '" data-type="', $line = 34, 
                $out += $escape(touristGroup.status), $out += '" class="T-action T-view btn-touristGroup-view cursor"> 查看 </a> ', 
                $line = 37, 1 == touristGroup.innerFlag && 1 == touristGroup.status ? ($out += ' <a class="T-action T-outer-turn cursor"> <label class="padding-right20">|</label> <span>外转</span> </a> ', 
                $line = 42) : 1 != touristGroup.innerFlag && ($out += ' <a data-entity-id="', $line = 43, 
                $out += $escape(touristGroup.id), $out += '" class="T-action R-right ', $line = 43, 
                touristGroup.canEdit && ($out += "T-edit", $line = 43), $out += ' cursor" ', $line = 43, 
                touristGroup.canEdit || ($out += 'style="color:#bbb;" title="', $line = 43, $out += $escape(touristGroup.editTitle), 
                $out += '"', $line = 43), $out += ' data-right="1470002"> <label class="padding-right20">|</label> <span>编辑</span> </a> <a data-entity-id="', 
                $line = 47, $out += $escape(touristGroup.id), $out += '" class="T-action R-right ', 
                $line = 47, touristGroup.canDelete && ($out += "T-del", $line = 47), $out += ' cursor" ', 
                $line = 47, touristGroup.canDelete || ($out += 'style="color:#bbb;" title="', $line = 47, 
                $out += $escape(touristGroup.deleteTitle), $out += '"', $line = 47), $out += ' data-right="1470003"> <label class="padding-right20">|</label> 删除 </a> ', 
                $line = 51), $out += " </div> </td> </tr> ", $line = 55, 5 == touristGroup.status && ($out += ' <tr class="hidden"> <td colspan="12"> <table class="table table-striped table-bordered hct-pos-inherit"> <thead> <tr> <th class="th-border">线路产品</th> <th class="th-border">出团日期</th> <th class="th-border">完团日期</th> <th class="th-border">状态</th> </tr> </thead> <tbody class="T-part-group-list"> </tbody> </table> </td> </tr> ', 
                $line = 72), $out += " ", $line = 73;
            }), $out += " ", new String($out);
        } catch (e) {
            throw {

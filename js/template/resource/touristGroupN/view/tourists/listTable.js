/*TMODJS:{"debug":true,"version":33,"md5":"ee27c0600db4a463ba03cd60777147ed"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $out += '</td> <td><span class="F-float F-money">', $line = 15, $out += $escape(touristGroup.currentNeedPayMoney), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 16, $out += $escape(touristGroup.needPayAllMoney), 
                ...
                $line = 34, $out += $escape(touristGroup.id), $out += '" class="T-action T-view btn-touristGroup-view cursor"> 查看 </a> ', 

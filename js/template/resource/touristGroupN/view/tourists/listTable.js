/*TMODJS:{"debug":true,"version":31,"md5":"48c31356ea94fc359c7b6847d17c1034"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/tourists/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(touristGroupList, function(touristGroup) {
                ...
                $line = 42, $out += $escape(touristGroup.editTitle), $out += '"', $line = 42), $out += ' data-right="1470002"> <label class="padding-right20">|</label> <span>编辑</span> </a> <a data-entity-id="', 

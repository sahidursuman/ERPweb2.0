/*TMODJS:{"debug":true,"version":18,"md5":"31d522f8de76494e14216e596a94e93a"}*/
define(function(require) {
    return require("../../../../../template")("resource/touristGroupN/view/tourists/view/viewBus", function($data, $filename) {
        try {
            ...
            $out += ' </div> <div class="col-xs-12 mar-t-20"> <div class="col-xs-8" style="padding-top: 4px;"> <label class="control-label pull-left" style="width: 35px;">应付</label> <span class="control-label pull-left F-float F-money">', 
            $line = 25, $out += $escape(needPayAllMoney), $out += '</span> </div> </div> <div class="col-xs-12 mar-t-20"> <table class="table table-striped table-new table-bordered table-hover"> <thead> <tr> <th>费用项</th> <th>数量</th> <th>单价</th> <th>金额</th> <th>说明</th> </tr> </thead> <tbody class="T-fee-list" data-del-json="', 
            $line = 39, $out += $escape(busFeeDel), $out += '"> ', $line = 40, busFee && busFee.length > 0 && ($out += " ", 
            $line = 41, $each(busFee, function(rs) {
                $out += ' <tr data-id="', $line = 42, $out += $escape(rs.id), $out += '"> <td> ', 
                $line = 44, $out += $escape($helpers.getFeeItemText(rs.type)), $out += ' </td> <td class="F-float F-count">', 
                $line = 46, $out += $escape(rs.count), $out += '</td> <td class="F-float F-money">', 
                $line = 47, $out += $escape(rs.price), $out += '</td> <td class="F-float F-money">', 
                $line = 48, $out += $escape(rs.price * rs.count), $out += "</td> <td>", $line = 49, 
                $out += $escape(rs.remark), $out += "</td> </tr> ", $line = 51;

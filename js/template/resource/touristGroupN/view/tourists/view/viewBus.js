/*TMODJS:{"debug":true,"version":15,"md5":"6f298e896d5188a28cb71f0596ec2005"}*/
define(function(require) {
    return require("/js/template/template")("resource/touristGroupN/view/tourists/view/viewBus", function($data, $filename) {
        try {
            ...
            $line = 44, $each(busFee, function(rs) {
                ...
                $line = 47, $out += $escape($helpers.getFeeItemText(rs.type)), $out += " </td> <td>", 

/*TMODJS:{"debug":true,"version":7,"md5":"d33a1827e7f33c253f2eade010fb2b37"}*/
define(function(require) {
    return require("/js/template/template")("resource/touristGroupN/view/tourists/view/viewInnerTurn", function($data, $filename) {
        try {
            ...
            $out += '</div> </div> <div class="col-xs-12 mar-t-20"> <div class="col-xs-1 text-right no-padding-right control-label">责任部门</div> <div class="col-xs-3 control-label">', 

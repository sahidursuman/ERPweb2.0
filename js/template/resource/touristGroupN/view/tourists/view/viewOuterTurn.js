/*TMODJS:{"debug":true,"version":8,"md5":"57af670e642992c9aa8ce31395bfdf27"}*/
define(function(require) {
    return require("/js/template/template")("resource/touristGroupN/view/tourists/view/viewOuterTurn", function($data, $filename) {
        try {
            ...
            $out += '</div> </div> <div class="col-xs-12 mar-t-20"> <div class="col-xs-1 text-right no-padding-right control-label">同行</div> <div class="col-xs-3 control-label">', 
            ...
            $line = 42, innerTransferFee && innerTransferFee.length > 0 && ($out += " ", $line = 43, 

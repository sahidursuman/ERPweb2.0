/*TMODJS:{"debug":true,"version":17,"md5":"a64cc389c0e89b65bf315c73b48b89da"}*/
define(function(require) {
    return require("../../../../../template")("resource/touristGroupN/view/tourists/view/viewHotel", function($data, $filename) {
        try {
            ...
            $line = 5, $out += $escape($helpers.dateFormat(intakeTime, "yyyy-MM-dd")), $out += '</div> </div> <div class="col-xs-12 mar-t-10"> <div class="col-xs-1 text-right no-padding-right control-label">星级</div> <div class="col-xs-3">', 
            ...
            $out += ' </div> <div class="col-xs-12 mar-t-20"> <div class="col-xs-8" style="padding-top: 4px;"> <label class="control-label pull-left" style="width: 35px;">应付</label> <span class="pull-left control-label F-float F-money">', 
            ...
            $each(hotelFee, function(rs) {
                ...
                $line = 54, $out += $escape($helpers.getFeeItemText(rs.type)), $out += ' </td> <td class="F-float F-count">', 
                $line = 56, $out += $escape(rs.count), $out += '</td> <td class="F-float F-money">', 
                $line = 57, $out += $escape(rs.price), $out += '</td> <td class="F-float F-money">', 
                $line = 58, $out += $escape(rs.price * rs.count), $out += "</td> <td>", $line = 59, 
                $out += $escape(rs.remark), $out += "</td> </tr> ", $line = 61;

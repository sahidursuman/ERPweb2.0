/*TMODJS:{"debug":true,"version":4,"md5":"7f32449423b44b8f83a81c43c428a823"}*/
define(function(require) {
    return require("../../../../template")("resource/touristGroupN/view/tourists/listCount", function($data, $filename) {
        try {
            ...
            $line = 2, $out += $escape(statistics.needPay || 0), $out += "</span>元</span></label>", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

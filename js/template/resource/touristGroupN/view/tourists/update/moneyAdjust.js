/*TMODJS:{"debug":true,"version":6,"md5":"d18472d27bbdde075090fedf36a385d4"}*/
define(function(require) {
    return require("../../../../../template")("resource/touristGroupN/view/tourists/update/moneyAdjust", function($data, $filename) {
        try {
            ...
            $out += '"> <div class="row"> <div class="col-xs-12"> <div class="col-xs-4 text-right no-padding-right control-label">本段团款</div> <div class="col-xs-8"> <input type="text" class="col-xs-12" name="subNeedPayMoney" value="', 

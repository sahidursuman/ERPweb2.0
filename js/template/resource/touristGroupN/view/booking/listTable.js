/*TMODJS:{"debug":true,"version":8,"md5":"23550fdcf5843c7db95f80417e1fe5eb"}*/
    ...
    return require("../../../../template")("resource/touristGroupN/view/booking/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookingOrderList, function(rs) {
                ...
                $out += $escape(rs.outOPUserName), $out += "</td> <td>", $line = 11, $out += $escape("1" == rs.status ? "已完成" : "未完成"), 
                $out += ' </td> <td> <div class="btn-group" style="width:120px;"> <a class="T-action T-view cursor"> 查看 </a> <a class="', 

...
$out+='"> <div class="row"> <div class="col-xs-12"> <div class="pull-right" style="margin-top: -6px;"> <label class="pull-left control-label text-right mar-r-10">代订单号</label> <input type="text" class="pull-left w-150" name="orderNumber" placeholder="默认系统自动生成" value="';
$line=6;$out+=$escape(orderNumber);
$out+='"> </div> </div> <div class="col-xs-12 mar-t-10"> <table class="table table-striped table-bordered table-hover hct-table-update"> <thead> <tr> <th rowspan="2">客户</th> <th colspan="4">代订项目</th> <th rowspan="2">代订小计</th> <th rowspan="2">应收</th> <th rowspan="2">客人信息</th> <th rowspan="2">联系电话</th> <th rowspan="2">外联销售</th> </tr> <tr> <th width="150">酒店</th> <th width="150">票务</th> <th width="150">景区</th> <th width="150">旅游车</th> </tr> </thead> <tbody class="T-booking-info"> <tr> <td><input type="text" class="col-xs-12 hct-cursor T-action T-client" readonly name="fromPartnerAgency" placeholder="点击选择客户" value="';
$line=30;$out+=$escape(partnerAgencyName);
$out+='" data-id="';
$line=30;$out+=$escape(partnerAgencyId);
$out+='" data-contact-id="';
$line=30;$out+=$escape(contactId);
$out+='"></td> <td> <input type="text" class="w-100 hct-cursor T-action T-hotel F-float F-money" readonly placeholder="点击填写酒店" ';
$line=32;if(!!hotel){
$out+='value="';
$line=32;$out+=$escape(hotelNeedPayMoney);
$out+='" data-json="';
$line=32;$out+=$escape(hotel);
$out+='"';
$line=32;}
$out+=' data-id="';
$line=32;$out+=$escape(hotelId);
$out+='"> <a class="cursor T-action T-clear" data-status="hotel">清空</a> </td> <td> <input type="text" class="w-100 hct-cursor T-action T-ticket F-float F-money" readonly placeholder="点击填写票务" ';
$line=36;if(!!ticket){
$out+='value="';
$line=36;$out+=$escape(ticketNeedPayMoney);
$out+='" data-json="';
$line=36;$out+=$escape(ticket);
$out+='"';
$line=36;}
$out+=' data-id="';
$line=36;$out+=$escape(ticketId);
$out+='"> <a class="cursor T-action T-clear" data-status="ticket">清空</a> </td> <td> <input type="text" class="w-100 hct-cursor T-action T-scenic F-float F-money" readonly placeholder="点击填写景区" ';
$line=40;if(!!scenic){
$out+='value="';
$line=40;$out+=$escape(scenicNeedPayMoney);
$out+='" data-json="';
$line=40;$out+=$escape(scenic);
$out+='"';
$line=40;}
$out+=' data-id="';
$line=40;$out+=$escape(scenicId);
$out+='"> <a class="cursor T-action T-clear" data-status="scenic">清空</a> </td> <td> <input type="text" class="w-100 hct-cursor T-action T-bus F-float F-money" readonly placeholder="点击填写旅游车" ';
$line=44;if(!!bus){
$out+='value="';
$line=44;$out+=$escape(busNeedPayMoney);
$out+='" data-json="';
$line=44;$out+=$escape(bus);
$out+='"';
$line=44;}
$out+=' data-id="';
$line=44;$out+=$escape(busId);
$out+='"> <a class="cursor T-action T-clear" data-status="bus">清空</a> </td> <td><input type="text" class="col-xs-12 F-float F-money" readonly name="bookingSubtotal" value="';
$line=47;$out+=$escape((hotelNeedPayMoney||0) + (ticketNeedPayMoney||0) + (scenicNeedPayMoney||0) + (busNeedPayMoney||0));
...
$line=48;if(!!needGet){
$out+='value="';
$line=48;$out+=$escape(needGetNeedPayMoney);
$out+='" data-json="';
$line=48;$out+=$escape(needGet);
$out+='"';
$line=48;}

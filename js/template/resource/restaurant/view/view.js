/*TMODJS:{"debug":true,"version":111,"md5":"57d9b4fa0e51f696b4fdd922f62fa482"}*/
define(function(require) {
    return require("../../../template")("resource/restaurant/view/view", function($data, $filename) {
        try {
            ...
            return $out += ' <form class="form-horizontal restaurantMainForm" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereOne"> <tr> <td colspan="4" class="HeadManage">餐厅主体信息</td> </tr> <tr> <td class="style-myself">餐厅名称：</td> <td class="styleOne-self">', 
            ...
            $line = 23, $out += $escape(restaurant.facility), $out += '</td> </tr> <tr> <td class="style-myself">餐厅所在省市：</td> <td class="styleOne-self">', 
            ...
            $line = 49, $out += $escape(restaurant.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">餐标列表</td> </tr> <tr> <td class="style-myself">用餐类型</td> <td class="style-myself">餐标</td> <td class="style-myself">菜单列表</td> <td class="style-myself">时间范围</td> <td class="style-myself">每位价格</td> <td class="style-myself">备注</td> </tr> ', 
            $line = 66, $each(restaurant.restaurantStandardList, function(restaurantStandard) {
                $out += ' <tr> <td class="">', $line = 68, "早餐" == restaurantStandard.type ? ($out += " 早餐 ", 
                $line = 70) : "午餐" == restaurantStandard.type ? ($out += " 午餐 ", $line = 72) : ($out += " 晚餐 ", 
                $line = 74), $out += "</td> <td>", $line = 75, $out += $escape(restaurantStandard.typeName), 
                $out += '</td> <td class="rangeTime">', $line = 76, $out += $escape(restaurantStandard.menuList), 
                $out += '</td> <td class="rangeTimeWidth">', $line = 77, $each(restaurantStandard.priceList, function(price) {
                    $out += " ", $line = 78, $out += $escape($helpers.dateFormat(price.startTime, "yyyy-MM-dd")), 
                    $out += "至", $line = 78, $out += $escape($helpers.dateFormat(price.endTime, "yyyy-MM-dd")), 
                    $out += " ", $line = 79;
                }), $out += "</td> <td> ", $line = 81, $each(restaurantStandard.priceList, function(price) {
                    $out += " <div> ", $line = 83, $out += $escape(price.contractPrice), $out += "元 </div> ", 
                    $line = 85;
                }), $out += ' </td> <td class="">', $line = 87, $out += $escape(restaurantStandard.remark), 
                $out += "</td> </tr> ", $line = 89;

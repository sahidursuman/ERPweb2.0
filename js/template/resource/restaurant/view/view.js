/*TMODJS:{"debug":true,"version":160,"md5":"98084ea540ce91380284abdd749c694b"}*/
define(function(require) {
    return require("../../../template")("resource/restaurant/view/view", function($data, $filename) {
        try {
            ...
            $line = 49, $out += $escape(restaurant.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo" style="width:1140px;"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">餐标列表</td> </tr> <tr> <td class="style-myself">用餐类型</td> <td class="style-myself">餐标</td> <td class="style-myself">菜单</td> <td class="style-myself">备注</td> </tr> ', 
            $line = 64, $each(restaurant.restaurantStandardList, function(restaurantStandard) {
                ...
                $out += '</td> <td style="padding:10px;">', $line = 74, $out += $escape(restaurantStandard.menuList), 

/*TMODJS:{"debug":true,"version":125,"md5":"ae0f4afae9c9bf2b424124a25b6dc086"}*/
define(function(require) {
    return require("../../../template")("resource/restaurant/view/view", function($data, $filename) {
        try {
            ...
            $line = 49, $out += $escape(restaurant.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">餐标列表</td> </tr> <tr> <td class="style-myself">用餐类型</td> <td class="style-myself">餐标</td> <td class="style-myself">菜单</td> <td class="style-myself">备注</td> </tr> ', 
            $line = 64, $each(restaurant.restaurantStandardList, function(restaurantStandard) {
                $out += ' <tr> <td class="">', $line = 66, "早餐" == restaurantStandard.type ? ($out += " 早餐 ", 
                $line = 68) : "午餐" == restaurantStandard.type ? ($out += " 午餐 ", $line = 70) : ($out += " 晚餐 ", 
                $line = 72), $out += "</td> <td>", $line = 73, $out += $escape(restaurantStandard.typeName), 
                $out += '</td> <td class="rangeTime">', $line = 74, $out += $escape(restaurantStandard.menuList), 
                $out += '</td> <td class="">', $line = 75, $out += $escape(restaurantStandard.remark), 
                $out += "</td> </tr> ", $line = 77;

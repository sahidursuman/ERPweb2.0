/*TMODJS:{"debug":true,"version":78,"md5":"ee6c6bd9bef8850bb60259f1e7ae1d6c"}*/
define(function(require) {
    return require("../../../template")("resource/insurance/view/view", function($data, $filename) {
        try {
            ...
            $line = 25, $out += $escape(insurance.faxNumber), $out += '</td> </tr> <tr> <td class="style-myself style-myselfOne">公司所在省市：</td> <td class="styleOne-self" colspan="3"> ', 
            ...
            $line = 46, $out += $escape(insurance.remark), $out += '</td> </tr> </table> <div class="space-10"></div> </form> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

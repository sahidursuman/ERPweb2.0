/*TMODJS:{"debug":true,"version":91,"md5":"b4fb5530456f5d1cfd7d13ba9764f5b9"}*/
    ...
    return require("../../../template")("resource/insurance/view/view", function($data, $filename) {
        try {
            ...
            $line = 49, $each(insurance.insuranceItemList, function(rs) {
                ...
                $line = 51, $out += $escape(rs.name), $out += "</td> <td>", $line = 52, $out += $escape(rs.price), 
                $out += "</td> <td>", $line = 53, $out += $escape(rs.days), $out += "天</td> <td>", 
                $line = 54, $out += $escape(rs.type), $out += "</td> <td>", $line = 55, $out += $escape(rs.remark), 
                $out += "</td> </tr> ", $line = 57;

define(function(require, exports) {
	...
	var hotel = {
			    	...
			    	$obj.find(".btn-hotel-standard-add").click(function(){
				    	...
				    	$obj.find(".hotelRoomStandardList .timeArea button.add").unbind().click(function(){
							...
							var timeLimitDiv = "<div data-index=\""+(index+1)+"\" class=\"clearfix appendDiv div-"+(index+1)+"\" style=\"margin-top:1px\"><input name=\"startTime\" type=\"text\" class=\"datepicker\" style=\"width:100px\"/><label>&nbsp;至&nbsp;</label><input name=\"endTime\" type=\"text\" class=\"datepicker\" style=\"width:100px\"/><label class=\"timeArea\" style=\"float:right; padding-top:3px;\">" + "<button class='btn btn-danger btn-sm btn-white del' style='margin-top: -3px'><i class='ace-icon fa fa-minus bigger-110 icon-only'></i></button>"
								"</label></div>";
							var marketPriceInput = "<div data-index=\""+(index+1)+"\" class=\"clearfix appendDiv div-"+(index+1)+"\" style=\"margin-top:6px\"><input name=\"marketPrice\" type=\"text\" class='col-sm-12 marketPrice'/></div>";
							var contractPriceInput = "<div data-index=\""+(index+1)+"\" class=\"clearfix appendDiv div-"+(index+1)+"\" style=\"margin-top:6px\"><input name=\"contractPrice\" type=\"text\" class='col-sm-12 price'/></div>";
						    ...
						    /*	//初始化省数据
						    	...
						    	$obj.find(".btn-hotel-standard-add").click(function(){
							    		var html = "<tr>" +
							    				...
							    				"<td><div data-index=\"1\" class=\"clearfix div-1\" style=\"margin-top:1px\"><input name=\"marketPrice\" class='col-sm-12' maxlength=\"9\" type=\"text\"/></div></td>" +
							    				"<td><div data-index=\"1\" class=\"clearfix div-1\" style=\"margin-top:1px\"><input name=\"contractPrice\" class='col-sm-12' maxlength=\"9\" type=\"text\"/></div></td>" +
							    				"<td><select name=\"containBreakfast\" class='no-padding foodsAll\'><option value=\"0\">不含</option><option value=\"1\">包含</option></select></td>" +
		...
		modifyOriginalRecord:function(obj){
			...
			var marketPriceInput = "<div data-index=\""+(index+1)+"\" class=\"clearfix div-"+(index+1)+"\" style=\"margin-top:6px\"><input name=\"marketPrice\" type=\"text\" class='col-sm-12'/></div>";
			var contractPriceInput = "<div data-index=\""+(index+1)+"\" class=\"clearfix div-"+(index+1)+"\" style=\"margin-top:6px\"><input name=\"contractPrice\" type=\"text\" class='col-sm-12'/></div>";
			td.append(timeLimitDiv);
			td.next().append(marketPriceInput);
			td.next().next().append(contractPriceInput);

/*TMODJS:{"debug":true,"version":137,"md5":"386842abf13440a822a0a1bbe910c86f"}*/
define(function(require) {
    return require("../../../template")("resource/hotel/view/view", function($data, $filename) {
        try {
            ...
            $line = 64, $out += $escape(hotel.remark), $out += '</td> <td class="style-myself">酒店最低价：</td> <td class="styleOne-self F-float F-money">', 
            ...
            $line = 88, $each(hotel.hotelRoomList, function(room) {
                ...
                $line = 93, $each(room.priceList, function(price) {
                    ...
                    $out += " </div> ", $line = 97;
                }), $out += ' </td> <td> <div class="F-float F-money"> ', $line = 101, $out += $escape(room.normalMarketPrice), 
                $out += " </div> ", $line = 103, $each(room.priceList, function(price) {
                    $out += ' <div class="F-float F-money"> ', $line = 105, $out += $escape(price.marketPrice), 
                    $out += " </div> ", $line = 107;
                }), $out += ' </td> <td> <div class="F-float F-money"> ', $line = 112, $out += $escape(room.normalInnerPrice), 
                $out += " </div> ", $line = 114, $each(room.priceList, function(price) {
                    $out += ' <div class="F-float F-money"> ', $line = 116, $out += $escape(price.contractPrice), 
                    $out += " </div> ", $line = 118;
                ...
                $line = 147, $out += $escape(room.areaSize), $out += ' </td> <td class="F-float F-count"> ', 
                $line = 150, $out += $escape(room.guestNumber), $out += ' </td> <td class="remarkWidth"> ', 

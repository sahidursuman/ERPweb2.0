...
define(function(require,exports){
	...
	BusCompany.addBusList = function($obj,typeFlag){
		var html = "<tr><td><input class=\"col-sm-12\" name=\"licenseNumber\" type=\"text\" maxlength=\"10\"/></td><td><input class=\"col-sm-12\" name=\"brand\" type=\"text\" maxlength=\"32\"/></td><td><input class=\"col-sm-10 F-float F-count\" name=\"seatCount\" type=\"text\" value=\"1\"  maxlength=\"3\"/></td><td class=\"col-sm-1\"><div class=\"input-group col-sm-12\"><input name=\"buyTime\" type=\"text\" class=\"datepicker\" style='width: 130px' /><span class=\"input-group-addon\"><i class=\"fa fa-calendar\"></i></span></div></td><td><select name=\"isChartered\"><option value=\"1\">是</option><option value=\"0\" selected=\"selected\">否</option></select></td>" +								"<td class=\"time\">" +
					...
					"</td>" +
					"<td><div data-index=\"1\" class=\"clearfix div-1\" style=\"margin-top:2px\"><input style=\"width:100px;\" name=\"contractPrice\" class=\" F-float F-money\" maxlength=\"9\" type=\"text\" readonly=\"readonly\"/><label>&nbsp;元</label></div></td>" +
	...
	BusCompany.addTimeArea = function($obj,typeFlag,validator){
		...
		var contractPriceInput = "<div data-index=\""+(index+1)+"\" class=\"clearfix appendDiv div-"+(index+1)+"\" style=\"margin-top:7px\"><input style=\"width:100px;\" name=\"contractPrice\" class=\"F-float F-money\" type=\"text\" maxlength=\"9\"/><label>&nbsp;元</label></div>";
	...
	BusCompany.addDriverList = function($obj){
		var html = "<tr><td><input name=\"driverName\" type=\"text\" maxlength=\"32\" class=\"col-sm-12\" /></td>"+
			...
			"<td><input name=\"driveYears\" class=\"F-float F-count\" maxlength=\"2\" type=\"text\" value=\"1\"/></td>"+

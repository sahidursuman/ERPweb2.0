			...
			var addBusCompanyLayer = layer.open({
				...
				success:function(){
					...
					$driverList.find(".btn-driver-add").click(function(){
						var html = "<tr><td><input name=\"driverName\" type=\"text\" maxlength=\"32\" class=\"col-sm-12\" /></td><td><select name=\"gender\"><option value=\"0\">男</option><option value=\"1\">女</option></select></td><td><input name=\"mobileNumber\" type=\"text\" class=\"col-sm-12\" maxlength=\"11\"/></td><td><input name=\"driveYears\" maxlength=\"2\" type=\"text\" value=\"1\"/></td><td><input name=\"licenseId\" maxlength=\"18\" class=\"col-sm-12\" type=\"text\" /></td><td width=\"8%\"><select name=\"status\" class=\"col-sm-12\"><option value=\"1\">启用</option><option value=\"0\">停用</option></select></td><td><input name=\"remark\" maxlength=\"500\" type=\"text\" class=\"col-sm-12\" /></td><td style=\"width:70px\"><a data-entiy-id=\"\" class=\" btn-xs btn-driver-delete\">删除</a></td></tr>";
					...
					if(result){
						...
						var updateBusCompanyLayer = layer.open({
							...
							success:function(){
								...
								$driverList.find(".btn-driver-add").click(function(){
									var html = "<tr><td><input name=\"driverName\" maxlength=\"32\" type=\"text\" class=\"col-sm-12\" /></td><td><select name=\"gender\" class=\"col-sm-12\"><option value=\"0\">男</option><option value=\"1\">女</option></select></td><td><input name=\"mobileNumber\" maxlength=\"11\" class=\"col-sm-12\" type=\"text\" /></td><td><input name=\"driveYears\" class=\"col-sm-12\" maxlength=\"2\" type=\"text\" value=\"1\"/></td><td><input name=\"licenseId\" maxlength=\"18\" type=\"text\" class=\"col-sm-12\" /></td><td width=\"8%\"><select name=\"status\" class=\"col-sm-12\"><option value=\"1\">启用</option><option value=\"0\">停用</option></select></td><td><input name=\"remark\" type=\"text\" maxlength=\"500\" class=\"col-sm-12\" /></td><td style=\"width:70px\"><a data-entiy-id=\"\" class=\" btn-driver-delete\">删除</a></td></tr>";

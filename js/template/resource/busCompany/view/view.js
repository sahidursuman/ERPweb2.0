/*TMODJS:{"debug":true,"version":162,"md5":"c6385d06eeb2127880e2db1fdf4ee29b"}*/
define(function(require) {
    return require("../../../template")("resource/busCompany/view/view", function($data, $filename) {
        try {
            ...
            $line = 20, $out += $escape(busCompany.mobileNumber), $out += '</td> </tr> <tr> <td class="style-myself">座机号：</td> <td class="styleOne-self">', 
            $line = 24, $out += $escape(busCompany.telNumber), $out += '</td> <td class="style-myself">传真：</td> <td class="styleOne-self">', 
            $line = 26, $out += $escape(busCompany.faxNumber), $out += '</td> </tr> <tr> <td class="style-myself">车队所在省市：</td> <td class="styleOne-self">', 
            ...
            $line = 48, $out += $escape(busCompany.street), $out += '</td> </tr> <tr> <td class="style-myself">车队简介：</td> <td class="styleOne-self" colspan="3">', 
            $line = 52, $out += $escape(busCompany.remark), $out += '</td> </tr> </table> </form> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <table class="whereQ whereTwo"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">车辆列表</td> </tr> <tr> <td class="style-myself">车牌号</td> <td class="styleOne-self">车辆品牌</td> <td class="style-myself">座位数</td> <td class="styleOne-self">购买时间</td> <td class="styleOne-self">协议包车</td> <td class="styleOne-self">包车时限</td> <td class="styleOne-self">包车价格</td> <td class="styleOne-self">备注</td> </tr> ', 
            $line = 71, $each(busCompany.busList, function(bus) {
                ...
                $out += '</td> <td class="style-myself">', $line = 75, $out += $escape(bus.seatCount), 
                $out += '</td> <td class="styleOne-self">', $line = 76, $out += $escape($helpers.dateFormat(bus.buyTime, "yyyy-MM-dd")), 
                $out += '</td> <td class="styleOne-self">', $line = 77, 0 == bus.isChartered ? ($out += " 否 ", 
                $line = 79) : ($out += " 是 ", $line = 81), $out += '</td> <td class="styleOne-self">', 
                $line = 82, $each(bus.priceList, function(price) {
                    ...
                    $out += " <div> ", $line = 93, 0 == bus.isChartered ? ($out += " - ", $line = 95) : ($out += " ", 
                    $line = 96, $out += $escape(price.contractPrice), $out += "元 ", $line = 97), $out += " </div> ", 
                    $line = 99;
                }), $out += '</td> <td class="styleOne-self">', $line = 100, $out += $escape(bus.remark), 
                $out += "</td> </tr> ", $line = 102;
            }), $out += ' </table> <table class="whereQ whereTwo" style="margin-top: 10px;"> <tr> <td colspan="8" class="HeadManage" style="text-align: left">司机列表</td> </tr> <tr> <td class="style-myself">司机姓名</td> <td class="styleOne-self">司机性别</td> <td class="style-myself">司机电话</td> <td class="styleOne-self">司机驾龄</td> <td class="styleOne-self">驾驶证编号</td> <td class="styleOne-self">是否启用</td> <td class="styleOne-self">备注</td> </tr> ', 
            $line = 118, $each(busCompany.driverList, function(driver) {
                ...
                $line = 126, $out += $escape(driver.mobileNumber), $out += '</td> <td class="styleOne-self">', 

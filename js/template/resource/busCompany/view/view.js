/*TMODJS:{"debug":true,"version":169,"md5":"bce681420e1aec1352238277a1eaf783"}*/
    ...
    return require("../../../template")("resource/busCompany/view/view", function($data, $filename) {
        try {
            ...
            $line = 71, $each(busCompany.busList, function(bus) {
                ...
                $out += '</td> <td class="styleOne-self">', $line = 76, null == bus.buyTime || "" == bus.buyTime ? ($out += "-", 
                $line = 76) : ($line = 76, $out += $escape($helpers.dateFormat(bus.buyTime, "yyyy-MM-dd")), 
                $line = 76), $out += '</td> <td class="styleOne-self">', $line = 77, 0 == bus.isChartered ? ($out += " 否 ", 

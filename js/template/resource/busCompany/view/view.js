/*TMODJS:{"debug":true,"version":210,"md5":"e6fb67fbdd7a877c79bf746311d451b4"}*/
    ...
    return require("../../../template")("resource/busCompany/view/view", function($data, $filename) {
        try {
            ...
            $line = 74, $each(busCompany.busList, function(bus) {
                ...
                $out += '</td> <td class="style-myself"><span class="F-float F-count">', $line = 78, 
                $out += $escape(bus.seatCount), $out += '</span></td> <td class="styleOne-self">', 
                $line = 79, null == bus.buyTime || "" == bus.buyTime ? ($out += "-", $line = 79) : ($line = 79, 
                $out += $escape($helpers.dateFormat(bus.buyTime, "yyyy-MM-dd")), $line = 79), $out += '</td> <td class="styleOne-self">', 
                $line = 80, 0 == bus.isChartered ? ($out += " 否 ", $line = 82) : ($out += " 是 ", 
                $line = 84), $out += '</td> <td class="styleOne-self" style="width: 140px">', $line = 85, 
                $each(bus.priceList, function(price) {
                    ...
                    $out += ' <div class="F-float F-money"> ', $line = 96, 0 == bus.isChartered ? ($out += " - ", 
                    $line = 98) : ($out += " ", $line = 99, $out += $escape(price.contractPrice), $out += "元 ", 
                    $line = 100), $out += " </div> ", $line = 102;
            ...
            $line = 121, $each(busCompany.driverList, function(driver) {
                ...
                $line = 129, $out += $escape(driver.mobileNumber), $out += '</td> <td class="styleOne-self F-float F-count">', 

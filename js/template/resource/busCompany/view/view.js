/*TMODJS:{"debug":true,"version":193,"md5":"7a725db41c212acec474568425463cbe"}*/
    ...
    return require("../../../template")("resource/busCompany/view/view", function($data, $filename) {
        try {
            ...
            $line = 71, $each(busCompany.busList, function(bus) {
                ...
                $line = 79) : ($out += " 是 ", $line = 81), $out += '</td> <td class="styleOne-self" style="width: 140px">', 
            ...
            $line = 118, $each(busCompany.driverList, function(driver) {
                ...
                $out += "</td> </tr> ", $line = 136;
            }), $out += ' </table> <div class="space-10"></div> </form> ', new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

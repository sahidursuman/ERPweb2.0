/*TMODJS:{"debug":true,"version":27,"md5":"6e546e32f799264f4728f13c673c739d"}*/
    ...
    return require("../../../template")("busOrder/newOrder/viewCity/viewCity", function($data, $filename) {
        try {
            ...
            $line = 44, $each(order.otherFeeList, function(rs) {
                $out += ' <div> <label class="lineblock width150">费用项：', $line = 46, $out += $escape(rs.name), 
                $out += '</label> <label class="lineblock width150">金额：', $line = 47, $out += $escape(rs.fee), 
            ...
            $line = 66), $out += " </tr> ", $line = 68, order.touristGroupList.length && ($out += " ", 
            $line = 69, $each(order.touristGroupList, function(group, i) {
                $out += ' <tr class="T-sort" data-index="', $line = 70, $out += $escape(group.touristGroupMemberList.length), 
                $out += '" data-id="', $line = 70, $out += $escape(group.id), $out += '" data-content="', 
                $line = 70, $out += $escape($helpers.stringify(group)), $out += '" data-adultcount="', 
                $line = 70, $out += $escape(group.adultCount), $out += '" data-childCount="', $line = 70, 
                $out += $escape(group.childCount), $out += '"> <td rowspan="', $line = 71, $out += $escape(group.touristGroupMemberList.length), 
                $out += '"></td> <td rowspan="', $line = 72, $out += $escape(group.touristGroupMemberList.length), 
                $out += '">', $line = 72, $out += $escape(group.tripNumber), $out += '</td> <td rowspan="', 
                $line = 73, $out += $escape(group.touristGroupMemberList.length), $out += '">', 
                $line = 73, $out += $escape(group.adultCount), $out += "大", $line = 73, $out += $escape(group.childCount), 
                $out += '小</td> <td rowspan="', $line = 74, $out += $escape(group.touristGroupMemberList.length), 
                $out += '">', $line = 74, $out += $escape(group.driverIncomeMoney), $out += "</td> ", 
                $line = 75, group.touristGroupMemberList.length ? ($out += " ", $line = 76, $each(group.touristGroupMemberList, function(rs, index) {
                    $out += " ", $line = 77, 0 == index && ($out += " <td>", $line = 78, $out += $escape(rs.name), 
                    $out += "</td> <td>", $line = 79, $out += $escape(rs.mobileNumber), $out += "</td> ", 
                    $line = 80), $out += " ", $line = 81;
                }), $out += " ", $line = 82) : ($out += " <td></td> <td></td> ", $line = 85), $out += ' <td rowspan="', 
                $line = 86, $out += $escape(group.touristGroupMemberList.length), $out += '"> ', 
                $line = 87, $out += $escape(group.hotelName), $out += ' </td> <td rowspan="', $line = 89, 
                $out += $escape(group.touristGroupMemberList.length), $out += '"> ', $line = 90, 
                $out += $escape(group.hotelAddress), $out += ' </td> <td rowspan="', $line = 92, 
                ...
                $line = 93), $out += '" title="', $line = 93, $out += $escape(group.remark), $out += '"> <span style="white-space: nowrap;">', 
                $line = 94, group.remark ? ($line = 94, $out += $escape(group.remark), $line = 94) : ($out += "&nbsp;", 
                $line = 94), $out += "</span> </div> </td> ", $line = 97, "1" == order.isShowArrangeInfoColumn && ($out += " ", 
                $line = 98, 0 == i && "0" == order.priceType ? ($out += ' <td rowspan="', $line = 99, 
                $out += $escape(order.sumMemberCount), $out += '">', $line = 99, order.arrangeInfo ? ($line = 99, 
                $out += $escape(order.arrangeInfo.driverName), $out += "<br>", $line = 99, $out += $escape(order.arrangeInfo.driverMobileNumber), 
                $out += "<br>", $line = 99, $out += $escape(order.arrangeInfo.licenceNumber), $line = 99) : ($out += '<span class="red">暂未派车</span>', 
                $line = 99), $out += "</td> ", $line = 100, order.isRoundTrip && ($out += ' <td rowspan="', 
                $line = 101, $out += $escape(order.sumMemberCount), $out += '">', $line = 101, order.roundArrangeInfo ? ($line = 101, 
                $out += $escape(order.roundArrangeInfo.driverName), $out += "<br>", $line = 101, 
                $out += $escape(order.roundArrangeInfo.driverMobileNumber), $out += "<br>", $line = 101, 
                $out += $escape(order.roundArrangeInfo.licenceNumber), $line = 101) : ($out += '<span class="red">暂未派车</span>', 
                $line = 101), $out += "</td> ", $line = 102), $out += " ", $line = 103) : "1" == order.priceType && ($out += ' <td rowspan="', 
                $line = 104, $out += $escape(group.touristGroupMemberList.length), $out += '">', 
                $line = 104, group.arrangeInfo ? ($line = 104, $out += $escape(group.arrangeInfo.driverName), 
                $out += "<br>", $line = 104, $out += $escape(group.arrangeInfo.driverMobileNumber), 
                $out += "<br>", $line = 104, $out += $escape(group.arrangeInfo.licenceNumber), $line = 104) : ($out += '<span class="red">暂未派车</span>', 
                $line = 104), $out += "</td> ", $line = 105, order.isRoundTrip && ($out += ' <td rowspan="', 
                $line = 106, $out += $escape(group.touristGroupMemberList.length), $out += '">', 
                $line = 106, group.roundArrangeInfo ? ($line = 106, $out += $escape(group.roundArrangeInfo.driverName), 
                $out += "<br>", $line = 106, $out += $escape(group.roundArrangeInfo.driverMobileNumber), 
                $out += "<br>", $line = 106, $out += $escape(group.roundArrangeInfo.licenceNumber), 
                $line = 106) : ($out += '<span class="red">暂未派车</span>', $line = 106), $out += "</td> ", 
                $line = 107), $out += " ", $line = 108), $out += " ", $line = 109), $out += " </tr> ", 
                $line = 111, $each(group.touristGroupMemberList, function(rs, index) {
                    $out += " ", $line = 112, index > 0 && ($out += " <tr> <td>", $line = 114, $out += $escape(rs.name), 
                    $out += "</td> <td>", $line = 115, $out += $escape(rs.mobileNumber), $out += "</td> </tr> ", 
                    $line = 117), $out += " ", $line = 118;
                }), $out += " ", $line = 119;
            }), $out += " ", $line = 120), $out += ' </table> <div class="col-xs-12"> <p>人数统计：<span class="T-allPeopleText">0大0小</span></p> <p>费用统计：<span class="T-allFeeText">0*(0+0)+0 = <span class="font-size20 red">0</span>元</span></p> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":18,"md5":"1c2769e5c4039687f64b17a1cd7a7c8a"}*/
    ...
    return require("../../../template")("busOrder/newOrder/view/chooseCompany", function($data, $filename) {
        try {
            ...
            $line = 10, $each(bindAccountList, function(rs) {
                ...
                $line = 11, $out += $escape(rs.name), $out += "\" data-companyid='", $line = 11, 
                $out += $escape(rs.companyId), $out += '\'> <td><label> <input class="ace" name="chooseCompanyRadio" type="radio"><span class="lbl"></span></label></td> <td>', 

/*TMODJS:{"debug":true,"version":2,"md5":"696d25724dacea2190f612c95e596d11"}*/
define(function(require) {
    return require("../../../template")("busOrder/newOrder/view/viewOperationRecord", function($data, $filename) {
        try {
            ...
            return $out += '<div class="T-viewOperationRecordContent container-fulid col-xs-12 mar-t20"> <table class="table table-striped table-bordered table-hover table-text-center"> <tr> <th style="width: 145px;max-width: 145px;">处理时间</th> <th style="width: 150px;max-width: 150px;">操作人</th> <th>处理信息</th> </tr> ', 

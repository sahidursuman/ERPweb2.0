/*TMODJS:{"debug":true,"version":183,"md5":"6b2eed7d0eada80abb3fd74cf2ce5d0d"}*/
define(function(require) {
    return require("../../../template")("busOrder/orderList/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover table-text-center T-showHighLight"> <thead> <tr> <th>车队</th> <th>订单编号</th> <th>行程类型</th> <th>行程日期</th> <th>航班号/班次</th> <th>车辆要求</th> <th>游客人数</th> <th>游客联系人</th> <th>游客电话</th> <th>上车点</th> <th>目的地</th> <th>费用</th> <th>订单状态</th> <th>操作</th> </tr> </thead> <tbody> ', 

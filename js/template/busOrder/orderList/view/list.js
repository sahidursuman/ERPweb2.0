/*TMODJS:{"debug":true,"version":185,"md5":"fbd45ae8b694f8cdac3ea67ea9c8f715"}*/
    ...
    return require("../../../template")("busOrder/orderList/view/list", function($data, $filename) {
        try {
            ...
            $line = 21, $each(orderList, function(rs) {
                ...
                $out += '">', $line = 72, ("1" == rs.orderStatus || "2" == rs.orderStatus || "3" == rs.orderStatus) && ($line = 72, 
                $out += $escape(rs.comfirmNeedPayMoney), $out += "元(回复价)<br/>", $line = 72), $out += '<span class="', 
                $line = 72, ("1" == rs.orderStatus || "2" == rs.orderStatus || "3" == rs.orderStatus) && ($out += "textd-line", 

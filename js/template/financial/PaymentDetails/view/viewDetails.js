/*TMODJS:{"debug":true,"version":15,"md5":"35e4cd0ef3b062d11cb9b104dfec7f9a"}*/
define(function(require) {
    return require("../../../template")("financial/PaymentDetails/view/viewDetails", function($data, $filename) {
        try {
            ...
            return $out += '<div class="row" style="margin: 0; padding: 10px 10px 0;"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>团号/收客单号</th> <th>金额</th> <th>备注</th> </tr> </thead> <tbody> ', 
            $line = 11, $each(detailList, function(rs) {
                $out += " <tr> <td>", $line = 13, $out += $escape(rs.number), $out += "</td> <td>", 

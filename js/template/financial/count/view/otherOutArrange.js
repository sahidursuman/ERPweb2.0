/*TMODJS:{"debug":true,"version":36,"md5":"5cc190791033ddc149c5f6613b777351"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/otherOutArrange", function($data, $filename) {
        try {
            ...
            $line = 71), $out += ' type="text" style="width:30%;" value="', $line = 71, $out += $escape(remarkArrangeList.otherOutRemark[0].opCheckRemark), 
            ...
            $line = 74), $out += ' type="text" style="width:30%;" value="', $line = 74, $out += $escape(remarkArrangeList.otherOutRemark[0].financeCheckRemark), 

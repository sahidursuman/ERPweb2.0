/*TMODJS:{"debug":true,"version":54,"md5":"261a344a9db67f64c412cd814a050ab7"}*/
        ...
        try {
            ...
            $line = 30, $each(dayList, function(day) {
                $out += " ", $line = 31, null != day.otherArrange && ($out += " ", $line = 32, $each(day.otherArrange, function(arrange) {
                    ...
                    $out += $escape(arrange.billRemark), $out += '" maxlength="1000" ', $line = 57, 
                    1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', $line = 57), $out += "/>", 
                    $line = 57) : ($line = 57, $out += $escape(arrange.billRemark), $line = 57), $out += "</td> <td>", 
                    $line = 58, 0 == arrange.isConfirmAccount ? ($out += "未对账", $line = 58) : ($out += "已对账", 
                    $line = 58), $out += "</td> </tr> ", $line = 60), $out += " ", $line = 61;

/*TMODJS:{"debug":true,"version":116,"md5":"4745bb7185aa1d1883074b49afe10483"}*/
        ...
        try {
            ...
            $line = 31, $each(dayList, function(day) {
                $out += " ", $line = 32, null != day.otherArrange && ($out += " ", $line = 33, $each(day.otherArrange, function(arrange) {
                    ...
                    $line = 70, 1 == arrange.badStatus ? ($out += " <span> ", $line = 72, 0 == arrange.payType ? ($out += " 现金 ", 
                    $line = 74) : 1 == arrange.payType ? ($out += " 刷卡 ", $line = 76) : 2 == arrange.payType && ($out += " 签单 ", 
                    ...
                    $out += $escape(arrange.realGuidePayMoney), $line = 81), $out += '</span> <span class="F-float F-money">', 
                    $line = 82, $out += $escape(arrange.realGuidePayMoney), $out += "</span>", $line = 82) : ($out += ' <select name="payType"> <option value="0" ', 
                    $line = 84, 0 == arrange.payType && ($out += 'selected="selected"', $line = 84), 
                    $out += '>现金</option> <option value="1" ', $line = 85, 1 == arrange.payType && ($out += 'selected="selected"', 
                    $line = 85), $out += '>刷卡</option> <option value="2" ', $line = 86, 2 == arrange.payType && ($out += 'selected="selected"', 

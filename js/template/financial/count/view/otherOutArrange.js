/*TMODJS:{"debug":true,"version":16,"md5":"b8287d82d89df831aa2e58021585c05e"}*/
        ...
        try {
            ...
            $each(dayList, function(day) {
                $out += " ", $line = 31, null != day.otherArrange && ($out += " ", $line = 32, $each(day.otherArrange, function(arrange) {
                    ...
                    $out += '"> <td>第', $line = 35, $out += $escape(arrange.whichDay), $out += "天</td> <td>", 
                    $line = 36, $out += $escape(arrange.name), $out += "</td> <td>", $line = 37, 1 == arrange.badStatus ? ($out += "<span>", 
                    $line = 37, $out += $escape(arrange.price), $out += "</span>", $line = 37) : ($out += ' <span class="price">', 
                    ...
                    $line = 38), $out += "/></td> <td>", $line = 39, 1 == arrange.badStatus ? ($out += "<span>", 
                    $line = 39, $out += $escape(arrange.memberCount), $out += "</span>", $line = 39) : ($out += ' <input style="width:90px;" type="text" name="realCount" ', 
                    ...
                    $out += "/>", $line = 40), $out += " </td> <td>", $line = 42, 1 == arrange.badStatus ? ($out += "<span>", 
                    $line = 42, $out += $escape(arrange.realReduceMoney), $out += "</span>", $line = 42) : ($out += '<input type="text" name="realReduceMoney" value="', 
                    $line = 42, $out += $escape(arrange.realReduceMoney), $out += '"/>', $line = 42), 
                    $out += " </td> <td>", $line = 44, 1 == arrange.badStatus ? ($out += '<span class="otherOutNeedPayMoney">', 
                    $line = 44, $out += $escape(arrange.payedMoney + arrange.realGuidePayMoney), $out += "</span>", 
                    $line = 44) : ($out += '<span class="otherOutNeedPayMoney"></span>', $line = 44), 
                    $out += ' <input type="hidden" name="needPayMoney" value="', $line = 45, $out += $escape(arrange.needPayMoney), 
                    $out += '"></td> <td>', $line = 46, $out += $escape(arrange.payedMoney), $out += "</td> <td>", 
                    $line = 47, 1 == arrange.badStatus ? ($out += "<span>", $line = 47, $out += $escape(arrange.realGuidePayMoney), 
                    $out += "</span>", $line = 47) : ($out += '<input style="width:90px;" type="text" name="realGuidePayMoney" ', 
                    $line = 47, null != arrange.billUpdateTime ? ($out += 'value="', $line = 47, $out += $escape(arrange.realGuidePayMoney), 
                    $out += '" ', $line = 47) : ($out += "value=0", $line = 47), $out += ' old="', $line = 47, 
                    $out += $escape(arrange.realGuidePayMoney), $out += '" maxlength="11" ', $line = 47, 
                    1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', $line = 47), $out += "/>", 
                    $line = 47), $out += ' <input type="hidden" name="payedMoney" value="', $line = 48, 
                    ...
                    $out += $escape(arrange.billRemark), $line = 57), $out += "</td> ", $line = 58, 
                    2 == tripPlan.billStatus && ($out += "<td>", $line = 58, 0 == arrange.isConfirmAccount ? ($out += "未对账", 
                    $line = 58) : ($out += "已对账", $line = 58), $out += "</td>", $line = 58), $out += " </tr> ", 
                    $line = 60), $out += " ", $line = 61;
            ...
            $line = 71), $out += ' type="text" style="width:30%;" value="', $line = 71, null != remarkArrangeList[9] && ($line = 71, 
            $out += $escape(remarkArrangeList[9].opCheckRemark), $line = 71), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 74, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 74), $out += ' type="text" style="width:30%;" value="', $line = 74, null != remarkArrangeList[9] && ($line = 74, 
            $out += $escape(remarkArrangeList[9].financeCheckRemark), $line = 74), $out += '" /> </div> </div> ', 
            $line = 77), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

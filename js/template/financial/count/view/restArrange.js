/*TMODJS:{"debug":true,"version":12,"md5":"f7c4e6d50f0b41f59828874a41bfd9dc"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/restArrange", function($data, $filename) {
        try {
            ...
            $each(dayList, function(day) {
                ...
                $each(day.restaurantArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.restaurantArrangeList, function(arrange, index) {
                        ...
                        $out += "</td> <td>", $line = 41, 1 == arrange.badStatus ? ($out += "<span>", $line = 41, 
                        $out += $escape(arrange.price), $out += "</span>", $line = 41) : ($out += '<span class="price">', 
                        ...
                        1 == arrange.badStatus ? ($out += "<span>", $line = 43, $out += $escape(arrange.memberCount), 
                        $out += "</span>", $line = 43) : ($out += '<input style="width:90px;" type="text" name="realCount" ', 
                        ...
                        $line = 45), $out += "/>", $line = 45), $out += " </td> <td>", $line = 47, 1 == arrange.badStatus ? ($out += "<span>", 
                        $line = 47, $out += $escape(arrange.realReduceMoney), $out += "</span>", $line = 47) : ($out += '<input type="text" name="realReduceMoney" value="', 
                        $line = 47, $out += $escape(arrange.realReduceMoney), $out += '" old="', $line = 47, 
                        $out += $escape(arrange.realReduceMoney), $out += '"/>', $line = 47), $out += " </td> <td>", 
                        $line = 49, 1 == arrange.badStatus ? ($out += '<span class="restneedPayMoney">', 
                        ...
                        $line = 50, $out += $escape(arrange.needPayMoney), $out += '" name="needPayMoney"></td> <td>', 
                        $line = 51, $out += $escape(arrange.payedMoney), $out += "</td> <td>", $line = 52, 
                        1 == arrange.badStatus ? ($out += "<span>", $line = 52, $out += $escape(arrange.realGuidePayMoney), 
                        $out += "</span>", $line = 52) : ($out += '<input style="width:90px;" type="text" name="realGuidePayMoney" ', 
            ...
            $line = 77), $out += ' type="text" style="width:30%;" value="', $line = 77, null != remarkArrangeList[5] && ($line = 77, 
            $out += $escape(remarkArrangeList[5].opCheckRemark), $line = 77), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 80, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 80), $out += ' type="text" style="width:30%;" value="', $line = 80, null != remarkArrangeList[5] && ($line = 80, 
            $out += $escape(remarkArrangeList[5].financeCheckRemark), $line = 80), $out += '" /> </div> </div> ', 

/*TMODJS:{"debug":true,"version":61,"md5":"aaa8e99ac80a5bd3fc75092c17af829f"}*/
            ...
            $each(dayList, function(day) {
                ...
                $each(day.restaurantArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.restaurantArrangeList, function(arrange, index) {
                        ...
                        $line = 54, -1 == tripPlan.billStatus ? ($line = 54, 1 == arrange.isChoose ? ($out += '<input type="text" name="price"/> <input type="hidden" name="standardId"><input type="hidden" name="type" value="', 

/*TMODJS:{"debug":true,"version":74,"md5":"03cf52d27ee39ea07444ef7994fbc758"}*/
            ...
            $line = 31, $each(dayList, function(day) {
                ...
                $each(day.restaurantArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.restaurantArrangeList, function(arrange, index) {
                        ...
                        $out += $escape(arrange.billRemark), $line = 79), $out += "</span></td> <td>", $line = 80, 
                        0 == arrange.isConfirmAccount ? ($out += "未对账", $line = 80) : ($out += "已对账", $line = 80), 
                        $out += "</td> </tr> ", $line = 82), $out += " ", $line = 83;
                    }), $out += " ", $line = 84;

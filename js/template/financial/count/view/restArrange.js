/*TMODJS:{"debug":true,"version":79,"md5":"d75b8e625423ec132c9a8ad500a24522"}*/
            ...
            $line = 31, $each(dayList, function(day) {
                ...
                $each(day.restaurantArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.restaurantArrangeList, function(arrange, index) {
                        ...
                        $line = 55, -1 == tripPlan.billStatus ? ($line = 55, 1 == arrange.isChoose ? ($out += "<input ", 
                        $line = 55, 1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', $line = 55), 
                        $out += ' value="', $line = 55, $out += $escape(arrange.price), $out += '" type="text" name="price" /> <input type="hidden" name="standardId"><input type="hidden" name="type" value="', 
                        ...
                        $out += $escape(arrange.realReduceMoney), $out += '" ', $line = 65, 1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', 
                        $line = 65), $out += "/>", $line = 65), $out += " </td> <td>", $line = 67, 1 == arrange.badStatus ? ($out += '<span class="restneedPayMoney F-float F-money">', 
                        $line = 67, $out += $escape(arrange.payedMoney + arrange.realGuidePayMoney), $out += "</span>", 
                        $line = 67) : ($out += '<span class="restneedPayMoney"></span>', $line = 67), $out += ' <input type="hidden" value="', 
                        $line = 68, $out += $escape(arrange.needPayMoney), $out += '" name="needPayMoney"></td> <td><span class="F-float F-money">', 
                        $line = 69, $out += $escape(arrange.payedMoney), $out += "</span></td> <td>", $line = 70, 
                        1 == arrange.badStatus ? ($out += '<span class="F-float F-money">', $line = 70, 
                        $out += $escape(arrange.realGuidePayMoney), $out += "</span>", $line = 70) : ($out += '<input style="width:90px;" type="text" class="F-float F-money" name="realGuidePayMoney" ', 
                        $line = 70, null != arrange.billUpdateTime ? ($out += 'value="', $line = 70, $out += $escape(arrange.realGuidePayMoney), 
                        $out += '"', $line = 70) : ($out += 'value="', $line = 70, $out += $escape(arrange.guidePayMoney), 
                        $out += '" ', $line = 70), $out += ' old="', $line = 70, $out += $escape(arrange.realGuidePayMoney), 
                        $out += '" maxlength="11" ', $line = 70, 1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', 
                        $line = 70), $out += "/>", $line = 70), $out += ' <input type="hidden" name="payedMoney" value="', 
                        $line = 71, $out += $escape(arrange.payedMoney), $out += '" /> <input type="hidden" name="guidePayMoney" value="', 
                        $line = 72, $out += $escape(arrange.guidePayMoney), $out += '" /></td> <td>', $line = 73, 
                        ...
                        $line = 75) : ($out += ' <span style="color:#bbb;">查看</span> ', $line = 77), $out += ' </td> <td><span class="difference"></span></td> <td><span class="billRemark">', 
                        $line = 80, 1 == editStatus ? ($out += '<input name="billRemark" value="', $line = 80, 
                        $out += $escape(arrange.billRemark), $out += '" maxlength="1000" ', $line = 80, 
                        1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', $line = 80), $out += "/>", 
                        $line = 80) : ($line = 80, $out += $escape(arrange.billRemark), $line = 80), $out += "</span></td> <td>", 
                        $line = 81, 0 == arrange.isConfirmAccount ? ($out += "未对账", $line = 81) : ($out += "已对账", 
                        $line = 81), $out += "</td> </tr> ", $line = 83), $out += " ", $line = 84;
                    }), $out += " ", $line = 85;
                }), $out += " ", $line = 86), $out += " ", $line = 87;
            }), $out += " </tbody> </table> ", $line = 91, tripPlan.billStatus > -1 && ($out += ' <div style="width:60%;"> <div> <label style="margin:5px 0px 0px 0px;">财务审核批注：</label> <input name="accountFinancialCheckComment" ', 
            $line = 95, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 95), $out += ' type="text" style="width:30%;" value="', $line = 95, remarkArrangeList.restRemark.length > 0 && ($line = 95, 
            $out += $escape(remarkArrangeList.restRemark[0].opCheckRemark), $line = 95), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 98, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 98), $out += ' type="text" style="width:30%;" value="', $line = 98, remarkArrangeList.restRemark.length > 0 && ($line = 98, 
            $out += $escape(remarkArrangeList.restRemark[0].financeCheckRemark), $line = 98), 

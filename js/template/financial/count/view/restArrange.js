/*TMODJS:{"debug":true,"version":27,"md5":"b2a9fa8135ac84ae1e89e4acf1f662e5"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/restArrange", function($data, $filename) {
        try {
            ...
            $line = 77), $out += ' type="text" style="width:30%;" value="', $line = 77, remarkArrangeList.restRemark.length > 0 && ($line = 77, 
            $out += $escape(remarkArrangeList.restRemark[0].opCheckRemark), $line = 77), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 80, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 80), $out += ' type="text" style="width:30%;" value="', $line = 80, remarkArrangeList.restRemark.length > 0 && ($line = 80, 
            $out += $escape(remarkArrangeList.restRemark[0].financeCheckRemark), $line = 80), 

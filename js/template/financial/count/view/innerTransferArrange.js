/*TMODJS:{"debug":true,"version":24,"md5":"9a30d98eda71d3fd71326d9ae17ae2c1"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/innerTransferArrange", function($data, $filename) {
        try {
            ...
            tripPlan.billStatus > -1 && ($out += ' <div style="width:60%;"> <label style="margin:5px 0px 0px 0px;">财务审核批注：</label> <input name="accountFinancialCheckComment" ', 
            $line = 38, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 38), $out += ' type="text" style="width:30%;" value="', $line = 38, remarkArrangeList.transferRemark.length > 0 && ($line = 38, 
            $out += $escape(remarkArrangeList.transferRemark[0].opCheckRemark), $line = 38), 
            $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 40, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 40), $out += ' type="text" style="width:30%;" value="', $line = 40, remarkArrangeList.transferRemark.length > 0 && ($line = 40, 
            $out += $escape(remarkArrangeList.transferRemark[0].financeCheckRemark), $line = 40), 
            $out += '" /> </div> ', $line = 42), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

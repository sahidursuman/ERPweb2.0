/*TMODJS:{"debug":true,"version":30,"md5":"a3865399159737b720b1fb754c4cf6ec"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/innerTransferArrange", function($data, $filename) {
        try {
            ...
            $utils.$escape), $string = $utils.$string, touristGroup = $data.touristGroup, tripPlan = $data.tripPlan, isFinance = $data.isFinance, remarkArrangeList = $data.remarkArrangeList, isOp = $data.isOp, $out = "";
            ...
            $line = 17, null != transfer && ($out += " ", $line = 18, $each(transfer.transferList, function(transfer, index) {
                ...
                $out += $string(transfer.orderNumber), $out += "</td> <td>", $line = 23, $out += $escape(transfer.contactNme), 
            ...
            tripPlan.billStatus > -1 && ($out += ' <div style="width:60%;"> <div arrangeType="innerTransfer"> <label style="margin:5px 0px 0px 0px;">财务审核批注：</label> <input name="accountFinancialCheckComment" ', 

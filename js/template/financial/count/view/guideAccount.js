/*TMODJS:{"debug":true,"version":181,"md5":"1e4e0b49b6ad8e72750f5a13cffdfbd0"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 17, $each(guideArrange.listMap, function(arrange) {
                ...
                $line = 83), $out += "/> ", $line = 84), $out += " </td> <td>", $line = 86, 0 == arrange.isConfirmAccount ? ($out += ' <a class="R-right ', 
                $line = 87, 1 == editStatus ? ($out += "T-toAccount T-check", $line = 87) : ($out += "black", 
                $line = 87), $out += '" data-right="1200002">未对账</a> ', $line = 88) : ($out += ' <a class="R-right ', 
                $line = 89, 1 == editStatus ? ($out += "T-toAccount T-clear", $line = 89) : ($out += "black", 
                $line = 89), $out += '" data-right="1200005|1200003">已对账</a> ', $line = 90), $out += " </td> </tr> ", 
                $line = 93;

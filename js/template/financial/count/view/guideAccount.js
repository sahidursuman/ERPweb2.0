/*TMODJS:{"debug":true,"version":87,"md5":"d65541e16721220d277bbd25774e6742"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 17, $each(guideArranges, function(rs) {
                ...
                $line = 41, $out += $escape(rs.guideAllPreMoney), $out += "</span></td> <td>", $line = 42, 
                $out += $escape(rs.remark), $out += "</td> <td>", $line = 43, 0 == rs.isConfirmAccount ? ($out += "未对账", 

/*TMODJS:{"debug":true,"version":43,"md5":"1f1a39db1aed85e0ec2183c0e7906ecd"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 16, $each(guideArranges, function(rs) {
                $out += ' <tr guideid = "', $line = 17, $out += $escape(rs.guide.id), $out += '"> <td><input type="radio" name="" ', 
                ...
                $out += "</td> <td>", $line = 37, $out += $escape(rs.price), $out += "</td> <td>", 
                $line = 38, $out += $escape(rs.manageFee), $out += "</td> <td>", $line = 39, $out += $escape(rs.guideAllPreMoney), 

/*TMODJS:{"debug":true,"version":159,"md5":"4e50685decd9423581d3509caf7a3860"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 97), $out += ' type="text" style="width:30%;" value="', $line = 97, remarkArrangeList.guideRemark.length > 0 && ($line = 97, 
            $out += $escape(remarkArrangeList.guideRemark[0].financeCheckRemark), $line = 97), 

/*TMODJS:{"debug":true,"version":73,"md5":"ef2c1268251a165002956b36b36b2a0d"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 51), $out += ' type="text" style="width:30%;" value="', $line = 51, $out += $escape(remarkArrangeList.guideRemark[0].opCheckRemark), 
            ...
            $line = 54), $out += ' type="text" style="width:30%;" value="', $line = 54, $out += $escape(remarkArrangeList.guideRemark[0].financeCheckRemark), 

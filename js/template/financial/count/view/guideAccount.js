/*TMODJS:{"debug":true,"version":122,"md5":"6c9fca91a319150ef25ac91ac4a9f267"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 82, isFinance || ($out += 'readonly="readonly"', $line = 82), $out += ' type="text" style="width:30%;" value="', 
            $line = 82, remarkArrangeList.guideRemark.length > 0 && ($line = 82, $out += $escape(remarkArrangeList.guideRemark[0].opCheckRemark), 
            $line = 82), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 

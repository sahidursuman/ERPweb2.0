/*TMODJS:{"debug":true,"version":54,"md5":"cff1583fc80f0b03ba25ae0b0b4f3409"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 16, $each(guideArranges, function(rs) {
                $out += ' <tr guideid = "', $line = 17, $out += $escape(rs.guide.id), $out += '"> <td><input disabled="disabled" type="radio" name="" ', 

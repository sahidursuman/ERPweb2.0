/*TMODJS:{"debug":true,"version":94,"md5":"41b20df1bce459f2df2172eb14f54f47"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 53, isFinance || ($out += 'readonly="readonly"', $line = 53), $out += ' type="text" style="width:30%;" value="', 
            $line = 53, remarkArrangeList.guideRemark.length > 0 && ($line = 53, $out += $escape(remarkArrangeList.guideRemark[0].opCheckRemark), 
            $line = 53), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 

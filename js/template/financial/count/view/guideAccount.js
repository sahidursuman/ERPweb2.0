/*TMODJS:{"debug":true,"version":67,"md5":"aae54bea22b2480bf57e8cc3bf8acde4"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $out += $escape(remarkArrangeList[8].opCheckRemark), $line = 51), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 54, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 54), $out += ' type="text" style="width:30%;" value="', $line = 54, null != remarkArrangeList[8] && ($line = 54, 
            $out += $escape(remarkArrangeList[8].financeCheckRemark), $line = 54), $out += '" /> </div> </div> ', 
            $line = 57), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

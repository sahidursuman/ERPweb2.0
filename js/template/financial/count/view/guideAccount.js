/*TMODJS:{"debug":true,"version":172,"md5":"e67d2395e17db9ddee5d49d728cb068e"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 17, $each(guideArrange.listMap, function(arrange) {
                ...
                $line = 18, $out += $escape(arrange.isAccountGuide), $out += '" data-id="', $line = 18, 
                $out += $escape(arrange.guideId), $out += '" data-name="', $line = 18, $out += $escape(arrange.guideName), 
                $out += '" data-type="guide"> <input name="sumIpt" type="hidden"> <td> ', $line = 21, 
                ...
                $line = 83), $out += "/> ", $line = 84), $out += " </td> <td>", $line = 86, 0 == arrange.isConfirmAccount ? ($out += ' <a class="', 
                $line = 87, tripPlan.billStatus > -1 ? ($out += "T-toAccount T-check", $line = 87) : ($out += "black", 
                $line = 87), $out += '">未对账</a> ', $line = 88) : ($out += ' <a class="', $line = 89, 
                tripPlan.billStatus > -1 ? ($out += "T-toAccount T-clear", $line = 89) : ($out += "black", 
                $line = 89), $out += '">已对账</a> ', $line = 90), $out += " </td> </tr> ", $line = 93;
            }), $out += " </tbody> </table> ", $line = 97, tripPlan.billStatus > -1 && ($out += ' <div style="width:60%;"> <div arrangeType="guide"> <label style="margin:5px 0px 0px 0px;">财务审核批注：</label> <input name="accountFinancialCheckComment" ', 
            $line = 101, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 101), $out += ' type="text" style="width:30%;" value="', $line = 101, remarkArrangeList.guideRemark.length > 0 && ($line = 101, 
            $out += $escape(remarkArrangeList.guideRemark[0].opCheckRemark), $line = 101), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 103, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 103), $out += ' type="text" style="width:30%;" value="', $line = 103, remarkArrangeList.guideRemark.length > 0 && ($line = 103, 
            $out += $escape(remarkArrangeList.guideRemark[0].financeCheckRemark), $line = 103), 
            $out += '" /> </div> </div> ', $line = 106), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

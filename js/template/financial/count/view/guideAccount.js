/*TMODJS:{"debug":true,"version":82,"md5":"c80e9efdcbd28ab8f7f84bcb2ccae714"}*/
    ...
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            $line = 16, $each(guideArranges, function(rs) {
                ...
                $line = 40, $out += $escape(rs.guideAllPreMoney), $out += '</span></td> <td><input type="text" name="remark" value="', 
                $line = 41, $out += $escape(rs.remark), $out += '" /></td> </tr> ', $line = 43;

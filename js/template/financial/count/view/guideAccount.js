/*TMODJS:{"debug":true,"version":158,"md5":"5ab87716db0114202aedf2dca6e5c786"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/guideAccount", function($data, $filename) {
        try {
            ...
            }), $out += " </tbody> </table> ", $line = 86, tripPlan.billStatus > -1 && ($out += ' <div style="width:60%;"> <div arrangeType="guide"> <label style="margin:5px 0px 0px 0px;">财务审核批注：</label> <input name="accountFinancialCheckComment" ', 
            $line = 90, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 90), $out += ' type="text" style="width:30%;" value="', $line = 90, remarkArrangeList.guideRemark.length > 0 && ($line = 90, 
            $out += $escape(remarkArrangeList.guideRemark[0].opCheckRemark), $line = 90), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 92, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 92), $out += ' type="text" style="width:30%;" value="', $line = 92, remarkArrangeList.guideRemark.length > 0 && ($line = 92, 
            $out += $escape(remarkArrangeList.guideRemark[0].financeCheckRemark), $line = 92), 
            $out += '" /> </div> </div> ', $line = 95), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

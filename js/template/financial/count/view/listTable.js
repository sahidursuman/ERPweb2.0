/*TMODJS:{"debug":true,"version":163,"md5":"9f48b460eb5eef8f4ce1f36aadf00390"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<table class="table table-striped table-bordered table-hover T-showHighLight" style="margin-top: 20px"> <thead> <tr class="bg-blur"> <th style="min-width:50px">团号</th> <th style="min-width:70px">出团日期</th> <th style="min-width:70px">完团日期</th> <th style="min-width:80px">线路产品</th> <th style="min-width:40px">人数</th> <th style="min-width:80px">团队人数</th> <th style="min-width:50px">导游</th> <th style="min-width:40pxpx">收入</th> <th style="min-width:40pxpx">成本</th> <th style="min-width:40pxpx">毛利</th> <th style="min-width:40px">人均毛利</th> <th style="min-width:80px">审核状态</th> <th style="min-width:40px">审核人</th> <th style="min-width:130px">操作</th> </tr> </thead> <tbody class="T-count-list"> ', 

/*TMODJS:{"debug":true,"version":117,"md5":"08a27131a5b5c03f24580295b21accdb"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '" class=" btn-count-examine cursor"> 明细 </a> ', $line = 75, 2 != financialTripPlan.tripPlan.billStatus && ($out += ' <a data-entity-billStatus="', 

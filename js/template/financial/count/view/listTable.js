/*TMODJS:{"debug":true,"version":114,"md5":"e6864e311b249a96d4c4e488f8a96e41"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '"', $line = 65), $out += '> <a data-entity-id="', $line = 67, $out += $escape(financialTripPlan.id), 
                $out += '" class="cursor btn-count-update T-audit"> 审核 <label style="padding-left:10px;">|</label> </a> <a data-entity-id="', 
                $line = 72, $out += $escape(financialTripPlan.id), $out += '" class=" btn-count-examine cursor"> 明细 </a> <a data-entity-billStatus="', 

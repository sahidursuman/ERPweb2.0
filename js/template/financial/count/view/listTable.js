/*TMODJS:{"debug":true,"version":51,"md5":"6305abf3951487ef26a7613894b09f94"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '"', $line = 65), $out += '> <a data-entity-id="', $line = 66, $out += $escape(financialTripPlan.id), 
                $out += '" class="cursor btn-count-update T-audit"> 审核 <label style="padding-left:10px;">|</label> </a> <a data-entity-id="', 
                $line = 70, $out += $escape(financialTripPlan.id), $out += '" class=" btn-count-examine cursor"> 明细 </a> <a data-entity-billStatus="', 
                $line = 73, $out += $escape(financialTripPlan.tripPlan.billStatus), $out += '" data-entity-id="', 
                $line = 73, $out += $escape(financialTripPlan.id), $out += '" class="cursor btn-guide-account R-right" data-right="1190004"> <label class="padding-right20">|</label> 报账 </a> </td> </tr> ', 

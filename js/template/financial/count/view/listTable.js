/*TMODJS:{"debug":true,"version":151,"md5":"73820e4a5d58d06e9ab8090ebdd0ad1c"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                $out += " ", $line = 23, null != financialTripPlan && ($out += ' <tr id="', $line = 24, 
                $out += $escape(financialTripPlan.id), $out += '" billStatus="', $line = 24, $out += $escape(financialTripPlan.tripPlan.billStatus), 
                $out += '" guideFinancialExamine = "', $line = 24, $out += $escape(financialTripPlan.guideFinancialExamine), 
                $out += '"> <td style="min-width:50px" ', $line = 25, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += 'rowspan="', 
                ...
                $line = 70, $out += $escape(financialTripPlan.id), $out += '" class="T-action T-detail cursor"> 明细 </a> ', 
                ...
                $line = 74, $out += $escape(financialTripPlan.id), $out += '" class="cursor T-action T-account R-right" data-right="1190004"> <label class="padding-right20">|</label> 报账 </a> ', 
                $line = 78), $out += " ", $line = 79, financialTripPlan.tripPlan && ($out += ' <a class="cursor R-right T-action T-quality" data-id="', 

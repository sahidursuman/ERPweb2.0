/*TMODJS:{"debug":true,"version":211,"md5":"c3f53e5e9cad0d4914e0648a91b0a871"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 20, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '</td> <td><span class="F-count">', $line = 28, $out += $escape(financialTripPlan.tripPlan.touristAdultCount), 
                $out += '</span>大<span class="F-count">', $line = 28, $out += $escape(financialTripPlan.tripPlan.touristChildCount), 
                $out += "</span>小</td> ", $line = 29) : ($out += " ", $line = 30, $each(financialTripPlan.tripPlan.tripPlanDetails, function(tripPlanDetails, index) {
                    ...
                    $out += '</td> <td><span class="F-count">', $line = 35, $out += $escape(tripPlanDetails.adultCount), 
                    $out += '</span>大 <span class="F-count">', $line = 36, $out += $escape(tripPlanDetails.childCount), 
                    $out += "</span>小</td> ", $line = 37), $out += " ", $line = 38;
                ...
                $line = 40), $out += ">", $line = 40, null != financialTripPlan.tripPlan.guide && ($line = 40, 
                $out += $escape(financialTripPlan.tripPlan.guide.realname), $line = 40), $out += '</td> <td style="vertical-align:middle" ', 
                ...
                $out += '"', $line = 46), $out += ">", $line = 46, -1 == financialTripPlan.tripPlan.billStatus ? ($out += ' <font color="#ff9900">待报账</font> ', 
                $line = 48) : 0 == financialTripPlan.tripPlan.billStatus ? ($out += ' <font color="#ff9900">待审核</font> ', 
                $line = 50) : 1 == financialTripPlan.tripPlan.billStatus ? ($out += ' <font color="green">计调已审</font> ', 
                $line = 52) : 2 == financialTripPlan.tripPlan.billStatus && ($out += ' <font color="green">财务已审</font> ', 
                $line = 54), $out += ' </td> <td style="vertical-align:middle" ', $line = 56, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += 'rowspan="', 
                $line = 56, $out += $escape(financialTripPlan.tripPlan.tripPlanDetails.length), 
                $out += '"', $line = 56), $out += "> ", $line = 57, 2 == financialTripPlan.tripPlan.billStatus ? ($out += " ", 
                $line = 58, null != financialTripPlan.tripPlan.financialCheckUser && ($line = 58, 
                $out += $escape(financialTripPlan.tripPlan.financialCheckUser.realName), $line = 58), 
                $out += " ", $line = 59) : 1 == financialTripPlan.tripPlan.billStatus && ($out += " ", 
                $line = 60, null != financialTripPlan.tripPlan.oPCheckUser && ($line = 60, $out += $escape(financialTripPlan.tripPlan.oPCheckUser.realName), 
                $line = 60), $out += " ", $line = 61), $out += ' </td> <td style="vertical-align:middle" ', 
                $line = 63, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += 'rowspan="', 
                $line = 63, $out += $escape(financialTripPlan.tripPlan.tripPlanDetails.length), 
                $out += '"', $line = 63), $out += '> <a data-entity-billStatus="', $line = 64, $out += $escape(financialTripPlan.tripPlan.billStatus), 
                $out += '" data-entity-id="', $line = 64, $out += $escape(financialTripPlan.id), 
                $out += '" data-guideFinancialExamine="', $line = 64, $out += $escape(financialTripPlan.guideFinancialExamine), 
                $out += '" class="cursor T-action T-update T-audit"> 审核 <label style="padding-left:10px;">|</label> </a> <a data-entity-id="', 
                $line = 68, $out += $escape(financialTripPlan.id), $out += '" class="T-action T-detail cursor"> 明细 </a> ', 
                $line = 71, -1 == financialTripPlan.tripPlan.billStatus && ($out += ' <a data-entity-billStatus="', 
                $line = 72, $out += $escape(financialTripPlan.tripPlan.billStatus), $out += '" data-entity-id="', 
                $line = 72, $out += $escape(financialTripPlan.id), $out += '" class="cursor T-action T-account R-right" data-right="1190004"> <label class="padding-right20">|</label> 报账 </a> ', 
                $line = 76), $out += " ", $line = 77, financialTripPlan.tripPlan && ($out += ' <a class="cursor R-right T-action T-quality" data-id="', 
                $line = 78, $out += $escape(financialTripPlan.tripPlan.id), $out += '" data-right="1190004"> <label class="padding-right20">|</label> 质量 </a> ', 
                $line = 82), $out += " </td> </tr> ", $line = 85, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += " ", 
                $line = 86, $each(financialTripPlan.tripPlan.tripPlanDetails, function(tripPlanDetails, index) {
                    $out += " ", $line = 87, index > 0 && ($out += " <tr> <td>", $line = 89, $out += $escape($helpers.dateFormat(tripPlanDetails.startTime, "yyyy-MM-dd")), 
                    ...
                    $out += '</td> <td> <span class="F-count">', $line = 93, $out += $escape(tripPlanDetails.adultCount), 
                    $out += '</span>大 <span class="F-count">', $line = 94, $out += $escape(tripPlanDetails.childCount), 
                    $out += "</span>小 </td> </tr> ", $line = 97), $out += " ", $line = 98;
                }), $out += " ", $line = 99), $out += " ", $line = 100), $out += " ", $line = 101;
            ...
            $line = 106, $out += $escape(recordSize), $out += ' 条记录</div> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

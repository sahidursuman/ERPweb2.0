/*TMODJS:{"debug":true,"version":198,"md5":"b2f8568272e34d2dca6caeda9cc8a33f"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 20, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '</td> <td><span class="F-float F-count">', $line = 28, $out += $escape(financialTripPlan.tripPlan.touristAdultCount), 
                $out += '</span>大<span class="F-float F-count">', $line = 28, $out += $escape(financialTripPlan.tripPlan.touristChildCount), 

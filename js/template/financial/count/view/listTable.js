/*TMODJS:{"debug":true,"version":22,"md5":"af900a590c6bb630b42a0b7a130e51d8"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '"', $line = 65), $out += "> ", $line = 66, -1 == financialTripPlan.tripPlan.billStatus ? ($out += " ", 
                $line = 67) : ($out += ' <a data-entity-billStatus="', $line = 68, $out += $escape(financialTripPlan.tripPlan.billStatus), 
                $out += '" data-entity-id="', $line = 68, $out += $escape(financialTripPlan.id), 
                $out += '" class="cursor btn-count-update"> 审核 </a><a href="" class="cursor"> |</a>', 
                $line = 70), $out += ' <a data-entity-id="', $line = 71, $out += $escape(financialTripPlan.id), 
                $out += '" class=" btn-count-examine cursor"> 明细 </a><a href="" class="cursor"> |</a> <a data-entity-billStatus="', 
                $line = 74, $out += $escape(financialTripPlan.tripPlan.billStatus), $out += '" data-entity-id="', 
                $line = 74, $out += $escape(financialTripPlan.id), $out += '" class="cursor btn-guide-account" > 报账 </a> </td> </tr> ', 
                $line = 79, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += " ", 
                $line = 80, $each(financialTripPlan.tripPlan.tripPlanDetails, function(tripPlanDetails, index) {
                    $out += " ", $line = 81, index > 0 && ($out += " <tr> <td>", $line = 83, $out += $escape($helpers.dateFormat(tripPlanDetails.startTime, "yyyy-MM-dd")), 
                    $out += "</td> <td>", $line = 84, $out += $escape($helpers.dateFormat(tripPlanDetails.endTime, "yyyy-MM-dd")), 
                    $out += "</td> <td>", $line = 85, $out += $escape(tripPlanDetails.lineProductName), 
                    $out += "</td> <td>", $line = 86, $out += $escape(tripPlanDetails.sumMemberCount), 
                    $out += "</td> </tr> ", $line = 88), $out += " ", $line = 89;
                }), $out += " ", $line = 90), $out += " ", $line = 91), $out += " ", $line = 92;
            ...
            $out += " ", $line = 110), $out += ' </a> </li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="next" href="javascript:void(0)">下一页</a></li> <li class="paginate_button" aria-controls="dynamic-table" tabindex="0"><a class="last" href="javascript:void(0)">尾页</a></li> </ul> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

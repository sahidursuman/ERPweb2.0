/*TMODJS:{"debug":true,"version":160,"md5":"c5f2c29137ce4bf33269b25dbeebbacb"}*/
    ...
    return require("../../../template")("financial/count/view/listTable", function($data, $filename) {
        try {
            ...
            $line = 22, $each(tripPlanList, function(financialTripPlan) {
                ...
                $out += '</td> <td><span class="F-float F-count">', $line = 30, $out += $escape(financialTripPlan.tripPlan.touristAdultCount + financialTripPlan.tripPlan.touristChildCount), 
                $out += "</span></td> ", $line = 31) : ($out += " ", $line = 32, $each(financialTripPlan.tripPlan.tripPlanDetails, function(tripPlanDetails, index) {
                ...
                $out += '"', $line = 47), $out += '><span class="F-float F-money">', $line = 47, 
                $out += $escape(financialTripPlan.perGrossProfitMoney), $out += '</span></td> <td style="vertical-align:middle" ', 
                $line = 48, financialTripPlan.tripPlan.tripPlanDetails.length > 1 && ($out += 'rowspan="', 

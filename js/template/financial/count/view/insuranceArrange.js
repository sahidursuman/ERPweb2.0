/*TMODJS:{"debug":true,"version":70,"md5":"e5ae79c644fb8be99d6790968d2d6e05"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $line = 40, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 40), $out += ' type="text" style="width:30%;" value="', $line = 40, remarkArrangeList.insuranceRemark.length > 0 && ($line = 40, 
            $out += $escape(remarkArrangeList.insuranceRemark[0].opCheckRemark), $line = 40), 

/*TMODJS:{"debug":true,"version":20,"md5":"25075724462de1dccaf3d21687df1492"}*/
    ...
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $each(insuranceArrangeList, function(insuranceArrange) {
                ...
                $out += "</td> <td>", $line = 18, $out += $escape(insuranceArrange.type), $out += '</td> <td><span class="F-float F-money">', 
                $line = 19, $out += $escape(insuranceArrange.price), $out += '</span></td> <td><span class="F-float F-count">', 
                $line = 20, $out += $escape(insuranceArrange.memberCount), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 21, $out += $escape(insuranceArrange.needPayMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 22, $out += $escape(insuranceArrange.payedMoney), $out += "</span></td> <td></td> </tr> ", 
                $line = 25;
            ...
            $line = 33), $out += ' type="text" style="width:30%;" value="', $line = 33, null != remarkArrangeList[3] && ($line = 33, 
            $out += $escape(remarkArrangeList[3].opCheckRemark), $line = 33), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 36, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 36), $out += ' type="text" style="width:30%;" value="', $line = 36, null != remarkArrangeList[11] && ($line = 36, 
            $out += $escape(remarkArrangeList[11].financeCheckRemark), $line = 36), $out += '" /> </div> </div> ', 
            $line = 39), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

/*TMODJS:{"debug":true,"version":103,"md5":"e83d4444f7bcec70167d8140f4e1aa0a"}*/
    ...
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $line = 14, $each(insuranceArrange, function(arrange) {
                ...
                $line = 15, $out += $escape(arrange.name), $out += '" data-type="insurance"> <input name="sumIpt" type="hidden"> <td>', 
                $line = 17, $out += $escape(arrange.name), $out += "</td> <td>", $line = 18, $out += $escape(arrange.type), 
                $out += '</td> <td><span class="F-float F-money">', $line = 19, $out += $escape(arrange.realPrice), 
                $out += '</span></td> <td><span class="F-float F-count">', $line = 20, $out += $escape(arrange.realCount), 
                $out += '</span></td> <td> <span class="F-float F-money realNeedPayMoney">', $line = 22, 
                $out += $escape(arrange.realNeedPayMoney), $out += '</span> <input name="realNeedPayMoney" value="', 
                ...
                0 == arrange.isConfirmAccount ? ($out += ' <a class="', $line = 28, tripPlan.billStatus > -1 ? ($out += "T-toAccount T-check", 
                $line = 28) : ($out += "black", $line = 28), $out += '">未对账</a> ', $line = 29) : ($out += ' <a class="', 
                $line = 30, tripPlan.billStatus > -1 ? ($out += "T-toAccount T-clear", $line = 30) : ($out += "black", 
                $line = 30), $out += '">已对账</a> ', $line = 31), $out += " </td> </tr> ", $line = 34;

/*TMODJS:{"debug":true,"version":112,"md5":"19ba1dc4b57bb3b6d720472a9dc4bd9b"}*/
    ...
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $line = 14, $each(insuranceArrange, function(arrange) {
                ...
                0 == arrange.isConfirmAccount ? ($out += ' <a class="', $line = 28, 1 == editStatus ? ($out += "T-toAccount T-check", 
                $line = 28) : ($out += "black", $line = 28), $out += '">未对账</a> ', $line = 29) : ($out += ' <a class="', 
                $line = 30, 1 == editStatus ? ($out += "T-toAccount T-clear", $line = 30) : ($out += "black", 

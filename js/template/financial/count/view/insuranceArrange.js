/*TMODJS:{"debug":true,"version":48,"md5":"1e81be9e1e36561e3036a974062a3012"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $line = 32, isFinance || ($out += 'readonly="readonly"', $line = 32), $out += ' type="text" style="width:30%;" value="', 
            $line = 32, remarkArrangeList.insuranceRemark.length > 0 && ($line = 32, $out += $escape(remarkArrangeList.insuranceRemark[0].opCheckRemark), 
            $line = 32), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 

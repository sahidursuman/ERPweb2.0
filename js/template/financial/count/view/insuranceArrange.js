/*TMODJS:{"debug":true,"version":11,"md5":"1453a84f38bebc04a753228825022dfa"}*/
    ...
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            $each(insuranceArrangeList, function(insuranceArrange) {
                ...
                $out += "</td> <td>", $line = 18, $out += $escape(insuranceArrange.type), $out += "</td> <td>", 
                $line = 19, $out += $escape(insuranceArrange.price), $out += "</td> <td>", $line = 20, 
                $out += $escape(insuranceArrange.memberCount), $out += "</td> <td>", $line = 21, 
                $out += $escape(insuranceArrange.needPayMoney), $out += "</td> <td>", $line = 22, 

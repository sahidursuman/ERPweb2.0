/*TMODJS:{"debug":true,"version":80,"md5":"686be7940556bcc62953454e578f431a"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/insuranceArrange", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover"> <thead> <tr class="bg-blur"> <th>保险公司</th> <th>险种</th> <th>单价</th> <th>数量</th> <th>应付</th> <th>已付</th> <th>对账状态</th> </tr> </thead> <tbody class="T-count-insurance"> ', 

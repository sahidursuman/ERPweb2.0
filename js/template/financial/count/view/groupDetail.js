/*TMODJS:{"debug":true,"version":79,"md5":"dc3e2c8e3f5875ac0e5958feb8a28c44"}*/
        ...
        try {
            ...
            $line = 20, $each(touristGroupList, function(touristGroup, index) {
                ...
                $out += "<br /> ", $line = 34, $each(touristGroup.touristGroupFeeList, function(touristGroupFee) {
                    ...
                    $out += "<br /> ", $line = 36;
                }), $out += " ", $line = 37), $out += " </td> <td>", $line = 39, null != touristGroup.remark && ($line = 39, 
                $out += $escape(touristGroup.remark), $line = 39), $out += "</td> </tr> ", $line = 41;

/*TMODJS:{"debug":true,"version":61,"md5":"9cc566d421fa003402f404ea3a860bc4"}*/
        ...
        try {
            ...
            $line = 20, $each(touristGroupList, function(touristGroup, index) {
                ...
                $out += "<br /> ", $line = 46, $each(touristGroup.touristGroupFeeList, function(touristGroupFee) {
                    ...
                    $out += "<br /> ", $line = 48;
                }), $out += " ", $line = 49), $out += " </td> <td>", $line = 51, null != touristGroup.touristGroupMember && ($line = 51, 
                $out += $escape(touristGroup.touristGroupMember.transRemark), $line = 51), $out += "</td> </tr> ", 
                $line = 53;

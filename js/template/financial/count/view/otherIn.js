/*TMODJS:{"debug":true,"version":51,"md5":"3eda9e7e72c1e76cc57046c4bdb21a7d"}*/
    ...
    return require("../../../template")("financial/count/view/otherIn", function($data, $filename) {
        try {
            ...
            $each(arrangeIncomePaymentList, function(otherInCome) {
                ...
                $line = 31), $out += '/></td> <td><input type="text" class="F-float F-money w-80" name="price" value="', 
                ...
                $out += ' /></td> <td><input type="text" class="F-float F-count w-50" name="count" value="', 

/*TMODJS:{"debug":true,"version":10,"md5":"ac761c0eddfba420e05a8b8575efc421"}*/
    ...
    return require("../../../template")("financial/count/view/otherIn", function($data, $filename) {
        try {
            ...
            $each(arrangeIncomePaymentList, function(otherInCome) {
                ...
                $out += '">第', $line = 29, $out += $escape(otherInCome.whichDay), $out += '天</td> <td><input style="width:90px;" type="text" name="title" reset="true" value="', 
                ...
                $line = 30), $out += '/></td> <td><input style="width:90px;" type="text" name="price" value="', 
                ...
                $line = 32), $out += ' /></td> <td><input style="width:90px;" type="text" name="count" value="', 
                ...
                $line = 35), $out += '/></td> <td><span class="needPayMoney"><input type="hidden" name="needPayMoney" value="', 
                ...
                $out += $escape(arrange.billRemark), $line = 44), $out += "</td> ", $line = 45, 
            ...
            $line = 55), $out += ' type="text" style="width:30%;" value="', $line = 55, null != remarkArrangeList[3] && ($line = 55, 
            $out += $escape(remarkArrangeList[3].opCheckRemark), $line = 55), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 58, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 58), $out += ' type="text" style="width:30%;" value="', $line = 58, null != remarkArrangeList[3] && ($line = 58, 
            $out += $escape(remarkArrangeList[3].financeCheckRemark), $line = 58), $out += '" /> </div> </div>', 
            $line = 60), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

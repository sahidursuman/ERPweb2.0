/*TMODJS:{"debug":true,"version":53,"md5":"cc33eda7d54f6122c8bc1231c19aca3b"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/busArrange", function($data, $filename) {
        try {
            ...
            $line = 84), $out += ' type="text" style="width:30%;" value="', $line = 84, null != remarkArrangeList[4] && ($line = 84, 
            $out += $escape(remarkArrangeList[4].opCheckRemark), $line = 84), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 87, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 87), $out += ' type="text" style="width:30%;" value="', $line = 87, null != remarkArrangeList[4] && ($line = 87, 
            $out += $escape(remarkArrangeList[4].financeCheckRemark), $line = 87), $out += '" /> </div> </div> ', 
            $line = 90), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

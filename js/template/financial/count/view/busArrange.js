/*TMODJS:{"debug":true,"version":57,"md5":"18ae14f2ed8a8c5b8d2dee256fdfe4d2"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/busArrange", function($data, $filename) {
        try {
            ...
            $line = 84), $out += ' type="text" style="width:30%;" value="', $line = 84, $out += $escape(remarkArrangeList.busRemark[0].opCheckRemark), 
            ...
            $line = 87), $out += ' type="text" style="width:30%;" value="', $line = 87, $out += $escape(remarkArrangeList.busRemark[0].financeCheckRemark), 

/*TMODJS:{"debug":true,"version":74,"md5":"cc23a5344e6dadb8a995fcc3e3c3b86d"}*/
    ...
    return require("../../../template")("financial/count/view/busArrange", function($data, $filename) {
        try {
            ...
            $line = 34, $each(busCompanyArrange, function(busCompany) {
                ...
                $out += $escape(busCompany.realGuidePayMoney), $out += '"', $line = 62) : ($out += 'value="', 
                $line = 62, $out += $escape(busCompany.guidePayMoney), $out += '" ', $line = 62), 
                $out += ' old="', $line = 62, $out += $escape(busCompany.realGuidePayMoney), $out += '" maxlength="11" ', 
                $line = 62, 1 == busCompany.isConfirmAccount && ($out += ' readOnly="readOnly" ', 
                ...
                $line = 72, $out += $escape(busCompany.billRemark), $out += '" name="billRemark" type="text"></td> <td>', 
                $line = 73, 0 == busCompany.isConfirmAccount ? ($out += "未对账", $line = 73) : ($out += "已对账", 
                $line = 73), $out += "</td> </tr> ", $line = 75), $out += " ", $line = 76;

/*TMODJS:{"debug":true,"version":37,"md5":"f752b72bf7b891a1a4a85b98e19ae861"}*/
    ...
    return require("../../../template")("financial/count/view/busArrange", function($data, $filename) {
        try {
            ...
            $each(busCompanyArrange, function(busCompany) {
                ...
                $out += $escape(busCompany.busCompany.companyName), $line = 37), $out += "</td> <td>", 
                $line = 38, null != busCompany.busCompany && ($line = 38, $out += $escape(busCompany.busCompany.companyName), 
                $line = 38), $out += "</td> <td>", $line = 39, null != busCompany.busCompany && ($line = 39, 
                $out += $escape(busCompany.busCompany.companyName), $line = 39), $out += "</td> <td>", 
                $line = 40, null != busCompany.busCompany && ($line = 40, $out += $escape(busCompany.busCompany.companyName), 
                $line = 40), $out += "</td> <td>", $line = 41, null != busCompany.bus && ($line = 41, 
                $out += $escape(busCompany.bus.licenseNumber), $line = 41), $out += "</td> <td>", 
                $line = 42, null != busCompany.bus && ($out += '<span calss="F-float F-count">', 
                $line = 42, $out += $escape(busCompany.bus.seatCount), $out += "</span>", $line = 42), 
                $out += "</td> <td>", $line = 43, 1 == busCompany.badStatus ? ($out += '<span class="F-float F-money">', 
                $line = 43, $out += $escape(busCompany.price), $out += "</span>", $line = 43) : ($out += '<input type="text" name="price" value="', 
                $line = 43, $out += $escape(busCompany.price), $out += '" class="F-float F-money"/>', 
                $line = 43), $out += '<input type="hidden" name="price" value="', $line = 43, $out += $escape(busCompany.price), 
                $out += '" /><input type="hidden" name="realPrice" value="', $line = 43, $out += $escape(busCompany.price), 
                $out += '" /><input type="hidden" name="realCount" value="1" /></td> <td>', $line = 44, 
                1 == busCompany.badStatus ? ($out += '<span class="F-float F-money"> ', $line = 44, 
                $out += $escape(busCompany.realReduceMoney), $out += "</span>", $line = 44) : ($out += '<input type="text" class="F-float F-money" name="realReduceMoney" value="', 
                $line = 44, $out += $escape(busCompany.realReduceMoney), $out += '" old="', $line = 44, 
                $out += $escape(busCompany.realReduceMoney), $out += '"/>', $line = 44), $out += "</td> <td>", 
                $line = 45, 1 == busCompany.badStatus ? ($out += '<span class="BusneedPayMoney F-float F-money">', 
                $line = 45, $out += $escape(busCompany.payedMoney + busCompany.realGuidePayMoney), 
                $out += "</span>", $line = 45) : ($out += '<span class="BusneedPayMoney F-float F-money"></span>', 
                $line = 45), $out += ' <input type="hidden" name="needPayMoney" value="', $line = 46, 
                $out += $escape(busCompany.needPayMoney), $out += '"/></td> <td><span class="F-float F-money">', 
                $line = 47, $out += $escape(busCompany.payedMoney), $out += "</span></td> <td>", 
                $line = 48, 1 == busCompany.badStatus ? ($out += '<span class="F-float F-money">', 
                $line = 48, $out += $escape(busCompany.realGuidePayMoney), $out += "</span>", $line = 48) : ($out += '<input style="width:90px;" class="F-float F-money" type="text" name="realGuidePayMoney" ', 
                $line = 48, null != busCompany.billUpdateTime ? ($out += 'value="', $line = 48, 
                $out += $escape(busCompany.realGuidePayMoney), $out += '"', $line = 48) : ($out += "value=0 ", 
                $line = 48), $out += ' old="', $line = 48, $out += $escape(busCompany.realGuidePayMoney), 
                $out += '" maxlength="11" ', $line = 48, 1 == busCompany.isConfirmAccount && ($out += ' readOnly="readOnly" ', 
                $line = 48), $out += "/>", $line = 48), $out += ' <input type="hidden" name="payedMoney" value="', 
                $line = 49, $out += $escape(busCompany.payedMoney), $out += '" ', $line = 49, 1 == busCompany.isConfirmAccount && ($out += 'readOnly="readOnly"', 
                $line = 49), $out += '/> <input type="hidden" name="guidePayMoney" value="', $line = 50, 
                $out += $escape(busCompany.guidePayMoney), $out += '" /></td> <td>', $line = 51, 
                null != busCompany.billImage && "" != busCompany.billImage ? ($out += ' <a href="javascript:void(0);" url="', 
                $line = 52, $out += $escape(busCompany.billImage), $out += '" class="btn-view">查看</a> ', 
                $line = 53) : ($out += ' <span style="color:#bbb;">查看</span> ', $line = 55), $out += ' </td> <td><span class="difference F-float F-money"></span></td> <td><input value="', 
                $line = 58, $out += $escape(busCompany.billRemark), $out += '" name="billRemark" type="text"></td> ', 
                $line = 59, 2 == tripPlan.billStatus && ($out += "<td>", $line = 59, 0 == busCompany.isConfirmAccount ? ($out += "未对账", 
                $line = 59) : ($out += "已对账", $line = 59), $out += "</td>", $line = 59), $out += " </tr> ", 
                $line = 61), $out += " ", $line = 62;
            ...
            $line = 70, 1 == tripPlan.billStatus && isFinance || ($out += 'readonly="readonly"', 
            $line = 70), $out += ' type="text" style="width:30%;" value="', $line = 70, null != remarkArrangeList[4] && ($line = 70, 
            $out += $escape(remarkArrangeList[4].opCheckRemark), $line = 70), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 73, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 73), $out += ' type="text" style="width:30%;" value="', $line = 73, null != remarkArrangeList[4] && ($line = 73, 
            $out += $escape(remarkArrangeList[4].financeCheckRemark), $line = 73), $out += '" /> </div> </div> ', 
            $line = 76), new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

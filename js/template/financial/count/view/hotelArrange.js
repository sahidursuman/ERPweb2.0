/*TMODJS:{"debug":true,"version":59,"md5":"e115df3275a885da04388fb71b675b4e"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/hotelArrange", function($data, $filename) {
        try {
            ...
            $each(dayList, function(day) {
                $out += " ", $line = 32, null != day.hotelArrange && ($out += " ", $line = 33, $each(day.hotelArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.hotelArrangeList, function(arrange, index) {
                        ...
                        $out += $escape(arrange.hotelRoom.id), $line = 36), $out += '" whichDay = "', $line = 36, 
                        $out += $escape(arrange.whichDay), $out += '"> ', $line = 37, 0 == index && ($out += '<td rowspan="', 
                        $line = 37, $out += $escape(arrangeList.hotelArrangeList.length), $out += '"><span class="whichDay"></span></td>', 
                        $line = 37), $out += " ", $line = 38, 0 == index && ($out += '<td rowspan="', $line = 38, 
                        $out += $escape(arrangeList.hotelArrangeList.length), $out += '">', $line = 38, 
                        null != arrange.hotel && ($line = 38, $out += $escape(arrange.hotel.name), $line = 38), 
                        $out += "</td>", $line = 38), $out += " <td>", $line = 39, null != arrange.hotelRoom && ($line = 39, 
                        ...
                        $out += '"', $line = 49) : ($out += 'value="', $line = 49, $out += $escape(arrange.guidePayMoney), 
                        $out += '" ', $line = 49), $out += ' oid="', $line = 49, $out += $escape(arrange.realGuidePayMoney), 
                        $out += '" maxlength="11" ', $line = 49, 1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', 
                        $line = 49), $out += "/>", $line = 49), $out += ' <input type="hidden" name="payedMoney" value="', 
                        $line = 50, $out += $escape(arrange.payedMoney), $out += '" /> <input type="hidden" name="guidePayMoney" value="', 
            ...
            $line = 74), $out += ' type="text" style="width:30%;" value="', $line = 74, remarkArrangeList.hotelRemark.length > 0 && ($line = 74, 
            $out += $escape(remarkArrangeList.hotelRemark[0].opCheckRemark), $line = 74), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 77, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 77), $out += ' type="text" style="width:30%;" value="', $line = 77, remarkArrangeList.hotelRemark.length > 0 && ($line = 77, 
            $out += $escape(remarkArrangeList.hotelRemark[0].financeCheckRemark), $line = 77), 

/*TMODJS:{"debug":true,"version":21,"md5":"cf8c7c110fd45fd0426ff5c8fb5deb98"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/hotelArrange", function($data, $filename) {
        try {
            ...
            $each(dayList, function(day) {
                $out += " ", $line = 32, null != day.hotelArrange && ($out += " ", $line = 33, $each(day.hotelArrange, function(arrangeList) {
                    $out += " ", $line = 34, $each(arrangeList.hotelArrangeList, function(arrange, index) {
                        ...
                        1 == arrange.badStatus ? ($out += "<span>", $line = 41, $out += $escape(arrange.memberCount), 
                        $out += "</span>", $line = 41) : ($out += '<input style="width:90px;" type="text" name="realCount" ', 
                        ...
                        $line = 42), $out += "/>", $line = 42), $out += " </td> <td>", $line = 44, 1 == arrange.badStatus ? ($out += "<span>", 
                        $line = 44, $out += $escape(arrange.realReduceMoney), $out += "</span>", $line = 44) : ($out += '<input type="text" name="realReduceMoney" value="', 
                        $line = 44, $out += $escape(arrange.realReduceMoney), $out += '" old="', $line = 44, 
                        $out += $escape(arrange.realReduceMoney), $out += '"/>', $line = 44), $out += " </td> <td>", 
                        $line = 46, 1 == arrange.badStatus ? ($out += '<span class="hotelneedPayMoney">', 
                        ...
                        $line = 46, $out += $escape(arrange.needPayMoney), $out += '">', $line = 46), $out += " </td> <td>", 
                        $line = 48, $out += $escape(arrange.payedMoney), $out += "</td> <td>", $line = 49, 
                        1 == arrange.badStatus ? ($out += "<span>", $line = 49, $out += $escape(arrange.realGuidePayMoney), 
                        $out += "</span>", $line = 49) : ($out += '<input style="width:90px;" type="text" name="realGuidePayMoney" ', 
                        ...
                        $line = 54) : ($out += ' <span style="color:#bbb;">查看</span> ', $line = 56), $out += ' </td> <td><span class="difference"></span></td> <td>', 
            ...
            $line = 74), $out += ' type="text" style="width:30%;" value="', $line = 74, null != remarkArrangeList[6] && ($line = 74, 
            $out += $escape(remarkArrangeList[6].opCheckRemark), $line = 74), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 77, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 77), $out += ' type="text" style="width:30%;" value="', $line = 77, null != remarkArrangeList[6] && ($line = 77, 
            $out += $escape(remarkArrangeList[6].financeCheckRemark), $line = 77), $out += '" /> </div> </div> ', 

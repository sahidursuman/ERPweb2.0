/*TMODJS:{"debug":true,"version":41,"md5":"0d76873598c603a5d4a028745f233891"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/viewCostRemark", function($data, $filename) {
        try {
            ...
            return $out += '<table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">费用项</th> <th class="th-border">单价</th> <th class="th-border">数量</th> <th class="th-border">单位</th> <th class="th-border">金额</th> <th class="th-border">说明</th> </tr> </thead> <tbody class="T-tripDetail"> <tr> ', 
            $line = 14, touristGroupFeeList.length > 0 ? ($out += " ", $line = 15, $each(touristGroupFeeList, function(touristGroupFee) {
                ...
                $line = 22, $out += $escape(touristGroupFee.price * touristGroupFee.count * touristGroupFee.days), 
                $out += "</span> </td> <td> ", $line = 26, $out += $escape(touristGroupFee.remark), 
                $out += " </td> </tr> ", $line = 29;

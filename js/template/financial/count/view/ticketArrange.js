/*TMODJS:{"debug":true,"version":61,"md5":"663a4139addc998c268c5532d0763d75"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/ticketArrange", function($data, $filename) {
        try {
            ...
            $line = 77), $out += ' type="text" style="width:30%;" value="', $line = 77, $out += $escape(remarkArrangeList.ticketRemark[0].opCheckRemark), 
            ...
            $line = 80), $out += ' type="text" style="width:30%;" value="', $line = 80, $out += $escape(remarkArrangeList.ticketRemark[0].financeCheckRemark), 

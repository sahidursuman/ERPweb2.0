/*TMODJS:{"debug":true,"version":71,"md5":"66572a1ddb4dc428f1ef488930271cea"}*/
        ...
        try {
            ...
            $line = 35, $each(ticketArrangeList, function(ticketArrange) {
                $out += " ", $line = 36, $each(ticketArrange.ticketArrangeList, function(arrange, index) {
                    ...
                    $line = 65, $out += $escape(arrange.billRemark), $out += '" name="billRemark" type="text"></td> <td>', 
                    $line = 66, 0 == arrange.isConfirmAccount ? ($out += "未对账", $line = 66) : ($out += "已对账", 
                    $line = 66), $out += "</td> </tr> ", $line = 68;
                }), $out += " ", $line = 69;

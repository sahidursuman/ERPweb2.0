/*TMODJS:{"debug":true,"version":27,"md5":"06cc69c997b7eab8a2542f66aecbf892"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/shopArrange", function($data, $filename) {
        try {
            ...
            $line = 43, $each(dayList, function(day) {
                $out += " ", $line = 44, null != day.shopArrange && ($out += " ", $line = 45, $each(day.shopArrange, function(shopArrangeList) {
                    $out += " ", $line = 46, $each(shopArrangeList.shopArrangePolicy, function(arrange, index) {
                        ...
                        $line = 49, $out += $escape(shopArrangeList.shopArrangePolicy.length), $out += '">第', 
                        $line = 49, $out += $escape(arrange.whichDay), $out += "天</td>", $line = 49), $out += " ", 
                        $line = 50, 0 == index && ($out += '<td rowspan="', $line = 50, $out += $escape(shopArrangeList.shopArrangePolicy.length), 
                        $out += '">', $line = 50, $out += $escape(arrange.shop.name), $out += "</td>", $line = 50), 
                        $out += ' <td><input name="shopPolicyName" value="', $line = 51, null != arrange.shopPolicy && ($line = 51, 
                        $out += $escape(arrange.shopPolicy.name), $line = 51), $out += '" type="text"><input name="shopPolicyId" type="hidden"></td> <td><input policyId="', 
                        $line = 52, null != arrange.shopPolicy && ($line = 52, $out += $escape(arrange.shopPolicy.id), 
                        ...
                        $out += "_", $line = 60, $out += $escape(arrange.shopId), $out += '"></span></td>', 
                        ...
                        $out += '/></td> <td><span class="travelAgencyRateMoney">', $line = 62, $out += $escape(arrange.travelAgencyRateMoney), 
                        $out += '</span><input type="hidden" class="travelAgencyRateMoney', $line = 62, 
                        $out += $escape(arrange.whichDay), $out += "_", $line = 62, $out += $escape(arrange.shopId), 
                        ...
                        $line = 63), $out += '/></td> <td><span class="guideRateMoney">', $line = 64, $out += $escape(arrange.guideRkateMoney), 
                        $out += '</span><input type="hidden" class="guideRateMoney', $line = 64, $out += $escape(arrange.whichDay), 
                        $out += "_", $line = 64, $out += $escape(arrange.shopId), $out += '" name="guideRateMoney" value="', 
                        $line = 64, $out += $escape(arrange.guideRateMoney), $out += '" ', $line = 65, 1 == arrange.isConfirmAccount && ($out += 'readOnly="readOnly"', 
                        ...
                        $out += ' sumCustomerRebateMoney">', $line = 67, $out += $escape(shopArrangeList.customerRebateMoney), 
                        ...
                        $out += ' sumParkingRebateMoney">', $line = 70, $out += $escape(shopArrangeList.parkingRebateMoney), 
                        ...
                        $out += '"></span></td>', $line = 71), $out += " <!-- ", $line = 72, 0 == index && ($out += '<td rowspan="', 
                        $line = 72, $out += $escape(shopArrangeList.shopArrangePolicy.length), $out += '"><input type="text" style="width:90px;"/></td>', 
                        $line = 72), $out += " --> ", $line = 73, 0 == index && ($out += '<td rowspan="', 
                        $line = 73, $out += $escape(shopArrangeList.shopArrangePolicy.length), $out += '">', 
                        $line = 73, 1 == editStatus ? ($out += '<input name="billRemark" value="', $line = 73, 
                        $out += $escape(arrange.billRemark), $out += '" maxlength="1000" />', $line = 73) : ($line = 73, 
                        $out += $escape(arrange.billRemark), $line = 73), $out += "</td>", $line = 73), 
                        $out += " ", $line = 74, 2 == tripPlan.billStatus && ($out += "<td>", $line = 74, 
                        0 == arrange.isConfirmAccount ? ($out += "未对账", $line = 74) : ($out += "已对账", $line = 74), 
                        $out += "</td>", $line = 74), $out += " </tr> ", $line = 76), $out += " ", $line = 77;
                    }), $out += " ", $line = 78;
            ...
            $line = 87), $out += ' type="text" style="width:30%;" value="', $line = 87, null != remarkArrangeList[1] && ($line = 87, 
            $out += $escape(remarkArrangeList[1].opCheckRemark), $line = 87), $out += '" /> <label style="margin:5px 0px 0px 10px;">计调审核批注：</label> <input name="accountOPCheckComment" ', 
            $line = 90, 0 == tripPlan.billStatus && isOp || ($out += 'readonly="readonly"', 
            $line = 90), $out += ' type="text" style="width:30%;" value="', $line = 90, null != remarkArrangeList[1] && ($line = 90, 
            $out += $escape(remarkArrangeList[1].financeCheckRemark), $line = 90), $out += '" /> </div> </div>', 
            $line = 92), $out += " </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

/*TMODJS:{"debug":true,"version":26,"md5":"1cd05c362ef6fe3e86272cc4e4fa203c"}*/
            ...
            $line = 43, $each(dayList, function(day) {
                $out += " ", $line = 44, null != day.shopArrange && ($out += " ", $line = 45, $each(day.shopArrange, function(shopArrangeList) {
                    $out += " ", $line = 46, $each(shopArrangeList.shopArrangePolicy, function(arrange, index) {
                        ...
                        $out += ' <td><input name="shopPolicyName" value="', $line = 51, $out += $escape(arrange.shopPolicy.name), 
                        $out += '" type="text"><input name="shopPolicyId" type="hidden"></td> <td><input policyId="', 

/*TMODJS:{"debug":true,"version":15,"md5":"baee53c1f4bccb9dde12fe4ba3d2c1f4"}*/
            ...
            $line = 43, $each(dayList, function(day) {
                $out += " ", $line = 44, null != day.shopArrange && ($out += " ", $line = 45, $each(day.shopArrange, function(shopArrangeList) {
                    $out += " ", $line = 46, $each(shopArrangeList.shopArrangePolicy, function(arrange, index) {
                        ...
                        $out += "_", $line = 48, $out += $escape(arrange.shopId), $out += '"> ', $line = 49, 
                        0 == index && ($out += '<td rowspan="', $line = 49, $out += $escape(shopArrangeList.shopArrangePolicy.length), 
                        ...
                        $line = 51, $out += $escape(arrange.shopPolicy.name), $out += '</td> <td><input policyId="', 

/*TMODJS:{"debug":true,"version":30,"md5":"480f16bd75f45abe4dede537fe11c8c5"}*/
            ...
            $line = 43, $each(dayList, function(day) {
                $out += " ", $line = 44, null != day.shopArrange && ($out += " ", $line = 45, $each(day.shopArrange, function(shopArrangeList) {
                    $out += " ", $line = 46, $each(shopArrangeList.shopArrangePolicy, function(arrange, index) {
                        ...
                        $out += $escape(arrange.shopPolicy.name), $line = 51), $out += '" type="text"><input name="shopPolicyId" type="hidden"></td> <td><input class="F-float F-money" policyId="', 
                        ...
                        $line = 73) : ($line = 73, $out += $escape(arrange.billRemark), $line = 73), $out += "</td>", 
                        $line = 73), $out += " ", $line = 74, 2 == tripPlan.billStatus && ($out += "<td>", 

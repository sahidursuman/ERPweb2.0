/*TMODJS:{"debug":true,"version":44,"md5":"2503c7c81c8728aee7229e087eb5d206"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/shopArrange", function($data, $filename) {
        try {
            ...
            $line = 87), $out += ' type="text" style="width:30%;" value="', $line = 87, $out += $escape(remarkArrangeList.shopReamrk[0].opCheckRemark), 
            ...
            $line = 90), $out += ' type="text" style="width:30%;" value="', $line = 90, $out += $escape(remarkArrangeList.shopReamrk[0].financeCheckRemark), 

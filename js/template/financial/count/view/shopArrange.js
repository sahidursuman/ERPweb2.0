/*TMODJS:{"debug":true,"version":72,"md5":"9bb83bb5ea3227d12e2132b52196400e"}*/
            ...
            $line = 35, $each(dayList, function(day) {
                $out += " ", $line = 36, null != day.shopArrange && ($out += " ", $line = 37, $each(day.shopArrange, function(shopArrangeList) {
                    $out += " ", $line = 38, $each(shopArrangeList.shopArrangePolicy, function(arrange, index) {
                        ...
                        $out += ' <td><div data-index="', $line = 43, $out += $escape(index + 1), $out += '">', 
                        $line = 43, null != arrange.shopPolicy ? ($line = 43, $out += $escape(arrange.shopPolicy.name), 
                        ...
                        $line = 44), $out += '</div></td> <td><div data-index="', $line = 45, $out += $escape(index + 1), 
                        ...
                        $line = 61), $out += "/></div></td> ", $line = 63, 0 == index && ($out += '<td rowspan="', 
                        $line = 63, $out += $escape(shopArrangeList.shopArrangePolicy.length), $out += '"><div data-index="', 
                        ...
                        $out += "</div></td>", $line = 63), $out += " ", $line = 65, 2 == tripPlan.billStatus && ($out += "<td>", 

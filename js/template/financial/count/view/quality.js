/*TMODJS:{"debug":true,"version":515,"md5":"28feae40d000922cb6da33845664bbfc"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/quality", function($data, $filename) {
        try {
            ...
            $line = 84, $out += $escape(serviceCount.hotelService.bad), $out += '</td> </tr> </table> </div> <div style="height: 25px"></div> <div class="col-sm-7 pull-right border margin-top" > ', 
            $line = 90, adviceList.length > 0 ? ($out += " ", $line = 91, $each(adviceList, function(advice) {
                $out += ' <div class="pull-left font-bold"> ', $line = 93, $out += $escape(advice.name), 
                $out += '： </div> <div class="pull-left col-sm-11"> ', $line = 96, $out += $escape(advice.advice), 
                $out += " </div> ", $line = 98;
            }), $out += " ", $line = 99) : ($out += " <span>暂时还没有评论哦~</span> ", $line = 101), 

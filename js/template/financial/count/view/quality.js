/*TMODJS:{"debug":true,"version":584,"md5":"0a1b9165253026625d4bfcb45ae9964c"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/quality", function($data, $filename) {
        try {
            ...
            $out += $escape(tripPlan.tripPlanDetails.length), $out += '">', $line = 36, $out += $escape($helpers.dateTimeFormat(tripPlan.createTime)), 

/*TMODJS:{"debug":true,"version":516,"md5":"0c4e4486182490866de3e48a42e3a746"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/quality", function($data, $filename) {
        try {
            ...
            $line = 83, $out += $escape(serviceCount.hotelService.bad), $out += '</td> </tr> </table> </div> <div style="height: 25px"></div> <div class="col-sm-7 pull-right border margin-top" > ', 
            $line = 89, adviceList.length > 0 ? ($out += " ", $line = 90, $each(adviceList, function(advice) {
                $out += ' <div class="pull-left font-bold"> ', $line = 92, $out += $escape(advice.name), 
                $out += '： </div> <div class="pull-left col-sm-11"> ', $line = 95, $out += $escape(advice.advice), 
                $out += " </div> ", $line = 97;
            }), $out += " ", $line = 98) : ($out += " <span>暂时还没有评论哦~</span> ", $line = 100), 

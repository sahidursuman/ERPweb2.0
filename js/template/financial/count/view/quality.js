/*TMODJS:{"debug":true,"version":540,"md5":"06858a8a15ece681fc2f97e445b2e7ce"}*/
define(function(require) {
    return require("../../../template")("financial/count/view/quality", function($data, $filename) {
        try {
            ...
            $line = 62, $out += $escape(serviceCount.guideService.bad), $out += "</td> </tr> <tr> <td>司机服务</td> <td>", 
            ...
            $line = 68, $out += $escape(serviceCount.guideService.notBad), $out += "</td> <td>", 
            $line = 69, $out += $escape(serviceCount.driverService.bad), $out += "</td> </tr> <tr> <td>线路安排</td> <td>", 
            ...
            $line = 76, $out += $escape(serviceCount.lineService.bad), $out += "</td> </tr> <tr> <td>住宿安排</td> <td>", 
            ...
            $line = 83, $out += $escape(serviceCount.hotelService.bad), $out += "</td> </tr> <tr> <td>餐饮安排</td> <td>", 
            ...
            $line = 97, $out += $escape(serviceCount.shoppingService.bad), $out += "</td> </tr> <tr> <td>娱乐安排</td> <td>", 
            ...
            $line = 104, $out += $escape(serviceCount.entertainmentService.bad), $out += '</td> </tr> </table> </div> <div style="height: 25px"></div> <div class="col-sm-7 pull-right border margin-top" > ', 
            $line = 110, adviceList.length > 0 ? ($out += " ", $line = 111, $each(adviceList, function(advice) {
                $out += ' <div class="pull-left font-bold"> ', $line = 113, $out += $escape(advice.name), 
                $out += '： </div> <div class="pull-left col-sm-11"> ', $line = 116, $out += $escape(advice.advice), 
                $out += " </div> ", $line = 118;
            }), $out += " ", $line = 119) : ($out += " <span>暂时还没有评论哦~</span> ", $line = 121), 

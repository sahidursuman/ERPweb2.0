/*TMODJS:{"debug":true,"version":140,"md5":"7023df46247de4ab6865c649273ed914"}*/
    ...
    return require("../../../template")("financial/transfer/view/list", function($data, $filename) {
        try {
            ...
            $line = 15, $each(monthList, function(month) {
                ...
                $line = 17;
            }), $out += ' </select> <button class="btn-sm btn-transfer-search search-btn marginLeft-30"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row transferList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover"> <thead> <tr class="bg-blur"> <th >同行地接</th> <th >总账面应付</th> <th >总实际应付</th> <th >总实际已付</th> <th >总账面未付</th> <th >总实际未付</th> <th >对账进度</th> <th >操作</th> </tr> </thead> <tbody> ', 
            $line = 40, $each(financialTransferList, function(transfer) {
                ...
                $line = 59, $out += $escape(searchParam.month), $out += '" class="cursor btn-transfer-check R-right" data-right="1300002"> 对账 </a> <a data-entity-id="', 
                $line = 62, $out += $escape(transfer.partnerAgencyId), $out += '" data-entity-partnerAgencyName="', 
                $line = 62, $out += $escape(transfer.partnerAgencyName), $out += '" data-entity-year="', 
                $line = 62, $out += $escape(searchParam.year), $out += '" ', $line = 63, "" == searchParam.month ? ($out += " data-entity-startMonth=1 data-entity-endMonth=12 ", 
                $line = 65) : ($out += ' data-entity-startMonth="', $line = 66, $out += $escape(searchParam.month), 
                $out += '" data-entity-endMonth="', $line = 66, $out += $escape(searchParam.month), 
                $out += '" ', $line = 67), $out += ' class="cursor R-right btn-transfer-balance" data-right="1300003"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 74;

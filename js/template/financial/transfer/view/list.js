/*TMODJS:{"debug":true,"version":153,"md5":"86bef54f53452692329e2f71cd5c17e7"}*/
    ...
    return require("../../../template")("financial/transfer/view/list", function($data, $filename) {
        try {
            ...
            $line = 15, $each(monthList, function(month) {
                ...
                $line = 17;
            }), $out += ' </select> <button class="btn-sm btn-transfer-search search-btn marginLeft-30"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row transferList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th >同行地接</th> <th >总账面应付</th> <th >总实际应付</th> <th >总实际已付</th> <th >总账面未付</th> <th >总实际未付</th> <th >对账进度</th> <th >操作</th> </tr> </thead> <tbody> ', 

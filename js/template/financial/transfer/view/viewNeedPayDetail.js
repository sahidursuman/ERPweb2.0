/*TMODJS:{"debug":true,"version":9,"md5":"448b0e13e7cb27b83da21290b44d5c14"}*/
define(function(require) {
    return require("../../../../../template")("js/template/financial/transfer/view/viewNeedPayDetail", function($data, $filename) {
        try {
            ...
            $line = 21, $each(needPayDetailList, function(rs) {
                ...
                $out += $escape(rs.businessType), $line = 24), $out += "</td> <td>", $line = 25, 
                $out += $escape(rs.payDifferenceMoney), $out += "</td> <td>", $line = 26, $out += $escape(rs.remark), 
                $out += "</td> <td>", $line = 27, null == rs.checkRealname || "" == rs.checkRealname ? ($out += "-", 

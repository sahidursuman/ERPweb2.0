/*TMODJS:{"debug":true,"version":36,"md5":"751e8075aa262f1cb0d279fb19daf170"}*/
    ...
    return require("../../../template")("financial/guide/view/operationDetail", function($data, $filename) {
        try {
            ...
            $line = 27, $each(payedRecordList, function(item) {
                ...
                $line = 48, $out += $escape(item.remark), $out += "</td> <td>", $line = 49, $out += $escape(item.checkRealname), 
                $out += "</td> <td>", $line = 50, $out += $escape(item.checkTime), $out += "</td> </tr> ", 
                $line = 52;
            }), $out += " ", $line = 53) : ($out += " ", $line = 54, $each(checkRecordList, function(item) {
                $out += " <tr> <td>", $line = 56, $out += $escape(item.receivableType), $out += "</td> <td>", 
                $line = 57, $out += $escape(item.businessType), $out += '</td> <td><span class="F-float F-money">', 
                $line = 58, $out += $escape(item.settlementMoney), $out += "</span></td> <td>", 
                $line = 59, $out += $escape(item.remark), $out += "</td> <td>", $line = 60, $out += $escape(item.checkRealname), 
                $out += "</td> <td>", $line = 61, $out += $escape(item.checkTime), $out += "</td> </tr> ", 
                $line = 63;
            }), $out += " ", $line = 64), $out += " </tbody> </table> </div>", new String($out);
        } catch (e) {
            throw {
                filename: $filename,
                name: "Render Error",

/*TMODJS:{"debug":true,"version":301,"md5":"8a7ac84b8857675b6af2e8eb9511a080"}*/
define(function(require) {
    return require("../../../template")("financial/guide/view/payment", function($data, $filename) {
        try {
            var $utils = this, $helpers = $utils.$helpers, $line = 0, type = $data.type, $escape = $utils.$escape, orderNumber = $data.orderNumber, createTime = $data.createTime, args = $data.args, resourceName = $data.resourceName, guideInfo = $data.guideInfo, payMoney = $data.payMoney, $out = "";
            return $out += '<div class="T-payment-container hct-pay-wrap"> <div class="row"> ', 
            $line = 3, 0 != type && ($out += ' <div class="col-sm-12"> <span class="col-sm-6 hct-pay-payee">支付单号：', 
            ...
            0 != type && ($out += '<a class="pull-left T-option T-detail" style="line-height:50px; font-size: 16px;">明细</a>', 
            $line = 31), $out += ' <a href="javascript:;" class="btn btn-warning pull-right T-option T-toPay" style="height:50px; font-size:22px;">确定</a> <div class="pull-right" style="padding-right:20px; line-height:50px;"> <span>付款金额：</span> <span style="font-size:32px; color: #ff8922;"><em style="color:#c0c1c0; font-style:normal;">￥</em>', 

/*TMODJS:{"debug":true,"version":57,"md5":"20273880ae261f77dd9f5509fdef5e38"}*/
    ...
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 25), $out += ' value="', $line = 25, $out += $escape(guide.payMoney), $out += '" ></td> <td><textarea class="col-sm-12 hct-textarea" name="payRemark" maxlength="1000" ', 

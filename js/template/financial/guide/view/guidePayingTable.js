/*TMODJS:{"debug":true,"version":20,"md5":"865d7fa65730d5eb9f5ad926048170d9"}*/
define(function(require) {
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            $data.$index, $utils.$escape), rs = $data.rs, isOuter = $data.isOuter, $out = "";
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 18, $out += $escape(rs.unPayedMoney), $out += '" ', $line = 18, !isOuter && rs.unPayedMoney <= 0 && ($out += " disabled ", 
                $line = 18), $out += ' value="', $line = 18, $out += $escape(guide.payMoney), $out += '" class="money"></td> <td><input type="text" name="payRemark" ', 
                $line = 19, !isOuter && rs.unPayedMoney <= 0 && ($out += " disabled ", $line = 19), 

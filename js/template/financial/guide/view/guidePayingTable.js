/*TMODJS:{"debug":true,"version":71,"md5":"f0671e9583e6e6d417ad0f7f949f3afd"}*/
define(function(require) {
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            $data.$index, $utils.$escape), isOuter = $data.isOuter, borrow = $data.borrow, $out = "";
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 25), $out += ' value="', $line = 25, borrow && 0 != guide.payMoney && ($line = 25, 

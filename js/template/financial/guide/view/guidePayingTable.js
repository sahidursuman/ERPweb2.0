/*TMODJS:{"debug":true,"version":55,"md5":"caad4b4974550dee64a4eb5c8b3b5a65"}*/
    ...
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 25), $out += ' value="', $line = 25, $out += $escape(guide.payMoney), $out += '" ></td> <td><input type="text" name="payRemark" ', 
                $line = 26, !isOuter && guide.unPayedMoney <= 0 && ($out += " disabled ", $line = 26), 
                $out += ' value="', $line = 26, $out += $escape(guide.payRemark), $out += '"></td> <td>', 

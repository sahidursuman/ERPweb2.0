/*TMODJS:{"debug":true,"version":48,"md5":"4fbb457288a8f8b9a5d945309e23f764"}*/
    ...
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 5, $out += $escape(guide.accountTime), $out += '</td> <td><a class="cursor T-action T-borrow-detail"><span class="F-float F-money T-preMoney">', 
                $line = 6, $out += $escape(guide.guideAllPreMoney), $out += '</span></a></td> <td><span class="F-float F-money">', 

/*TMODJS:{"debug":true,"version":19,"md5":"ee8de1f0ed6238a9e2ad5ce873e6fa9a"}*/
    ...
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 17, $out += $escape(guide.unPayedMoney), $out += '</td> <td><input type="text" name="payMoney" value="', 
                ...
                $line = 23), $out += ' &nbsp; <a class="cursor T-action T-view R-right" data-right="1290003">查看</a> </td> </tr> ', 
                $line = 27;
            }), new String($out);
        } catch (e) {
            throw {

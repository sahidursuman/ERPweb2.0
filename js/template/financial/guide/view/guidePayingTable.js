/*TMODJS:{"debug":true,"version":86,"md5":"704c89bf5c3fba68b4bdfa206d2b8095"}*/
    ...
    return require("../../../template")("financial/guide/view/guidePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 25), $out += ' value="', $line = 25, guide.payMoney2 ? ($line = 25, $out += $escape(guide.payMoney2), 
                $line = 25) : isPayMoney && 0 != guide.payMoney && ($line = 25, $out += $escape(guide.payMoney), 
                $line = 25), $out += '" ></td> <td><textarea class="col-sm-12 hct-textarea" name="payRemark" maxlength="1000" ', 
                ...
                $line = 30) : ($out += " 未对账 ", $line = 30), $out += ' &nbsp; <a class="cursor T-action T-view R-right" data-right="1290003">查看', 
                $line = 31, isPayMoney && ($out += "chbvfceabrfha", $line = 31), $out += "</a> </td> </tr> ", 
                $line = 34;
            }), new String($out);
        } catch (e) {
            throw {

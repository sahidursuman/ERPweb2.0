/*TMODJS:{"debug":true,"version":5,"md5":"52ee506301c450d840479f7a51db05e1"}*/
define(function(require) {
    return require("../../../template")("financial/guide/view/guideRecords", function($data, $filename) {
        try {
            ...
            return $out += '<div class="financialGuideRecords"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>操作详情</th> </tr> </thead> <tbody> ', 

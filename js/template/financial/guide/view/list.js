/*TMODJS:{"debug":true,"version":253,"md5":"bb5962ef9c23d433c3fa0b9918d9c0f6"}*/
    ...
    return require("../../../template")("financial/guide/view/list", function($data, $filename) {
        try {
            ...
            $line = 53, $each(financialGuideSumList, function(sumList) {
                ...
                $out += '" class=" btn-divide btn-guide-checking cursor R-right" data-right="1200002"> 对账 </a><a href="" class="cursor"> |</a> <a data-entity-id="', 
                $line = 72, $out += $escape(sumList.guideId), $out += '" class="btn-guide-view R-right cursor btn-transfter btn-guide-clearing " data-right="1200003"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 78;

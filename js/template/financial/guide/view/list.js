/*TMODJS:{"debug":true,"version":17,"md5":"e11522e4cc8be9e84df4b2b486000a74"}*/
define(function(require) {
    return require("../../../template")("financial/guide/view/list", function($data, $filename) {
        try {
            ...
            $line = 5, $out += $escape(guideName), $out += '" maxlength="100"> </div> <div class="form-group input-daterange marginLeft-30"> <label>账期：</label> <input type="text" class="form-control datepicker T-search-start-date" value="', 
            $line = 9, $out += $escape(startDate), $out += '"> <label>&nbsp;至&nbsp;</label> <input type="text" class="form-control datepicker T-search-end-date" value="', 
            ...
            $line = 35, $each(list, function(rs) {
                ...
                $out += "</span>", $line = 43), $out += '</td> <td> <a class="cursor T-action T-check R-right" data-right="1290002">对账</a> <label class="cursor R-right" data-right="1290002"> <a class="R-right" data-right="1290003"> |</a></label> <a class="cursor T-action T-pay R-right" data-right="1290003">付款</a> </td> </tr> ', 
                $line = 50;

/*TMODJS:{"debug":true,"version":27,"md5":"651b554a4c87c76b9c397de396a78aca"}*/
    ...
    return require("../../../template")("financial/guide/view/list", function($data, $filename) {
        try {
            ...
            $line = 35, $each(list, function(rs) {
                ...
                $line = 37, $out += $escape(rs.realname), $out += '</td> <td><span class="F-float F-money">', 
                $line = 38, $out += $escape(rs.sumZhangmiantuibu), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 39, $out += $escape(rs.sumSettlementMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 40, $out += $escape(rs.sumPayedMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 41, 0 != rs.sumUnPayedMoney ? ($out += '<span style="color:#FF0000;">', 
                $line = 41, $out += $escape(rs.sumUnPayedMoney), $out += "</span>", $line = 41) : ($line = 41, 
                $out += $escape(rs.sumUnPayedMoney), $line = 41), $out += "</span></td> <td>", $line = 42, 

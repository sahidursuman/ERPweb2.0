/*TMODJS:{"debug":true,"version":84,"md5":"8005e7ba842143d8d2ae58121ac35735"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $out += $escape(guide.checkRealName), $out += '</td> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-checkbox" ', 
                $line = 38, (guide.change && 1 == guide.isChecked || !guide.change && 1 == guide.isConfirmAccount) && ($out += ' checked="checked" ', 
                $line = 38), $out += '/> <span class="lbl">对账</span> </label> <label class="cursor"> |</a></label> <a class="cursor T-action T-view" data-right="1200003">查看</a> </td> </tr> ', 
                $line = 45;
            }), new String($out);
        } catch (e) {
            throw {

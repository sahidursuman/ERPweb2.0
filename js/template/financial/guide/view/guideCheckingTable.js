/*TMODJS:{"debug":true,"version":34,"md5":"d67db73396e130ae3a819a0ce078c7e8"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $out += "</td> <td>", $line = 20, $out += $escape(guide.checkRealName), $out += '</td> <td> <label class="pos-rel R-right" data-right="1290002"> <input type="checkbox" class="ace T-checkbox" ', 

/*TMODJS:{"debug":true,"version":39,"md5":"86fc2d4d086ba69081a7771ca937fb34"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                guide.isConfirmAccount && ($out += ' checked="checked" ', $line = 23), $out += '/> <span class="lbl">对账</span> </label> ', 
                $line = 26, guide.isConfirmAccount && ($out += ' <label class="cursor" ', $line = 27, 
                guide.isConfirmAccount ? ($out += ' data-right="1200005" ', $line = 27) : ($out += ' data-right="1200002" ', 
                $line = 27), $out += '> <a data-right="1200003"> |</a></label> <a class="cursor T-action T-view" data-right="1200003">查看</a> ', 

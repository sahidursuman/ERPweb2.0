/*TMODJS:{"debug":true,"version":38,"md5":"58390c78d5fe672a98168067e037ccab"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                guide.isConfirmAccount && ($out += ' checked="checked" ', $line = 23), $out += '/> <span class="lbl"></span> </label> ', 
                $line = 26, guide.isConfirmAccount && ($out += ' <label class="cursor R-right" ', 
                $line = 27, guide.isConfirmAccount ? ($out += ' data-right="1200005" ', $line = 27) : ($out += ' data-right="1200002" ', 
                $line = 27), $out += '> <a class="R-right" data-right="1200003"> |</a></label> <a class="cursor T-action T-view R-right" data-right="1200003">查看</a> ', 

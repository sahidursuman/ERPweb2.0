/*TMODJS:{"debug":true,"version":73,"md5":"778133d9ec4ce977ba049c3d7b5b949f"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $line = 24, $out += $escape(guide.unPayedMoney), $out += '</span></td> <td><input type="text" class="T-checkRemark" name="checkRemark" value="', 
                $line = 25, $out += $escape(guide.checkRemark), $out += '" ', $line = 25, guide.isConfirmAccount && ($out += ' disabled="disabled"', 
                $line = 25), $out += "></td> <td>", $line = 26, $out += $escape(guide.checkTime), 
                $out += "</td> <td>", $line = 27, $out += $escape(guide.checkRealName), $out += '</td> <td> <label class="pos-rel R-right" ', 
                ...
                guide.isConfirmAccount && ($out += ' checked="checked" ', $line = 30), $out += '/> <span class="lbl">对账</span> </label> <label class="cursor" ', 

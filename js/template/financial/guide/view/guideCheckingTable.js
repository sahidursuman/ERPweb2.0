/*TMODJS:{"debug":true,"version":48,"md5":"2e021482b9d3689a0e61f5377cb2ef64"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $out += $escape(guide.payedMoney), $out += '">', $line = 16, 0 != guide.payedMoney ? ($out += '<a href="javascript:void(0);" class="T-action T-viewPayedMoney">', 

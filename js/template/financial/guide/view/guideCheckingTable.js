/*TMODJS:{"debug":true,"version":60,"md5":"eb5707756ad2f391667fd2d65292b768"}*/
    ...
    return require("../../../template")("financial/guide/view/guideCheckingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(guide) {
                ...
                $out += '</td> <td><input name="settlementMoney" type="text" class="money T-settlementMoney" value="', 
                ...
                $line = 16, $out += $escape(guide.payedMoney), $out += '</a></td> <td name="unPayedMoney">', 

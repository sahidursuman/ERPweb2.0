/*TMODJS:{"debug":true,"version":38,"md5":"638abe8ec8eb6594d858a9a01e64d7d8"}*/
    ...
    return require("../../../template")("financial/collectedGuests/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(resultList, function(rs) {
                ...
                $line = 10), $out += "</td> <td>", $line = 11, null == rs.contactName || "" == rs.contactName ? ($out += "-", 
                $line = 11) : ($line = 11, $out += $escape(rs.contactName), $line = 11), $out += "</td> <td>", 
                $line = 12, $out += $escape(rs.adultCount || 0), $out += " 大 ", $line = 12, $out += $escape(rs.childCount || 0), 
                $out += " 小</td> <td>", $line = 13, null == rs.fromPartnerAgencyName || "" == rs.fromPartnerAgencyName ? ($out += "-", 
                $line = 13) : ($line = 13, $out += $escape(rs.fromPartnerAgencyName), $line = 13), 
                $out += '</td> <td><span class="F-float F-money">', $line = 14, $out += $escape(rs.totalIncome), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 15, $out += $escape(rs.totalOtherIncome), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 16, $out += $escape(rs.totalOut), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 17, $out += $escape(rs.totalTrip), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 18, $out += $escape(rs.totalTransfer), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 19, $out += $escape(rs.incomeTrip), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 20, $out += $escape(rs.payTrip), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 21, $out += $escape(rs.profit), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 22, $out += $escape(rs.avgProfit), 
                $out += "</span></td> </tr> ", $line = 24;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,

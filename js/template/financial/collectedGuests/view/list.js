/*TMODJS:{"debug":true,"version":53,"md5":"812bc1382fc8be90140454de229538ab"}*/
    ...
    return require("../../../template")("financial/collectedGuests/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $line = 15, $out += $escape(rs.groupName), $out += '</td> <td><span class="F-float F-money">', 
                $line = 16, $out += $escape(rs.tripIncome), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 17, $out += $escape(rs.otherIncome), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 18, $out += $escape(rs.outCost), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 19, $out += $escape(rs.tripCost), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 20, $out += $escape(rs.transferCost), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 21, $out += $escape(rs.income), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 22, $out += $escape(rs.cost), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 23, $out += $escape(rs.profit), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 24, $out += $escape(rs.avgProfit), $out += "</span></td> </tr> ", $line = 26;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":51,"md5":"28db888f023fa6e5d98df3ef9216c630"}*/
    ...
    return require("../../../template")("financial/collectedGuests/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $out += '</td> <td><span class="F-float F-money">', $line = 14, $out += $escape(rs.tripIncome), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 15, $out += $escape(rs.otherIncome), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 16, $out += $escape(rs.outCost), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 17, $out += $escape(rs.tripCost), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 18, $out += $escape(rs.transferCost), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 19, $out += $escape(rs.income), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 20, $out += $escape(rs.cost), 

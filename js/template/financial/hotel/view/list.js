/*TMODJS:{"debug":true,"version":130,"md5":"e85ea98f3e6b5989f2916f4b84f21c14"}*/
    ...
    return require("../../../template")("financial/hotel/view/list", function($data, $filename) {
        try {
            ...
            $line = 44, $each(financialHotelSettlementList, function(hotel) {
                ...
                $out += $escape(searchParam.month), $out += '" class="cursor btn-financialHotel-check R-right" data-right="1220002"> 对账 </a><a href="" class="cursor"> |</a> <a data-entity-id="', 

/*TMODJS:{"debug":true,"version":213,"md5":"c3da5fa30653bbfd8f2728941e7da089"}*/
define(function(require) {
    return require("../../../template")("financial/hotel/view/list", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), searchParam = $data.searchParam, $escape = $utils.$escape, $each = $utils.$each, financialHotelList = $data.financialHotelList, $out = ($data.rs, 
            $data.$index, "");
            return $out += '<div class="row" > <div class="form-horizontal T-search-area"> <div class="form-group" > <label style="margin-left:15px;">酒店：</label> <input type="text" class="T-chooseHotel" name="hotelName" value="', 
            $line = 5, "" == searchParam.hotelName ? ($out += "全部", $line = 5) : ($line = 5, 
            $out += $escape(searchParam.hotelName), $line = 5), $out += '" /> <input type="hidden" name="hotelId" value="', 
            ...
            $line = 34, $each(financialHotelList, function(rs) {
                ...
                $out += "</span> ", $line = 53), $out += ' </td> <td> <a class="cursor T-option T-check R-right" data-right="1220002|1220005">对账</a> <label class="cursor R-right" data-right="1220002"><a class="R-right" data-right="1220003"> |</a></label> <a class="cursor R-right T-option T-clear" data-right="1220003">付款</a> </td> </tr> ', 
                $line = 61;

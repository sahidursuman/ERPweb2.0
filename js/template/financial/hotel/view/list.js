/*TMODJS:{"debug":true,"version":143,"md5":"3ca8a1043b7a514a09ad37b3f6c98965"}*/
    ...
    return require("../../../template")("financial/hotel/view/list", function($data, $filename) {
        try {
            ...
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class="btn-sm btn-financialHotel-search search-btn marginLeft-30 " > <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row hotelaurantList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th class="col-sm-1">酒店</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 44, $each(financialHotelSettlementList, function(hotel) {
                ...
                $out += $escape(searchParam.month), $out += '" class="cursor btn-financialHotel-check R-right" data-right="1220002"> 对账 </a> <label class="cursor R-right" data-right="1220002"><a class="R-right" data-right="1220003"> |</a></label> <a data-entity-id="', 
                $line = 68, $out += $escape(hotel.hotelId), $out += '" data-entity-hotelName="', 
                $line = 68, $out += $escape(hotel.hotelName), $out += '" data-entity-year="', $line = 68, 
                $out += $escape(searchParam.year), $out += '" ', $line = 69, "" == searchParam.month ? ($out += " data-entity-startMonth=1 data-entity-endMonth=12 ", 
                ...
                $out += '" ', $line = 73), $out += ' class="cursor R-right btn-financialHotel-balance" data-right="1220003"> 结算 </a> </td> </tr> ', 
                $line = 79;

/*TMODJS:{"debug":true,"version":393,"md5":"b89a4c0b2b0c7bfbc355ed55cd7f23d2"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $out += "</td> <td>", $line = 5, $out += $escape(checking.contactUserName), $out += '</td> <td><a href="#" class="T-seeGroup" data-list="', 
                ...
                $line = 8, $out += $escape(checking.childCount), $out += "</span>小 </a> </td> <td>", 
                $line = 11, $out += $escape(checking.operateTransRealname), $out += "</td> <td>", 
                ...
                $line = 28, 1 == checking.isConfirmAccount && ($out += "disabled", $line = 28), 
                $out += ">", $line = 28, $out += $escape(checking.checkRemark), $out += "</textarea></td> <td>", 

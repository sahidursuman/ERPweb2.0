/*TMODJS:{"debug":true,"version":433,"md5":"28c22ffc9c57e3b5e00d25d31b542397"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 25, $out += $escape(checking.payedMoney), $out += "</span></a></td> <td>", 
                $line = 26, 1 == checking.isConfirmAccount ? ($out += '<span class="F-float F-money">', 
                $line = 26, checking.backMoney ? ($line = 26, $out += $escape(checking.backMoney), 
                $line = 26) : ($line = 26, $out += $escape(checking.punishMoney), $line = 26), $out += "</span> ", 
                $line = 27) : ($out += '<input type="text" class="col-sm-12 T-refund money F-float F-money" value="', 
                $line = 27, checking.backMoney ? ($line = 27, $out += $escape(checking.backMoney), 
                $line = 27) : ($line = 27, $out += $escape(checking.punishMoney), $line = 27), $out += '" name="settlementMoney" /> ', 
                $line = 28), $out += ' </td> <td class="T-settlementMoney F-float F-money">', $line = 30, 
                $out += $escape(checking.settlementMoney), $out += '</td> <td class="T-unReceivedMoney F-float F-money" name="unPayedMoney">', 
                $line = 31, $out += $escape(checking.unPayedMoney), $out += "</td> <td>", $line = 32, 
                1 == checking.isConfirmAccount ? ($line = 32, $out += $escape(checking.checkRemark), 
                $out += " ", $line = 33) : ($out += '<textarea class="col-sm-12 hct-textarea" name="checkRemark" maxlength="1000">', 
                $line = 33, $out += $escape(checking.checkRemark), $out += "</textarea> ", $line = 34), 
                $out += " </td> <td>", $line = 36, 0 == checking.isConfirmAccount ? ($out += "<span>-</span>", 
                ...
                $line = 36), $line = 36), $out += "</td> <td>", $line = 37, 0 == checking.isConfirmAccount ? ($out += "<span>-</span>", 
                ...
                $line = 37), $out += '</td> <td> <label class="pos-rel"> <input type="checkbox" checkStatus="', 
                $line = 40, $out += $escape(checking.isConfirmAccount), $out += '" class="ace T-checkbox" ', 
                $line = 41, (checking.change && 1 == checking.isChecked || !checking.change && 1 == checking.isConfirmAccount) && ($out += 'checked="checked"', 
                $line = 41), $out += '/> <span class="lbl">对账</span> </label> <label>|</label> <label> <a href="#" class="T-check-Detail" style="margin-left:5px">查看</a> </label> </td> </tr> ', 
                $line = 51;
            }), new String($out);
        } catch (e) {
            throw {

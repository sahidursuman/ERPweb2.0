/*TMODJS:{"debug":true,"version":139,"md5":"2111f306bad26205c327bc1cca7ae53d"}*/
define(function(require) {
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            "");
            return $line = 1, $each(list, function(checking, index) {
                ...
                $out += $escape(index + 1), $out += "</td> <td>", $line = 4, $out += $escape(checking.lineProductName), 
                $out += "</td> <td>", $line = 5, $out += $escape($helpers.dateFormat(checking.accountTime, "yyyy-MM-dd")), 
                $out += "</td> <td>111</td><!-- ", $line = 6, $out += $escape(checking.contactUserName), 
                $out += " --> <td>", $line = 7, $out += $escape(checking.adultCount), $out += "大", 
                $line = 7, $out += $escape(checking.childCount), $out += '小<a href="#" class="T-seeGroup" style="margin-left:5px">展开</a></td> <td>', 
                $line = 8, $out += $escape(checking.operateTransRealname), $out += "</td> <td>", 
                $line = 9, $out += $escape($helpers.dateFormat(checking.operateTransTime, "yyyy-MM-dd")), 
                $out += '</td> <td><span class="transNeedPayMoney">', $line = 10, $out += $escape(checking.transNeedPayMoney), 
                $out += "</span></td> <td> 大人:", $line = 12, $out += $escape(checking.transAdultPrice), 
                $out += "(元)*", $line = 12, $out += $escape(checking.transAdultCount), $out += "=", 
                $line = 12, $out += $escape(checking.transAdultPrice * checking.transAdultCount), 
                $out += "<br> 小孩:", $line = 13, $out += $escape(checking.transChildPrice), $out += "(元)*", 
                $line = 13, $out += $escape(checking.transChildCount), $out += "=", $line = 13, 
                $out += $escape(checking.transChildPrice * checking.transChildCount), $out += "<br> ", 
                $line = 14, 0 != checking.innerTransferFeeList.length ? ($out += " ", $line = 15, 
                $each(checking.innerTransferFeeList, function(otherFee) {
                    $out += " ", $line = 16, $out += $escape(otherFee.discribe), $out += ":", $line = 16, 
                    $out += $escape(otherFee.price), $out += "(元)*", $line = 16, $out += $escape(otherFee.count), 
                    $out += "=", $line = 16, $out += $escape(otherFee.price * otherFee.count), $out += "<br> ", 
                    $line = 17;
                }), $out += " ", $line = 18) : ($out += " - ", $line = 20), $out += ' </td> <td><a href="javascript:void(0)" class="T-viewDetail">社付：<span class="travelPayedMoney">', 
                $line = 22, $out += $escape(checking.payedMoney), $out += '</span><br>导游现收：<span class="currentNeedPayMoney">', 
                $line = 22, $out += $escape(checking.currentNeedPayMoney), $out += "</span></a></td> <td>", 
                $line = 23, 1 == checking.isConfirmAccount ? ($out += "<span>", $line = 23, $out += $escape(checking.punishMoney), 
                $out += "</span>", $line = 23) : ($out += '<input type="text" name="punishMoney" maxlength="9" value="', 
                $line = 23, $out += $escape(checking.punishMoney), $out += '"/>', $line = 23), $out += '</td> <td><span class="settlementMoney">', 
                $line = 24, $out += $escape(checking.settlementMoney), $out += '</span></td> <td><span class="unPayedMoney">', 
                $line = 25, $out += $escape(checking.unPayedMoney), $out += "</span></td> <td>", 
                $line = 26, 1 == checking.isConfirmAccount ? ($out += "<span>", $line = 26, $out += $escape(checking.checkRemark), 
                $line = 26) : ($out += '<input type="text" maxlength="9" name="checkRemark" value="', 
                ...
                $out += $escape($helpers.dateFormat(checking.checkTime, "yyyy-MM-dd")), $line = 27), 
                $line = 27), $out += "</td> <td>", $line = 28, 0 == checking.isConfirmAccount ? ($out += "<span>-</span>", 
                ...
                $out += '/> <span class="lbl"></span> </label> ', $line = 35, 1 == checking.isConfirmAccount && ($out += ' <label> <a href="#" class="T-check-Detail" style="margin-left:5px">查看</a> </label> ', 
                $line = 39), $out += ' </td> </tr> <tr class="hide"> <td colspan="17"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">序号</th> <th class="th-border">姓名</th> <th class="th-border">联系电话</th> <th class="th-border">证件类型</th> <th class="th-border">证件号</th> <th class="th-border">是否联系人</th> </tr> </thead> <tbody> ', 

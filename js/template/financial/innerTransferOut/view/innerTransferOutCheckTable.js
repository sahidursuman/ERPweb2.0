/*TMODJS:{"debug":true,"version":423,"md5":"2c1fc701f73ad92f9309177838a9a280"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $out += " {[else", $line = 33, $out += $escape(checking.checkRemark), $out += "</textarea> ", 
                $line = 34), $out += " </td> <td>", $line = 36, 0 == checking.isConfirmAccount ? ($out += "<span>-</span>", 

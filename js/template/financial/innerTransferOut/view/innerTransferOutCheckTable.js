/*TMODJS:{"debug":true,"version":214,"md5":"8f3edc98f8bd5b1ea1a57b23b2a6ee6c"}*/
    ...
    return require("../../../../../template")("js/template/financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 22, 1 == checking.isConfirmAccount ? ($out += '<span><input type="text" name="punishMoney" readonly="readonly" value="', 
                $line = 22, $out += $escape(checking.punishMoney), $out += '"/></span>', $line = 22) : ($out += '<input type="text" name="punishMoney" value="', 
                ...
                $out += '/> <span class="lbl">对账</span> </label> ', $line = 35, 1 == checking.isConfirmAccount && ($out += ' <label>|</label> <label> <a href="#" class="T-check-Detail" style="margin-left:5px">查看</a> </label> ', 
                $line = 40), $out += ' </td> </tr> <tr class="hide"> <td colspan="17"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">序号</th> <th class="th-border">姓名</th> <th class="th-border">联系电话</th> <th class="th-border">证件类型</th> <th class="th-border">证件号</th> <th class="th-border">是否联系人</th> </tr> </thead> <tbody> ', 
                $line = 57, $each(checking.touristGroupMemberList, function(visitor, index) {
                    $out += " <tr> <td>", $line = 59, $out += $escape(index + 1), $out += "</td> <td>", 
                    $line = 60, $out += $escape(visitor.name), $out += "</td> <td>", $line = 61, $out += $escape(visitor.mobileNumber), 
                    $out += "</td> <td>", $line = 62, 0 == visitor.idCardType && ($out += "身份证", $line = 62), 
                    $line = 62, 1 == visitor.idCardType && ($out += "护照", $line = 62), $line = 62, 2 == visitor.idCardType && ($out += "其他", 
                    $line = 62), $out += "</td> <td>", $line = 63, $out += $escape(visitor.idCardNumber), 
                    $out += "</td> <td>", $line = 64, 1 == visitor.isContactUser && ($out += "是", $line = 64), 
                    $out += "</td> </tr> ", $line = 66;
                }), $out += " </tbody> </table> </td> </tr> ", $line = 71;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,

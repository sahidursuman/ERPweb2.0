/*TMODJS:{"debug":true,"version":399,"md5":"6fec8bdbbe8ce9215d099d3ce2a03fda"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $out += '"> <td>', $line = 3, $out += $escape(checking.orderNumber), $out += "</td> <td>", 
                $line = 4, $out += $escape(checking.lineProductName), $out += "</td> <td>", $line = 5, 
                $out += $escape($helpers.dateFormat(checking.accountTime, "yyyy-MM-dd")), $out += "</td> <td>", 
                $line = 6, $out += $escape(checking.contactUserName), $out += '</td> <td><a href="#" class="T-seeGroup" data-list="', 
                ...
                $each(checking.innerTransferFeeList, function(otherFee) {
                    ...
                    $line = 21;
                }), $out += " ", $line = 22) : ($out += "- ", $line = 23), $out += ' </td> <td><a href="javascript:void(0)" class="T-viewDetail">社付：<span class="travelPayedMoney F-float F-money">', 
                ...
                $line = 26, $out += $escape(checking.punishMoney), $out += '" name="settlementMoney" ', 
                ...
                $out += '</td> <td><span class="T-unReceivedMoney F-float F-money">', $line = 28, 
                $out += $escape(checking.unPayedMoney), $out += '</span></td> <td><span><textarea class="col-sm-12 hct-textarea" name="checkRemark" maxlength="1000" ', 
                ...
                $line = 35, 1 == checking.isConfirmAccount && ($out += 'checked="checked"', $line = 35), 

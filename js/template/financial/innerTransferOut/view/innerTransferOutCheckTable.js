/*TMODJS:{"debug":true,"version":239,"md5":"5347aeb28c37b82f7be9e70a62808653"}*/
    ...
    return require("../../../../../template")("js/template/financial/innerTransferOut/view/innerTransferOutCheckTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 22, 1 == checking.isConfirmAccount ? ($out += '<span><input type="text" readonly="readonly" value="', 
                $line = 22, $out += $escape(checking.punishMoney), $out += '"/></span>', $line = 22) : ($out += '<input type="text" name="settlementMoney" value="', 

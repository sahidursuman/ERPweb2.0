/*TMODJS:{"debug":true,"version":14,"md5":"b1653251bd7ef270175948d62e5e9c34"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutDetail", function($data, $filename) {
        try {
            ...
            $line = 14, $each(checkRecordList, function(record) {
                ...
                $line = 21, $out += $escape($helpers.dateFormat(record.checkTime, "yyyy-MM-dd")), 
                $out += "</td> </tr> ", $line = 23;

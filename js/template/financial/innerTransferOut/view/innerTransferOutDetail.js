/*TMODJS:{"debug":true,"version":15,"md5":"dca2da66ab841669b5adb9972cbcd5c4"}*/
define(function(require) {
    return require("../../../../../template")("js/template/financial/innerTransferOut/view/innerTransferOutDetail", function($data, $filename) {
        try {
            ...
            $line = 14, $each(checkRecordList, function(record) {
                ...
                $line = 17, $out += $escape(record.businessType), $out += "</td> <td>", $line = 18, 
                $out += $escape(record.payDifferenceMoney), $out += "</td> <td>", $line = 19, $out += $escape(record.remark), 
                $out += "</td> <td>", $line = 20, $out += $escape(record.checkRealname), $out += "</td> <td>", 
                $line = 21, $out += $escape($helpers.dateFormat(record.checkTime, "yyyy-MM-dd hh:mm:ss")), 
                $out += "</td> </tr> ", $line = 23;

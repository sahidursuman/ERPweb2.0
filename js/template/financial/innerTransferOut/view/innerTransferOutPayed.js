/*TMODJS:{"debug":true,"version":16,"md5":"33bce682f6e76bb4d4a5be43183a46c4"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutPayed", function($data, $filename) {
        try {
            ...
            $line = 16, $each(payedRecordList, function(payedRecord) {
                ...
                $line = 21, $out += $escape(payedRecord.payDifferenceMoney), $out += "</span></td> <td>", 
                $line = 22, 0 == payedRecord.payType ? ($out += " 现金 ", $line = 24) : 1 == payedRecord.payType ? ($out += " 银行转账 ", 

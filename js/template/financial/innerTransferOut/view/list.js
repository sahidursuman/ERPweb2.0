/*TMODJS:{"debug":true,"version":70,"md5":"e27ffd5e0b1d1196ce3bd6cd93a3e5fa"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/list", function($data, $filename) {
        try {
            ...
            $line = 20, $each(monthList, function(month) {
                ...
                $line = 22;
            }), $out += ' </select> <button class="marginLeft-30 btn-sm search-btn btn-innerTransferOut-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> </div> <div class="row innerTransferOutList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>部门</th> <th>总人数</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

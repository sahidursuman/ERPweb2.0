/*TMODJS:{"debug":true,"version":90,"md5":"b2e29f7ec74f997178cdc3dde106a79c"}*/
define(function(require) {
    return require("../../../template")("financial/innerTransferOut/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row FinancialinnerTransferOut" > <div class="form-horizontal search-area"> <div class="form-group T-search-area"> <label class="control-label pull-left" style="margin-left: 22px">部门：</label> <select class="col-xs-12" name="toBusinessGroupId" style="width: 220px"> <option value ="">全部</option> ', 
            ...
            $line = 20, $each(monthList, function(month) {
                ...
                $line = 22;
            }), $out += ' </select> <button class="marginLeft-30 btn-sm search-btn T-innerTransferOut-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> </div> <div class="row innerTransferOutList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>部门</th> <th>总人数</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody class="T-innerTransferOutList"> ', 
            $line = 45, $each(financialInnerTransferInList, function(innerTransferOut) {
                $out += " <tr> <td>", $line = 47, $out += $escape(innerTransferOut.toBusinessGroupName), 
                $out += "</td> <td>", $line = 48, $out += $escape(innerTransferOut.allPerson), $out += "</td> <td>", 
                $line = 49, $out += $escape(innerTransferOut.needPayMoney), $out += "</td> <td>", 
                $line = 50, $out += $escape(innerTransferOut.realNeedPayMoney), $out += "</td> <td>", 
                $line = 51, $out += $escape(innerTransferOut.realPayedMoney), $out += "</td> <td>", 
                $line = 52, $out += $escape(innerTransferOut.unPayedMoney), $out += '</td> <td> <span style="color:red">', 
                $line = 54, $out += $escape(innerTransferOut.realUnPayedMoney), $out += "</span> </td> <td > ", 
                $line = 58, innerTransferOut.allCount != innerTransferOut.checkedCount && ($out += ' <span style="color:#ff9900"> ', 
                $line = 59, $out += $escape(innerTransferOut.checkedCount), $line = 59, $out += $escape("/"), 
                $line = 59, $out += $escape(innerTransferOut.allCount), $out += "</span> ", $line = 60), 
                $out += " ", $line = 61, innerTransferOut.allCount == innerTransferOut.checkedCount && ($out += ' <span style="color:green"> ', 
                $line = 62, $out += $escape(innerTransferOut.checkedCount), $line = 62, $out += $escape("/"), 
                $line = 62, $out += $escape(innerTransferOut.allCount), $out += "</span> ", $line = 63), 
                $out += ' </td> <td> <a data-entity-id="', $line = 66, $out += $escape(innerTransferOut.toBusinessGroupId), 
                $out += '" data-entity-toBusinessGroupName="', $line = 66, $out += $escape(innerTransferOut.toBusinessGroupName), 
                $out += '" data-entity-year="', $line = 66, $out += $escape(searchParam.year), $out += '" data-entity-month="', 
                $line = 66, $out += $escape(searchParam.month), $out += '" class="cursor T-action T-check R-right" data-right="1370001"> 对账 </a> <label class="cursor R-right" data-right="1370001"><a class="R-right" data-right="1370002"> |</a></label> <a data-entity-id="', 
                ...
                $out += '" ', $line = 75), $out += ' class="cursor T-action T-balance R-right" data-right="1370002"> 结算 </a> </td> </tr> ', 
                $line = 81;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 86, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":69,"md5":"011ce624908f0fc4a741d7469219170f"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/list", function($data, $filename) {
        try {
            ...
            $line = 20, $each(monthList, function(month) {
                ...
                $line = 22;
            }), $out += ' </select> <button class="marginLeft-30 btn-sm search-btn btn-innerTransferOut-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> </div> <div class="row innerTransferOutList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>部门</th> <th>总人数</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 44, $each(financialInnerTransferInList, function(innerTransferOut) {
                ...
                $out += ' </td> <td> <a data-entity-id="', $line = 65, $out += $escape(innerTransferOut.toBusinessGroupId), 
                $out += '" data-entity-toBusinessGroupName="', $line = 65, $out += $escape(innerTransferOut.toBusinessGroupName), 
                $out += '" data-entity-year="', $line = 65, $out += $escape(searchParam.year), $out += '" data-entity-month="', 
                $line = 65, $out += $escape(searchParam.month), $out += '" class="cursor btn-innerTransferOut-check R-right" data-right="1370001"> 对账 </a> <label class="cursor R-right" data-right="1370001"><a class="R-right" data-right="1370002"> |</a></label> <a data-entity-id="', 
                $line = 69, $out += $escape(innerTransferOut.toBusinessGroupId), $out += '" data-entity-toBusinessGroupName="', 
                $line = 69, $out += $escape(innerTransferOut.toBusinessGroupName), $out += '" data-entity-year="', 
                ...
                $out += '" ', $line = 74), $out += ' class="cursor btn-innerTransferOut-balance R-right" data-right="1370002"> 结算 </a> </td> </tr> ', 
                $line = 80;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 85, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":83,"md5":"31c7db251f9aae70ac61c99c13b44c51"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutClearTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 27, $out += $escape(checking.payRemark), $out += '" ', $line = 28, !showBtnFlag && checking.unPayedMoney <= 0 && ($out += " disabled ", 

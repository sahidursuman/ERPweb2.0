/*TMODJS:{"debug":true,"version":203,"md5":"8f79c99352123ea96d4f8112c8dd4c1b"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutClearTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 25, $out += $escape(checking.rowLen), $out += '" class="align-left"><a href="javascript:void(0)" class="T-viewDetail in-block">社付：<span class="F-float F-money">', 

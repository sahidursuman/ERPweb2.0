/*TMODJS:{"debug":true,"version":65,"md5":"41372e09492428a75f40fd9eff5e9e7d"}*/
    ...
    return require("../../../../../template")("js/template/financial/innerTransferOut/view/innerTransferOutClearTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $out += '</td> <td><input name="payMoney" type="text" class="money" value="', $line = 25, 
                $out += $escape(checking.payMoney), $out += '" data-le="', $line = 25, $out += $escape(checking.unPayedMoney), 
                $out += '" ', $line = 26, !showBtnFlag && checking.unPayedMoney <= 0 && ($out += " disabled ", 

/*TMODJS:{"debug":true,"version":49,"md5":"11c993d5320c4c7d79db641050293b5b"}*/
define(function(require) {
    return require("../../../../../template")("js/template/financial/innerTransferOut/view/innerTransferOutClearTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $line = 21, $out += $escape(checking.payedMoney), $out += "<br>导游现收：", $line = 21, 
                $out += $escape(checking.currentNeedPayMoney), $out += "</a></td> <td><span>", $line = 22, 
                $out += $escape(checking.punishMoney), $out += "</span></td> <td>", $line = 23, 
                $out += $escape(checking.settlementMoney), $out += "</td> <td>", $line = 24, $out += $escape(checking.unPayedMoney), 
                $out += '</td> <td><input name="payMoney" type="text" value="', $line = 25, $out += $escape(checking.payMoney), 
                $out += '"/></td> <td><input type="text" maxlength="9" name="payRemark" value="', 
                $line = 26, $out += $escape(checking.checkRemark), $out += '"></td> <td>', $line = 27, 
                0 == checking.isConfirmAccount ? ($out += "<span>-</span>", $line = 27) : ($line = 27, 
                ...
                $line = 28), $out += '</td> <td> <label class="pos-rel"> ', $line = 31, 1 == checking.isConfirmAccount ? ($out += "<span>已对账</span>", 
                $line = 31) : ($out += "<span>未对账</span>", $line = 31), $out += " </label> ", $line = 33, 
                1 == checking.isConfirmAccount && ($out += ' <label> <a href="#" class="T-check-Detail" style="margin-left:5px">查看</a> </label> ', 
                $line = 37), $out += ' </td> </tr> <tr class="hide"> <td colspan="17"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border">序号</th> <th class="th-border">姓名</th> <th class="th-border">联系电话</th> <th class="th-border">证件类型</th> <th class="th-border">证件号</th> <th class="th-border">是否联系人</th> </tr> </thead> <tbody> ', 

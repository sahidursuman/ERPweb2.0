/*TMODJS:{"debug":true,"version":192,"md5":"083927235e6a26b5a3a38daab4871495"}*/
    ...
    return require("../../../template")("financial/innerTransferOut/view/innerTransferOutClearTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(list, function(checking) {
                ...
                $out += '</td> <td rowspan="', $line = 5, $out += $escape(checking.rowLen), $out += '">', 
                $line = 5, $out += $escape(checking.contactUserName), $out += '</td> <td rowspan="', 
                ...
                $line = 30, !showBtnFlag && checking.unPayedMoney <= 0 && ($out += " disabled ", 
                $line = 30), $out += ">", $line = 30, $out += $escape(checking.payRemark), $out += '</textarea></td> <td rowspan="', 

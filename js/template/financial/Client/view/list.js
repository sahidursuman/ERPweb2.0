/*TMODJS:{"debug":true,"version":32,"md5":"66ec8451805eb8c35315454aa7ada730"}*/
    ...
    return require("../../../template")("financial/Client/view/list", function($data, $filename) {
        try {
            ...
            $line = 41, $each(customerAccountList, function(rs) {
                ...
                $out += "</span>", $line = 51), $out += '</td> <td> <a class="cursor T-action T-checking R-right" data-right="1280002|1280005">对账</a> <label class="cursor R-right" data-right="1280002|1280005"> <a class="R-right" data-right="1280003"> |</a></label> <a class="cursor T-action T-balance R-right" data-right="1280003">收款</a> </td> </tr> ', 
                $line = 58;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 63, $out += $escape(searchParam.recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

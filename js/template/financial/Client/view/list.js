/*TMODJS:{"debug":true,"version":10,"md5":"ff08de7486165c15194b89522cb35a3b"}*/
define(function(require) {
    return require("../../../template")("financial/Client/view/list", function($data, $filename) {
        try {
            ...
            $line = 5, $out += $escape(searchParam.headerAgencyName), $out += '" maxlength="100"> </div> <div class="form-group marginLeft-30"> <label>客户：</label> <input type="text" class="form-control T-search-customer" style="width: 220px;" value="', 
            $line = 9, $out += $escape(searchParam.fromPartnerAgencyName), $out += '" maxlength="100"> </div> <div class="form-group marginLeft-30"> <label>账期：</label> <input type="text" class="form-control date-picker T-search-start-date" value="', 

/*TMODJS:{"debug":true,"version":33,"md5":"cf4b5f0e91ca726f9076995d0a35f4e2"}*/
define(function(require) {
    return require("/js/template/template")("financial/Client/view/feeDetails", function($data, $filename) {
        try {
            ...
            $line = 13, $each(otherFee, function(of) {
                $out += " ", $line = 14, $each(of.otherFeeList, function(rs) {

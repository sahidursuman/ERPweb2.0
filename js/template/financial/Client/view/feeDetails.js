...
define(function(require) {
    return require("../../../template")("financial/Client/view/feeDetails", function($data, $filename) {
        try {
            ...
            return $out += '<div class="row" style="margin: 0; padding: 10px 10px 0;"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>费用项</th> <th>数量</th> <th>单价</th> <th>天数</th> <th>金额</th> <th>说明</th> </tr> </thead> <tbody> ', 

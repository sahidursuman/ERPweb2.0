/*TMODJS:{"debug":true,"version":2,"md5":"f0864aa2413308609eff1f0ea7146da4"}*/
define(function(require) {
    return require("../../../template")("financial/planProfit/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<thead> <tr class="bg-blur T-tr-fixed"> <th rowspan="2">团信息</th> <th rowspan="2">状态</th> <th rowspan="2" style="width:60px;">收/付</th> <th colspan="5">发团收入</th> <th colspan="12">发团成本</th> ', 
            ...
            $line = 44), $out += " </tr> </thead> <tbody> ", $line = 48, $each(result, function(rs) {
                $out += ' <tr data-id="', $line = 49, $out += $escape(rs.financialId), $out += '"> <td rowspan="3"> <a href="javascript:void(0)" class="T-toTripAccount">', 
                ...
                $line = 54, $out += $escape(rs.creatorName), $out += '</span></a> </td> <td rowspan="3"> ', 

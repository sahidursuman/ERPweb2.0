/*TMODJS:{"debug":true,"version":205,"md5":"63ed5a42b87211beb4530097ceb8d7c7"}*/
    ...
    return require("../../../template")("financial/planProfit/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $line = 27, $out += $escape(rs.scenicMoney), $out += "</td> <td >", $line = 28, 
                $out += $escape(rs.ticketMoney), $out += "</td> <td >", $line = 29, $out += $escape(rs.otherMoney), 
                $out += "</td> <td >", $line = 30, $out += $escape(rs.shopCostMoney), $out += "</td> <td >", 
                $line = 31, $out += $escape(rs.selfMoney), $out += "</td> <td >", $line = 32, $out += $escape(rs.outBusMoney), 

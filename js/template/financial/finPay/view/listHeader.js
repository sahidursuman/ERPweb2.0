/*TMODJS:{"debug":true,"version":10,"md5":"dd26f40825f46317ca713903d8f6520a"}*/
define(function(require) {
    return require("../../../template")("financial/finPay/view/listHeader", function($data, $filename) {
        try {
            ...
            $line = 7, $out += $escape(sumPaiedMoney), $out += '</label> </div> <div class="form-group mar-r-20"> <label class="control-label">未付金额合计：</label> <label class="control-label F-float F-money T-sumUnPaiedMoney">', 

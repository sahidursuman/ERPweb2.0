/*TMODJS:{"debug":true,"version":9,"md5":"e56f1507e526d0ca2e4a069bb6c420dd"}*/
define(function(require) {
    return require("../../../template")("financial/finPay/view/listHeader", function($data, $filename) {
        try {
            ...
            return $out += '<div class="form-group marginLeft-30"> <label class="control-label">应付金额合计：</label> <label class="control-label F-float F-money T-sumStMoney">', 
            $line = 3, $out += $escape(sumNeedPayMoney), $out += '</label> </div> <div class="form-group marginLeft-30"> <label class="control-label">已付金额合计：</label> <label class="control-label F-float F-money T-sumPaiedMoney">', 
            $line = 7, $out += $escape(sumPaiedMoney), $out += '</label> </div> <div class="form-group marginLeft-30"> <label class="control-label">未付金额合计：</label> <label class="control-label F-float F-money T-sumUnPaiedMoney">', 

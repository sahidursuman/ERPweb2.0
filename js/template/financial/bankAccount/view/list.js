/*TMODJS:{"debug":true,"version":115,"md5":"e90c6305f29ff83ef87b608139e44cb5"}*/
define(function(require) {
    return require("../../../template")("financial/bankAccount/view/list", function($data, $filename) {
        try {
            ...
            $data.$index, "");
            return $out += '<div class="T-search-area search-area guideAdd"> <label class="control-label">期初余额合计: <span class=" F-float F-money">', 
            $line = 2, $out += $escape(beginningBalance), $out += '</span></label> <label class="control-label marginLeft-30">收入合计：<span class=" F-float F-money">', 
            $line = 3, $out += $escape(incomeMoney), $out += '</span></label> <label class="control-label marginLeft-30">支出合计：<span class=" F-float F-money">', 
            $line = 4, $out += $escape(payMoney), $out += '</span></label> <label class="control-label marginLeft-30">结余合计：<span class=" F-float F-money">', 
            ...
            $line = 39, $each(newBankAccountList, function(rs) {
                ...
                $out += "</td> <td>", $line = 43, $out += $escape(rs.bankAccountNumber), $out += "</td> <td>", 
                $line = 44, $out += $escape(rs.openingBank), $out += "</td> <td>", $line = 45, $out += $escape(rs.accountName), 
                $out += "</td> <td>", $line = 46, $out += $escape($helpers.dateFormat(rs.beginningTime, "yyyy-MM-dd")), 
                $out += '</td> <td class="F-float F-money">', $line = 47, $out += $escape(rs.beginningBalance), 
                $out += '</td> <td class="F-float F-money">', $line = 48, $out += $escape(rs.incomeMoney), 
                $out += '</td> <td class="F-float F-money">', $line = 49, $out += $escape(rs.payMoney), 
                $out += "</td> <td>", $line = 50, $out += $escape(rs.balance), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="T-action T-view cursor"> 查看 </a> </div> </td> </tr> ', 
                $line = 59;

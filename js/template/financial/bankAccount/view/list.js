/*TMODJS:{"debug":true,"version":121,"md5":"09fe917f6a0c243c51df3a6a4bf96457"}*/
    ...
    return require("../../../template")("financial/bankAccount/view/list", function($data, $filename) {
        try {
            ...
            $line = 39, $each(newBankAccountList, function(rs) {
                ...
                $out += $escape(rs.balance), $out += '" data-type="', $line = 40, $out += $escape(rs.type), 
                $out += '"> <td>', $line = 41, 0 == rs.type ? ($out += "现金账户", $line = 41) : ($out += "银行账户", 
                $line = 41), $out += "</td> <td>", $line = 42, $out += $escape(rs.aliasName), $out += "</td> <td>", 

/*TMODJS:{"debug":true,"version":83,"md5":"263684351784818ba83f42ca96b85b83"}*/
define(function(require) {
    return require("../../../template")("financial/bankAccount/view/list", function($data, $filename) {
        try {
            ...
            $line = 4, $out += $escape(payMoney), $out += '</span></label> </div> <div class="row guideList guideAdd"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight table-fixed"> <colgroup> <col style="width:20%;"></col> <col style="width:10%;"></col> <col style="width:8%;"></col> <col style="width:8%;"></col> <col style="width:8%;"></col> <col style="width:8%;"></col> <col style="width:8%;"></col> <col style="width:8%;"></col> <col style="width:12%;"></col> </colgroup> <thead> <tr class="bg-blur guideListSmall"> <th>银行账号</th> <th>开户银行</th> <th>开户户名</th> <th>期初日期</th> <th>期初余额</th> <th>收入</th> <th>支出</th> <th>结余</th> <th>明细</th> </tr> </thead> <tbody class="T-bankAcc-list"> ', 
            $line = 34, $each(newBankAccountList, function(rs) {
                $out += ' <tr bankid="', $line = 35, $out += $escape(rs.id), $out += '" banknum="', 
                $line = 35, $out += $escape(rs.bankAccountNumber), $out += '" bankMoney="', $line = 35, 
                $out += $escape(rs.balance), $out += '"> <td>', $line = 36, $out += $escape(rs.bankAccountNumber), 
                $out += "</td> <td> ", $line = 38, $out += $escape(rs.openingBank), $out += " </td> <td>", 
                $line = 40, $out += $escape(rs.accountName), $out += "</td> <td>", $line = 41, $out += $escape($helpers.dateFormat(rs.beginningTime, "yyyy-MM-dd")), 
                $out += '</td> <td class="F-float F-money">', $line = 42, $out += $escape(rs.beginningBalance), 
                $out += '</td> <td class="F-float F-money">', $line = 43, $out += $escape(rs.incomeMoney), 
                $out += '</td> <td class="F-float F-money">', $line = 44, $out += $escape(rs.payMoney), 
                $out += "</td> <td>", $line = 45, $out += $escape(rs.balance), $out += '</td> <td> <div class="hidden-sm hidden-xs btn-group"> <a class="T-action T-view cursor"> 查看 </a> </div> </td> </tr> ', 
                $line = 54;

/*TMODJS:{"debug":true,"version":390,"md5":"e04a47f0ef273ac82577267d687d977f"}*/
define(function(require) {
    return require("../../../template")("financial/Restaurant/view/list", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), searchParam = $data.searchParam, $escape = $utils.$escape, $each = $utils.$each, financialRestaurantList = $data.financialRestaurantList, $out = ($data.rs, 
            $data.$index, "");
            ...
            $line = 4, "" == searchParam.restaurantName ? ($out += "全部", $line = 4) : ($line = 4, 
            $out += $escape(searchParam.restaurantName), $line = 4), $out += '" /> <input type="hidden" name="restaurantId" value="', 
            ...
            $line = 31, $each(financialRestaurantList, function(rs) {
                ...
                $out += '</td> <td><span class="F-float F-money">', $line = 34, $out += $escape(rs.sumNeedPayMoney), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 35, $out += $escape(rs.sumSettlementMoney), 
                $out += '</span></td> <td><span class="F-float F-money">', $line = 36, $out += $escape(rs.sumPayedMoney), 
                $out += '</span></td> <td><span class="F-float F-money" ', $line = 37, 0 != rs.sumUnPayedMoney && ($out += 'style="color:red"', 
                ...
                $out += "</span> ", $line = 50), $out += ' </td> <td> <a class="cursor T-option T-check R-right" data-right="1240002|1240005">对账</a> <label class="cursor R-right" data-right="1240002"><a class="R-right" data-right="1240003"> |</a></label> <a class="cursor T-option T-clear R-right" data-right="1240003">付款</a> </td> </tr> ', 
                $line = 58;

/*TMODJS:{"debug":true,"version":251,"md5":"9f1805731a60d206c1d42620a7c94de1"}*/
    ...
    return require("../../../template")("financial/Restaurant/view/list", function($data, $filename) {
        try {
            ...
            $line = 42, $each(financialRestaurantSettlementList, function(rest) {
                ...
                $line = 64, $out += $escape(searchParam.month), $out += '" class="cursor btn-divide R-right" data-right="1240002"> 对账 </a> <a data-entity-id="', 
                ...
                $out += '" ', $line = 73), $out += ' class="cursor btn-balance R-right" data-right="1240003"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 80;

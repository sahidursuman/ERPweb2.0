/*TMODJS:{"debug":true,"version":289,"md5":"5321fe8fbd11de90106492ee131c396f"}*/
    ...
    return require("../../../template")("financial/Restaurant/view/list", function($data, $filename) {
        try {
            ...
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class=" btn-sm search-btn btn-restaurant-search marginLeft-30"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row restaurantList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>餐厅</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 42, $each(financialRestaurantSettlementList, function(rest) {
                ...
                $line = 62, $out += $escape(rest.restaurantId), $out += '" data-entity-restaurantName="', 
                $line = 62, $out += $escape(rest.restaurantName), $out += '" data-entity-year="', 
                $line = 62, $out += $escape(searchParam.year), $out += '" data-entity-month="', 
                $line = 62, $out += $escape(searchParam.month), $out += '" class="cursor btn-divide R-right" data-right="1240002"> 对账 </a> <label class="cursor R-right" data-right="1240002"><a class="R-right" data-right="1240003"> |</a></label> <a data-entity-id="', 
                $line = 66, $out += $escape(rest.restaurantId), $out += '" data-entity-restaurantName="', 
                $line = 66, $out += $escape(rest.restaurantName), $out += '" data-entity-year="', 
                ...
                $out += '" ', $line = 71), $out += ' class="cursor btn-balance R-right" data-right="1240003"> 结算 </a> </td> </tr> ', 
                $line = 77;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 82, $out += $escape(recordSize), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> </div> </div>', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

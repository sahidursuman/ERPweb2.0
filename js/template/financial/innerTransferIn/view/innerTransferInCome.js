/*TMODJS:{"debug":true,"version":5,"md5":"cf7320bbab155b4080dfb1c8aa0eca7c"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/innerTransferInCome", function($data, $filename) {
        try {
            ...
            $line = 16, $each(incomeDetailsList, function(income) {
                ...
                $out += "</td> <td>", $line = 25, $out += $escape($helpers.dateFormat(income.checkTime, "yyyy-MM-dd")), 
                $out += "</td> </tr> ", $line = 27;

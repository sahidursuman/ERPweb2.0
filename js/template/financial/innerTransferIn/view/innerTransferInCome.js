/*TMODJS:{"debug":true,"version":24,"md5":"ff768759e8ee3201e926819a7644d289"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/innerTransferInCome", function($data, $filename) {
        try {
            ...
            $line = 16, $each(receivedDetailsList, function(income) {
                ...
                $line = 21, $out += $escape(income.incomeMoney), $out += "</span></td> <td> ", $line = 23, 
                0 == income.payType ? ($out += " 现金 ", $line = 25) : 1 == income.payType ? ($out += " 银行转账 ", 

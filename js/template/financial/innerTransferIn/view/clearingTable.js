/*TMODJS:{"debug":true,"version":13,"md5":"835910e9ae8cb76a37621f5562e23511"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/clearingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(innerTransferIncomeDetailsList, function(checking) {
                ...
                }), $out += " ", $line = 22), $out += ' </td> <td><a href="javascript:void(0)" class="T-action T-needPayDetail"><span>社收:<span class="F-float F-money">', 
                ...
                $line = 36) : ($out += " 未对账 ", $line = 38), $out += ' </label> <label> <a href="#" class="T-action T-payedDetail" style="margin-left:5px">查看</a> </label> </td> </tr> ', 
                $line = 45;
            }), new String($out);
        } catch (e) {
            throw {

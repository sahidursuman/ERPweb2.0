/*TMODJS:{"debug":true,"version":11,"md5":"92e98d487ae07e3a59d136345278c274"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/clearingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(innerTransferIncomeDetailsList, function(checking) {
                ...
                $out += "</td> <td>", $line = 6, $out += $escape(checking.contactUserName), $out += '</td> <td><a href="#" class="T-seeGroup" title="查看小组" data-list="', 
                ...
                }), $out += " ", $line = 22), $out += ' </td> <td><a href="javascript:void(0)" class="T-viewDetail"><span>社收:<span class="F-float F-money">', 
                ...
                $out += '></td> <td><textarea class="col-sm-12 hct-textarea" maxlength="1000" name="payRemark" ', 
                ...
                $line = 36) : ($out += " 未对账 ", $line = 38), $out += ' </label> <label> <a href="#" class="T-check-Detail" style="margin-left:5px">查看</a> </label> </td> </tr> ', 
                $line = 45;
            }), new String($out);
        } catch (e) {
            throw {

/*TMODJS:{"debug":true,"version":9,"md5":"5320c3c783a8ccb29f9ccb8b89c6b6b8"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/innerTransferInCheckDetail", function($data, $filename) {
        try {
            ...
            $line = 14, $each(incomeDetailsList, function(detail) {
                ...
                $out += "</td> <td>", $line = 21, $out += $escape($helpers.dateFormat(detail.checkTime, "yyyy-MM-dd hh:mm:ss")), 
                $out += "</td> </tr> ", $line = 23;

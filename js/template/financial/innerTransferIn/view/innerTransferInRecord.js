/*TMODJS:{"debug":true,"version":29,"md5":"8d571c1438ce5d04cc9b033fee548ed8"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/innerTransferInRecord", function($data, $filename) {
        try {
            ...
            $line = 9, $each(financialInnerTransferInSettlementRecordList, function(record) {
                ...
                $out += $escape(record.month), $out += '月,收款金额:<span class="F-float F-money">', 
                $line = 12, $out += $escape(record.incomeMoney), $out += "</span>,收款方式:", $line = 12, 
                $out += $escape(record.payType), $out += ",备注:", $line = 12, $out += $escape(record.remark), 
                $out += ")</td> </tr> ", $line = 14;

/*TMODJS:{"debug":true,"version":113,"md5":"3b96a15d06b8bbf7834435c7856ee27d"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/list", function($data, $filename) {
        try {
            ...
            $line = 20, $each(monthList, function(month) {
                ...
                $line = 22;
            }), $out += ' </select> <button class="marginLeft-30 btn-sm search-btn btn-innerTransferIn-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row innerTransferInList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>部门</th> <th>总人数</th> <th>总账面应收</th> <th>总实际应收</th> <th>总实际已收</th> <th>总账面未收</th> <th>总实际未收</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

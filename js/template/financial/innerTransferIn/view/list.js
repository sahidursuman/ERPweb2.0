/*TMODJS:{"debug":true,"version":81,"md5":"b77c7e43016792644d8ae7860a6199b0"}*/
    ...
    return require("../../../template")("financial/innerTransferIn/view/list", function($data, $filename) {
        try {
            ...
            $line = 43, $each(financialInnerTransferInList, function(innerTransferIn) {
                ...
                $line = 66, $out += $escape(searchParam.month), $out += '" class="cursor btn-innerTransferIn-check R-right" data-right="1360001"> 对账 </a> <a data-entity-id="', 
                $line = 69, $out += $escape(innerTransferIn.fromBusinessGroupId), $out += '" data-entity-fromBusinessGroupName="', 
                $line = 69, $out += $escape(innerTransferIn.fromBusinessGroupName), $out += '" data-entity-year="', 
                ...
                $out += '" ', $line = 74), $out += ' class="cursor btn-innerTransferIn-balance R-right" data="1360002"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 81;

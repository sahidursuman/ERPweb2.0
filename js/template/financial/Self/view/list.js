/*TMODJS:{"debug":true,"version":157,"md5":"a8991ab2376db93400ed8446a11c4a9a"}*/
define(function(require) {
    return require("../../../template")("financial/Self/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row T-ListSelf globalAdd" > <div class="form-horizontal search-area"> <div class="form-group T-search-area" > <label class="control-label pull-left" style="margin-left: 15px">自费商家：</label> <select class="col-xs-12" name="selfPayId" style="width: 220px"> <option value ="">全部</option> ', 
            ...
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class=" btn-sm search-btn marginLeft-30 T-search "> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row selfPayList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>自费商家</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 41, $each(financialSelfPayList, function(selfPay) {
                $out += ' <tr data-id ="', $line = 42, $out += $escape(selfPay.id), $out += '"> <td>', 
                $line = 43, $out += $escape(selfPay.selfPayName), $out += "</td> <td>", $line = 44, 
                $out += $escape(selfPay.sumNeedPayMoney), $out += "</td> <td>", $line = 45, $out += $escape(selfPay.sumRealNeedPayMoney), 
                $out += "</td> <td>", $line = 46, $out += $escape(selfPay.sumRealPayedMoney), $out += "</td> <td>", 
                $line = 47, $out += $escape(selfPay.sumUnPayedMoney), $out += '</td> <td> <span style="color:red">', 
                $line = 49, $out += $escape(selfPay.sumRealUnPayedMoney), $out += "</span> </td> <td > ", 
                $line = 52, selfPay.allCount != selfPay.checkedCount && ($out += ' <span style="color:#ff9900"> ', 
                ...
                $line = 60, $out += $escape(searchParam.month), $out += '" class="cursor T-option T-check R-right" data-right="1260002"> 对账 </a> <label class="cursor R-right" data-right="1260002"><a class="R-right" data-right="1260003"> |</a></label> <a data-entity-id="', 
                ...
                $out += '" ', $line = 69), $out += ' class="cursor R-right T-option T-clear" data-right="1260003"> 结算 </a> </td> </tr> ', 
                $line = 75;

/*TMODJS:{"debug":true,"version":105,"md5":"fa90e5fbab64aae49c8a197f527488bf"}*/
    ...
    return require("../../../template")("financial/Self/view/list", function($data, $filename) {
        try {
            ...
            $line = 41, $each(financialSelfPayList, function(selfPay) {
                ...
                $line = 63, $out += $escape(searchParam.month), $out += '" class="cursor btn-selfPay-check R-right" data-right="1260002"> 对账 </a> <label class="cursor R-right" data-right="1260002"><a class="R-right" data-right="1260003"></a> |</label> <a data-entity-id="', 
                $line = 67, $out += $escape(selfPay.selfPayId), $out += '" data-entity-selfPayName="', 
                $line = 67, $out += $escape(selfPay.selfPayName), $out += '" data-entity-year="', 
                ...
                $out += '" ', $line = 72), $out += ' class="cursor R-right btn-self-balance" data-right="1260003"> 结算 </a> </td> </tr> ', 
                $line = 78;

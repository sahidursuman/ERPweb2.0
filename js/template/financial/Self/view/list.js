/*TMODJS:{"debug":true,"version":195,"md5":"52f0aa0747dcd81069c1625fd039ed50"}*/
    ...
    return require("../../../template")("financial/Self/view/list", function($data, $filename) {
        try {
            ...
            $line = 34, $each(list, function(rs) {
                ...
                $out += "</span> ", $line = 53), $out += ' </td> <td> <a class="cursor T-option T-check R-right" data-right="1260002|1260005">对账</a> <label class="cursor R-right" data-right="1260002"><a class="R-right" data-right="1260003"> |</a></label> <a class="cursor T-option T-clear R-right" data-right="1260003">付款</a> </td> </tr> ', 
                $line = 61;

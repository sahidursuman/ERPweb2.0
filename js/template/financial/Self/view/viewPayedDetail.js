/*TMODJS:{"debug":true,"version":8,"md5":"94b117fb2a4ff25349449f3b8bb9f9fb"}*/
    ...
    return require("../../../template")("financial/Self/view/viewPayedDetail", function($data, $filename) {
        try {
            ...
            $line = 23, $each(paymentDetailsList, function(rs) {
                ...
                $out += '</td> <td class="F-float F-money">', $line = 29, $out += $escape($helpers.getPayTypeText(rs.payType)), 
                $out += "</td> <td>", $line = 30, null == rs.accountName || "" == rs.accountName ? ($out += "-", 

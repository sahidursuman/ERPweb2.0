/*TMODJS:{"debug":true,"version":5,"md5":"ad4391bdf7822105c4df6c1b2a98004d"}*/
define(function(require) {
    return require("../../../template")("financial/Self/view/viewPayedDetail", function($data, $filename) {
        try {
            ...
            $line = 22, $each(paymentDetailsList, function(rs) {
                ...
                $out += '</td> <td class="F-float F-money">', $line = 28, $out += $escape($helpers.getPayTypeText(rs.payType)), 
                $out += "</td> <td>", $line = 29, $out += $escape(rs.remark), $out += "</td> <td>", 
                $line = 30, null == rs.checkRealname || "" == rs.checkRealname ? ($out += "-", $line = 30) : ($line = 30, 
                $out += $escape(rs.checkRealname), $line = 30), $out += "</td> <td>", $line = 31, 
                null == rs.checkTime || "" == rs.checkTime ? ($out += "-", $line = 31) : ($line = 31, 

/*TMODJS:{"debug":true,"version":8,"md5":"722648e4114917fedb410eee04cc989a"}*/
define(function(require) {
    return require("../../../template")("financial/Scenic/view/ScenicRecords", function($data, $filename) {
        try {
            ...
            return $out += '<div class="scenicFinancialRecords"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>操作详情</th> </tr> </thead> <tbody> ', 

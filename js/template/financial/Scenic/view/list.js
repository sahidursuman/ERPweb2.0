/*TMODJS:{"debug":true,"version":45,"md5":"a8c5bc664b68f8e9834141607c709dbe"}*/
define(function(require) {
    return require("../../../template")("financial/Scenic/view/list", function($data, $filename) {
        try {
            ...
            return $out += '<div class="row Scenic scenicMain"> <div class="form-horizontal search-area"> <div class="form-group" > <label class="control-label pull-left" style="margin-left: 15px">景区:</label> <div class="col-sm-2"> <select class="col-xs-12" name="scenicId"> <option value ="">全部</option> ', 
            ...
            $line = 22, $each(monthList, function(month) {
                ...
                $line = 24;
            }), $out += ' </select> </div> <button class="btn-height btn-sm search-btn btn-scenic-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row ticketList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover"> <thead> <tr class="bg-blur"> <th class="col-sm-1">景区</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

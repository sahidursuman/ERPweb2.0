/*TMODJS:{"debug":true,"version":78,"md5":"502e09e0b0298825cdda193c7086ebdb"}*/
    ...
    return require("../../../template")("financial/Scenic/view/list", function($data, $filename) {
        try {
            ...
            $line = 42, $each(financialScenicList, function(rs) {
                ...
                $out += '" ', $line = 69), $out += ' class="cursor R-right btn-scenic-balance" data-right="1250003"> 结算 </a> </td> </tr> ', 
                $line = 76;

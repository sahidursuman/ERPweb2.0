/*TMODJS:{"debug":true,"version":98,"md5":"5e8d7d47c56440526dc1793505bff1e3"}*/
    ...
    return require("../../../template")("financial/Scenic/view/list", function($data, $filename) {
        try {
            ...
            $line = 42, $each(financialScenicList, function(rs) {
                ...
                $out += $escape(searchParam.month), $out += '" class="cursor R-right btn-scenic-Check" data-right="1250002"> 对账 </a> <a data-entity-id="', 

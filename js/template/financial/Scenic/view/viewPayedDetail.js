/*TMODJS:{"debug":true,"version":17,"md5":"1f87523df1be08af3c91178525dd8be0"}*/
define(function(require) {
    return require("../../../template")("financial/Scenic/view/viewPayedDetail", function($data, $filename) {
        try {
            ...
            $line = 24, $each(payedMoneyDetailList, function(rs) {
                ...
                $line = 29, $out += $escape(rs.payDifferenceMoney), $out += "</td> <td>", $line = 30, 
                $out += $escape($helpers.getPayTypeText(rs.payType)), $out += "</td> <td>", $line = 31, 
                null == rs.accountName || "" == rs.accountName ? ($out += "-", $line = 31) : ($line = 31, 

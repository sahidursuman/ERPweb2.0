/*TMODJS:{"debug":true,"version":14,"md5":"1c5ee6b0e022b5af1f60293c7986d14d"}*/
    ...
    return require("../../../template")("financial/Scenic/view/viewPayedDetail", function($data, $filename) {
        try {
            ...
            $line = 23, $each(payedMoneyDetailList, function(rs) {
                ...
                $out += $escape($helpers.getPayTypeText(rs.payType)), $out += "</td> <td>", $line = 30, 
                $out += $escape(rs.remark), $out += "</td> <td>", $line = 31, null == rs.checkRealname || "" == rs.checkRealname ? ($out += "-", 

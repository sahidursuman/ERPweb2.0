/*TMODJS:{"debug":true,"version":13,"md5":"16bf179458049c35fdf2230f8b6ae275"}*/
    ...
    return require("../../../template")("financial/OtherAccounts/view/ViewAmountPaid", function($data, $filename) {
        try {
            ...
            $line = 13, $each(paymentDetailsList, function(paid) {
                ...
                $line = 18, $out += $escape(paid.payDifferenceMoney), $out += '</td> <td class="F-float F-money">', 
                $line = 19, $out += $escape($helpers.getPayTypeText(paid.payType)), $out += "</td> <td>", 

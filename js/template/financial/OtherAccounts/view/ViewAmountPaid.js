/*TMODJS:{"debug":true,"version":12,"md5":"8fc1731b20377189d5674240823ae470"}*/
    ...
    return require("../../../template")("financial/OtherAccounts/view/ViewAmountPaid", function($data, $filename) {
        try {
            ...
            $line = 13, $each(paymentDetailsList, function(paid) {
                ...
                $out += "</td> <td>", $line = 19, $out += $escape($helpers.getPayTypeText(paid.payType)), 
                $out += "</td> <td>", $line = 20, $out += $escape(paid.remark), $out += "</td> <td>", 

/*TMODJS:{"debug":true,"version":38,"md5":"59aebf4a91b190f520497aab748b9fa6"}*/
    ...
    return require("../../../template")("financial/totalProfit/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $out += "</span>", $line = 23), $out += "</td> <td>", $line = 24, null == rs.totalTransfer || "" == rs.totalTransfer ? ($out += "-", 
                $line = 24) : ($out += '<span class="F-float F-money">', $line = 24, $out += $escape(rs.totalTransfer), 

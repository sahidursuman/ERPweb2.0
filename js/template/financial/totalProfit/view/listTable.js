/*TMODJS:{"debug":true,"version":74,"md5":"b1a24fd1dee71739d50ecf5a0e97495f"}*/
    ...
    return require("../../../template")("financial/totalProfit/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $line = 20, $out += $escape(rs.creatorName), $out += "</td> --> <td>", $line = 21, 
                $out += $escape(rs.businessGroup), $out += "</td> <td>", $line = 22, null == rs.tripIncome || "" === rs.tripIncome ? ($out += "-", 

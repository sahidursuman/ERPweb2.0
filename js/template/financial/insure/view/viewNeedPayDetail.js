/*TMODJS:{"debug":true,"version":9,"md5":"988d0dda2afb532e426f0e8d8383c6a8"}*/
    ...
    return require("../../../template")("financial/insure/view/viewNeedPayDetail", function($data, $filename) {
        try {
            ...
            $line = 25, $each(needPayDetailList, function(rs) {
                ...
                $line = 29, $out += $escape(rs.price), $out += '</td> <td class="F-float F-count">', 
                ...
                $out += $escape($helpers.dateTimeFormat(rs.checkTime)), $line = 36), $out += "</td> </tr> ", 
                $line = 38;

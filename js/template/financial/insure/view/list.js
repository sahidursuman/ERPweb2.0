/*TMODJS:{"debug":true,"version":191,"md5":"44da4bbddc81eeffb845f1bcbbbe3b3e"}*/
    ...
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class=" btn-sm marginLeft-30 btn-insurance-search search-btn " > <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row insuranceList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>保险公司</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

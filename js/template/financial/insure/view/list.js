/*TMODJS:{"debug":true,"version":297,"md5":"8e807f37f49634a1e578aabd8ef4e831"}*/
define(function(require) {
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row T-ListInsure globalAdd" > <div class="form-horizontal search-area"> <div class="form-group" > <label class="control-label pull-left">保险公司：</label> <select class="col-xs-1 insuranceId" name="insuranceId"> <option value ="">全部</option> ', 
            ...
            $line = 42, $each(financialInsuranceSettlementList, function(insurance) {
                ...
                $out += '" data-id="1" data-entity-insuranceCompanyName="', $line = 61, $out += $escape(insurance.insuranceCompanyName), 
                $out += '" data-entity-year="', $line = 61, $out += $escape(searchParam.year), $out += '" data-entity-month="', 
                $line = 61, $out += $escape(searchParam.month), $out += '" class="cursor R-right T-check T-option " data-right="1270002"> 对账 </a> <label class="cursor R-right" data-right="1270002"><a class="R-right" data-right="1270003"> |</a></label> <a data-entity-id="', 

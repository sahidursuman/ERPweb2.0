/*TMODJS:{"debug":true,"version":396,"md5":"9233a01e8a9e4ef01188e8a830331127"}*/
    ...
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $line = 34, $each(financialInsuranceList, function(rs) {
                ...
                $line = 35, $out += $escape(rs.insuranceName), $out += '"> <td>', $line = 36, $out += $escape(rs.insuranceName), 
                ...
                $out += "</span> ", $line = 53), $out += ' </td> <td> <a class="cursor R-right T-check T-option " data-right="1270002">对账</a> <label class="cursor R-right" data-right="1270002"><a class="R-right" data-right="1270003"> |</a></label> <a class="cursor T-option T-clear R-right" data-right="1270003">结算</a> </td> </tr> ', 
                $line = 61;

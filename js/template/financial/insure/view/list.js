/*TMODJS:{"debug":true,"version":397,"md5":"2828bfcf91dab1a0e3d561db06d50fe6"}*/
    ...
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $line = 34, $each(financialInsuranceList, function(rs) {
                ...
                $out += "</span> ", $line = 53), $out += ' </td> <td> <a class="cursor R-right T-check T-option " data-right="1270002|1270005">对账</a> <label class="cursor R-right" data-right="1270002"><a class="R-right" data-right="1270003"> |</a></label> <a class="cursor T-option T-clear R-right" data-right="1270003">结算</a> </td> </tr> ', 
                $line = 61;

    ...
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $line = 42, $each(financialInsuranceSettlementList, function(insurance) {
                ...
                $line = 61, $out += $escape(searchParam.month), $out += '" class="cursor R-right btn-insurance-check" data-right="1270002"> 对账 </a> <a data-entity-id="', 
                ...
                $out += '" ', $line = 69), $out += ' class="cursor R-right btn-insurance-balance" data-right="1270003"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 76;

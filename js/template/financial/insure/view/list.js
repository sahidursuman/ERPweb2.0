/*TMODJS:{"debug":true,"version":332,"md5":"25903fc712a6560632f96463ce0230ce"}*/
define(function(require) {
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row T-ListInsure globalAdd" > <div class="form-horizontal T-search-area search-area"> <div class="form-group" > <label class="control-label pull-left">保险公司：</label> <select class="col-xs-1 T-insuranceName" name="insuranceId"> <option value ="">全部</option> ', 
            ...
            $line = 41, $each(financialInsuranceSettlementList, function(insurance) {
                $out += ' <tr data-value="', $line = 42, $out += $escape(insurance.insuranceId), 
                $out += '"> <td>', $line = 43, $out += $escape(insurance.insuranceCompanyName), 
                $out += "</td> <td>", $line = 44, $out += $escape(insurance.sumNeedPayMoney), $out += "</td> <td>", 
                $line = 45, $out += $escape(insurance.sumRealNeedPayMoney), $out += "</td> <td>", 
                $line = 46, $out += $escape(insurance.sumRealPayedMoney), $out += "</td> <td>", 
                $line = 47, $out += $escape(insurance.sumUnPayedMoney), $out += '</td> <td> <span style="color:red">', 

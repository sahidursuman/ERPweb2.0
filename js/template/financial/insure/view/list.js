/*TMODJS:{"debug":true,"version":212,"md5":"7f0d770562fab7a7324ad2bc2d848898"}*/
define(function(require) {
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row Financialinsurance globalAdd" > <div class="form-horizontal search-area"> <div class="form-group" > <label class="control-label pull-left">保险公司：</label> <select class="col-xs-4 insuranceId" name="insuranceId"> <option value ="">全部</option> ', 
            $line = 7, $each(insuranceCompanyNameListNew, function(insurance) {
                ...
                $line = 9;
            }), $out += ' </select> <label class="control-label pull-left marginLeft-30" >账期：</label> <select class="col-sm-1 year" name="year" > ', 
            ...
            }), $out += ' </select> <select class="col-sm-1 month marginLeft-30" name="month" > <option value ="">全部</option> ', 
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class=" btn-sm marginLeft-30 btn-insurance-search search-btn " > <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row insuranceList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>保险公司</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 42, $each(financialInsuranceSettlementList, function(insurance) {
                ...
                $line = 61, $out += $escape(searchParam.month), $out += '" class="cursor R-right btn-insurance-check" data-right="1270002"> 对账 </a> <label class="cursor R-right" data-right="1270002"><a class="R-right" data-right="1270003"> |</a></label> <a data-entity-id="', 
                $line = 65, $out += $escape(insurance.insuranceId), $out += '" data-entity-insuranceCompanyName="', 
                $line = 65, $out += $escape(insurance.insuranceCompanyName), $out += '" data-entity-year="', 
                $line = 65, $out += $escape(searchParam.year), $out += '" ', $line = 66, "" == searchParam.month ? ($out += " data-entity-startMonth=1 data-entity-endMonth=12 ", 
                $line = 68) : ($out += ' data-entity-startMonth="', $line = 69, $out += $escape(searchParam.month), 
                $out += '" data-entity-endMonth="', $line = 69, $out += $escape(searchParam.month), 
                $out += '" ', $line = 70), $out += ' class="cursor R-right btn-insurance-balance" data-right="1270003"> 结算 </a> </td> </tr> ', 
                $line = 76;

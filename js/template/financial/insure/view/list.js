/*TMODJS:{"debug":true,"version":223,"md5":"5f6ec5cc5a55966325e93aea488c6f1e"}*/
define(function(require) {
    return require("../../../template")("financial/insure/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row T-ListInsure globalAdd" > <div class="form-horizontal search-area"> <div class="form-group" > <label class="control-label pull-left">保险公司：</label> <select class="col-xs-4 insuranceId" name="insuranceId"> <option value ="">全部</option> ', 
            ...
            $line = 42, $each(financialInsuranceSettlementList, function(insurance) {
                ...
                $line = 61, $out += $escape(searchParam.month), $out += '" class="cursor R-right T-check T-option btn-insurance-check" data-right="1270002"> 对账 </a> <label class="cursor R-right" data-right="1270002"><a class="R-right" data-right="1270003"> |</a></label> <a data-entity-id="', 
                ...
                $out += '" ', $line = 70), $out += ' class="cursor T-option T-clear R-right btn-insurance-balance" data-right="1270003"> 结算 </a> </td> </tr> ', 
                $line = 76;

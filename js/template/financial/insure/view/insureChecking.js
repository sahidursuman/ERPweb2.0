/*TMODJS:{"debug":true,"version":409,"md5":"079cec4eb5cabc3de76e35bf7735a79b"}*/
define(function(require){return require('../../../template')('financial/insure/view/insureChecking', function($data,$filename
/**/) {
try{'use strict';var $utils=this,$helpers=$utils.$helpers,$line=0,$escape=$utils.$escape,searchParam=$data.searchParam,insuranceName=$data.insuranceName,insuranceId=$data.insuranceId,sumNeedPayMoney=$data.sumNeedPayMoney,sumPayedMoney=$data.sumPayedMoney,sumSettlementMoney=$data.sumSettlementMoney,sumUnPayedMoney=$data.sumUnPayedMoney,checkedUnPayedMoney=$data.checkedUnPayedMoney,WEB_IMG_URL_BIG=$data.WEB_IMG_URL_BIG,WEB_IMG_URL_SMALL=$data.WEB_IMG_URL_SMALL,$each=$utils.$each,financialInsuranceList=$data.financialInsuranceList,rs=$data.rs,index=$data.index,$out='';$out+='<div class="row T-newData" data-id="';
$line=1;$out+=$escape(searchParam.insuranceId);
$out+='" data-name="';
$line=1;$out+=$escape(insuranceName);
$out+='"> <div class="col-xs-12" style="padding-bottom: 0px"> <form class="form-horizontal" role="form" onsubmit="return false"> <div class="T-search-area"> <div class="form-group"> <label>保险公司：</label> <input type="text" class="T-insuranceName mar-r-10" value="';
$line=7;$out+=$escape(insuranceName);
$out+='"> <input type="hidden" class="T-insuranceId" value="';
$line=8;$out+=$escape(insuranceId);
$out+='"> <label>账期：</label> <input class="date-picker" name="startDate" placeholder="开始日期" type="text" value="';
$line=10;$out+=$escape(searchParam.startDate);
$out+='" style="width:100px;" /> <label>&nbsp;至&nbsp;</label> <input class="date-picker mar-r-10" name="endDate" placeholder="结束日期" type="text" value="';
$line=12;$out+=$escape(searchParam.endDate);
$out+='" style="width:100px;" /> <label>团信息：</label> <input name="accountInfo" class="mar-r-10" placeholder="团信息" type="text" value="';
$line=14;$out+=$escape(searchParam.accountInfo);
$out+='" style="width:200px;" /> <label>对账状态：</label> <div class="btn-group T-check-status mar-r-10"> <button data-value="';
$line=17;$out+=$escape(searchParam.isConfirmAccount);
$out+='" data-toggle="dropdown" class=" btn-sm dropdown-toggle block-up" aria-expanded="false"> <span> ';
$line=19;if(!searchParam.isConfirmAccount || searchParam.isConfirmAccount === ""){
$out+=' 全部 ';
$line=21;}else if(searchParam.isConfirmAccount == 1){
$out+=' 已对账 ';
$line=23;}else{
$out+=' 未对账 ';
$line=25;}
...
$line=38;$out+=$escape(searchParam.accountStatus);
$out+='"> <button class="btn-sm search-btn T-btn-export">导出报表</button> </div> </div> </form> <form class="form-horizontal" role="form" onsubmit="return false"> <div class="form-group"> <label class="control-label pull-left">账面应付合计：<span class="F-float F-money">';
$line=45;$out+=$escape(sumNeedPayMoney);
$out+='</span></label> <label class="control-label marginLeft-30">已付金额合计：<span class="F-float F-money">';
$line=46;$out+=$escape(sumPayedMoney);
$out+='</span></label> <label class="control-label marginLeft-30">结算金额合计：<span class="T-stMoney F-float F-money" >';
$line=47;$out+=$escape(sumSettlementMoney);
$out+='</span></label> <label class="control-label marginLeft-30">未付金额合计：<span class="T-unpayMoney F-float F-money">';
$line=48;$out+=$escape(sumUnPayedMoney);
$out+='</span></label> <label class="control-label marginLeft-30">未付金额合计(已对账)：<span class="F-float F-money">';
$line=49;$out+=$escape(checkedUnPayedMoney);
$out+='</span></label> </div> </form> </div> <input type="hidden" value="';
$line=53;$out+=$escape(WEB_IMG_URL_BIG);
$out+='" name="WEB_IMG_URL_BIG" /> <input type="hidden" value="';
$line=54;$out+=$escape(WEB_IMG_URL_SMALL);
$out+='" name="WEB_IMG_URL_SMALL" /> <div class="clearfix"></div> <table class="table table-striped table-bordered table-hover all hct_align_middle"> <thead> <tr class="T-tr-fixed bg-blur"> <th>团信息</th> <th>消费日期(账期)</th> <th>险种</th> <th>单价</th> <th>数量</th> <th>优惠</th> <th>账面应付</th> <th>已付金额</th> <th>单据</th> <th>结算金额</th> <th>未付金额</th> <th>备注</th> <th>对账时间</th> <th>对账人</th> <th style="width:108px">对账</th> </tr> </thead> <tbody class="T-checkList" data-right="1270005"> ';
$line=77;$each(financialInsuranceList,function(rs,index){
$out+=' <tr class="T-checkTr ';
$line=78;if(rs.change){
$out+='success';
$line=78;}
$out+='" data-id="';
$line=78;$out+=$escape(rs.id);
$out+='" data-confirm="';
$line=78;$out+=$escape(rs.isConfirmAccount);
$out+='" ';
$line=78;if(rs.change){
$out+='data-change="true"';
$line=78;}
$out+='> <td>';
$line=79;if(rs.tripNumber !=null && rs.tripNumber != ""){
$line=79;$out+=$escape(rs.tripNumber);
$out+=' ';
$line=80;if(rs.lineProductName || rs.guideName){
$out+='，';
$line=80;}
$out+=' ';
$line=81;}
$out+=' ';
$line=82;if(rs.lineProductName != null && rs.lineProductName != ""){
$line=82;$out+=$escape(rs.lineProductName);
$out+=' ';
$line=83;if(rs.guideName){
$out+='，';
$line=83;}
$out+=' ';
$line=84;}
$out+=' ';
$line=85;if(rs.guideName != null && rs.guideName != ""){
$line=85;$out+=$escape(rs.guideName);
$line=85;}
$out+=' </td> <td>';
$line=87;if(rs.accountTime == null || rs.accountTime == ""){
$out+=' - ';
$line=87;}else{
$out+=' ';
$line=87;$out+=$escape($helpers. dateFormat(rs.accountTime , 'yyyy-MM-dd'));
$out+=' ';
$line=87;}
$out+=' </td> <td>';
$line=89;if(rs.type == null || rs.type == ""){
$out+='-';
$line=89;}else{
$line=89;$out+=$escape(rs.type);
$line=89;}
$out+='</td> <td class="F-float F-money">';
$line=90;$out+=$escape(rs.price);
$out+='</td> <td class="F-float F-count">';
$line=91;$out+=$escape(rs.memberCount);
$out+='</td> <td class="F-float F-money">';
$line=92;$out+=$escape(rs.reduceMoney);
$out+='</td> <td class="F-float F-money">';
$line=93;$out+=$escape(rs.needPayMoney);
$out+='</td> <td><a class="T-option T-payedDetail" data-money="';
$line=94;$out+=$escape(rs.payedMoney);
$out+='">';
$line=94;$out+=$escape("社付：");
$out+='<span class="F-float F-money">';
$line=94;$out+=$escape(rs.payedMoney);
$out+='</span></a></td> <td>';
$line=95;if(rs.billImage != null && rs.billImage !=""){
$out+='<a href="#" class="T-option T-insuranceImg" url="';
$line=95;$out+=$escape(rs.billImage);
$out+='"><span>查看</span></a>';
$line=95;}else{
$out+='<span style="color:#bbb">查看</span>';
$line=95;}
$out+='</td> <td> <input type="text" class="col-sm-12 F-float F-money" maxlength="9" name="settlementMoney" value="';
$line=97;$out+=$escape(rs.settlementMoney);
$out+='" class="money"> </td> <td class="F-float F-money" name="unPayedMoney">';
$line=99;$out+=$escape(rs.unPayedMoney);
$out+='</td> <td><textarea class="col-sm-12 hct-textarea" name="checkRemark" maxlength="1000">';
$line=100;$out+=$escape(rs.checkRemark);
$out+='</textarea></td> <td>';
$line=101;if(rs.checkTime == null || rs.checkTime == ""){
$out+='-';
$line=101;}else{
$line=101;$out+=$escape($helpers. dateFormat(rs.checkTime , 'yyyy-MM-dd hh:mm:ss'));
$line=101;}
$out+='</td> <td>';
$line=102;if(rs.checkUserName == null || rs.checkUserName == ""){
$out+='-';
$line=102;}else{
$line=102;$out+=$escape(rs.checkUserName);
$line=102;}
$out+='</td> <td> <label class="pos-rel"> <input type="checkbox" class="ace T-checkbox" ';
$line=105;if((rs.change && rs.isChecked == 1) || (!rs.change && rs.isConfirmAccount) ){
$out+='checked="checked" ';
$line=105;}
...
$line=118;$out+=$escape(searchParam.recordSize);

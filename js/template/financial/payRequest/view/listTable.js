/*TMODJS:{"debug":true,"version":85,"md5":"2922919b6c4c589fcee3dbc4616feeda"}*/
    ...
    return require("../../../template")("financial/payRequest/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $out += $escape(rs.realNeedPay), $line = 18), $out += '" /></td> <td><textarea class="col-sm-12 hct-textarea" name="checkRemark" maxlength="1000">', 

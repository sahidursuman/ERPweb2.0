/*TMODJS:{"debug":true,"version":80,"md5":"669bf5f8b4c69b9e4f4cc12a34076bdc"}*/
    ...
    return require("../../../template")("financial/payRequest/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $line = 18, rs.change ? ($line = 18, $out += $escape(rs.settlementMoney), $line = 18) : rs.realNeedPay ? ($line = 18, 
                $out += $escape(rs.realNeedPay), $line = 18) : ($line = 18, $out += $escape(rs.needPay), 
                $line = 18), $out += '" /></td> <td><textarea class="col-sm-12 hct-textarea" name="checkRemark" maxlength="1000">', 
                ...
                $line = 24), $out += ' /> <span class="lbl"></span> 对账 </label> <a class="cursor"> |</a> <a class="cursor T-pay">付款</a> </td> </tr> ', 
                $line = 31;
            }), new String($out);
        } catch (e) {
            throw {

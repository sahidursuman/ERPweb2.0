/*TMODJS:{"debug":true,"version":4,"md5":"b9a4c293f1ab55cfb2647199b95d3ae4"}*/
    ...
    return require("../../../template")("financial/payRequest/view/payedDetail", function($data, $filename) {
        try {
            ...
            $line = 16, $each(bookingAcountDetailList, function(item) {
                ...
                $line = 24, $out += $escape(item.remark), $out += "</td> <td>", $line = 25, $out += $escape(item.creatorName), 
                $out += "</td> <td>", $line = 26, $out += $escape(item.createTime), $out += "</td> </tr> ", 
                $line = 28;

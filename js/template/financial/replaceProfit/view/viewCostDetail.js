/*TMODJS:{"debug":true,"version":6,"md5":"879524975101a0b24e8cdd968ae2ecd1"}*/
    ...
    return require("../../../template")("financial/replaceProfit/view/viewCostDetail", function($data, $filename) {
        try {
            ...
            $line = 22, $each(needPayDetailsList, function(rs) {
                ...
                $out += $escape(rs.payMoney), $out += "</td> <td>", $line = 28, $out += $escape(rs.remark), 
                $out += "</td> <td>", $line = 29, null == rs.checkRealname || "" == rs.checkRealname ? ($out += "-", 

/*TMODJS:{"debug":true,"version":248,"md5":"80cb4602facab2486cc11e756879cb29"}*/
    ...
    return require("../../../template")("financial/replaceProfit/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookingOrderList, function(rs) {
                ...
                $line = 33), $out += " </td> <td>", $line = 35, $out += $escape(rs.sumSaleCostMoney), 
                $out += '</td> <td><a class="T-option T-costDetail F-float F-money">', $line = 36, 
                $out += $escape(rs.sumCostMoney), $out += '</a></td> <td><span class="F-float F-money">', 

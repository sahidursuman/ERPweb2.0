/*TMODJS:{"debug":true,"version":245,"md5":"13baa8fe03967b4b3cd0ca245f73e89b"}*/
    ...
    return require("../../../template")("financial/replaceProfit/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookingOrderList, function(rs) {
                ...
                $line = 5), $out += "</td> <td>", $line = 6, rs.businessGroup && ($line = 6, $out += $escape(rs.businessGroup.name), 

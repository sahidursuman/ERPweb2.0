/*TMODJS:{"debug":true,"version":247,"md5":"4e587e731ad46d89187d7a3b29558e3e"}*/
    ...
    return require("../../../template")("financial/replaceProfit/view/list", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookingOrderList, function(rs) {
                ...
                $line = 35, $out += $escape(rs.sumSaleCostMoney), $out += '</a></td> <td><a class="T-option T-costDetail F-float F-money">', 

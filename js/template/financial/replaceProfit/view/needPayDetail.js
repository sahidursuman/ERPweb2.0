/*TMODJS:{"debug":true,"version":4,"md5":"8dcbc7a814a6184c4d74dc697d768b8f"}*/
define(function(require) {
    return require("../../../template")("financial/replaceProfit/view/needPayDetail", function($data, $filename) {
        try {
            ...
            $line = 21, $each(payedMoneyDetailList, function(rs) {
                $out += ' <tr data-id="', $line = 22, $out += $escape(rs.id), $out += '"> <td>', 
                $line = 23, null == rs.payType || "" == rs.payType ? ($out += "-", $line = 23) : ($line = 23, 
                $out += $escape(rs.payType), $line = 23), $out += "</td> <td>", $line = 24, null == rs.businessType || "" == rs.businessType ? ($out += "-", 
                $line = 24) : ($line = 24, $out += $escape(rs.businessType), $line = 24), $out += "</td> <td>", 
                $line = 25, $out += $escape(rs.payDifferenceMoney), $out += "</td> <td>", $line = 26, 

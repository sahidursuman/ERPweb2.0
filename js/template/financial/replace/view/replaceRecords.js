/*TMODJS:{"debug":true,"version":22,"md5":"8fba368d514b7ed32ad709df41296b0e"}*/
define(function(require) {
    return require("../../../template")("financial/replace/view/replaceRecords", function($data, $filename) {
        try {
            ...
            return $out += '<div class="bookingFinancialRecords"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th>操作详情</th> </tr> </thead> <tbody> ', 

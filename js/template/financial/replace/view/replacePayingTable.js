    ...
    return require("../../../template")("financial/replace/view/replacePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookinAccountList, function(rs) {
                ...
                $line = 10, $out += $escape(rs.unReceiveMoney), $out += '</td> <th><input type="text" class="col-xs-12 T-reciveMoney" data-le="', 
                ...
                $out += '"></th> <td><input type="text" class="col-xs-12 T-remark" ', $line = 12, 

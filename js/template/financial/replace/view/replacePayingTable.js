/*TMODJS:{"debug":true,"version":51,"md5":"49e0e82d91fcaad7c03f53209e103b07"}*/
    ...
    return require("../../../template")("financial/replace/view/replacePayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(bookinAccountList, function(rs) {
                ...
                $line = 6, $out += $string(rs.newDetail), $out += '" ><span style="height:35px;">', 
                $line = 6, $out += $string(rs.newDetail), $out += '</span></td> <td><span class="F-float F-money">', 
                ...
                $out += "</td> <td> ", $line = 16, rs.isConfirmAccount ? ($out += "已", $line = 16) : ($out += "未", 
                $line = 16), $out += '对账 <label class="cursor" data-right="1290004"> <a> |</a></label> <a class="cursor T-action T-view-Received" data-right="1290004">查看</a> </td> </tr> ', 
                $line = 21;
            }), new String($out);
        } catch (e) {
            throw {

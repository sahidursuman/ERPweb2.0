/*TMODJS:{"debug":true,"version":13,"md5":"1873673faa56d52e4772b1fc0749cc21"}*/
    ...
    return require("../../../template")("financial/replace/view/list", function($data, $filename) {
        try {
            ...
            $line = 35, $each(bookingAccountList, function(rs) {
                ...
                0 != rs.unReceivedMoney && ($out += 'style="color:#FF0000;"', $line = 41), $out += ">", 
                $line = 41, $out += $escape(rs.unReceivedMoney), $out += '</span></td> <td><span style="color:#', 
                ...
                $line = 43, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking" data-right="1290002">对账</a> <label class="cursor R-right" data-right="1290002|1290003"> <a> |</a></label> <a class="cursor T-action T-balance R-right" data-right="1290003">收款</a> </td> </tr> ', 
                $line = 50;

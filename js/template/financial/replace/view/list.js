/*TMODJS:{"debug":true,"version":18,"md5":"aa348b8de992c83592ccb6f1e8cc447a"}*/
define(function(require) {
    return require("../../../template")("financial/replace/view/list", function($data, $filename) {
        try {
            ...
            $line = 11, $out += $escape(searchParam.endDate), $out += '"> </div> <div class="form-group marginLeft-30"> <button class="btn-sm search-btn T-btn-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </form> </div> <div class="row"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>客户</th> <th>代订金额</th> <th>结算金额</th> <th>已收金额 </th> <th>未收金额</th> <th>对账进度</th> <th>收款进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 35, $each(bookingAccountList, function(rs) {
                ...
                $line = 38, $out += $escape(rs.bookingMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 39, $out += $escape(rs.settlementMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 40, $out += $escape(rs.receiveMoney), $out += '</span></td> <td><span class="F-float F-money" ', 
                $line = 41, 0 != rs.unReceivedMoney && ($out += 'style="color:#FF0000;"', $line = 41), 
                $out += ">", $line = 41, $out += $escape(rs.unReceivedMoney), $out += '</span></td> <td><span style="color:#', 
                ...
                $line = 43, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking R-right" data-right="1290002">对账</a> <label class="cursor R-right" data-right="1290002|1290003"> <a> |</a></label> <a class="cursor T-action T-balance R-right" data-right="1290003">收款</a> </td> </tr> ', 
                $line = 50;

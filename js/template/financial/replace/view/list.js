/*TMODJS:{"debug":true,"version":124,"md5":"f2fe362194d3b99e07f28d09f077cb12"}*/
    ...
    return require("../../../template")("financial/replace/view/list", function($data, $filename) {
        try {
            ...
            $line = 15, $each(monthList, function(month) {
                ...
                $line = 17;
            }), $out += ' </select> <button class=" btn-sm search-btn marginLeft-30 btn-financialbooking-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row bookingaurantList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>客户</th> <th>总账面应收</th> <th>总实际应收</th> <th>总实际已收</th> <th>总账面未收</th> <th>总实际未收</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

/*TMODJS:{"debug":true,"version":12,"md5":"53e2fcd959f5a90b1d88598e0a31cbac"}*/
    ...
    return require("../../../template")("financial/replace/view/viewReceived", function($data, $filename) {
        try {
            ...
            $line = 17, $each(bookingAcountDetailList, function(item) {
                ...
                $line = 25, $out += $escape(item.remark), $out += "</td> <td>", $line = 26, $out += $escape(item.remark), 
                $out += "</td> <td>", $line = 27, $out += $escape(item.creatorName), $out += "</td> <td>", 
                $line = 28, $out += $escape(item.createTime), $out += "</td> </tr> ", $line = 30;

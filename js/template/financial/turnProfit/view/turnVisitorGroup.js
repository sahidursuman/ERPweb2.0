/*TMODJS:{"debug":true,"version":46,"md5":"a8115726fb8384e03f66282e3220a0c5"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/turnVisitorGroup", function($data, $filename) {
        try {
            ...
            $line = 19, $out += $escape(touristGroup.transPayedMoney), $out += '</td> </tr> </table> </form> </div> <div class="col-xs-12"> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <div class="form-group"> <div class="col-xs-12 col-sm-12 widget-container-col"> <div class="ui-sortable-handle"> <h5 class="title-size"> 转客列表 </h5> <div class="widget-body"> <div class="widget-main no-padding"> <table class="whereQ whereTwo" style="width: 100%"> <thead> <tr> <td class="th-border">类型</td> <td class="th-border">说明</td> <td class="th-border">数量</td> <td class="th-border">转客单价</td> </tr> </thead> <tbody> <tr> <td>转客价</td> <td>大人</td> <td>', 

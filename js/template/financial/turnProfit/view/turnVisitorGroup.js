/*TMODJS:{"debug":true,"version":43,"md5":"9c71cc54cd89d12336cab4b7d04b859c"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/turnVisitorGroup", function($data, $filename) {
        try {
            ...
            $line = 19, $out += $escape(touristGroup.transPayedMoney), $out += '</td> </tr> </table> </form> </div> <div class="col-xs-12"> <form class="form-horizontal" role="form" style="margin-top:10px" onsubmit="return false"> <div class="form-group"> <div class="col-xs-12 col-sm-12 widget-container-col"> <div class="ui-sortable-handle"> <h5 class="title-size"> 转客列表 </h5> <div class="widget-body"> <div class="widget-main no-padding"> <table class="table table-striped table-hover hotelRoomStandardList"> <thead> <tr> <th class="th-border">类型</th> <th class="th-border">说明</th> <th class="th-border">数量</th> <th class="th-border">转客单价</th> </tr> </thead> <tbody> <tr> <td>转客价</td> <td>大人</td> <td>', 

/*TMODJS:{"debug":true,"version":40,"md5":"18a57fecaf5eee9af456be3c440f5f3b"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/visitorGroupMainInfo", function($data, $filename) {
        try {
            var $utils = this, $helpers = $utils.$helpers, $line = 0, touristGroupDetail = $data.touristGroupDetail, $escape = $utils.$escape, $out = "";
            ...
            $line = 76, $out += $escape(touristGroupDetail.adultPrice), $out += "</label> </td> </tr> </table> </form> ", 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":154,"md5":"a7389506418770059e9f7b975e58b12d"}*/
    ...
    return require("../../../template")("financial/turnProfit/view/visitorGroupMainInfo", function($data, $filename) {
        try {
            ...
            $line = 14, $each(income, function(detail) {
                ...
                $line = 18, $out += $escape(detail.incomeDifferenceMoney), $out += "</span></td> <td>", 

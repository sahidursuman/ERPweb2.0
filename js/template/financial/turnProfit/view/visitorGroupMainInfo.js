/*TMODJS:{"debug":true,"version":62,"md5":"bcff4fb4c3dc8e6d2c874163a8002283"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/visitorGroupMainInfo", function($data, $filename) {
        try {
            ...
            $line = 87, $out += $escape(touristGroupDetail.childCount), $out += '</label> </td> <td> <label class="control-label">', 
            $line = 90, $out += $escape(touristGroupDetail.childPrice), $out += "</label> </td> </tr>  ", 
            $line = 94, $each(touristGroupDetail.touristGroupTransferFeeSet, function(transferFee) {
                $out += " ", $line = 95, null != transferFee && ($out += " <tr> <td>其他费用</td> <td>", 
                $line = 98, $out += $escape(transferFee.discribe), $out += "</td> <td>", $line = 99, 
                $out += $escape(transferFee.count), $out += "</td> <td>", $line = 100, $out += $escape(transferFee.otherPrice), 
                $out += "</td> </tr> ", $line = 102), $out += " ", $line = 103;

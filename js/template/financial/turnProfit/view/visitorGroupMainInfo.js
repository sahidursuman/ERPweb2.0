/*TMODJS:{"debug":true,"version":85,"md5":"e1c6e23ad7062f3c8730ca3882737106"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/visitorGroupMainInfo", function($data, $filename) {
        try {
            ...
            $line = 6, null != touristGroupDetail.lineProduct && ($line = 6, $out += $escape(touristGroupDetail.lineProduct.name), 
            $line = 6), $out += '</td> <td class="style-myself">出游日期：</td> <td class="styleOne-self">', 
            $line = 8, $out += $escape($helpers.dateFormat(touristGroupDetail.startTime, "yyyy-MM-dd")), 
            $out += '</td> </tr> <tr> <td class="style-myself" style="width:150px">是否购买保险：</td> <td class="styleOne-self">', 
            $line = 13, 0 == touristGroupDetail.buyInsurance ? ($out += " 否 ", $line = 15) : ($out += " 是 ", 
            $line = 17), $out += '</td> <td class="style-myself">客户来源：</td> <td class="styleOne-self" >', 
            $line = 19, null != touristGroupDetail.partnerAgency && ($line = 19, $out += $escape(touristGroupDetail.partnerAgency.travelAgencyName), 
            $line = 19), $out += '</td> </tr> <tr> <td class="style-myself" style="width:150px">同行联系人：</td> <td class="styleOne-self" >', 
            $line = 24, null != touristGroupDetail.partnerAgencyContact && ($line = 24, $out += $escape(touristGroupDetail.partnerAgencyContact.contactRealname), 
            $out += " -[", $line = 24, $out += $escape(touristGroupDetail.partnerAgencyContact.contactMobileNumber), 
            $out += "]", $line = 24), $out += '</td> <td class="style-myself">获得方式：</td> <td class="styleOne-self" >', 
            $line = 26, 1 == touristGroupDetail.getType ? ($out += " 旅行社系统 ", $line = 28) : 2 == touristGroupDetail.getType ? ($out += " 传真 ", 
            $line = 30) : 3 == touristGroupDetail.getType ? ($out += " 短信 ", $line = 32) : 4 == touristGroupDetail.getType ? ($out += " 电话 ", 
            $line = 34) : 5 == touristGroupDetail.getType && ($out += " QQ ", $line = 36), $out += '</td> </tr> <tr> <td class="style-myself">应收：</td> <td class="styleOne-self" >', 
            $line = 41, $out += $escape(touristGroupDetail.needPayAllMoney), $out += '</td> <td class="style-myself">已收：</td> <td class="styleOne-self">', 
            $line = 43, $out += $escape(touristGroupDetail.payedMoney), $out += '</td> </tr> <tr> <td class="style-myself">现收：</td> <td class="styleOne-self">', 
            $line = 47, $out += $escape(touristGroupDetail.currentNeedPayMoney), $out += '</td> <td class="style-myself">未收：</td> <td class="styleOne-self">', 
            $line = 50, $out += $escape(touristGroupDetail.unIncomeMoney), $out += '</td></tr> </table> <table class="whereQ whereTwo" style="width:97%;margin-top:20px">    <tr> <td class="style-myself">类型</td> <td class="style-myself">说明</td> <td class="style-myself">数量</td> <td class="style-myself">单价</td> </tr> <tr> <td> 结算价 </td> <td> 大人 </td> <td> <label class="control-label">', 
            $line = 72, $out += $escape(touristGroupDetail.adultCount), $out += '</label> </td> <td> <label class="control-label">', 
            $line = 75, $out += $escape(touristGroupDetail.adultPrice), $out += '</label> </td> </tr> <tr> <td> 结算价 </td> <td> 小孩 </td> <td> <label class="control-label">', 
            $line = 86, $out += $escape(touristGroupDetail.childCount), $out += '</label> </td> <td> <label class="control-label">', 
            $line = 89, $out += $escape(touristGroupDetail.childPrice), $out += "</label> </td> </tr>  ", 
            $line = 93, $each(touristGroupDetail.touristGroupTransferFeeSet, function(transferFee) {
                $out += " ", $line = 94, null != transferFee && ($out += " <tr> <td>其他费用</td> <td>", 
                $line = 97, $out += $escape(transferFee.discribe), $out += "</td> <td>", $line = 98, 
                $out += $escape(transferFee.count), $out += "</td> <td>", $line = 99, $out += $escape(transferFee.otherPrice), 

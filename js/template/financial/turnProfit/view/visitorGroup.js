/*TMODJS:{"debug":true,"version":33,"md5":"9e2c804bc45c36ee8d3b606cb0e17bce"}*/
define(function(require) {
    return require("../../../template")("financial/turnProfit/view/visitorGroup", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), touristGroupDetail = $data.touristGroupDetail, $escape = $utils.$escape, $each = $utils.$each, id = ($data.touristGroup, 
            ...
            $line = 45, $each(touristGroupDetail.touristGroupMemberList, function(touristGroup) {
                $out += ' <tr data-entity-id="touristGroup.id"> <td>', $line = 47, $out += $escape(id), 

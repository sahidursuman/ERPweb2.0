/*TMODJS:{"debug":true,"version":25,"md5":"fd5572540f894a13da0c914b2c8e88e6"}*/
    ...
    return require("../../../template")("financial/transferProfits/view/viewCostDetail", function($data, $filename) {
        try {
            ...
            $line = 14, $each(financialNeedPays, function(rs) {
                ...
                $out += $escape(rs.creator), $line = 20), $out += "</td> <td>", $line = 21, $out += $escape($helpers.dateFormat(rs.createTime, "yyyy-MM-dd hh:mm:ss")), 
                $out += "</td> </tr> ", $line = 23;

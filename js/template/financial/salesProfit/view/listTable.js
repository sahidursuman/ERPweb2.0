/*TMODJS:{"debug":true,"version":40,"md5":"454452d776ae5465e882c754abc71bec"}*/
    ...
    return require("../../../template")("financial/salesProfit/view/listTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(result, function(rs) {
                ...
                $line = 21), $out += "</td> <td>", $line = 22, rs.currentMoneyProfit || "0" == rs.currentMoneyProfit ? ($out += '<span class="F-float F-money">', 
                $line = 22, $out += $escape(rs.currentMoneyProfit), $out += "</span>", $line = 22) : ($out += "-", 
                $line = 22), $out += "</td> <td>", $line = 23, rs.orderIncome || "0" == rs.orderIncome ? ($out += '<span class="F-float F-money">', 
                $line = 23, $out += $escape(rs.orderIncome), $out += "</span>", $line = 23) : ($out += "-", 
                $line = 23), $out += "</td> <td>", $line = 24, rs.outCost || "0" == rs.outCost ? ($out += '<span class="F-float F-money">', 
                $line = 24, $out += $escape(rs.outCost), $out += "</span>", $line = 24) : ($out += "-", 
                $line = 24), $out += "</td> <td>", $line = 25, rs.tripCost || "0" == rs.tripCost ? ($out += '<span class="F-float F-money">', 
                $line = 25, $out += $escape(rs.tripCost), $out += "</span>", $line = 25) : ($out += "-", 
                $line = 25), $out += "</td> <td>", $line = 26, rs.transferCost || "0" == rs.transferCost ? ($out += '<span class="F-float F-money">', 
                $line = 26, $out += $escape(rs.transferCost), $out += "</span>", $line = 26) : ($out += "-", 
                $line = 26), $out += "</td> <td>", $line = 27, rs.innerCost || "0" == rs.innerCost ? ($out += '<span class="F-float F-money">', 
                $line = 27, $out += $escape(rs.innerCost), $out += "</span>", $line = 27) : ($out += "-", 
                $line = 27), $out += "</td> <td>", $line = 28, rs.orderCost || "0" == rs.orderCost ? ($out += '<span class="F-float F-money">', 
                $line = 28, $out += $escape(rs.orderCost), $out += "</span>", $line = 28) : ($out += "-", 
                $line = 28), $out += "</td> <td>", $line = 29, rs.income || "0" == rs.income ? ($out += '<span class="F-float F-money">', 
                $line = 29, $out += $escape(rs.income), $out += "</span>", $line = 29) : ($out += "-", 
                $line = 29), $out += "</td> <td>", $line = 30, rs.cost || "0" == rs.cost ? ($out += '<span class="F-float F-money">', 
                $line = 30, $out += $escape(rs.cost), $out += "</span>", $line = 30) : ($out += "-", 
                $line = 30), $out += "</td> <td>", $line = 31, rs.profit || "0" == rs.profit ? ($out += '<span class="F-float F-money">', 
                $line = 31, $out += $escape(rs.profit), $out += "</span>", $line = 31) : ($out += "-", 
                $line = 31), $out += "</td> <td>", $line = 32, rs.avgProfit || "0" == rs.avgProfit ? ($out += '<span class="F-float F-money">', 
                $line = 32, $out += $escape(rs.avgProfit), $out += "</span>", $line = 32) : ($out += "-", 
                $line = 32), $out += "</td> </tr> ", $line = 34;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,

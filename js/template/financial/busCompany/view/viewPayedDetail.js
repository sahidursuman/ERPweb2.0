/*TMODJS:{"debug":true,"version":22,"md5":"d7ac773717e267014186be43b445b0ac"}*/
define(function(require) {
    return require("../../../template")("financial/busCompany/view/viewPayedDetail", function($data, $filename) {
        try {
            ...
            $line = 23, $each(payedMoneyDetailList, function(rs) {
                ...
                $out += "</td> <td>", $line = 28, $out += $escape($helpers.getPayTypeText(rs.payType)), 

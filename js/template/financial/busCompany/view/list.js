/*TMODJS:{"debug":true,"version":234,"md5":"7defb804eb2bc5bc7f1d56318ffd9cce"}*/
    ...
    return require("../../../template")("financial/busCompany/view/list", function($data, $filename) {
        try {
            ...
            $line = 19, $each(monthList, function(month) {
                ...
                $line = 21;
            }), $out += ' </select> <button class="btn-sm btn-busCompany-search search-btn marginLeft-30" > <i class="ace-ico n fa fa-search"></i> 搜索 </button> </div> </div> <div class="row busCompanyList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-NotShowHighLight"> <thead> <tr class="bg-blur"> <th>车队</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 44, $each(financialBusCompanyList, function(busCompany) {
                ...
                $line = 61, $out += $escape(searchParam.month), $out += '" class="cursor btn-busCompany-check R-right" data-right="1230002"> 对账 </a> <label class="cursor R-right" data-right=\'1230002\'> <a class=\'R-right\' data-right=\'1230003\'> |</a></label> <a data-entity-id="', 
                $line = 65, $out += $escape(busCompany.busCompanyId), $out += '" data-entity-CompanyName="', 
                $line = 65, $out += $escape(busCompany.CompanyName), $out += '" data-entity-year="', 
                ...
                $out += '" ', $line = 70), $out += ' class=" btn-busCompany-balance cursor R-right" data-right="1230003"> 结算 </td> </tr> ', 
                $line = 75;

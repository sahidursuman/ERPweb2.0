/*TMODJS:{"debug":true,"version":7,"md5":"b5e952cb75e67be99335704adf761356"}*/
define(function(require) {
    return require("../../../template")("financial/busCompany/view/planCollection", function($data, $filename) {
        try {
            ...
            $line = 15, $each(collectionList, function(item) {
                ...
                $out += $escape(item.outOPUser), $out += '</td> <td><input type="text" name="collection" readonly=\'readonly\' value="', 
                ...
                $line = 35), $out += ' name="collectionType" class="ace ridioCheck T-assign-check" class="T-assign-check"> <span class="lbl"></span> 代收团款 </label> <label class="pos-rel"> <input type="radio" ', 
                $line = 39, 1 == item.collectionType && ($out += ' checked="checked" value="1" ', 
                $line = 39), $out += ' name="collectionType" class="ace ridioCheck T-assign-check" class="T-assign-check"> <span class="lbl"></span> 代收增项 </label> </td> </tr> ', 
                $line = 43;

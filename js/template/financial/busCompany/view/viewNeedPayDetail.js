/*TMODJS:{"debug":true,"version":36,"md5":"88c6a37bf958fb53e19233bedd9b6646"}*/
define(function(require) {
    return require("../../../template")("financial/busCompany/view/viewNeedPayDetail", function($data, $filename) {
        try {
            ...
            $line = 24, $each(payedMoneyDetailList, function(rs) {
                ...
                $line = 29, $out += $escape(rs.reduceMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 30, $out += $escape(rs.needPayMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 31, $out += $escape(rs.settlementMoney), $out += "</span></td> <td>", $line = 32, 

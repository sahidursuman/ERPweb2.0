/*TMODJS:{"debug":true,"version":33,"md5":"039a1d43066d586d95c119bf30cf87c1"}*/
    ...
    return require("../../../template")("financial/busCompany/view/viewNeedPayDetail", function($data, $filename) {
        try {
            ...
            $line = 24, $each(payedMoneyDetailList, function(rs) {
                ...
                $out += $escape(rs.price), $out += "</td> <td>", $line = 29, $out += $escape(rs.reduceMoney), 
                $out += "</td> <td>", $line = 30, $out += $escape(rs.needPayMoney), $out += "</td> <td>", 
                $line = 31, $out += $escape(rs.settlementMoney), $out += "</td> <td>", $line = 32, 

/*TMODJS:{"debug":true,"version":9,"md5":"71d15a19ca7bcf5caf9d2a4c9bd07c34"}*/
define(function(require) {
    return require("../../../template")("financial/shop/view/viewReceived", function($data, $filename) {
        try {
            var $utils = this, $line = ($utils.$helpers, 0), $each = $utils.$each, shopAccountDetailList = $data.shopAccountDetailList, $escape = ($data.item, 
            ...
            $line = 16, $each(shopAccountDetailList, function(item) {
                ...
                $out += $escape(item.payType), $out += "</td> <td>", $line = 21, $out += $escape(item.incomeMoney), 

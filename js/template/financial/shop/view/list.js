/*TMODJS:{"debug":true,"version":7,"md5":"e8791cc091ca0b62105f3b771883ba09"}*/
    ...
    return require("../../../template")("financial/shop/view/list", function($data, $filename) {
        try {
            ...
            $line = 38, $each(shopAccountList, function(rs) {
                ...
                $line = 48, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking">对账</a> <label class="cursor"> <a> |</a></label> <a class="cursor T-action T-settlement">付款</a> </td> </tr> ', 
                $line = 55;

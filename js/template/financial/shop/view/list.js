/*TMODJS:{"debug":true,"version":10,"md5":"c9bc7185295a6106e29685230287fa85"}*/
    ...
    return require("../../../template")("financial/shop/view/list", function($data, $filename) {
        try {
            ...
            $line = 38, $each(shopAccountList, function(rs) {
                ...
                $line = 48, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking" data-right="1310002">对账</a> <label class="cursor R-right" data-right="1310002|1310003"> <a> |</a></label> <a class="cursor T-action T-settlement R-right" data-right="1310003">付款</a> </td> </tr> ', 
                $line = 55;

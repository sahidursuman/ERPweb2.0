/*TMODJS:{"debug":true,"version":26,"md5":"c1252513dc15c13470becdb3ed7b0c44"}*/
define(function(require) {
    return require("../../../template")("financial/shop/view/list", function($data, $filename) {
        try {
            ...
            $line = 12, $out += $escape(searchParam.endDate), $out += '" style="width: 100px; text-align: center;"> </div> <div class="form-group marginLeft-30"> <button class="btn-sm search-btn T-btn-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </form> </div> <div class="clearfix"></div> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>购物店</th> <th>总人数</th> <th>打单金额</th> <th>返佣金额</th> <th>结算金额</th> <th>已收金额</th> <th>未收金额</th> <th>对账进度</th> <th>收款进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 38, $each(shopAccountList, function(rs) {
                ...
                $out += "</td> <td><span>", $line = 41, $out += $escape(rs.sumCount), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 42, $out += $escape(rs.shopMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 43, $out += $escape(rs.backMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 44, $out += $escape(rs.settlementMoney), $out += '</span></td> <td><span class="F-float F-money">', 
                $line = 45, $out += $escape(rs.reciveMoney), $out += '</span></td> <td><span class="F-float F-money" ', 
                $line = 46, 0 != rs.unReciveMoney && ($out += 'style="color:#FF0000;"', $line = 46), 
                $out += ">", $line = 46, $out += $escape(rs.unReciveMoney), $out += '</span></td> <td><span style="color:#', 
                ...
                $line = 48, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking R-right" data-right="1310002">对账</a> <label class="cursor R-right" data-right="1310002|1310003"> <a> |</a></label> <a class="cursor T-action T-settlement R-right" data-right="1310003">收款</a> </td> </tr> ', 
                $line = 55;

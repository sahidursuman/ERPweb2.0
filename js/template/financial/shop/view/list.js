/*TMODJS:{"debug":true,"version":2,"md5":"a6fb8af7bf8c4239f859023455d4ef1a"}*/
define(function(require) {
    return require("../../../template")("financial/shop/view/list", function($data, $filename) {
        try {
            ...
            $line = 10, $out += $escape(searchParam.startTime), $out += '" style="width: 100px; text-align: center;"> <label>&nbsp;至&nbsp;</label> <input type="text" class="form-control datepicker T-search-end-date" value="', 
            $line = 12, $out += $escape(searchParam.endTime), $out += '" style="width: 100px; text-align: center;"> </div> <div class="form-group marginLeft-30"> <button class="btn-sm search-btn T-btn-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </form> </div> <div class="clearfix"></div> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>购物店</th> <th>总人数</th> <th>购物金额</th> <th>返佣金额</th> <th>结算金额</th> <th>已收金额</th> <th>未收金额</th> <th>对账进度</th> <th>付款进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 38, $each(shopAccountList, function(rs) {
                $out += ' <tr data-id="', $line = 39, $out += $escape(rs.shopId), $out += '"> <td>', 
                $line = 40, $out += $escape(rs.shopName), $out += "</td> <td>大小</td> <td>", $line = 42, 
                $out += $escape(rs.shopMoney), $out += "</td> <td>", $line = 43, $out += $escape(rs.backMoney), 
                ...
                $line = 48, $out += $escape(rs.allRecord), $out += '</span></td> <td> <a class="cursor T-action T-checking">对账</a> <label class="cursor"> <a> |</a></label> <a class="cursor T-action T-settlement">收款</a> </td> </tr> ', 
                $line = 55;

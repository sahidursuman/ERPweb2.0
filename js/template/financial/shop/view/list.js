/*TMODJS:{"debug":true,"version":4,"md5":"e644935e9f7e53c93195bcc38fe28e37"}*/
    ...
    return require("../../../template")("financial/shop/view/list", function($data, $filename) {
        try {
            ...
            $line = 38, $each(shopAccountList, function(rs) {
                ...
                $out += "</td> <td>大小</td> <td>", $line = 42, $out += $escape(rs.shopMoney), $out += "</td> <td>", 
                $line = 43, $out += $escape(rs.backMoney), $out += "</td> <td>", $line = 44, $out += $escape(rs.settlementMoney), 
                $out += "</td> <td>", $line = 45, $out += $escape(rs.reciveMoney), $out += "</td> <td><span ", 

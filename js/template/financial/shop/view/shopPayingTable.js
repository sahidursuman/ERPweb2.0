/*TMODJS:{"debug":true,"version":9,"md5":"03c94eaad83986d61e6c1c7aeda0d361"}*/
    ...
    return require("../../../template")("financial/shop/view/shopPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(shopAccountList, function(rs, index) {
                ...
                $line = 7, rs.shopItem.length > 0 && ($line = 7, $out += $escape(rs.shopItem[0].itemName), 
                $line = 7, rs.shopItem.length > 1 && ($out += "...", $line = 7), $out += '<a class="cursor T-action T-see-group">展开</a>', 
                ...
                $line = 24) : ($out += "未", $line = 24), $out += '对账</span> </label> <label class="cursor" data-right="1310004"> <a> |</a></label> <a class="cursor T-action T-view-details" data-right="1310004">查看</a> </td> </tr> ', 
                $line = 30, rs.shopItem.length > 0 && ($out += ' <tr class="hide"> <td colspan="19"> <table class="table table-striped table-bordered table-hover"> <thead> <tr> <th class="th-border" style="min-width: 45px;">序号</th> <th class="th-border" style="min-width: 70px;">商品</th> <th class="th-border" style="min-width: 120px;">消费金额</th> <th class="th-border" style="min-width: 45px;">社佣</th> <th class="th-border" style="min-width: 45px;">导佣</th> </tr> </thead> <tbody> ', 
                $line = 44, $each(rs.shopItem, function(list, i) {
                    $out += " <tr> <td>", $line = 46, $out += $escape(i + 1), $out += "</td> <td>", 
                    $line = 47, $out += $escape(list.itemName), $out += "</td> <td>", $line = 48, $out += $escape(list.consumeMoney), 
                    $out += "</td> <td>", $line = 49, $out += $escape(list.travelAgencyRebateMoney), 
                    $out += "</td> <td>", $line = 50, $out += $escape(list.guideRebateMoney), $out += "</td> </tr> ", 
                    $line = 52;
                }), $out += " </tbody> </table> </td> </tr> ", $line = 58), $out += " ", $line = 59;
            }), new String($out);
        } catch (e) {
            throw {
                filename: $filename,

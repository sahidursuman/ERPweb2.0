/*TMODJS:{"debug":true,"version":41,"md5":"7d9677623b5e0024236148bc2798ce2c"}*/
    ...
    return require("../../../template")("financial/shop/view/shopPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(shopAccountList, function(rs) {
                ...
                $line = 13, $out += $escape(rs.unReceiveMoney), $out += '</span></td> <td><input type="text" class="col-sm-12 T-reciveMoney F-float F-money" name="payMoney" value="', 
                $line = 14, $out += $escape(rs.payMoney), $out += '"></td> <td><textarea class="col-sm-12 hct-textarea T-payRemark" name="payRemark" maxlength="1000">', 
                $line = 15, $out += $escape(rs.payRemark), $out += "</textarea></td> <td>", $line = 16, 
                $out += $escape(rs.checkTime), $out += "</td> <td>", $line = 17, $out += $escape(rs.checkName), 

/*TMODJS:{"debug":true,"version":2,"md5":"a32d5f88d04acbc275751a6a3ee8ef47"}*/
    ...
    return require("../../../template")("financial/shop/view/shopPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(shopAccountList, function(rs, index) {
                ...
                $out += "</td> <td>", $line = 12, $out += $escape(rs.parkingRebateMoney), $out += '</td> <td><a class="cursor T-action T-view-receipts">查看</a></td> <td>', 
                $line = 14, $out += $escape(rs.backMoney), $out += '</td> <td><a class="cursor T-action ">', 

/*TMODJS:{"debug":true,"version":147,"md5":"2a9fce21035a660d3d083dc6810d3cfe"}*/
define(function(require) {
    return require("../../../template")("financial/offsetByDetail/view/listMain", function($data, $filename) {
        try {
            ...
            $line = 8), $out += ' value="22">客户</option> </select> </div> <div class="form-group mar-r-10"> <label>对方单位</label> <input type="text" class="form-control" name="resourceName" style="width: 120px;" value="" maxlength="100" placeholder="对方单位"> </div> <div class="form-group input-daterange mar-r-10"> <label>记账日期</label> <input type="text" class="form-control datepicker w100" name="startDate" value="', 

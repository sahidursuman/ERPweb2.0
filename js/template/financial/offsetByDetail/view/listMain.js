/*TMODJS:{"debug":true,"version":151,"md5":"a627111294eb9d19414c22027e476604"}*/
define(function(require) {
    return require("../../../template")("financial/offsetByDetail/view/listMain", function($data, $filename) {
        try {
            ...
            $data.$index, "");
            return $out += '<div class="row T-search-area"> <form class="form-inline" role="form" onsubmit="return false"> <div class="form-group mar-r-10"> <label>资源类型</label> <select name="resourceType" style="width: 51px;"> <option ', 
            ...
            $line = 8), $out += ' value="22">客户</option> </select> </div> <div class="form-group mar-r-10"> <label>对方单位</label> <input type="text" class="form-control" name="resourceName" style="width: 120px;" value="', 
            $line = 13, $out += $escape(searchParam.resourceName), $out += '" maxlength="100" placeholder="对方单位"> </div> <div class="form-group input-daterange mar-r-10"> <label>记账日期</label> <input type="text" class="form-control datepicker w100" name="startDate" value="', 
            $line = 18, $out += $escape(searchParam.startDate), $out += '"> <label>&nbsp;至&nbsp;</label> <input type="text" class="form-control datepicker w100" name="endDate" value="', 
            $line = 20, $out += $escape(searchParam.endDate), $out += '"> </div> <div class="form-group"> <button class="btn-sm search-btn T-btn-search"><i class="ace-icon fa fa-search"></i> 搜索</button> </div> </form> </div> <div class="row"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur T-tr-fixed"> <th>对方单位</th> <th>余额</th> <th>冲抵明细</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 37, $each(result, function(rs) {
                $out += ' <tr data-resourceId="', $line = 38, $out += $escape(rs.resourceId), $out += '" data-resourceType="', 
                $line = 38, $out += $escape(rs.resourceType), $out += '"> <td>', $line = 39, $out += $escape(rs.resourceName), 
                $out += '</td> <td><a class="cursor T-action T-balance">', $line = 40, $out += $escape(rs.balance), 
                $out += '</a></td> <td><a class="cursor T-action T-viewDetails">查看</a></td> </tr> ', 
                $line = 43;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 48, $out += $escape(searchParam.totalCount), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":28,"md5":"0fe327fc3a5feb8097ec4f57aa8033c5"}*/
define(function(require) {
    return require("../../../template")("financial/offsetByDetail/view/listMain", function($data, $filename) {
        try {
            ...
            $line = 38, $each(result, function(rs) {
                $out += ' <tr data-resourceId="', $line = 39, $out += $escape(rs.resourceId), $out += '" data-resourceType="', 
                $line = 39, $out += $escape(rs.resourceType), $out += '"> <td>', $line = 40, $out += $escape(rs.resourceName), 
                $out += '</td> <td><a class="cursor T-action T-income">', $line = 41, $out += $escape(rs.income), 
                $out += '</a></td> <td><a class="cursor T-action T-viewDetails">', $line = 42, $out += $escape(rs.pay), 
                $out += "</a></td> <td>", $line = 43, $out += $escape(rs.balance), $out += "</td> </tr> ", 
                $line = 45;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 50, $out += $escape(searchParam.totalCount), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

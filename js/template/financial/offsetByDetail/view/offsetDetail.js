/*TMODJS:{"debug":true,"version":8,"md5":"1da3741d60a1f033ad42d65cf8d74339"}*/
    ...
    return require("../../../template")("financial/offsetByDetail/view/offsetDetail", function($data, $filename) {
        try {
            ...
            $line = 41, $each(result, function(rs) {
                ...
                $line = 49), $out += '</td> <td> <a class="cursor T-view" style="color:#337ab7"> ', 
                $line = 52, 0 == rs.incomeMoney ? ($line = 52, $out += $escape(rs.payMoney), $line = 52) : ($line = 52, 
                $out += $escape(rs.incomeMoney), $line = 52), $out += " </a> </td> <td> ", $line = 56, 
                null != rs.bankAccount ? ($out += " ", $line = 57, null == rs.bankAccount.bankAccountNumber || "" == rs.bankAccount.bankAccountNumber ? ($out += " - ", 
                $line = 59) : ($out += " ", $line = 60, $out += $escape(rs.bankAccount.bankAccountNumber), 
                $out += " ", $line = 61), $out += " ", $line = 62) : ($out += " - ", $line = 64), 
                $out += " </td> <td>", $line = 66, $out += $escape(rs.remark), $out += "</td> <td>", 
                $line = 67, rs.user && ($line = 67, $out += $escape(rs.user.realName), $line = 67), 
                $out += "</td> <td>", $line = 68, $out += $escape(rs.createTime), $out += "</td> </tr> ", 
                $line = 70;
            }), $out += ' </tbody> </table> <div class="row pageMode"> <div class="col-xs-6"> <small>共计 ', 
            $line = 75, $out += $escape(searchParam.totalCount), $out += ' 条记录</small> </div> <div class="col-xs-6"> <div class="dataTables_paginate paging_simple_numbers T-pagenation"> </div> </div> </div> </div> ', 
            new String($out);
        } catch (e) {
            throw {
                filename: $filename,

/*TMODJS:{"debug":true,"version":56,"md5":"f04976d9ba58c34135fd0dcd70ed2ec5"}*/
    ...
    return require("../../../template")("financial/ticket/view/ticketPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(financialTicketList, function(rs) {
                ...
                $out += $escape(rs.payRecoredId), $out += '"><span class="F-float F-money">', $line = 12, 
                $out += $escape(rs.prePayMoney), $out += '</span></a></td> <td class="T-payedDetail align-left" data-money="', 
                $line = 13, $out += $escape(rs.payedMoney + rs.realGuidePayMoney), $out += '"> <a class="T-action T-payDetails"> <span class="in-block">社付<span class="F-float F-money">', 

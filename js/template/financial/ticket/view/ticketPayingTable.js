/*TMODJS:{"debug":true,"version":33,"md5":"4af98c0ab017470bd64cd85f73678015"}*/
    ...
    return require("../../../template")("financial/ticket/view/ticketPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(financialTicketList, function(rs) {
                ...
                $out += '</td> <td><input type="text" class="col-sm-12 T-reciveMoney F-float F-money" name="payMoney" data-le="', 

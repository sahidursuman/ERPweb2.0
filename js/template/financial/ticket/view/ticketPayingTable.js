/*TMODJS:{"debug":true,"version":23,"md5":"a3e9cd8e3806f8cf055ed878dc50ae7d"}*/
    ...
    return require("../../../template")("financial/ticket/view/ticketPayingTable", function($data, $filename) {
        try {
            ...
            return $line = 1, $each(financialTicketList, function(rs) {
                ...
                $out += "</td> <td>", $line = 8, $out += $escape(rs.price), $out += "</td> <td>", 
                $line = 9, $out += $escape(rs.memberCount), $out += "</td> <td>", $line = 10, $out += $escape(rs.reduceMoney), 
                ...
                $line = 12, $out += $escape(rs.payedMoney), $line = 12, 1 != rs.isGuidePay && ($out += "，导付", 
                $line = 12, $out += $escape(rs.realGuidePayMoney), $line = 12), $out += "</a></td> <td>", 

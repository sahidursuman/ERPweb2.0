/*TMODJS:{"debug":true,"version":183,"md5":"7729d61e87a553e5cdfb0fc894b818fa"}*/
    ...
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $line = 21, $each(monthList, function(month) {
                ...
                $line = 23;
            }), $out += ' </select>  <button class=" btn-sm search-btn marginLeft-30 btn-ticket-search "> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row ticketList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover"> <thead> <tr class="bg-blur" > <th>票务商家</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 
            $line = 45, $each(financialTicketSettlementList, function(ticket) {
                ...
                $line = 64, $out += $escape(searchParam.month), $out += '" class="cursor btn-ticket-check R-right" data-right="1210002"> 对账 </a> <a data-entity-id="', 
                $line = 67, $out += $escape(ticket.ticketId), $out += '" data-entity-companyName="', 
                $line = 67, $out += $escape(ticket.companyName), $out += '" data-entity-year="', 
                $line = 67, $out += $escape(searchParam.year), $out += '" ', $line = 68, "" == searchParam.month ? ($out += " data-entity-startMonth=1 data-entity-endMonth=12 ", 
                ...
                $out += '" ', $line = 72), $out += ' class="cursor R-right btn-ticket-balance" data-right="1210003"> <label class="padding-right20"> |</label> 结算 </a> </td> </tr> ', 
                $line = 79;

/*TMODJS:{"debug":true,"version":11,"md5":"81ef24166e9ff9c72bc0fe0bbfca8266"}*/
    ...
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $line = 36, $each(financialTicketList, function(rs) {
                ...
                $line = 44, $out += $escape(rs.allPayCount), $out += '</span></td> <td> <a class="cursor T-action T-checking">对账</a> <label class="cursor"> <a> |</a></label> <a class="cursor T-action T-balance">付款</a> </td> </tr> ', 
                $line = 51;

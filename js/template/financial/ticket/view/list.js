/*TMODJS:{"debug":true,"version":4,"md5":"ed92ffc449e0f1dc3f4838b1bb7d9064"}*/
define(function(require) {
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $data.recordSize), $out = "";
            return $out += '<div class="row FinancialTicket globalAdd" > <div class="form-horizontal search-area T-search-area"> <div class="form-group" > <label class="control-label pull-left" style="margin-left: 15px">票务商家：</label> <select class="col-xs-12 T-search-name" name="ticketId" style="width: 220px"> <option value ="">全部</option> ', 
            $line = 7, $each(companyNameListNew, function(ticket) {
                ...
                $line = 9;
            }), $out += ' </select> <label class="control-label pull-left marginLeft-30" >账期：</label>  <select class="col-sm-1 T-search-year" name="year" > ', 
            ...
            }), $out += ' </select> <select class="marginLeft-30 col-sm-1 T-search-month" name="month"> <option value ="">全部</option> ', 
            $line = 21, $each(monthList, function(month) {
                ...
                $line = 23;
            }), $out += ' </select>  <button class=" btn-sm search-btn marginLeft-30 T-btn-search "> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row ticketList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur" > <th>票务商家</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 45, $each(financialTicketSettlementList, function(ticket) {
                $out += ' <tr data-id="', $line = 46, $out += $escape(ticket.ticketId), $out += '"> <td>', 
                $line = 47, $out += $escape(ticket.companyName), $out += "</td> <td>", $line = 48, 
                $out += $escape(ticket.sumNeedPayMoney), $out += "</td> <td>", $line = 49, $out += $escape(ticket.sumRealNeedPayMoney), 
                $out += "</td> <td>", $line = 50, $out += $escape(ticket.sumRealPayedMoney), $out += "</td> <td>", 
                $line = 51, $out += $escape(ticket.sumUnPayedMoney), $out += '</td> <td> <span style="color:red">', 
                ...
                $line = 60, $out += $escape(ticket.allCount), $out += "</span> ", $line = 61), $out += ' </td> <td> <a data-entity-companyName="', 
                $line = 64, $out += $escape(ticket.companyName), $out += '" data-entity-year="', 
                $line = 64, $out += $escape(searchParam.year), $out += '" data-entity-month="', 
                $line = 64, $out += $escape(searchParam.month), $out += '" class="cursor T-action T-check R-right" data-right="1210002"> 对账 </a> <label class="cursor R-right" data-right="1210002"><a class="R-right" data-right="1210003"> |</a></label> <a data-entity-companyName="', 
                ...
                $out += '" ', $line = 73), $out += ' class="cursor R-right T-action T-balance" data-right="1210003"> 结算 </a> </td> </tr> ', 
                $line = 79;

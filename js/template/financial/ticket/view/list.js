/*TMODJS:{"debug":true,"version":14,"md5":"a495e86da70448e97d386ec0fde816f4"}*/
    ...
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $line = 36, $each(financialTicketList, function(rs) {
                ...
                $out += "</td> <td>", $line = 39, $out += $escape(rs.sumNeedPayMoney), $out += "</td> <td>", 
                $line = 40, $out += $escape(rs.sumSettlementMoney), $out += "</td> <td>", $line = 41, 
                $out += $escape(rs.sumPayedMoney), $out += "</td> <td><span ", $line = 42, 0 != rs.sumUnPayedMoney && ($out += 'style="color:#FF0000;"', 
                ...
                $line = 44, $out += $escape(rs.allPayCount), $out += '</span></td> <td> <a class="cursor T-action T-checking" data-right="1210002">对账</a> <label class="cursor R-right" data-right="1210002|1210003"> <a> |</a></label> <a class="cursor T-action T-balance R-right" data-right="1210003">付款</a> </td> </tr> ', 
                $line = 51;

/*TMODJS:{"debug":true,"version":199,"md5":"65d868593691229ab411b3a7bdf61afa"}*/
    ...
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $line = 21, $each(monthList, function(month) {
                ...
                $line = 23;
            }), $out += ' </select>  <button class=" btn-sm search-btn marginLeft-30 btn-ticket-search "> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </div> <div class="row ticketList"> <div class="col-xs-12"> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur" > <th>票务商家</th> <th>总账面应付</th> <th>总实际应付</th> <th>总实际已付</th> <th>总账面未付</th> <th>总实际未付</th> <th>对账进度</th> <th>操作</th> </tr> </thead> <tbody> ', 

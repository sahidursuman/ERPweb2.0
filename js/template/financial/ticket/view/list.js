/*TMODJS:{"debug":true,"version":16,"md5":"dd4871275cf8314ab80abaa879848859"}*/
define(function(require) {
    return require("../../../template")("financial/ticket/view/list", function($data, $filename) {
        try {
            ...
            $line = 12, $out += $escape(searchParam.endDate), $out += '" style="width: 100px; text-align: center;"> </div> <div class="form-group marginLeft-30"> <button class="btn-sm search-btn T-btn-search"> <i class="ace-icon fa fa-search"></i> 搜索 </button> </div> </form> </div> <div class="clearfix"></div> <table class="table table-striped table-bordered table-hover T-showHighLight"> <thead> <tr class="bg-blur"> <th>票务商家</th> <th>账面应付</th> <th>结算金额</th> <th>已付金额 </th> <th>未付金额</th> <th>对账进度</th> <th>付款进度</th> <th>操作</th> </tr> </thead> <tbody class="T-list"> ', 
            $line = 36, $each(financialTicketList, function(rs) {
                $out += ' <tr data-id="', $line = 37, $out += $escape(rs.ticketId), $out += '" data-name="', 
                $line = 37, $out += $escape(rs.ticketName), $out += '"> <td>', $line = 38, $out += $escape(rs.ticketName), 
                $out += '</td> <td class="F-float F-money">', $line = 39, $out += $escape(rs.sumNeedPayMoney), 
                $out += '</td> <td class="F-float F-money">', $line = 40, $out += $escape(rs.sumSettlementMoney), 
                $out += '</td> <td class="F-float F-money">', $line = 41, $out += $escape(rs.sumPayedMoney), 
                $out += '</td> <td class="F-float F-money"><span ', $line = 42, 0 != rs.sumUnPayedMoney && ($out += 'style="color:#FF0000;"', 
                $line = 42), $out += ">", $line = 42, $out += $escape(rs.sumUnPayedMoney), $out += '</span></td> <td><span style="color:#', 
                ...
                $line = 44, rs.payedCount == rs.allPayCount ? ($out += "00CC00", $line = 44) : ($out += "FF9900", 
                $line = 44), $out += ';">', $line = 44, $out += $escape(rs.payedCount), $out += "/", 
                $line = 44, $out += $escape(rs.allPayCount), $out += '</span></td> <td> <a class="cursor T-action T-checking R-right" data-right="1210002">对账</a> <label class="cursor R-right" data-right="1210002|1210003"> <a> |</a></label> <a class="cursor T-action T-balance R-right" data-right="1210003">付款</a> </td> </tr> ', 
                $line = 51;
